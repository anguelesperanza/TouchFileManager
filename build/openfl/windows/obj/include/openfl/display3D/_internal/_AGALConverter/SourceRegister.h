...
class HXCPP_CLASS_ATTRIBUTES SourceRegister_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::display3D::_internal::_AGALConverter::SourceRegister parse(::cpp::Int64 v, ::openfl::display3D::_internal::_AGALConverter::ProgramType programType,int sourceMask);

...
class HXCPP_CLASS_ATTRIBUTES CairoGraphics_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::Dynamic createGradientPattern( ::Dynamic type,::Array< int > colors,::Array< Float > alphas,::Array< int > ratios, ::openfl::geom::Matrix matrix, ::Dynamic spreadMethod, ::Dynamic interpolationMethod,Float focalPointRatio);

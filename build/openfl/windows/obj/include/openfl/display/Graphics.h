...
class HXCPP_CLASS_ATTRIBUTES Graphics_obj : public ::hx::Object
{
	...
	public:
		...
		::Dynamic _hx___hitTest_dyn();
		 ...
		 ::Dynamic _hx___findExtrema(Float p1,Float p2,Float p3,Float p4);
		::Dynamic _hx___findExtrema_dyn();
		...
		void _hx___update( ::openfl::geom::Matrix displayMatrix,Float pixelRatio);

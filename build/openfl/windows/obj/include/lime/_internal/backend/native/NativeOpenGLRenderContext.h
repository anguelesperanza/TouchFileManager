...
class HXCPP_CLASS_ATTRIBUTES NativeOpenGLRenderContext_obj : public ::hx::Object
{
	...
	public:
		...
		int clientWaitSync( ::Dynamic sync,int flags,::cpp::Int64 timeout);
		...
		::cpp::Int64 getInteger64(int pname);
		::Dynamic getInteger64_dyn();

		::cpp::Int64 getInteger64i(int pname);
		...
		void waitSync( ::Dynamic sync,int flags,::cpp::Int64 timeout);

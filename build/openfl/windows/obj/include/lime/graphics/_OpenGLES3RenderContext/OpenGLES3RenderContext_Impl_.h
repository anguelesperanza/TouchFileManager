...
class HXCPP_CLASS_ATTRIBUTES OpenGLES3RenderContext_Impl__obj : public ::hx::Object
{
	...
	public:
		...
		static int clientWaitSync( ::lime::_internal::backend::native::NativeOpenGLRenderContext this1, ::Dynamic sync,int flags,::cpp::Int64 timeout);
		...
		static ::cpp::Int64 getInteger64( ::lime::_internal::backend::native::NativeOpenGLRenderContext this1,int pname);
		static ::Dynamic getInteger64_dyn();

		static ::cpp::Int64 getInteger64i( ::lime::_internal::backend::native::NativeOpenGLRenderContext this1,int pname);
		...
		static void waitSync( ::lime::_internal::backend::native::NativeOpenGLRenderContext this1, ::Dynamic sync,int flags,::cpp::Int64 timeout);

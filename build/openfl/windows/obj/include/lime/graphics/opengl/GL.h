...
class HXCPP_CLASS_ATTRIBUTES GL_obj : public ::hx::Object
{
	...
	public:
		...
		static int clientWaitSync( ::Dynamic sync,int flags,::cpp::Int64 timeout);
		...
		static ::cpp::Int64 getInteger64(int pname);
		static ::Dynamic getInteger64_dyn();

		static ::cpp::Int64 getInteger64i(int pname);
		...
		static void waitSync( ::Dynamic sync,int flags,::cpp::Int64 timeout);

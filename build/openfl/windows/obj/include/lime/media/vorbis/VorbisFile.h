...
class HXCPP_CLASS_ATTRIBUTES VorbisFile_obj : public ::hx::Object
{
	...
	public:
		...
		int pcmSeek(::cpp::Int64 pos);
		::Dynamic pcmSeek_dyn();

		int pcmSeekLap(::cpp::Int64 pos);
		::Dynamic pcmSeekLap_dyn();

		int pcmSeekPage(::cpp::Int64 pos);
		::Dynamic pcmSeekPage_dyn();

		int pcmSeekPageLap(::cpp::Int64 pos);
		::Dynamic pcmSeekPageLap_dyn();

		::cpp::Int64 pcmTell();
		::Dynamic pcmTell_dyn();

		::cpp::Int64 pcmTotal(::hx::Null< int >  bitstream);
		::Dynamic pcmTotal_dyn();

		int rawSeek(::cpp::Int64 pos);
		::Dynamic rawSeek_dyn();

		int rawSeekLap(::cpp::Int64 pos);
		::Dynamic rawSeekLap_dyn();

		::cpp::Int64 rawTell();
		::Dynamic rawTell_dyn();

		::cpp::Int64 rawTotal(::hx::Null< int >  bitstream);

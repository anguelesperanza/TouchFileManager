...
HXDLIN(  36)				return 0;
            			...
            			break;
            			case (int)1: {
HXLINE(  38)				 ::haxe::zip::Huffman a = t->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >();
HXDLIN(  38)				 ::haxe::zip::Huffman b = t->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >();
...
HXDLIN(  41)				return (1 + _hx_tmp);
            			...
            			break;
            			case (int)2: {
HXLINE(  37)				int _g1 = t->_hx_getInt(0);
HXDLIN(  37)				::Array< ::Dynamic> _g2 = t->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE(  51)				 ::haxe::zip::Huffman a = t->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >();
HXDLIN(  51)				 ::haxe::zip::Huffman b = t->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >();

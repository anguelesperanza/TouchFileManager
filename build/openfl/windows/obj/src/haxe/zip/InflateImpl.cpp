...
HXLINE( 174)		 ::haxe::zip::InflateImpl _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 174)		_hx_tmp4->nbits = (_hx_tmp4->nbits - n);
HXLINE( 175)		 ::haxe::zip::InflateImpl _hx_tmp5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 175)		_hx_tmp5->bits = (_hx_tmp5->bits >> n);
HXLINE( 176)		return b;
            	}
...
HXDLIN( 231)				return this->applyHuffman(_hx_tmp);
            			...
            			break;
            			case (int)2: {
HXLINE( 232)				int n1 = h->_hx_getInt(0);
HXDLIN( 232)				::Array< ::Dynamic> tbl = h->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 232)				return this->applyHuffman(tbl->__get(this->getBits(n1)).StaticCast<  ::haxe::zip::Huffman >());
            			}
            			break;
            		}
HXLINE( 229)		return 0;
...
HXLINE( 249)						HX_STACK_DO_THROW(HX_("Invalid data",13,38,70,89));
            					}
...
HXLINE( 256)					if ((i > max)) {
HXLINE( 257)						HX_STACK_DO_THROW(HX_("Invalid data",13,38,70,89));
            					}
            				}
            				break;
            				case (int)18: {
...
HXLINE( 260)					if ((i > max)) {
HXLINE( 261)						HX_STACK_DO_THROW(HX_("Invalid data",13,38,70,89));
            					}
            				}
            				break;
            				default:{
HXLINE( 263)					HX_STACK_DO_THROW(HX_("Invalid data",13,38,70,89));
            				}
            			}
            		}
            	}
...
HXLINE( 274)				if ((cm != 8)) {
HXLINE( 275)					HX_STACK_DO_THROW(HX_("Invalid data",13,38,70,89));
            				}
HXLINE( 276)				int flg = this->input->readByte();
HXLINE( 278)				bool fdict = ((flg & 32) != 0);
HXLINE( 280)				if ((::hx::Mod(((cmf << 8) + flg),31) != 0)) {
HXLINE( 281)					HX_STACK_DO_THROW(HX_("Invalid data",13,38,70,89));
            				}
HXLINE( 282)				if (fdict) {
HXLINE( 283)					HX_STACK_DO_THROW(HX_("Unsupported dictionary",41,65,81,ac));
            				}
...
HXLINE( 306)							HX_STACK_DO_THROW(HX_("Invalid data",13,38,70,89));
            						}
...
HXDLIN( 322)								int i1 = (_g2 - 1);
HXLINE( 323)								this->lengths[::haxe::zip::InflateImpl_obj::CODE_LENGTHS_POS->__get(i1)] = 0;
            							}
            						}
...
HXLINE( 332)						return true;
            					...
            					break;
            					default:{
HXLINE( 334)						HX_STACK_DO_THROW(HX_("Invalid data",13,38,70,89));
            					}
            				}
            			}
            			break;
...
HXLINE( 373)							HX_STACK_DO_THROW(HX_("Invalid data",13,38,70,89));
            						}
HXLINE( 374)						int _hx_tmp1 = ::haxe::zip::InflateImpl_obj::LEN_BASE_VAL_TBL->__get(n);
HXDLIN( 374)						this->len = (_hx_tmp1 + this->getBits(extra_bits));
...
HXLINE( 378)							HX_STACK_DO_THROW(HX_("Invalid data",13,38,70,89));
            						}
HXLINE( 379)						int _hx_tmp2 = ::haxe::zip::InflateImpl_obj::DIST_BASE_VAL_TBL->__get(dist_code);
HXDLIN( 379)						this->dist = (_hx_tmp2 + this->getBits(extra_bits));
HXLINE( 380)						int _hx_tmp3 = this->dist;
HXDLIN( 380)						if ((_hx_tmp3 > this->window->available())) {
HXLINE( 381)							HX_STACK_DO_THROW(HX_("Invalid data",13,38,70,89));
            						}
HXLINE( 382)						 ::haxe::zip::_InflateImpl::State _hx_tmp4;
HXDLIN( 382)						if ((this->dist == 1)) {
HXLINE( 382)							_hx_tmp4 = ::haxe::zip::_InflateImpl::State_obj::DistOne_dyn();
            						}
            						else {
HXLINE( 382)							_hx_tmp4 = ::haxe::zip::_InflateImpl::State_obj::Dist_dyn();
            						}
HXDLIN( 382)						this->state = _hx_tmp4;
...
HXLINE( 339)				 ::haxe::zip::InflateImpl _hx_tmp5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 339)				_hx_tmp5->len = (_hx_tmp5->len - rlen);
HXLINE( 340)				this->addBytes(bytes,0,rlen);
HXLINE( 341)				if ((this->len == 0)) {
HXLINE( 342)					 ::haxe::zip::_InflateImpl::State _hx_tmp6;
HXDLIN( 342)					if (this->isFinal) {
HXLINE( 342)						_hx_tmp6 = ::haxe::zip::_InflateImpl::State_obj::Crc_dyn();
            					}
            					else {
HXLINE( 342)						_hx_tmp6 = ::haxe::zip::_InflateImpl::State_obj::Block_dyn();
            					}
HXDLIN( 342)					this->state = _hx_tmp6;
            				}
...
HXLINE( 294)					HX_STACK_DO_THROW(HX_("Invalid CRC",eb,ac,c2,76));
            				}
...
HXLINE( 352)					bool _hx_tmp7;
HXDLIN( 352)					if ((this->len > 0)) {
HXLINE( 352)						_hx_tmp7 = (this->needed > 0);
            					}
            					else {
HXLINE( 352)						_hx_tmp7 = false;
            					}
...
HXLINE( 354)					int rlen1;
HXDLIN( 354)					if ((this->needed < rdist)) {
HXLINE( 354)						rlen1 = this->needed;
            					}
            					else {
HXLINE( 354)						rlen1 = rdist;
            					}
HXLINE( 355)					this->addDist(this->dist,rlen1);
HXLINE( 356)					 ::haxe::zip::InflateImpl _hx_tmp8 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 356)					_hx_tmp8->len = (_hx_tmp8->len - rlen1);
            				}
            				_hx_goto_22:;
...
HXLINE( 360)				return (this->needed > 0);
            			...
            			break;
            			case (int)6: {
HXLINE( 345)				int rlen2;
HXDLIN( 345)				if ((this->len < this->needed)) {
HXLINE( 345)					rlen2 = this->len;
            				}
            				else {
HXLINE( 345)					rlen2 = this->needed;
            				}
HXLINE( 346)				this->addDistOne(rlen2);
HXLINE( 347)				 ::haxe::zip::InflateImpl _hx_tmp9 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 347)				_hx_tmp9->len = (_hx_tmp9->len - rlen2);

...
HXLINE( 128)					Float columnWidths2 = columnWidths->__get(columnIndex);
HXDLIN( 128)					Float xposChild3 = (xpos + (columnWidths2 - ( (Float)(child->get_componentWidth()) )));
HXDLIN( 128)					Float xposChild4 = (xposChild3 + this->marginLeft(child));
HXDLIN( 128)					xposChild = (xposChild4 - this->marginRight(child));
HXDLIN( 128)					goto _hx_goto_9;
            				}
            				/* default */{
HXLINE( 130)					Float xposChild5 = (xpos + this->marginLeft(child));
HXDLIN( 130)					xposChild = (xposChild5 - this->marginRight(child));
            				}
            				_hx_goto_9:;
...
HXLINE( 134)					Float rowHeights2 = rowHeights->__get(rowIndex);
HXDLIN( 134)					Float yposChild3 = (ypos + ((rowHeights2 - ( (Float)(child->get_componentHeight()) )) * ((Float)0.5)));
HXDLIN( 134)					Float yposChild4 = (yposChild3 + this->marginTop(child));
HXDLIN( 134)					yposChild = (yposChild4 - this->marginBottom(child));
HXDLIN( 134)					goto _hx_goto_10;
            				}
            				/* default */{
HXLINE( 138)					Float yposChild5 = (ypos + this->marginTop(child));
HXDLIN( 138)					yposChild = (yposChild5 - this->marginBottom(child));
            				}
            				_hx_goto_10:;
HXLINE( 141)				child->moveComponent(xposChild,yposChild);
HXLINE( 143)				Float rowHeights3 = rowHeights->__get(rowIndex);
HXDLIN( 143)				ypos = (ypos + (rowHeights3 + this->get_verticalSpacing()));
HXLINE( 145)				rowIndex = (rowIndex + 1);
HXLINE( 146)				if ((rowIndex >= this->_rows)) {
HXLINE( 147)					ypos = this->get_paddingTop();
HXLINE( 148)					Float columnWidths3 = columnWidths->__get(columnIndex);
HXDLIN( 148)					xpos = (xpos + (columnWidths3 + this->get_horizontalSpacing()));
...
HXLINE( 175)				 ::haxe::ui::core::Component child1 = _g5->__get(_g4).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 175)				_g4 = (_g4 + 1);
HXLINE( 177)				if ((child1->get_includeInLayout() == false)) {
HXLINE( 178)					continue;
            				}
HXLINE( 181)				if (::hx::IsNull( child1->get_percentWidth() )) {
HXLINE( 182)					 ::Dynamic _hx_tmp = child1->get_componentWidth();
HXDLIN( 182)					if (::hx::IsGreater( _hx_tmp,columnWidths->__get(columnIndex) )) {
HXLINE( 183)						columnWidths[columnIndex] = ( (Float)(child1->get_componentWidth()) );
            					}
            				}
...
HXDLIN( 196)				 ::haxe::ui::core::Component _this3 = this->get_component();
HXDLIN( 196)				::Array< ::Dynamic> _g7;
HXDLIN( 196)				if (::hx::IsNull( _this3->_children )) {
HXLINE( 196)					_g7 = ::Array_obj< ::Dynamic>::__new(0);
            				}
            				else {
HXLINE( 196)					_g7 = _this3->_children;
            				}
HXDLIN( 196)				while((_g6 < _g7->length)){
HXLINE( 196)					 ::haxe::ui::core::Component child2 = _g7->__get(_g6).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 196)					_g6 = (_g6 + 1);
HXLINE( 198)					if ((child2->get_includeInLayout() == false)) {
HXLINE( 199)						continue;
            					}
HXLINE( 202)					if (::hx::IsNotNull( child2->get_percentWidth() )) {
HXLINE( 203)						Float usableSize1 = usableSize->width;
HXDLIN( 203)						Float cx = ((usableSize1 * ( (Float)(child2->get_percentWidth()) )) / ( (Float)(100) ));
HXLINE( 204)						bool _hx_tmp1;
HXDLIN( 204)						if ((cx > columnWidths->__get(rowIndex))) {
HXLINE( 204)							_hx_tmp1 = (this->_rows == 1);
            						}
            						else {
...
HXDLIN( 251)				 ::haxe::ui::core::Component _this1 = this->get_component();
HXDLIN( 251)				::Array< ::Dynamic> _g5;
HXDLIN( 251)				if (::hx::IsNull( _this1->_children )) {
HXLINE( 251)					_g5 = ::Array_obj< ::Dynamic>::__new(0);
            				}
            				else {
HXLINE( 251)					_g5 = _this1->_children;
            				}
HXDLIN( 251)				while((_g4 < _g5->length)){
HXLINE( 251)					 ::haxe::ui::core::Component child1 = _g5->__get(_g4).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 251)					_g4 = (_g4 + 1);
HXLINE( 253)					if ((child1->get_includeInLayout() == false)) {
HXLINE( 254)						continue;
            					}
HXLINE( 256)					if (::hx::IsNotNull( child1->get_percentHeight() )) {
HXLINE( 257)						Float usableSize1 = usableSize->height;
HXDLIN( 257)						Float cy = ((usableSize1 * ( (Float)(child1->get_percentHeight()) )) / ( (Float)(100) ));
...
HXLINE( 293)				 ::haxe::ui::core::Component child1 = _g5->__get(_g4).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 293)				_g4 = (_g4 + 1);
HXLINE( 294)				if ((child1->get_includeInLayout() == false)) {
HXLINE( 295)					continue;
            				}
HXLINE( 298)				bool _hx_tmp;
HXDLIN( 298)				if (::hx::IsNull( child1->get_percentWidth() )) {
HXLINE( 298)					_hx_tmp = ::hx::IsGreater( child1->get_componentWidth(),0 );
            				}
            				else {

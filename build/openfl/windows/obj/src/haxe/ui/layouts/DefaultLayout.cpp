...
HXLINE(  18)		{
HXLINE(  18)			int _g = 0;
HXDLIN(  18)			 ::haxe::ui::core::Component _this1 = this->get_component();
HXDLIN(  18)			::Array< ::Dynamic> _g1;
HXDLIN(  18)			if (::hx::IsNull( _this1->_children )) {
HXLINE(  18)				_g1 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE(  18)				_g1 = _this1->_children;
            			}
...
HXLINE(  23)					_hx_tmp2 = ::hx::IsNotEq( child->get_percentWidth(),100 );
            				}
            				else {
...
HXDLIN(  30)			 ::haxe::ui::core::Component _this2 = this->get_component();
HXDLIN(  30)			::Array< ::Dynamic> remainderWidth1;
HXDLIN(  30)			if (::hx::IsNull( _this2->_children )) {
HXLINE(  30)				remainderWidth1 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE(  30)				remainderWidth1 = _this2->_children;
            			}
...
HXLINE(  33)				{
HXLINE(  33)					int _g2 = 0;
HXDLIN(  33)					 ::haxe::ui::core::Component _this3 = this->get_component();
HXDLIN(  33)					::Array< ::Dynamic> _g3;
HXDLIN(  33)					if (::hx::IsNull( _this3->_children )) {
HXLINE(  33)						_g3 = ::Array_obj< ::Dynamic>::__new(0);
            					}
            					else {
HXLINE(  33)						_g3 = _this3->_children;
            					}
HXDLIN(  33)					while((_g2 < _g3->length)){
HXLINE(  33)						 ::haxe::ui::core::Component child1 = _g3->__get(_g2).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN(  33)						_g2 = (_g2 + 1);
HXLINE(  34)						if ((child1->get_includeInLayout() == false)) {
HXLINE(  35)							continue;
            						}
HXLINE(  38)						int n = 0;
...
HXLINE(  66)						_hx_tmp2 = ::hx::IsNotNull( child->get_percentWidth() );
            					}
            					else {
HXLINE(  66)						_hx_tmp2 = false;
            					}
HXDLIN(  66)					if (_hx_tmp2) {
HXLINE(  66)						_hx_tmp1 = ::hx::IsEq( child->get_percentWidth(),100 );
            					}
            					else {
...
HXLINE(  69)						_hx_tmp4 = ::hx::IsNotNull( child->get_percentHeight() );
            					}
            					else {
HXLINE(  69)						_hx_tmp4 = false;
            					}
HXDLIN(  69)					if (_hx_tmp4) {
HXLINE(  69)						_hx_tmp3 = ::hx::IsEq( child->get_percentHeight(),100 );
            					}
            					else {
...
HXLINE(  89)		{
HXLINE(  89)			int _g2 = 0;
HXDLIN(  89)			 ::haxe::ui::core::Component _this1 = this->get_component();
HXDLIN(  89)			::Array< ::Dynamic> _g3;
HXDLIN(  89)			if (::hx::IsNull( _this1->_children )) {
HXLINE(  89)				_g3 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE(  89)				_g3 = _this1->_children;
            			}
HXDLIN(  89)			while((_g2 < _g3->length)){
HXLINE(  89)				 ::haxe::ui::core::Component child1 = _g3->__get(_g2).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN(  89)				_g2 = (_g2 + 1);
HXLINE(  90)				if ((child1->get_includeInLayout() == false)) {
HXLINE(  91)					continue;
            				}
HXLINE(  94)				 ::Dynamic cx = null();
HXLINE(  95)				 ::Dynamic cy = null();
HXLINE(  97)				if (::hx::IsNotNull( child1->get_percentWidth() )) {
HXLINE(  98)					 ::Dynamic childPercentWidth = child1->get_percentWidth();
...
HXDLIN( 102)					Float cx2 = (cx1 - this->marginLeft(child1));
HXDLIN( 102)					cx = (cx2 - this->marginRight(child1));
HXLINE( 103)					bool _hx_tmp5;
HXDLIN( 103)					if (::hx::IsNotNull( childRoundingWidth )) {
HXLINE( 103)						_hx_tmp5 = childRoundingWidth->exists(child1);
            					}
            					else {
HXLINE( 103)						_hx_tmp5 = false;
            					}
HXDLIN( 103)					if (_hx_tmp5) {
HXLINE( 104)						 ::Dynamic roundDirection = childRoundingWidth->get(child1);
...
HXLINE( 120)				if (::hx::IsNotNull( child1->get_percentHeight() )) {
HXLINE( 121)					 ::Dynamic childPercentHeight = child1->get_percentHeight();
...
HXDLIN( 125)					Float cy2 = (cy1 - this->marginTop(child1));
HXDLIN( 125)					cy = (cy2 - this->marginBottom(child1));
            				}
HXLINE( 136)				bool _hx_tmp6;
HXDLIN( 136)				if (this->fixedMinWidth(child1)) {
HXLINE( 136)					_hx_tmp6 = ::hx::IsNotNull( child1->get_percentWidth() );
            				}
            				else {
HXLINE( 136)					_hx_tmp6 = false;
            				}
HXDLIN( 136)				if (_hx_tmp6) {
HXLINE( 137)					percentWidth = (percentWidth - ( (Float)(child1->get_percentWidth()) ));
            				}
HXLINE( 139)				bool _hx_tmp7;
HXDLIN( 139)				if (this->fixedMinHeight(child1)) {
HXLINE( 139)					_hx_tmp7 = ::hx::IsNotNull( child1->get_percentHeight() );
            				}
            				else {
HXLINE( 139)					_hx_tmp7 = false;
            				}
HXDLIN( 139)				if (_hx_tmp7) {
HXLINE( 140)					percentHeight = (percentHeight - ( (Float)(child1->get_percentHeight()) ));
            				}
HXLINE( 143)				child1->resizeComponent(cx,cy);
            			}
            		}
            	}
...
HXLINE( 162)					 ::Dynamic xpos4 = this->get_component()->get_componentWidth();
HXDLIN( 162)					 ::Dynamic xpos5 = child->get_componentWidth();
HXDLIN( 162)					Float xpos6 = (xpos5 + this->get_paddingRight());
HXDLIN( 162)					xpos = (( (Float)(xpos4) ) - (xpos6 + this->marginRight(child)));
HXDLIN( 162)					goto _hx_goto_8;
            				}
            				/* default */{
HXLINE( 164)					Float xpos7 = this->get_paddingLeft();
HXDLIN( 164)					xpos = (xpos7 + this->marginLeft(child));
            				}
            				_hx_goto_8:;
...
HXLINE( 169)					Float usableSize2 = usableSize->height;
HXDLIN( 169)					Float ypos4 = ((usableSize2 - ( (Float)(child->get_componentHeight()) )) / ( (Float)(2) ));
HXDLIN( 169)					Float ypos5 = (ypos4 + this->get_paddingTop());
HXDLIN( 169)					Float ypos6 = (ypos5 + this->marginTop(child));
HXDLIN( 169)					ypos = (ypos6 - this->marginBottom(child));
HXDLIN( 169)					goto _hx_goto_9;
            				}
            				/* default */{
HXLINE( 173)					Float ypos7 = this->get_paddingTop();
HXDLIN( 173)					ypos = (ypos7 + this->marginTop(child));
            				}
            				_hx_goto_9:;

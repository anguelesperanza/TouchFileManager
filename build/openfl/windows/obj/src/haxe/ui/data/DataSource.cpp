...
void DataSource_obj::sort(::String field,::String direction){
            		HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0,::String,field1, ::haxe::ui::data::DataSource,_g) HXARGC(3)
            		int _hx_run( ::Dynamic o1, ::Dynamic o2,::String direction){
            			HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_161_sort)
HXDLIN( 161)			return _g->sortByFn(o1,o2,direction,field1);
            		}
            		HX_END_LOCAL_FUNC3(return)

            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_161_sort)
HXDLIN( 161)		 ::haxe::ui::data::DataSource _g = ::hx::ObjectPtr<OBJ_>(this);

...
HXLINE( 162)				{
HXLINE( 162)					 ::Dynamic eventType2 = this->_disabledEvents->keys();
HXDLIN( 162)					while(( (bool)(eventType2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 162)						::String eventType3 = ( (::String)(eventType2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 163)						 ::haxe::ui::util::FunctionArray listeners1 = this->_disabledEvents->listeners(eventType3);
HXLINE( 164)						if (::hx::IsNotNull( listeners1 )) {
HXLINE( 165)							 ::Dynamic listener2 = listeners1->copy()->iterator();
HXDLIN( 165)							while(( (bool)(listener2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 165)								 ::haxe::ui::util::_Listener::ListenerInternal listener3 = ( ( ::haxe::ui::util::_Listener::ListenerInternal)(listener2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 166)								this->registerEvent(eventType3,::haxe::ui::util::_Listener::Listener_Impl__obj::toFunc(listener3),null());
            							}
            						}
            					}
            				}
...
HXLINE( 202)				_hx_tmp1 = (this->_interactivityDisabled == true);
            			}
            			else {
...
HXLINE( 230)					::String eventType2 = copy->__get(_g);
HXDLIN( 230)					_g = (_g + 1);
HXLINE( 231)					 ::haxe::ui::util::FunctionArray listeners = this->_hx___events->listeners(eventType2);
...
HXDLIN( 235)								if ((_hx_tmp->remove(eventType2,::haxe::ui::util::_Listener::Listener_Impl__obj::toFunc(listener1)) == true)) {
HXLINE( 236)									this->unmapEvent(eventType2,this->_onMappedEvent_dyn());
            								}
            							}
            						}
            					}

...
HXLINE(  93)				HX_STACK_DO_THROW(HX_("The validation queue returned too many times during validation. This may be an infinite loop. Try to avoid doing anything that calls invalidate() during validation.",74,3c,c2,7e));
            			}
...
HXDLIN( 111)			::Array< ::Dynamic> _g3;
HXDLIN( 111)			if (::hx::IsNull( this->_children )) {
HXLINE( 111)				_g3 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE( 111)				_g3 = this->_children;
            			}
HXDLIN( 111)			while((_g2 < _g3->length)){
HXLINE( 111)				 ::haxe::ui::core::Component child1 = _g3->__get(_g2).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 111)				_g2 = (_g2 + 1);
HXLINE( 112)				child1->invalidateComponent(flag,recursive);
            			}
            		}
            	}
...
HXDLIN( 239)					HX_STACK_DO_THROW(((_hx_tmp + this->get_id()) + HX_(")",29,00,00,00)));
            				}
            				else {
HXLINE( 244)					::String _hx_tmp1 = ((HX_("The syncValidation returned too many times during validation. This may be an infinite loop. Try to avoid doing anything that calls invalidate() during validation (",78,cf,c5,85) + ::Type_obj::getClassName(::Type_obj::getClass(::hx::ObjectPtr<OBJ_>(this)))) + HX_("#",23,00,00,00));
HXDLIN( 244)					HX_STACK_DO_THROW(((_hx_tmp1 + this->get_id()) + HX_(").",e5,23,00,00)));
            				}
            			}
            		}
            	}

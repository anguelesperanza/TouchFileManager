...
HXLINE( 152)					_hx_tmp1 = layoutProps->exists(HX_("class",38,78,58,48));
            				}
            				else {
...
HXLINE( 559)				_hx_tmp1 = (this->_layoutLocked == true);
            			}
            			else {
...
HXLINE( 666)				_hx_tmp1 = (this->_layoutLocked == true);
            			}
            			else {
...
HXLINE( 685)			::Array< ::Dynamic> _hx_tmp1;
HXDLIN( 685)			if (::hx::IsNull( this->_children )) {
HXLINE( 685)				_hx_tmp1 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE( 685)				_hx_tmp1 = this->_children;
            			}
HXDLIN( 685)			_hx_tmp1->__get(0).StaticCast<  ::haxe::ui::core::Component >()->addClasses(::Array_obj< ::String >::fromData( _hx_array_data_1376d360_36,2),invalidate,null());
HXLINE( 686)			return;
            		}
HXLINE( 688)		{
HXLINE( 688)			int _g = 0;
...
HXDLIN( 692)					::Array< ::Dynamic> _hx_tmp3;
HXDLIN( 692)					if (::hx::IsNull( this->_children )) {
HXLINE( 692)						_hx_tmp3 = ::Array_obj< ::Dynamic>::__new(0);
            					}
            					else {
HXLINE( 692)						_hx_tmp3 = this->_children;
            					}
HXDLIN( 692)					if ((_hx_tmp3->length > 1)) {
HXLINE( 692)						::Array< ::Dynamic> _hx_tmp4;
HXDLIN( 692)						if (::hx::IsNull( this->_children )) {
HXLINE( 692)							_hx_tmp4 = ::Array_obj< ::Dynamic>::__new(0);
            						}
            						else {
HXLINE( 692)							_hx_tmp4 = this->_children;
            						}
HXDLIN( 692)						_hx_tmp2 = (i == (_hx_tmp4->length - 1));
            					}
            					else {
...
HXDLIN( 802)				::Array< ::Dynamic> _g3;
HXDLIN( 802)				if (::hx::IsNull( this->_children )) {
HXLINE( 802)					_g3 = ::Array_obj< ::Dynamic>::__new(0);
            				}
            				else {
HXLINE( 802)					_g3 = this->_children;
            				}
HXDLIN( 802)				while((_g2 < _g3->length)){
HXLINE( 802)					 ::haxe::ui::core::Component child1 = _g3->__get(_g2).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 802)					_g2 = (_g2 + 1);
HXLINE( 803)					 ::haxe::ui::core::Component temp = ( ( ::haxe::ui::core::Component)(child1->findComponent(criteria,type,recursive,searchType)) );
...
HXLINE( 809)				_hx_tmp3 = ::hx::IsNotNull( this->_compositeBuilder );
            			}
            			else {
...
HXLINE( 845)		{
HXLINE( 845)			int _g1 = 0;
HXDLIN( 845)			::Array< ::Dynamic> _g2;
HXDLIN( 845)			if (::hx::IsNull( this->_children )) {
HXLINE( 845)				_g2 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE( 845)				_g2 = this->_children;
            			}
HXDLIN( 845)			while((_g1 < _g2->length)){
HXLINE( 845)				 ::haxe::ui::core::Component child = _g2->__get(_g1).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 845)				_g1 = (_g1 + 1);
...
HXLINE( 857)					::cpp::VirtualArray childArray1 = child->findComponents(styleName,type,maxDepth);
HXLINE( 858)					{
HXLINE( 858)						int _g3 = 0;
HXDLIN( 858)						while((_g3 < childArray1->get_length())){
HXLINE( 858)							 ::Dynamic c1 = childArray1->__get(_g3);
HXDLIN( 858)							_g3 = (_g3 + 1);
HXLINE( 859)							r->push(c1);
            						}
            					}
            				}
            			}
...
HXLINE( 969)			index1 = this->_children->indexOf(child,null());
            		}
HXLINE( 971)		return index1;
            	}
...
HXLINE( 992)					_hx_tmp2 = (this->_layoutLocked == true);
            				}
            				else {
HXLINE( 992)					_hx_tmp2 = true;
            				}
HXDLIN( 992)				if (!(_hx_tmp2)) {
...
HXLINE(1084)					_hx_tmp1 = (_this->_layoutLocked == true);
            				}
            				else {
...
HXLINE(1104)					_hx_tmp1 = (_this->_layoutLocked == true);
            				}
            				else {
HXLINE(1104)					_hx_tmp1 = true;
            				}
...
HXLINE(1272)			int _g1 = 0;
HXDLIN(1272)			::Array< ::Dynamic> _g2;
HXDLIN(1272)			if (::hx::IsNull( this->_children )) {
HXLINE(1272)				_g2 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE(1272)				_g2 = this->_children;
            			}
HXDLIN(1272)			while((_g1 < _g2->length)){
HXLINE(1272)				 ::haxe::ui::core::Component child = _g2->__get(_g1).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN(1272)				_g1 = (_g1 + 1);
...
HXDLIN(1325)			::Array< ::Dynamic> _g2;
HXDLIN(1325)			if (::hx::IsNull( this->_children )) {
HXLINE(1325)				_g2 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE(1325)				_g2 = this->_children;
            			}
HXDLIN(1325)			while((_g1 < _g2->length)){
HXLINE(1325)				 ::haxe::ui::core::Component child = _g2->__get(_g1).StaticCast<  ::haxe::ui::core::Component >();
...
HXDLIN(1415)			::Array< ::String > _g3 = this->_styleNamesList;
HXDLIN(1415)			while((_g2 < _g3->length)){
HXLINE(1415)				::String x1 = _g3->__get(_g2);
HXDLIN(1415)				_g2 = (_g2 + 1);
HXLINE(1416)				if ((newStyleNamesList->indexOf(x1,null()) == -1)) {
HXLINE(1417)					classesToRemove->push(x1);
...
HXLINE(1426)			{
HXLINE(1426)				int _g4 = 0;
HXDLIN(1426)				while((_g4 < classesToAdd->length)){
HXLINE(1426)					::String x2 = classesToAdd->__get(_g4);
HXDLIN(1426)					_g4 = (_g4 + 1);
HXLINE(1427)					this->addClass(x2,false,false);
            				}
            			}
HXLINE(1429)			{
HXLINE(1429)				int _g5 = 0;
HXDLIN(1429)				while((_g5 < classesToRemove->length)){
HXLINE(1429)					::String x3 = classesToRemove->__get(_g5);
HXDLIN(1429)					_g5 = (_g5 + 1);
HXLINE(1430)					this->removeClass(x3,false,false);
            				}
            			}
...
HXLINE(1624)					 ::haxe::ui::core::Component _gthis2 = _gthis;
HXDLIN(1624)					_gthis2->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("shown",d1,88,27,7c),null(),null()));
            				}
            			}
...
HXDLIN(1839)			bool _hx_tmp3;
HXDLIN(1839)			if (::hx::IsNull( this->_style->initialWidth )) {
HXLINE(1839)				_hx_tmp3 = ::hx::IsNotNull( this->_style->initialPercentWidth );
            			}
            			else {
HXLINE(1839)				_hx_tmp3 = true;
            			}
HXDLIN(1839)			if (_hx_tmp3) {
HXLINE(1839)				if ((this->get_width() <= 0)) {
HXLINE(1839)					_hx_tmp2 = ::hx::IsNull( this->get_percentWidth() );
            				}
            				else {
...
HXLINE(1849)			bool _hx_tmp4;
HXDLIN(1849)			bool _hx_tmp5;
HXDLIN(1849)			if (::hx::IsNull( this->_style->initialHeight )) {
HXLINE(1849)				_hx_tmp5 = ::hx::IsNotNull( this->_style->initialPercentHeight );
            			}
            			else {
HXLINE(1849)				_hx_tmp5 = true;
            			}
HXDLIN(1849)			if (_hx_tmp5) {
HXLINE(1849)				if ((this->get_height() <= 0)) {
HXLINE(1849)					_hx_tmp4 = ::hx::IsNull( this->get_percentHeight() );
            				}
            				else {
HXLINE(1849)					_hx_tmp4 = false;
            				}
            			}
            			else {
HXLINE(1849)				_hx_tmp4 = false;
            			}
HXDLIN(1849)			if (_hx_tmp4) {
...
HXDLIN(1888)				bool _hx_tmp1;
HXDLIN(1888)				if (::hx::IsNotNull( _this->_layout )) {
HXLINE(1888)					_hx_tmp1 = (_this->_layoutLocked == true);
            				}
            				else {
HXLINE(1888)					_hx_tmp1 = true;
            				}
...
HXDLIN(1914)			bool _hx_tmp3;
HXDLIN(1914)			if (::hx::IsNotNull( this->get_style()->maxWidth )) {
HXLINE(1914)				_hx_tmp3 = ::hx::IsNull( this->get_style()->maxPercentWidth );
            			}
            			else {
HXLINE(1914)				_hx_tmp3 = false;
            			}
HXDLIN(1914)			if (_hx_tmp3) {
HXLINE(1914)				 ::Dynamic _hx_tmp4 = this->_componentWidth;
HXDLIN(1914)				_hx_tmp2 = ::hx::IsGreater( _hx_tmp4,this->get_style()->maxWidth );
            			}
            			else {
...
HXLINE(1916)				bool _hx_tmp5;
HXDLIN(1916)				if (::hx::IsNull( this->get_style()->maxWidth )) {
HXLINE(1916)					_hx_tmp5 = ::hx::IsNotNull( this->get_style()->maxPercentWidth );
            				}
            				else {
HXLINE(1916)					_hx_tmp5 = false;
            				}
HXDLIN(1916)				if (_hx_tmp5) {
HXLINE(1917)					 ::haxe::ui::core::Component p = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(1918)					Float max = ( (Float)(0) );
HXLINE(1919)					while(::hx::IsNotNull( p )){
HXLINE(1920)						bool _hx_tmp6;
HXDLIN(1920)						if (::hx::IsNotNull( p->get_style() )) {
HXLINE(1920)							_hx_tmp6 = ::hx::IsNull( p->get_style()->maxPercentWidth );
            						}
            						else {
HXLINE(1920)							_hx_tmp6 = false;
            						}
HXDLIN(1920)						if (_hx_tmp6) {
HXLINE(1921)							max = (max + p->get_width());
HXLINE(1922)							goto _hx_goto_128;
            						}
HXLINE(1924)						bool _hx_tmp7;
HXDLIN(1924)						if (::hx::IsNotNull( p->get_style() )) {
HXLINE(1924)							_hx_tmp7 = ::hx::IsInstanceNotEq( p,::hx::ObjectPtr<OBJ_>(this) );
            						}
            						else {
HXLINE(1924)							_hx_tmp7 = false;
            						}
HXDLIN(1924)						if (_hx_tmp7) {
...
HXLINE(1930)					bool _hx_tmp8;
HXDLIN(1930)					if ((max > 0)) {
HXLINE(1930)						_hx_tmp8 = ::hx::IsGreater( this->_componentWidth,max );
            					}
            					else {
HXLINE(1930)						_hx_tmp8 = false;
            					}
HXDLIN(1930)					if (_hx_tmp8) {
HXLINE(1931)						this->_componentWidth = (this->_actualWidth = (this->_width = max));
            					}
            				}
            			}
HXLINE(1936)			bool _hx_tmp9;
HXDLIN(1936)			if (::hx::IsNotNull( this->get_style()->minHeight )) {
HXLINE(1936)				 ::Dynamic _hx_tmp10 = this->_componentHeight;
HXDLIN(1936)				_hx_tmp9 = ::hx::IsLess( _hx_tmp10,this->get_style()->minHeight );
            			}
            			else {
HXLINE(1936)				_hx_tmp9 = false;
            			}
HXDLIN(1936)			if (_hx_tmp9) {
HXLINE(1937)				this->_componentHeight = (this->_actualHeight = (this->_height = this->get_style()->minHeight));
            			}
HXLINE(1941)			bool _hx_tmp11;
HXDLIN(1941)			bool _hx_tmp12;
HXDLIN(1941)			if (::hx::IsNotNull( this->get_style()->maxHeight )) {
HXLINE(1941)				_hx_tmp12 = ::hx::IsNull( this->get_style()->maxPercentHeight );
            			}
            			else {
HXLINE(1941)				_hx_tmp12 = false;
            			}
HXDLIN(1941)			if (_hx_tmp12) {
HXLINE(1941)				 ::Dynamic _hx_tmp13 = this->_componentHeight;
HXDLIN(1941)				_hx_tmp11 = ::hx::IsGreater( _hx_tmp13,this->get_style()->maxHeight );
            			}
            			else {
HXLINE(1941)				_hx_tmp11 = false;
            			}
HXDLIN(1941)			if (_hx_tmp11) {
HXLINE(1942)				this->_componentHeight = (this->_actualHeight = (this->_height = this->get_style()->maxHeight));
            			}
            			else {
HXLINE(1943)				bool _hx_tmp14;
HXDLIN(1943)				if (::hx::IsNull( this->get_style()->maxHeight )) {
HXLINE(1943)					_hx_tmp14 = ::hx::IsNotNull( this->get_style()->maxPercentHeight );
            				}
            				else {
HXLINE(1943)					_hx_tmp14 = false;
            				}
HXDLIN(1943)				if (_hx_tmp14) {
HXLINE(1944)					 ::haxe::ui::core::Component p1 = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(1945)					Float max2 = ( (Float)(0) );
HXLINE(1946)					while(::hx::IsNotNull( p1 )){
HXLINE(1947)						bool _hx_tmp15;
HXDLIN(1947)						if (::hx::IsNotNull( p1->get_style() )) {
HXLINE(1947)							_hx_tmp15 = ::hx::IsNull( p1->get_style()->maxPercentHeight );
            						}
            						else {
HXLINE(1947)							_hx_tmp15 = false;
            						}
HXDLIN(1947)						if (_hx_tmp15) {
HXLINE(1948)							max2 = (max2 + p1->get_height());
HXLINE(1949)							goto _hx_goto_129;
            						}
HXLINE(1951)						bool _hx_tmp16;
HXDLIN(1951)						if (::hx::IsNotNull( p1->get_style() )) {
HXLINE(1951)							_hx_tmp16 = ::hx::IsInstanceNotEq( p1,::hx::ObjectPtr<OBJ_>(this) );
            						}
            						else {
HXLINE(1951)							_hx_tmp16 = false;
            						}
HXDLIN(1951)						if (_hx_tmp16) {
HXLINE(1952)							 ::Dynamic max3 = p1->get_style()->paddingTop;
HXDLIN(1952)							max2 = (max2 - (max3 + p1->get_style()->paddingBottom));
            						}
HXLINE(1954)						p1 = p1->parentComponent;
            					}
            					_hx_goto_129:;
HXLINE(1956)					max2 = ((max2 * ( (Float)(this->get_style()->maxPercentHeight) )) / ( (Float)(100) ));
HXLINE(1957)					bool _hx_tmp17;
HXDLIN(1957)					if ((max2 > 0)) {
HXLINE(1957)						_hx_tmp17 = ::hx::IsGreater( this->_componentHeight,max2 );
            					}
            					else {
HXLINE(1957)						_hx_tmp17 = false;
            					}
HXDLIN(1957)					if (_hx_tmp17) {
HXLINE(1958)						this->_componentHeight = (this->_actualHeight = (this->_height = max2));
            					}
            				}
            			}
            		}
...
HXLINE(1975)				_hx_tmp1 = ::hx::IsNotNull( this->_style );
            			}
            			else {
...
HXLINE(1979)			bool _hx_tmp2;
HXDLIN(1979)			if (::hx::IsNotNull( this->_style )) {
HXLINE(1979)				 ::Dynamic _hx_tmp3 = this->_style->get_fullBorderSize();
HXDLIN(1979)				_hx_tmp2 = ::hx::IsNotEq( _hx_tmp3,s->get_fullBorderSize() );
            			}
            			else {
...
HXLINE(1986)				bool _hx_tmp4;
HXDLIN(1986)				if (::hx::IsNotNull( this->_layout )) {
HXLINE(1986)					_hx_tmp4 = (this->_layoutLocked == true);
            				}
            				else {
HXLINE(1986)					_hx_tmp4 = true;
            				}
HXDLIN(1986)				if (!(_hx_tmp4)) {
...
HXDLIN(1989)				bool _hx_tmp5;
HXDLIN(1989)				if (::hx::IsNotNull( _this->_layout )) {
HXLINE(1989)					_hx_tmp5 = (_this->_layoutLocked == true);
            				}
            				else {
HXLINE(1989)					_hx_tmp5 = true;
            				}
HXDLIN(1989)				if (!(_hx_tmp5)) {
...
HXLINE(2014)			bool _hx_tmp4;
HXDLIN(2014)			if (::hx::IsNotNull( this->get_style() )) {
HXLINE(2014)				_hx_tmp4 = ::hx::IsNotNull( this->get_style()->clip );
            			}
            			else {
HXLINE(2014)				_hx_tmp4 = false;
            			}
HXDLIN(2014)			if (_hx_tmp4) {
...
HXLINE(2015)			 ::haxe::ui::geom::Rectangle _hx_tmp5;
HXDLIN(2015)			if (::hx::IsNotNull( this->_componentClipRect )) {
HXLINE(2015)				_hx_tmp5 = this->_componentClipRect;
            			}
            			else {
HXLINE(2015)				 ::Dynamic _hx_tmp6 = this->get_componentWidth();
HXDLIN(2015)				_hx_tmp5 =  ::haxe::ui::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,_hx_tmp6,this->get_componentHeight());
            			}
HXDLIN(2015)			this->handleClipRect(_hx_tmp5);
            		}
            	}
...
HXDLIN(2049)			bool _hx_tmp2;
HXDLIN(2049)			if (::hx::IsNull( style->initialWidth )) {
HXLINE(2049)				_hx_tmp2 = ::hx::IsNotNull( style->initialPercentWidth );
            			}
            			else {
HXLINE(2049)				_hx_tmp2 = true;
            			}
HXDLIN(2049)			if (_hx_tmp2) {
HXLINE(2049)				if ((this->get_width() <= 0)) {
HXLINE(2049)					_hx_tmp1 = ::hx::IsNull( this->get_percentWidth() );
            				}
            				else {
...
HXDLIN(2059)			bool _hx_tmp4;
HXDLIN(2059)			if (::hx::IsNull( style->initialHeight )) {
HXLINE(2059)				_hx_tmp4 = ::hx::IsNotNull( style->initialPercentHeight );
            			}
            			else {
HXLINE(2059)				_hx_tmp4 = true;
            			}
HXDLIN(2059)			if (_hx_tmp4) {
HXLINE(2059)				if ((this->get_height() <= 0)) {
HXLINE(2059)					_hx_tmp3 = ::hx::IsNull( this->get_percentHeight() );
            				}
            				else {
HXLINE(2059)					_hx_tmp3 = false;
            				}
            			}
            			else {
HXLINE(2059)				_hx_tmp3 = false;
...
HXLINE(2113)			_hx_tmp5 = (style->pointerEvents != HX_("none",b8,12,0a,49));
            		}
            		else {
...
HXLINE(2178)			bool _hx_tmp3;
HXDLIN(2178)			if (::hx::IsNotNull( this->_componentAnimation )) {
HXLINE(2178)				_hx_tmp3 = (this->_componentAnimation->name == animationKeyFrames->id);
            			}
            			else {
HXLINE(2178)				_hx_tmp3 = false;
            			}
HXDLIN(2178)			if (_hx_tmp3) {
...
HXLINE(2219)			 ::haxe::ui::styles::Style _hx_tmp3 = c->get_customStyle();
HXDLIN(2219)			_hx_tmp3->apply(this->get_customStyle());
            		}
HXLINE( 456)		{
HXLINE( 457)			::Array< ::Dynamic> _hx_tmp4;
HXDLIN( 457)			if (::hx::IsNull( this->_children )) {
HXLINE( 457)				_hx_tmp4 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE( 457)				_hx_tmp4 = this->_children;
            			}
HXDLIN( 457)			::Array< ::Dynamic> _hx_tmp5;
HXDLIN( 457)			if (::hx::IsNull( c->_children )) {
HXLINE( 457)				_hx_tmp5 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE( 457)				_hx_tmp5 = c->_children;
            			}
HXDLIN( 457)			if ((_hx_tmp4->length != _hx_tmp5->length)) {
HXLINE( 458)				int _g = 0;
...
HXLINE(2255)				_hx_tmp1 = ::hx::IsGreater( this->get_style()->opacity,0 );
            			}
            			else {
HXLINE(2255)				_hx_tmp1 = true;
            			}
HXDLIN(2255)			if (_hx_tmp1) {
HXLINE(2256)				bool _hx_tmp2;
HXDLIN(2256)				if (::hx::IsNotNull( this->get_style()->backgroundOpacity )) {
HXLINE(2256)					_hx_tmp2 = ::hx::IsGreater( this->get_style()->backgroundOpacity,0 );
            				}
            				else {
HXLINE(2256)					_hx_tmp2 = true;
            				}
HXDLIN(2256)				if (_hx_tmp2) {

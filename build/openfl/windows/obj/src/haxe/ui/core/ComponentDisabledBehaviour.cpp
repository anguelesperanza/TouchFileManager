...
HXLINE( 298)			 ::haxe::ui::core::Component _hx_tmp1 = this->_component;
HXDLIN( 298)			_hx_tmp1->disableInteractivity(::haxe::ui::util::_Variant::Variant_Impl__obj::toBool(value),true,true,null());
            		}
            	}

...
HXLINE(  76)				_hx_tmp3 = (this->_layoutLocked == true);
            			}
            			else {
...
HXLINE( 572)			 ::Dynamic _hx_tmp2 = this->get_componentWidth();
HXDLIN( 572)			return  ::haxe::ui::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,_hx_tmp2,this->get_componentHeight());
            		}

...
HXLINE( 160)				_hx_tmp7 = ::hx::IsLessEq( this->borderLeftSize,0 );
            			}
            			else {
...
HXLINE( 160)					_hx_tmp6 = ::hx::IsLessEq( this->borderRightSize,0 );
            				}
            				else {
...
HXLINE( 160)					_hx_tmp5 = ::hx::IsLessEq( this->borderRightSize,0 );
            				}
            				else {
...
HXLINE( 160)					_hx_tmp4 = ::hx::IsLessEq( this->borderTopSize,0 );
            				}
            				else {
...
HXLINE( 422)				 ::haxe::ui::styles::Value _g1 = v->value;
HXDLIN( 422)				switch((int)(_g1->_hx_getIndex())){
            					case (int)5: {
HXLINE( 423)						::String f = _g1->_hx_getString(0);
HXDLIN( 423)						::Array< ::Dynamic> vl = _g1->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 423)						{
...
HXLINE( 426)							this->backdropFilter = ::Array_obj< ::Dynamic>::__new(1)->init(0,::haxe::ui::filters::FilterParser_obj::parseFilter(arr));
            					...
            					break;
            					case (int)6: {
HXLINE( 427)						::String f1 = _g1->_hx_getString(0);
HXLINE( 428)						this->backdropFilter = ::Array_obj< ::Dynamic>::__new(1)->init(0,::haxe::ui::filters::FilterParser_obj::parseFilter(::cpp::VirtualArray_obj::__new(1)->init(0,f1)));
            					}
            					break;
            					case (int)9: {
...
HXLINE( 244)				 ::haxe::ui::styles::Value _g2 = v->value;
HXLINE( 245)				{
...
HXLINE( 405)				 ::haxe::ui::styles::Value _g3 = v->value;
HXDLIN( 405)				switch((int)(_g3->_hx_getIndex())){
            					case (int)5: {
HXLINE( 406)						::String f2 = _g3->_hx_getString(0);
HXDLIN( 406)						::Array< ::Dynamic> vl1 = _g3->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 406)						{
HXLINE( 407)							::cpp::VirtualArray arr1 = ::haxe::ui::styles::ValueTools_obj::array(vl1);
HXLINE( 408)							arr1->insert(0,f2);
HXLINE( 409)							this->filter = ::Array_obj< ::Dynamic>::__new(1)->init(0,::haxe::ui::filters::FilterParser_obj::parseFilter(arr1));
            						}
            					}
            					break;
            					case (int)6: {
HXLINE( 410)						::String f3 = _g3->_hx_getString(0);
HXLINE( 411)						this->filter = ::Array_obj< ::Dynamic>::__new(1)->init(0,::haxe::ui::filters::FilterParser_obj::parseFilter(::cpp::VirtualArray_obj::__new(1)->init(0,f3)));
            					}
            					break;
            					case (int)9: {

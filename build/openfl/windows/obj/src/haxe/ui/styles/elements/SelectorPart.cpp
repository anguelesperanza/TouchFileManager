...
HXLINE(  34)			::String x1 = this->nodeName;
HXDLIN(  34)			if (::hx::IsNotNull( sb->charBuf )) {
HXLINE(  34)				sb->flush();
            			}
HXDLIN(  34)			if (::hx::IsNull( sb->b )) {
HXLINE(  34)				sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            			}
            			else {
HXLINE(  34)				::Array< ::String > sb2 = sb->b;
HXDLIN(  34)				sb2->push(::Std_obj::string(x1));
            			}
            		}
HXLINE(  36)		if (::hx::IsNotNull( this->className )) {
HXLINE(  37)			::String x2 = (HX_(".",2e,00,00,00) + this->className);
HXDLIN(  37)			if (::hx::IsNotNull( sb->charBuf )) {
HXLINE(  37)				sb->flush();
            			}
HXDLIN(  37)			if (::hx::IsNull( sb->b )) {
HXLINE(  37)				sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2));
            			}
            			else {
HXLINE(  37)				::Array< ::String > sb3 = sb->b;
HXDLIN(  37)				sb3->push(::Std_obj::string(x2));
            			}
            		}
HXLINE(  39)		if (::hx::IsNotNull( this->pseudoClass )) {
HXLINE(  40)			::String x3 = (HX_(":",3a,00,00,00) + this->pseudoClass);
HXDLIN(  40)			if (::hx::IsNotNull( sb->charBuf )) {
HXLINE(  40)				sb->flush();
            			}
HXDLIN(  40)			if (::hx::IsNull( sb->b )) {
HXLINE(  40)				sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3));
            			}
            			else {
HXLINE(  40)				::Array< ::String > sb4 = sb->b;
HXDLIN(  40)				sb4->push(::Std_obj::string(x3));
            			}
            		}

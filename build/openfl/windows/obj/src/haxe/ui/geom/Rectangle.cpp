...
HXLINE(  62)				_hx_tmp2 = (rect->top > this->top);
            			}
            			else {
HXLINE(  62)				_hx_tmp2 = false;
            			}
HXDLIN(  62)			if (_hx_tmp2) {
HXLINE(  62)				Float _hx_tmp3 = rect->get_right();
HXDLIN(  62)				_hx_tmp1 = (_hx_tmp3 < this->get_right());
            			}
            			else {
HXLINE(  62)				_hx_tmp1 = false;
            			}
HXDLIN(  62)			if (_hx_tmp1) {
HXLINE(  62)				Float _hx_tmp4 = rect->get_bottom();
HXDLIN(  62)				return (_hx_tmp4 < this->get_bottom());
            			}
            			else {
...
HXLINE(  64)				_hx_tmp6 = (rect->top >= this->top);
            			}
            			else {
HXLINE(  64)				_hx_tmp6 = false;
            			}
HXDLIN(  64)			if (_hx_tmp6) {
HXLINE(  64)				Float _hx_tmp7 = rect->get_right();
HXDLIN(  64)				_hx_tmp5 = (_hx_tmp7 <= this->get_right());
            			}
            			else {
HXLINE(  64)				_hx_tmp5 = false;
            			}
HXDLIN(  64)			if (_hx_tmp5) {
HXLINE(  64)				Float _hx_tmp8 = rect->get_bottom();
HXDLIN(  64)				return (_hx_tmp8 <= this->get_bottom());
            			}
            			else {

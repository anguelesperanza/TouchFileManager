...
HXLINE( 200)				_hx_tmp1 = (::haxe::ui::focus::IFocusable_obj::get_autoFocus(f) == false);
            			}
            			else {
...
HXLINE( 203)				_hx_tmp2 = (::haxe::ui::focus::IFocusable_obj::get_disabled(f) == false);
            			}
            			else {
...
HXDLIN( 218)				_g = (_g + 1);
HXLINE( 219)				::Dynamic f1 = this->buildFocusableList(child,list,considerAutoFocus);
HXLINE( 220)				if (::hx::IsNotNull( f1 )) {
HXLINE( 221)					currentFocus = f1;
            				}
            			}
            		}

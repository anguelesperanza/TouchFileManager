...
HXLINE( 531)			int _hx_tmp1;
HXDLIN( 531)			if (this->_button->get_easeInRepeater()) {
HXLINE( 531)				_hx_tmp1 = (this->_button->get_repeatInterval() * 2);
            			}
            			else {
HXLINE( 531)				_hx_tmp1 = this->_button->get_repeatInterval();
            			}
HXDLIN( 531)			this->_repeatInterval = _hx_tmp1;
            		}
...
HXLINE( 536)			int _hx_tmp3 = this->_repeatInterval;
HXDLIN( 536)			_hx_tmp2 = (_hx_tmp3 == this->_button->get_repeatInterval());
            		}
            		else {
...
HXDLIN( 545)							_hx_tmp1 = (_gthis1 > _gthis->_button->get_repeatInterval());
            						}
            						else {
HXLINE( 545)							_hx_tmp1 = false;
            						}
HXDLIN( 545)						if (_hx_tmp1) {
HXLINE( 546)							int _gthis2 = _gthis->_repeatInterval;
HXDLIN( 546)							int _gthis3 = _gthis->_repeatInterval;
HXDLIN( 546)							Float _hx_tmp2 = (( (Float)(_gthis2) ) - (( (Float)((_gthis3 - _gthis->_button->get_repeatInterval())) ) / ( (Float)(2) )));
HXDLIN( 546)							_gthis->_repeatInterval = ::Std_obj::_hx_int(_hx_tmp2);
...
HXLINE( 627)				 ::haxe::ui::components::Button _hx_tmp2 = this->_button;
HXDLIN( 627)				_hx_tmp2->dispatch( ::haxe::ui::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("click",48,7c,5e,48)));
            			}
            		}
            	}

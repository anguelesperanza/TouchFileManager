...
HXLINE( 786)						_hx_tmp2 = (b->get_selected() == true);
            					}
            					else {
...
HXLINE( 792)				_hx_tmp3 = (allowDeselection == false);
            			}
            			else {
...
HXLINE( 798)			_hx_tmp4 = (value == true);
            		}
            		else {
HXLINE( 798)			_hx_tmp4 = false;
            		}
HXDLIN( 798)		if (_hx_tmp4) {
HXLINE( 799)			 ::haxe::ui::components::ButtonGroups arr2 = ::haxe::ui::components::ButtonGroups_obj::get_instance();
HXDLIN( 799)			::Array< ::Dynamic> arr3 = arr2->get(button->get_componentGroup());
HXLINE( 800)			if (::hx::IsNotNull( arr3 )) {
HXLINE( 801)				int _g1 = 0;
HXDLIN( 801)				while((_g1 < arr3->length)){
HXLINE( 801)					 ::haxe::ui::components::Button b1 = arr3->__get(_g1).StaticCast<  ::haxe::ui::components::Button >();
HXDLIN( 801)					_g1 = (_g1 + 1);
HXLINE( 802)					if (::hx::IsInstanceNotEq( b1,button )) {
HXLINE( 803)						b1->set_selected(false);
            					}
            				}
            			}
            		}
HXLINE( 809)		bool _hx_tmp5;
HXDLIN( 809)		if ((allowDeselection == true)) {
HXLINE( 809)			_hx_tmp5 = (value == false);
            		}
            		else {
HXLINE( 809)			_hx_tmp5 = false;
            		}
HXDLIN( 809)		if (_hx_tmp5) {
HXLINE( 810)			 ::haxe::ui::behaviours::Behaviours button2 = button->behaviours;
HXDLIN( 810)			button2->softSet(HX_("selected",5b,2a,6d,b1),::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(false));
            		}
            	}

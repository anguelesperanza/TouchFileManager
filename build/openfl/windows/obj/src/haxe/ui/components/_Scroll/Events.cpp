...
HXLINE( 166)			 ::haxe::ui::components::Scroll _hx_tmp1 = this->_scroll;
HXDLIN( 166)			_hx_tmp1->applyPageFromCoord( ::haxe::ui::geom::Point_obj::__alloc( HX_CTX ,(event->screenX - componentOffset->x),(event->screenY - componentOffset->y)));
            		}
            	}

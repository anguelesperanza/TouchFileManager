...
HXLINE(  87)			Float p2 = p->x;
HXDLIN(  87)			Float _hx_tmp1 = thumb->get_screenLeft();
HXDLIN(  87)			if ((p2 > (_hx_tmp1 + thumb->get_width()))) {
HXLINE(  88)				Float _hx_tmp2 = scroll->get_pos();
HXDLIN(  88)				scroll->set_pos((_hx_tmp2 + scroll->get_pageSize()));
            			}
            		}

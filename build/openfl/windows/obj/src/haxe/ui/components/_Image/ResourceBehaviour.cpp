...
HXLINE( 240)				::String _hx_tmp3 = existingCanvas->get_id();
HXDLIN( 240)				_hx_tmp2 = (_hx_tmp3 == canvas->get_id());
            			}
            			else {
...
HXLINE( 249)				::Dynamic this2 = this->_canvasMap;
HXDLIN( 249)				newCanvas = ( ( ::haxe::ui::components::Canvas)(( ( ::haxe::ds::StringMap)(this2) )->get(canvas->get_id())) );
            			}
            			else {
...
HXLINE( 252)				{
HXLINE( 252)					::Dynamic this3 = this->_canvasMap;
HXDLIN( 252)					( ( ::haxe::ds::StringMap)(this3) )->set(canvas->get_id(),newCanvas);
            				}
            			}
...
HXLINE( 256)				_hx_tmp4 = ::Std_obj::isOfType(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->_value),::hx::ClassOf< ::haxe::ui::components::Image >());
            			}
            			else {
...
HXLINE( 277)								_hx_tmp1 = ::hx::IsNotNull( image->parentComponent );
            							}
            							else {
...
HXLINE( 278)									_hx_tmp2 = (_this->_layoutLocked == true);
            								}
            								else {

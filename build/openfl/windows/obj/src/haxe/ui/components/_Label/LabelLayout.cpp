...
HXLINE(  87)			 ::haxe::ui::core::TextDisplay _hx_tmp4 = this->get_component()->getTextDisplay();
HXDLIN(  87)			_hx_tmp4->set_width(this->get_component()->getTextDisplay()->get_textWidth());
            		}
HXLINE(  90)		if ((this->get_component()->get_autoHeight() == true)) {
HXLINE(  91)			 ::haxe::ui::core::TextDisplay _hx_tmp5 = this->get_component()->getTextDisplay();
HXDLIN(  91)			_hx_tmp5->set_height(this->get_component()->getTextDisplay()->get_textHeight());
            		}
            		else {
HXLINE(  93)			 ::haxe::ui::core::TextDisplay _hx_tmp6 = this->get_component()->getTextDisplay();
HXDLIN(  93)			_hx_tmp6->set_height(this->get_component()->get_height());
            		}
            	}

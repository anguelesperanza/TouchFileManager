...
HXLINE( 119)				bool invalidate1 = false;
HXLINE( 111)				bool _hx_tmp8;
HXDLIN( 111)				if (::hx::IsNotNull( style->cursor )) {
HXLINE( 111)					_hx_tmp8 = (c1->get_customStyle()->cursor != style->cursor);
            				}
            				else {
...
HXLINE( 113)					invalidate1 = true;
            				}
HXLINE( 123)				if ((invalidate1 == true)) {
...
HXLINE( 154)					 ::haxe::ui::components::Label c2 = list->__get(_g).StaticCast<  ::haxe::ui::components::Label >();
HXDLIN( 154)					_g = (_g + 1);
HXLINE( 155)					bool invalidate2 = false;
HXLINE( 157)					{
HXLINE( 147)						bool _hx_tmp9;
HXDLIN( 147)						if (::hx::IsNotNull( style->color )) {
HXLINE( 147)							_hx_tmp9 = ::hx::IsNotEq( c2->get_customStyle()->color,style->color );
            						}
            						else {
HXLINE( 147)							_hx_tmp9 = false;
            						}
HXDLIN( 147)						if (_hx_tmp9) {
HXLINE( 148)							c2->get_customStyle()->color = style->color;
HXLINE( 149)							invalidate2 = true;
            						}
HXLINE( 147)						bool _hx_tmp10;
HXDLIN( 147)						if (::hx::IsNotNull( style->fontName )) {
HXLINE( 147)							_hx_tmp10 = (c2->get_customStyle()->fontName != style->fontName);
            						}
            						else {
HXLINE( 147)							_hx_tmp10 = false;
            						}
HXDLIN( 147)						if (_hx_tmp10) {
HXLINE( 148)							c2->get_customStyle()->fontName = style->fontName;
HXLINE( 149)							invalidate2 = true;
            						}
HXLINE( 147)						bool _hx_tmp11;
HXDLIN( 147)						if (::hx::IsNotNull( style->fontSize )) {
HXLINE( 147)							_hx_tmp11 = ::hx::IsNotEq( c2->get_customStyle()->fontSize,style->fontSize );
            						}
            						else {
HXLINE( 147)							_hx_tmp11 = false;
            						}
HXDLIN( 147)						if (_hx_tmp11) {
HXLINE( 148)							c2->get_customStyle()->fontSize = style->fontSize;
HXLINE( 149)							invalidate2 = true;
            						}
HXLINE( 147)						bool _hx_tmp12;
HXDLIN( 147)						if (::hx::IsNotNull( style->cursor )) {
HXLINE( 147)							_hx_tmp12 = (c2->get_customStyle()->cursor != style->cursor);
            						}
            						else {
HXLINE( 147)							_hx_tmp12 = false;
            						}
HXDLIN( 147)						if (_hx_tmp12) {
HXLINE( 148)							c2->get_customStyle()->cursor = style->cursor;
HXLINE( 149)							invalidate2 = true;
            						}
HXLINE( 147)						bool _hx_tmp13;
HXDLIN( 147)						if (::hx::IsNotNull( style->textAlign )) {
HXLINE( 147)							_hx_tmp13 = (c2->get_customStyle()->textAlign != style->textAlign);
            						}
            						else {
HXLINE( 147)							_hx_tmp13 = false;
            						}
HXDLIN( 147)						if (_hx_tmp13) {
HXLINE( 148)							c2->get_customStyle()->textAlign = style->textAlign;
HXLINE( 149)							invalidate2 = true;
            						}
HXLINE( 147)						bool _hx_tmp14;
HXDLIN( 147)						if (::hx::IsNotNull( style->fontBold )) {
HXLINE( 147)							_hx_tmp14 = ::hx::IsNotEq( c2->get_customStyle()->fontBold,style->fontBold );
            						}
            						else {
HXLINE( 147)							_hx_tmp14 = false;
            						}
HXDLIN( 147)						if (_hx_tmp14) {
HXLINE( 148)							c2->get_customStyle()->fontBold = style->fontBold;
HXLINE( 149)							invalidate2 = true;
            						}
HXLINE( 147)						bool _hx_tmp15;
HXDLIN( 147)						if (::hx::IsNotNull( style->fontUnderline )) {
HXLINE( 147)							_hx_tmp15 = ::hx::IsNotEq( c2->get_customStyle()->fontUnderline,style->fontUnderline );
            						}
            						else {
HXLINE( 147)							_hx_tmp15 = false;
            						}
HXDLIN( 147)						if (_hx_tmp15) {
HXLINE( 148)							c2->get_customStyle()->fontUnderline = style->fontUnderline;
HXLINE( 149)							invalidate2 = true;
            						}
HXLINE( 147)						bool _hx_tmp16;
HXDLIN( 147)						if (::hx::IsNotNull( style->fontItalic )) {
HXLINE( 147)							_hx_tmp16 = ::hx::IsNotEq( c2->get_customStyle()->fontItalic,style->fontItalic );
            						}
            						else {
HXLINE( 147)							_hx_tmp16 = false;
            						}
HXDLIN( 147)						if (_hx_tmp16) {
HXLINE( 148)							c2->get_customStyle()->fontItalic = style->fontItalic;
HXLINE( 149)							invalidate2 = true;
            						}
            					}
HXLINE( 159)					if ((invalidate2 == true)) {
HXLINE( 160)						c2->invalidateComponent(HX_("style",31,a5,1d,84),false);
HXDLIN( 160)						{
            						}
            					}
            				}

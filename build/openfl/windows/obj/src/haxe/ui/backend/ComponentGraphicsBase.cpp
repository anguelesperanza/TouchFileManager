...
HXLINE(  86)						this->setPixels(pixels);
            					...
            					break;
            					case (int)3: {
HXLINE(  87)						Float x1 = c->_hx_getFloat(0);
HXDLIN(  87)						Float y1 = c->_hx_getFloat(1);
HXLINE(  88)						this->moveTo(x1,y1);
            					}
            					break;
            					case (int)4: {
HXLINE(  89)						Float x2 = c->_hx_getFloat(0);
HXDLIN(  89)						Float y2 = c->_hx_getFloat(1);
HXLINE(  90)						this->lineTo(x2,y2);
            					}
            					break;
            					case (int)5: {
HXLINE(  91)						 ::Dynamic color1 = c->_hx_getObject(0);
HXDLIN(  91)						 ::Dynamic thickness = c->_hx_getObject(1);
HXDLIN(  91)						 ::Dynamic alpha = c->_hx_getObject(2);
HXLINE(  92)						this->strokeStyle(color1,thickness,alpha);
            					}
            					break;
            					case (int)6: {
HXLINE(  93)						Float x3 = c->_hx_getFloat(0);
HXDLIN(  93)						Float y3 = c->_hx_getFloat(1);
HXDLIN(  93)						Float radius = c->_hx_getFloat(2);
HXLINE(  94)						this->circle(x3,y3,radius);
            					}
            					break;
            					case (int)7: {
HXLINE(  95)						 ::Dynamic color2 = c->_hx_getObject(0);
HXDLIN(  95)						 ::Dynamic alpha1 = c->_hx_getObject(1);
HXLINE(  96)						this->fillStyle(color2,alpha1);
            					}
            					break;
            					case (int)8: {
...
HXDLIN(  99)						Float anchorX1 = c->_hx_getFloat(4);
HXDLIN(  99)						Float anchorY1 = c->_hx_getFloat(5);
HXLINE( 100)						this->cubicCurveTo(controlX1,controlY1,controlX2,controlY2,anchorX1,anchorY1);
            					}
            					break;
            					case (int)10: {
HXLINE( 101)						Float x4 = c->_hx_getFloat(0);
HXDLIN( 101)						Float y4 = c->_hx_getFloat(1);
HXDLIN( 101)						Float width = c->_hx_getFloat(2);
HXDLIN( 101)						Float height = c->_hx_getFloat(3);
HXLINE( 102)						this->rectangle(x4,y4,width,height);
            					}
            					break;
            					case (int)11: {
HXLINE( 103)						 ::haxe::ui::util::VariantType resource = c->_hx_getObject(0).StaticCast<  ::haxe::ui::util::VariantType >();
HXDLIN( 103)						Float x5 = c->_hx_getFloat(1);
HXDLIN( 103)						Float y5 = c->_hx_getFloat(2);
HXDLIN( 103)						Float width1 = c->_hx_getFloat(3);
HXDLIN( 103)						Float height1 = c->_hx_getFloat(4);
HXLINE( 104)						this->image(resource,x5,y5,width1,height1);
            					}
            					break;
            				}
            			}

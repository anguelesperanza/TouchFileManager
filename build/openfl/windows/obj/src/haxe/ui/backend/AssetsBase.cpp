...
HXDLIN(  43)				{
HXLINE(  44)					 ::Dynamic _hx_tmp1 = ::haxe::Log_obj::trace;
HXDLIN(  44)					::String _hx_tmp2 = (HX_("Problem loading image file: ",ec,2c,08,c9) + ::Std_obj::string(e));
HXDLIN(  44)					_hx_tmp1(_hx_tmp2,::hx::SourceInfo(HX_("haxe/ui/backend/AssetsBase.hx",7d,c3,45,0e),44,HX_("haxe.ui.backend.AssetsBase",00,58,07,8b),HX_("imageFromFile",81,cb,29,81)));

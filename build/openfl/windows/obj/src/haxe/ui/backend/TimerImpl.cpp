...
HXLINE(  14)				 ::haxe::ui::backend::TimerImpl timer1 = ::haxe::ui::backend::TimerImpl_obj::_hx___timers->__get(i).StaticCast<  ::haxe::ui::backend::TimerImpl >();
HXLINE(  15)				bool _hx_tmp;
HXDLIN(  15)				if ((timer1->_start <= currentTime)) {
HXLINE(  15)					_hx_tmp = !(timer1->_stopped);
            				}
            				else {
HXLINE(  15)					_hx_tmp = false;
            				}
HXDLIN(  15)				if (_hx_tmp) {
HXLINE(  16)					timer1->_start = (currentTime + (( (Float)(timer1->_delay) ) / ( (Float)(1000) )));
HXLINE(  17)					timer1->_callback();
            				}
            			}
            		}
...
HXLINE(  22)			 ::haxe::ui::backend::TimerImpl timer2 = ::haxe::ui::backend::TimerImpl_obj::_hx___timers->__get(count).StaticCast<  ::haxe::ui::backend::TimerImpl >();
HXLINE(  23)			if (timer2->_stopped) {
HXLINE(  24)				timer2->_callback = null();
HXLINE(  25)				::haxe::ui::backend::TimerImpl_obj::_hx___timers->remove(timer2);
            			}
            		}
            		_hx_goto_3:;

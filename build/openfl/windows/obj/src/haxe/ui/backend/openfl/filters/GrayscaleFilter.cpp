...
HXDLIN(  19)		this->filter =  ::openfl::filters::ColorMatrixFilter_obj::__alloc( HX_CTX ,::Array_obj< Float >::__new(20)->init(0,(1 + (((Float)-0.70100000000000007) * amount)))->init(1,(((Float)0.587) * amount))->init(2,(((Float)0.114) * amount))->init(3,0)->init(4,0)->init(5,(((Float)0.299) * amount))->init(6,(1 + (((Float)-0.41300000000000003) * amount)))->init(7,(((Float)0.114) * amount))->init(8,0)->init(9,0)->init(10,(((Float)0.299) * amount))->init(11,(((Float)0.587) * amount))->init(12,(1 + (((Float)-0.886) * amount)))->init(13,0)->init(14,0)->init(15,0)->init(16,0)->init(17,0)->init(18,1)->init(19,0));
            	}

...
HXLINE(  61)				 ::openfl::text::TextField _hx_tmp1 = this->textField;
HXDLIN(  61)				_hx_tmp1->set_htmlText(this->normalizeText(this->_htmlText));
            			}
            		}
            	}
...
HXLINE( 111)		bool _hx_tmp4 = this->textField->get_wordWrap();
HXDLIN( 111)		if ((_hx_tmp4 != this->_displayData->wordWrap)) {
...
HXLINE( 115)			_hx_tmp5 = ::hx::IsNotNull( this->_htmlText );
            		}
            		else {
HXLINE( 115)			_hx_tmp5 = false;
            		}
HXDLIN( 115)		if (_hx_tmp5) {
HXLINE( 116)			 ::openfl::text::TextField _hx_tmp6 = this->textField;
HXDLIN( 116)			_hx_tmp6->set_htmlText(this->normalizeText(this->_htmlText));
            		}
HXLINE( 119)		bool _hx_tmp7 = this->textField->get_multiline();
HXDLIN( 119)		if ((_hx_tmp7 != this->_displayData->multiline)) {
...
HXLINE( 203)			 ::haxe::ui::backend::TextDisplayImpl _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 203)			_hx_tmp1->_textWidth = (_hx_tmp1->_textWidth + 1);
            		}
HXLINE( 205)		this->_textHeight = ( (Float)(::Math_obj::round(this->_textHeight)) );
HXLINE( 206)		if ((::hx::Mod(this->_textHeight,2) == 0)) {
HXLINE( 207)			 ::haxe::ui::backend::TextDisplayImpl _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 207)			_hx_tmp2->_textHeight = (_hx_tmp2->_textHeight + 1);
            		}
            	}

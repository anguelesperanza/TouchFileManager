...
HXLINE(  47)				::Array< ::String > parts1 = s.split(HX_("&&",40,21,00,00));
HXLINE(  48)				{
HXLINE(  48)					int _g1 = 0;
HXDLIN(  48)					while((_g1 < parts1->length)){
HXLINE(  48)						::String p1 = parts1->__get(_g1);
HXDLIN(  48)						_g1 = (_g1 + 1);
HXLINE(  49)						if (::hx::IsNull( r )) {
HXLINE(  50)							r = ::haxe::ui::util::SimpleExpressionEvaluator_obj::evalSingle(::StringTools_obj::trim(p1),context);
            						}
            						else {
HXLINE(  52)							if (( (bool)(r) )) {
HXLINE(  52)								r = ::haxe::ui::util::SimpleExpressionEvaluator_obj::evalSingle(::StringTools_obj::trim(p1),context);
            							}
            							else {
HXLINE(  52)								r = false;
            							}
...
HXLINE(  92)										_hx_tmp1 = (next != HX_("=",3d,00,00,00));
            									}
            									else {
...
HXLINE(  96)											_hx_tmp2 = (next != HX_("=",3d,00,00,00));
            										}
            										else {
...
HXLINE( 100)												_hx_tmp3 = (next == HX_("=",3d,00,00,00));
            											}
            											else {
...
HXLINE( 104)													_hx_tmp4 = (next == HX_("=",3d,00,00,00));
            												}
            												else {
...
HXLINE( 108)														_hx_tmp5 = (next == HX_("=",3d,00,00,00));
            													}
            													else {
...
HXLINE( 112)															_hx_tmp6 = (next == HX_("=",3d,00,00,00));
            														}
            														else {
...
HXLINE( 116)																_hx_tmp7 = (next == HX_("&",26,00,00,00));
            															}
            															else {
...
HXLINE( 120)																	_hx_tmp8 = (next == HX_("|",7c,00,00,00));
            																}
            																else {
...
HXLINE( 144)						_hx_tmp11 = false;
            					}
            				}
HXDLIN( 144)				if (_hx_tmp11) {
HXLINE( 145)					result = trimmedToken.substr(1,(trimmedToken.length - 2));
            				}
            				else {
HXLINE( 147)					::String token1 = HX_("",00,00,00,00);
HXLINE( 148)					int bracketsOpen = 0;
HXLINE( 149)					::String call = null();
HXLINE( 150)					::String callParams = null();
HXLINE( 151)					{
HXLINE( 151)						int _g2 = 0;
HXDLIN( 151)						int _g3 = trimmedToken.length;
HXDLIN( 151)						while((_g2 < _g3)){
HXLINE( 151)							_g2 = (_g2 + 1);
HXDLIN( 151)							int i1 = (_g2 - 1);
HXLINE( 152)							::String ch1 = trimmedToken.charAt(i1);
HXLINE( 153)							if ((ch1 == HX_("(",28,00,00,00))) {
HXLINE( 154)								bracketsOpen = (bracketsOpen + 1);
HXLINE( 155)								if ((bracketsOpen == 1)) {
HXLINE( 156)									call = token1;
HXLINE( 157)									token1 = HX_("",00,00,00,00);
            								}
            								else {
HXLINE( 159)									token1 = (token1 + ch1);
            								}
            							}
            							else {
HXLINE( 161)								if ((ch1 == HX_(")",29,00,00,00))) {
HXLINE( 162)									bracketsOpen = (bracketsOpen - 1);
HXLINE( 163)									if ((bracketsOpen == 0)) {
HXLINE( 164)										callParams = token1;
            									}
            									else {
HXLINE( 166)										token1 = (token1 + HX_(")",29,00,00,00));
            									}
            								}
            								else {
HXLINE( 169)									token1 = (token1 + ch1);
            								}
            							}
            						}
            					}
...
HXLINE( 181)						token1 = HX_("",00,00,00,00);
HXLINE( 182)						{
HXLINE( 182)							int _g4 = 0;
HXDLIN( 182)							int _g5 = callParams.length;
HXDLIN( 182)							while((_g4 < _g5)){
HXLINE( 182)								_g4 = (_g4 + 1);
HXDLIN( 182)								int i2 = (_g4 - 1);
HXLINE( 183)								::String ch2 = callParams.charAt(i2);
HXLINE( 184)								if ((ch2 == HX_("(",28,00,00,00))) {
HXLINE( 185)									bracketsOpen = (bracketsOpen + 1);
            								}
            								else {
HXLINE( 186)									if ((ch2 == HX_(")",29,00,00,00))) {
HXLINE( 187)										bracketsOpen = (bracketsOpen - 1);
            									}
            								}
HXLINE( 190)								if ((ch2 == HX_(",",2c,00,00,00))) {
HXLINE( 191)									if ((bracketsOpen == 0)) {
HXLINE( 192)										parsedCallParams->push(token1);
HXLINE( 193)										token1 = HX_("",00,00,00,00);
            									}
            									else {
HXLINE( 195)										token1 = (token1 + ch2);
            									}
            								}
            								else {
HXLINE( 198)									token1 = (token1 + ch2);
            								}
            							}
            						}
HXLINE( 202)						if ((token1.length != 0)) {
HXLINE( 203)							parsedCallParams->push(token1);
            						}
            					}
...
HXDLIN( 213)								while((_g6 < callParts->length)){
HXLINE( 213)									::String callPart = callParts->__get(_g6);
HXDLIN( 213)									_g6 = (_g6 + 1);
...
HXLINE( 222)										HX_STACK_DO_THROW((callPart + HX_(" not found",55,f3,a5,21)));
            									}
            								}
            							}
HXLINE( 226)							bool _hx_tmp14;
HXDLIN( 226)							if (::hx::IsNotNull( ref )) {
HXLINE( 226)								_hx_tmp14 = ::Reflect_obj::isFunction(ref);
            							}
            							else {
HXLINE( 226)								_hx_tmp14 = false;
            							}
HXDLIN( 226)							if (_hx_tmp14) {
HXLINE( 227)								::cpp::VirtualArray paramValues = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 228)								{
HXLINE( 228)									int _g7 = 0;
HXDLIN( 228)									while((_g7 < parsedCallParams->length)){
HXLINE( 228)										::String param = parsedCallParams->__get(_g7);
HXDLIN( 228)										_g7 = (_g7 + 1);
...
HXLINE( 240)								 ::Dynamic ref1 = context;
HXLINE( 241)								{
HXLINE( 241)									int _g8 = 0;
HXDLIN( 241)									while((_g8 < propParts->length)){
HXLINE( 241)										::String propPart = propParts->__get(_g8);
HXDLIN( 241)										_g8 = (_g8 + 1);
HXLINE( 242)										ref1 = ::Reflect_obj::field(ref1,propPart);
            									}
            								}
HXLINE( 244)								if (::Reflect_obj::hasField(ref1,propName)) {
HXLINE( 245)									result = ::Reflect_obj::field(ref1,propName);
            								}
            								else {
HXLINE( 247)									result = ::Reflect_obj::getProperty(ref1,propName);
            								}
            							}
            						}
            					}

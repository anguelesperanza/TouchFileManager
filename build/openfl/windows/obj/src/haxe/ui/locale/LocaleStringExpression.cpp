...
HXLINE(  36)					::String floatResult;
HXDLIN(  36)					if (::hx::IsNull( this->eval(floatValue,expr1) )) {
HXLINE(  36)						floatResult = HX_("null",87,9e,0e,49);
            					}
            					else {
HXLINE(  36)						floatResult = ::Std_obj::string(this->eval(floatValue,expr1));
            					}
HXDLIN(  36)					Float floatResult1 = ::Std_obj::parseFloat(floatResult);
HXLINE(  37)					r = (floatValue == floatResult1);
            				}
            				else {
HXLINE(  38)					if (::hx::IsPointerEq( ::Type_obj::_hx_typeof(varValue),::ValueType_obj::TInt_dyn() )) {
HXLINE(  39)						int intValue = ( (int)(varValue) );
HXLINE(  40)						::String intResult;
HXDLIN(  40)						if (::hx::IsNull( this->eval(intValue,expr1) )) {
HXLINE(  40)							intResult = HX_("null",87,9e,0e,49);
            						}
            						else {
HXLINE(  40)							intResult = ::Std_obj::string(this->eval(intValue,expr1));
            						}
HXDLIN(  40)						int intResult1 = ( (int)(::Std_obj::parseInt(intResult)) );
HXLINE(  41)						r = (intValue == intResult1);
            					}
            					else {
HXLINE(  43)						::String stringValue = ::Std_obj::string(varValue);
HXLINE(  44)						::String stringResult;
HXDLIN(  44)						if (::hx::IsNull( this->eval(stringValue,expr1) )) {
HXLINE(  44)							stringResult = HX_("null",87,9e,0e,49);
            						}
            						else {
HXLINE(  44)							stringResult = ::Std_obj::string(this->eval(stringValue,expr1));
            						}
...
HXLINE(  47)				return r;
            			...
            			break;
            			case (int)1: {
HXLINE(  48)				 ::haxe::ui::locale::_LocaleStringExpression::LocalStringExpressionOperation expr2 = expr->_hx_getObject(0).StaticCast<  ::haxe::ui::locale::_LocaleStringExpression::LocalStringExpressionOperation >();
HXLINE(  49)				bool r1 = false;
HXLINE(  50)				if (::hx::IsPointerEq( ::Type_obj::_hx_typeof(varValue),::ValueType_obj::TFloat_dyn() )) {
HXLINE(  51)					Float floatValue1 = ( (Float)(varValue) );
HXLINE(  52)					::String floatResult2;
HXDLIN(  52)					if (::hx::IsNull( this->eval(floatValue1,expr2) )) {
HXLINE(  52)						floatResult2 = HX_("null",87,9e,0e,49);
            					}
            					else {
HXLINE(  52)						floatResult2 = ::Std_obj::string(this->eval(floatValue1,expr2));
            					}
HXDLIN(  52)					Float floatResult3 = ::Std_obj::parseFloat(floatResult2);
HXLINE(  53)					r1 = (floatValue1 < floatResult3);
            				}
            				else {
HXLINE(  54)					if (::hx::IsPointerEq( ::Type_obj::_hx_typeof(varValue),::ValueType_obj::TInt_dyn() )) {
HXLINE(  55)						int intValue1 = ( (int)(varValue) );
HXLINE(  56)						::String intResult2;
HXDLIN(  56)						if (::hx::IsNull( this->eval(intValue1,expr2) )) {
HXLINE(  56)							intResult2 = HX_("null",87,9e,0e,49);
            						}
            						else {
HXLINE(  56)							intResult2 = ::Std_obj::string(this->eval(intValue1,expr2));
            						}
HXDLIN(  56)						int intResult3 = ( (int)(::Std_obj::parseInt(intResult2)) );
HXLINE(  57)						r1 = (intValue1 < intResult3);
            					}
            				}
HXLINE(  59)				return r1;
            			}
            			break;
            			case (int)2: {
HXLINE(  60)				 ::haxe::ui::locale::_LocaleStringExpression::LocalStringExpressionOperation expr3 = expr->_hx_getObject(0).StaticCast<  ::haxe::ui::locale::_LocaleStringExpression::LocalStringExpressionOperation >();
HXLINE(  61)				bool r2 = false;
HXLINE(  62)				if (::hx::IsPointerEq( ::Type_obj::_hx_typeof(varValue),::ValueType_obj::TFloat_dyn() )) {
HXLINE(  63)					Float floatValue2 = ( (Float)(varValue) );
HXLINE(  64)					::String floatResult4;
HXDLIN(  64)					if (::hx::IsNull( this->eval(floatValue2,expr3) )) {
HXLINE(  64)						floatResult4 = HX_("null",87,9e,0e,49);
            					}
            					else {
HXLINE(  64)						floatResult4 = ::Std_obj::string(this->eval(floatValue2,expr3));
            					}
HXDLIN(  64)					Float floatResult5 = ::Std_obj::parseFloat(floatResult4);
HXLINE(  65)					r2 = (floatValue2 > floatResult5);
            				}
            				else {
HXLINE(  66)					if (::hx::IsPointerEq( ::Type_obj::_hx_typeof(varValue),::ValueType_obj::TInt_dyn() )) {
HXLINE(  67)						int intValue2 = ( (int)(varValue) );
HXLINE(  68)						::String intResult4;
HXDLIN(  68)						if (::hx::IsNull( this->eval(intValue2,expr3) )) {
HXLINE(  68)							intResult4 = HX_("null",87,9e,0e,49);
            						}
            						else {
HXLINE(  68)							intResult4 = ::Std_obj::string(this->eval(intValue2,expr3));
            						}
HXDLIN(  68)						int intResult5 = ( (int)(::Std_obj::parseInt(intResult4)) );
HXLINE(  69)						r2 = (intValue2 > intResult5);
            					}
            				}
HXLINE(  71)				return r2;
            			}
            			break;
            			case (int)3: {
HXLINE(  72)				 ::haxe::ui::locale::_LocaleStringExpression::LocalStringExpressionOperation expr4 = expr->_hx_getObject(0).StaticCast<  ::haxe::ui::locale::_LocaleStringExpression::LocalStringExpressionOperation >();
HXLINE(  73)				bool r3 = false;
HXLINE(  74)				if (::hx::IsPointerEq( ::Type_obj::_hx_typeof(varValue),::ValueType_obj::TFloat_dyn() )) {
HXLINE(  75)					Float floatValue3 = ( (Float)(varValue) );
HXLINE(  76)					::String floatResult6;
HXDLIN(  76)					if (::hx::IsNull( this->eval(floatValue3,expr4) )) {
HXLINE(  76)						floatResult6 = HX_("null",87,9e,0e,49);
            					}
            					else {
HXLINE(  76)						floatResult6 = ::Std_obj::string(this->eval(floatValue3,expr4));
            					}
HXDLIN(  76)					Float floatResult7 = ::Std_obj::parseFloat(floatResult6);
HXLINE(  77)					r3 = (floatValue3 <= floatResult7);
            				}
            				else {
HXLINE(  78)					if (::hx::IsPointerEq( ::Type_obj::_hx_typeof(varValue),::ValueType_obj::TInt_dyn() )) {
HXLINE(  79)						int intValue3 = ( (int)(varValue) );
HXLINE(  80)						::String intResult6;
HXDLIN(  80)						if (::hx::IsNull( this->eval(intValue3,expr4) )) {
HXLINE(  80)							intResult6 = HX_("null",87,9e,0e,49);
            						}
            						else {
HXLINE(  80)							intResult6 = ::Std_obj::string(this->eval(intValue3,expr4));
            						}
HXDLIN(  80)						int intResult7 = ( (int)(::Std_obj::parseInt(intResult6)) );
HXLINE(  81)						r3 = (intValue3 <= intResult7);
            					}
            				}
HXLINE(  83)				return r3;
            			}
            			break;
            			case (int)4: {
HXLINE(  84)				 ::haxe::ui::locale::_LocaleStringExpression::LocalStringExpressionOperation expr5 = expr->_hx_getObject(0).StaticCast<  ::haxe::ui::locale::_LocaleStringExpression::LocalStringExpressionOperation >();
HXLINE(  85)				bool r4 = false;
HXLINE(  86)				if (::hx::IsPointerEq( ::Type_obj::_hx_typeof(varValue),::ValueType_obj::TFloat_dyn() )) {
HXLINE(  87)					Float floatValue4 = ( (Float)(varValue) );
HXLINE(  88)					::String floatResult8;
HXDLIN(  88)					if (::hx::IsNull( this->eval(floatValue4,expr5) )) {
HXLINE(  88)						floatResult8 = HX_("null",87,9e,0e,49);
            					}
            					else {
HXLINE(  88)						floatResult8 = ::Std_obj::string(this->eval(floatValue4,expr5));
            					}
HXDLIN(  88)					Float floatResult9 = ::Std_obj::parseFloat(floatResult8);
HXLINE(  89)					r4 = (floatValue4 >= floatResult9);
            				}
            				else {
HXLINE(  90)					if (::hx::IsPointerEq( ::Type_obj::_hx_typeof(varValue),::ValueType_obj::TInt_dyn() )) {
HXLINE(  91)						int intValue4 = ( (int)(varValue) );
HXLINE(  92)						::String intResult8;
HXDLIN(  92)						if (::hx::IsNull( this->eval(intValue4,expr5) )) {
HXLINE(  92)							intResult8 = HX_("null",87,9e,0e,49);
            						}
            						else {
HXLINE(  92)							intResult8 = ::Std_obj::string(this->eval(intValue4,expr5));
            						}
HXDLIN(  92)						int intResult9 = ( (int)(::Std_obj::parseInt(intResult8)) );
HXLINE(  93)						r4 = (intValue4 >= intResult9);
            					}
            				}
HXLINE(  95)				return r4;
            			}
...
HXLINE(  97)				if (::hx::IsGreaterEq( varValue,start )) {
HXLINE(  97)					return ::hx::IsLessEq( varValue,end );
            				}
            				else {
...
HXDLIN( 109)				 ::haxe::ui::locale::_LocaleStringExpression::LocalStringExpressionOperation expr6 = expr->_hx_getObject(1).StaticCast<  ::haxe::ui::locale::_LocaleStringExpression::LocalStringExpressionOperation >();
HXLINE( 110)				Float r5 = ::hx::Mod(varValue,modulus);
HXLINE( 111)				return this->eval(r5,expr6);
            			}
            			break;
            			case (int)7: {
...
HXLINE( 194)									Float expression2 = ::Std_obj::parseFloat(range->__get(0));
HXDLIN( 194)									expression = ::haxe::ui::locale::_LocaleStringExpression::LocalStringExpressionOperation_obj::Range(expression2,::Std_obj::parseFloat(range->__get(1)));
            								}
            								else {
...
HXDLIN( 198)											while((_g2 < valueParts->length)){
HXLINE( 198)												::String p = valueParts->__get(_g2);

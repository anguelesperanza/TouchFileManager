...
HXLINE(  29)				_hx_tmp1 = ::hx::IsNotNull( param0->__Field(HX_("text",ad,cc,f9,4c),::hx::paccDynamic) );
            			}
            			else {
...
HXLINE(  30)				_hx_tmp2 = ::hx::IsNotNull( param1->__Field(HX_("text",ad,cc,f9,4c),::hx::paccDynamic) );
            			}
            			else {
...
HXLINE(  31)				_hx_tmp3 = ::hx::IsNotNull( param2->__Field(HX_("text",ad,cc,f9,4c),::hx::paccDynamic) );
            			}
            			else {
...
HXLINE(  32)				_hx_tmp4 = ::hx::IsNotNull( param3->__Field(HX_("text",ad,cc,f9,4c),::hx::paccDynamic) );
            			}
            			else {
...
HXLINE(  61)				bool _hx_tmp5;
HXDLIN(  61)				if ((result.indexOf(HX_("{{",a0,6b,00,00),null()) != -1)) {
HXLINE(  61)					_hx_tmp5 = (result.indexOf(HX_("}}",60,6d,00,00),null()) != -1);
            				}
            				else {
...
HXLINE( 130)				 ::haxe::ui::locale::_LocaleString::LocaleStringPart part1 = _g3->__get(_g2).StaticCast<  ::haxe::ui::locale::_LocaleString::LocaleStringPart >();
HXDLIN( 130)				_g2 = (_g2 + 1);
HXLINE( 131)				switch((int)(part1->_hx_getIndex())){
            					case (int)0: {
HXLINE( 132)						::String s1 = part1->_hx_getString(0);
            					}
            					break;
            					case (int)1: {
HXLINE( 133)						 ::haxe::ui::locale::LocaleStringExpressionBlock block1 = part1->_hx_getObject(0).StaticCast<  ::haxe::ui::locale::LocaleStringExpressionBlock >();
HXLINE( 134)						bool _hx_tmp;
HXDLIN( 134)						if (::hx::IsNotNull( block1->expressions )) {
HXLINE( 134)							_hx_tmp = (block1->expressions->length > 0);
            						}
            						else {

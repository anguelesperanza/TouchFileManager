...
HXLINE( 135)		Float e5 = e->screenX;
HXDLIN( 135)		Float _hx_tmp = (e5 - ( (Float)(this->_currentComponent->get_left()) ));
HXDLIN( 135)		Float e6 = e->screenY;
HXDLIN( 135)		this->_mouseOffset =  ::haxe::ui::geom::Point_obj::__alloc( HX_CTX ,_hx_tmp,(e6 - ( (Float)(this->_currentComponent->get_top()) )));
...
HXLINE( 148)		Float e5 = e->screenX;
HXDLIN( 148)		Float x1 = (e5 - ( (Float)(this->_currentComponent->get_left()) ));
HXDLIN( 148)		Float e6 = e->screenY;
HXDLIN( 148)		Float y1 = (e6 - ( (Float)(this->_currentComponent->get_top()) ));
...
HXLINE( 174)				bool boundX2;
HXDLIN( 174)				if (::hx::IsNotNull( min )) {
HXLINE( 174)					boundX2 = ::hx::IsLess( v,min );
            				}
            				else {
HXLINE( 174)					boundX2 = false;
            				}
HXDLIN( 174)				if (boundX2) {
HXLINE( 174)					v = min;
            				}
            				else {
HXLINE( 174)					bool boundX3;
HXDLIN( 174)					if (::hx::IsNotNull( max2 )) {
HXLINE( 174)						boundX3 = ::hx::IsGreater( v,max2 );
            					}
            					else {
HXLINE( 174)						boundX3 = false;
            					}
HXDLIN( 174)					if (boundX3) {
HXLINE( 174)						v = max2;
            					}
            				}
...
HXLINE( 175)				bool boundY2;
HXDLIN( 175)				if (::hx::IsNotNull( min1 )) {
HXLINE( 175)					boundY2 = ::hx::IsLess( v1,min1 );
            				}
            				else {
HXLINE( 175)					boundY2 = false;
            				}
HXDLIN( 175)				if (boundY2) {
HXLINE( 175)					v1 = min1;
            				}
            				else {
HXLINE( 175)					bool boundY3;
HXDLIN( 175)					if (::hx::IsNotNull( max5 )) {
HXLINE( 175)						boundY3 = ::hx::IsGreater( v1,max5 );
            					}
            					else {
HXLINE( 175)						boundY3 = false;
            					}
HXDLIN( 175)					if (boundY3) {
HXLINE( 175)						v1 = max5;
            					}
            				}

...
HXDLIN(  10)		HX_STACK_DO_THROW(HX_("Locale parser not implemented!",47,5b,e5,53));
...
HXLINE(  18)			HX_STACK_DO_THROW(((HX_("No locale parser found for \"",73,17,77,f8) + extension) + HX_("\"",22,00,00,00)));
            		}
...
HXLINE(  23)			HX_STACK_DO_THROW(((HX_("Could not create locale parser instance \"",4a,6d,a0,1c) + ::Std_obj::string(cls)) + HX_("\"",22,00,00,00)));
            		}

...
HX_LOCAL_STACK_FRAME(_hx_pos_97671fefbd3e0550_237_clear,"haxe.ds.BalancedTree","clear",0xa4a48bbc,"haxe.ds.BalancedTree.clear","C:\\HaxeToolkit\\haxe\\std/haxe/ds/BalancedTree.hx",237,0x9022da28)
...
HXLINE(  86)				if (::Std_obj::isOfType(_g->value,::hx::ClassOf< ::String >())) {
HXLINE(  90)					return false;
            				}
            				else {
...
void BalancedTree_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_97671fefbd3e0550_237_clear)

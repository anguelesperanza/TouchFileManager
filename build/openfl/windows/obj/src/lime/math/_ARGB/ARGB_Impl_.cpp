...
HXDLIN( 102)				this1 = (((((a & 255) << 24) | ((r & 255) << 16)) | ((g & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + offset)) & 255)) ) & 255));
            			...
            			break;
            			case (int)1: {
HXLINE( 105)				int a1 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 2))) & 255)) );
HXDLIN( 105)				int r1 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 3))) & 255)) );
HXDLIN( 105)				int g1 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + offset)) & 255)) );
HXDLIN( 105)				this1 = (((((a1 & 255) << 24) | ((r1 & 255) << 16)) | ((g1 & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 1))) & 255)) ) & 255));
            			}
            			break;
            			case (int)2: {
HXLINE(  99)				int a2 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 1))) & 255)) );
HXDLIN(  99)				int r2 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + offset)) & 255)) );
HXDLIN(  99)				int g2 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 3))) & 255)) );
HXDLIN(  99)				this1 = (((((a2 & 255) << 24) | ((r2 & 255) << 16)) | ((g2 & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 2))) & 255)) ) & 255));
            			}
            			break;
            		}
...
HXDLIN( 110)					int r3 = ( (int)(( ::__hxcpp_memory_get_byte(this2->buffer->b,(this2->byteOffset + ::Math_obj::floor((( (Float)((::hx::UShr(this1,16) & 255)) ) * ::lime::math::_ARGB::ARGB_Impl__obj::unmult)))) & 255)) );
HXDLIN( 110)					 ::lime::utils::ArrayBufferView this3 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 110)					int g3 = ( (int)(( ::__hxcpp_memory_get_byte(this3->buffer->b,(this3->byteOffset + ::Math_obj::floor((( (Float)((::hx::UShr(this1,8) & 255)) ) * ::lime::math::_ARGB::ARGB_Impl__obj::unmult)))) & 255)) );
HXDLIN( 110)					 ::lime::utils::ArrayBufferView this4 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 110)					this1 = ((((((::hx::UShr(this1,24) & 255) & 255) << 24) | ((r3 & 255) << 16)) | ((g3 & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(this4->buffer->b,(this4->byteOffset + ::Math_obj::floor((( (Float)((this1 & 255)) ) * ::lime::math::_ARGB::ARGB_Impl__obj::unmult)))) & 255)) ) & 255));
            				}
            			}
            		}
            	}

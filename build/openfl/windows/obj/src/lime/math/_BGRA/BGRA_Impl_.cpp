...
HXDLIN( 102)				this1 = (((((b & 255) << 24) | ((g & 255) << 16)) | ((r & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 3))) & 255)) ) & 255));
            			...
            			break;
            			case (int)1: {
HXLINE( 105)				int b1 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 3))) & 255)) );
HXDLIN( 105)				int g1 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 2))) & 255)) );
HXDLIN( 105)				int r1 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 1))) & 255)) );
HXDLIN( 105)				this1 = (((((b1 & 255) << 24) | ((g1 & 255) << 16)) | ((r1 & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + offset)) & 255)) ) & 255));
            			}
            			break;
            			case (int)2: {
HXLINE(  99)				int b2 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + offset)) & 255)) );
HXDLIN(  99)				int g2 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 1))) & 255)) );
HXDLIN(  99)				int r2 = ( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 2))) & 255)) );
HXDLIN(  99)				this1 = (((((b2 & 255) << 24) | ((g2 & 255) << 16)) | ((r2 & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(data->buffer->b,(data->byteOffset + (offset + 3))) & 255)) ) & 255));
            			}
            			break;
            		}
...
HXDLIN( 110)					int b3 = ( (int)(( ::__hxcpp_memory_get_byte(this2->buffer->b,(this2->byteOffset + ::Math_obj::floor((( (Float)((::hx::UShr(this1,24) & 255)) ) * ::lime::math::_BGRA::BGRA_Impl__obj::unmult)))) & 255)) );
HXDLIN( 110)					 ::lime::utils::ArrayBufferView this3 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 110)					int g3 = ( (int)(( ::__hxcpp_memory_get_byte(this3->buffer->b,(this3->byteOffset + ::Math_obj::floor((( (Float)((::hx::UShr(this1,16) & 255)) ) * ::lime::math::_BGRA::BGRA_Impl__obj::unmult)))) & 255)) );
HXDLIN( 110)					 ::lime::utils::ArrayBufferView this4 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 110)					this1 = (((((b3 & 255) << 24) | ((g3 & 255) << 16)) | ((( (int)(( ::__hxcpp_memory_get_byte(this4->buffer->b,(this4->byteOffset + ::Math_obj::floor((( (Float)((::hx::UShr(this1,8) & 255)) ) * ::lime::math::_BGRA::BGRA_Impl__obj::unmult)))) & 255)) ) & 255) << 8)) | ((this1 & 255) & 255));
            				}
            			}
            		}
            	}
...
HXDLIN( 164)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),val3);
            			...
            			case (int)1: {
HXLINE( 167)				{
HXLINE( 167)					int val4 = (this1 & 255);
HXDLIN( 167)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),val4);
            				}
HXLINE( 168)				{
HXLINE( 168)					int val5 = (::hx::UShr(this1,8) & 255);
HXDLIN( 168)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),val5);
            				}
HXLINE( 169)				{
HXLINE( 169)					int val6 = (::hx::UShr(this1,16) & 255);
HXDLIN( 169)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),val6);
            				}
HXLINE( 170)				{
HXLINE( 170)					int val7 = (::hx::UShr(this1,24) & 255);
HXDLIN( 170)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),val7);
            				}
            			}
            			break;
            			case (int)2: {
HXLINE( 155)				{
HXLINE( 155)					int val8 = (::hx::UShr(this1,24) & 255);
HXDLIN( 155)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),val8);
            				}
HXLINE( 156)				{
HXLINE( 156)					int val9 = (::hx::UShr(this1,16) & 255);
HXDLIN( 156)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),val9);
            				}
HXLINE( 157)				{
HXLINE( 157)					int val10 = (::hx::UShr(this1,8) & 255);
HXDLIN( 157)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),val10);
            				}
HXLINE( 158)				{
HXLINE( 158)					int val11 = (this1 & 255);
HXDLIN( 158)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),val11);
            				}
            			}
            			break;
            		}

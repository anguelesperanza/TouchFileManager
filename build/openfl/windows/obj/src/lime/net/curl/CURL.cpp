...
HXLINE( 198)					callback2(_gthis,header);
            				}
            				HX_END_LOCAL_FUNC1((void))

HXLINE( 189)				 ::Dynamic callback2 = parameter;
HXLINE( 196)				parameter =  ::Dynamic(new _hx_Closure_2(_gthis,callback2));
            			}
            			break;
            			case (int)20219: {
...
HXLINE( 164)					return ( (int)(callback3(_gthis,dltotal,dlnow,ultotal,ulnow)) );
            				}

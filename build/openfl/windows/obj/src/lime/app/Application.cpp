...
HXLINE( 467)				_g->_hx___onWindowClose(window1);
            			}
            			HX_END_LOCAL_FUNC0((void))

HXLINE( 464)			this->_hx___windows->push(window);
HXLINE( 465)			this->_hx___windowByID->set(window->id,window);
HXLINE( 467)			 ::lime::app::Application _g = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 565)			_g->onGamepadAxisMove(gamepad1,axis,value);
            		}
...
HXLINE( 566)			_g1->onGamepadButtonDown(gamepad2,button);
            		}
...
HXLINE( 567)			_g2->onGamepadButtonUp(gamepad3,button);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE( 566)		 ::lime::app::Application _g1 = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 567)		 ::lime::app::Application _g2 = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 568)		 ::lime::app::Application _g3 = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 575)			_g->onJoystickAxisMove(joystick1,axis,value);
            		}
            		HX_END_LOCAL_FUNC2((void))
...
HXLINE( 576)			_g1->onJoystickButtonDown(joystick2,button);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE( 577)			_g2->onJoystickButtonUp(joystick3,button);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE( 578)			_g3->onJoystickDisconnect(joystick4);
            		}
            		HX_END_LOCAL_FUNC0((void))
...
HXLINE( 579)			_g4->onJoystickHatMove(joystick5,hat,position);
            		}
            		HX_END_LOCAL_FUNC2((void))

            		HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_5, ::lime::ui::Joystick,joystick6, ::lime::app::Application,_g5) HXARGC(3)
            		void _hx_run(int trackball,Float x,Float y){
            			HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_580___onJoystickConnect)
HXLINE( 580)			_g5->onJoystickTrackballMove(joystick6,trackball,x,y);
            		}
            		HX_END_LOCAL_FUNC3((void))

            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_572___onJoystickConnect)
HXLINE( 573)		this->onJoystickConnect(joystick);
HXLINE( 575)		 ::lime::app::Application _g = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 576)		 ::lime::app::Application _g1 = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 577)		 ::lime::app::Application _g2 = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 578)		 ::lime::app::Application _g3 = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 579)		 ::lime::app::Application _g4 = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 580)		 ::lime::app::Application _g5 = ::hx::ObjectPtr<OBJ_>(this);

...
HX_DEFINE_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_42_new,"lime.app.Event","new",0xaf38c4c6,"lime.app.Event.new","lime/app/Event.hx",42,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_58_add,"lime.app.Event","add",0xaf2ee687,"lime.app.Event.add","lime/app/Event.hx",58,0xbda45bec)
...
void Event_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_42_new)
HXLINE(  44)		this->canceled = false;
HXLINE(  45)		this->_hx___listeners = ::cpp::VirtualArray_obj::__new();
...
bool Event_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x4b520ece;
}
...
void Event_obj::add( ::Dynamic listener,::hx::Null< bool >  __o_once,::hx::Null< int >  __o_priority){
            	...
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_58_add)
HXLINE(  60)		{
HXLINE(  60)			int _g = 0;
...
void Event_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_82_cancel)
...
bool Event_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_127_has)
HXLINE( 129)		{
HXLINE( 129)			int _g = 0;
HXDLIN( 129)			::cpp::VirtualArray _g1 = this->_hx___listeners;
HXDLIN( 129)			while((_g < _g1->get_length())){
...
void Event_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_143_remove)
HXLINE( 145)		int i = this->_hx___listeners->get_length();
...
HXLINE( 151)				this->_hx___listeners->splice(i,1);
...
static ::hx::StorageInfo Event_obj_sMemberStorageInfo[] = {
	{::hx::fsBool,(int)offsetof(Event_obj,canceled),HX_("canceled",59,18,26,1f)},
	{::hx::fsObject /* ::cpp::VirtualArray */ ,(int)offsetof(Event_obj,_hx___listeners),HX_("__listeners",5f,ae,ba,21)},
	{::hx::fsObject /* ::Array< bool > */ ,(int)offsetof(Event_obj,_hx___repeat),HX_("__repeat",7b,02,ac,ae)},
	{::hx::fsObject /* ::Array< int > */ ,(int)offsetof(Event_obj,_hx___priorities),HX_("__priorities",e2,cb,e6,1c)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(Event_obj,dispatch),HX_("dispatch",ba,ce,63,1e)},
	{ ::hx::fsUnknown, 0, null()}
};
...
void Event_obj::__register()
{
	...
	__mClass->mName = HX_("lime.app.Event",d4,a9,01,b3);

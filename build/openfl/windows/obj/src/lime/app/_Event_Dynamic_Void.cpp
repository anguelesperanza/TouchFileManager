...
HX_DEFINE_STACK_FRAME(_hx_pos_1c30b4cf7548edbd_42_new,"lime.app._Event_Dynamic_Void","new",0xa035b3a4,"lime.app._Event_Dynamic_Void.new","lime/app/Event.hx",42,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_1c30b4cf7548edbd_58_add,"lime.app._Event_Dynamic_Void","add",0xa02bd565,"lime.app._Event_Dynamic_Void.add","lime/app/Event.hx",58,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_1c30b4cf7548edbd_82_cancel,"lime.app._Event_Dynamic_Void","cancel",0xb3546cb6,"lime.app._Event_Dynamic_Void.cancel","lime/app/Event.hx",82,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_1c30b4cf7548edbd_127_has,"lime.app._Event_Dynamic_Void","has",0xa031229e,"lime.app._Event_Dynamic_Void.has","lime/app/Event.hx",127,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_1c30b4cf7548edbd_143_remove,"lime.app._Event_Dynamic_Void","remove",0xffa91b80,"lime.app._Event_Dynamic_Void.remove","lime/app/Event.hx",143,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_1c30b4cf7548edbd_163_removeAll,"lime.app._Event_Dynamic_Void","removeAll",0x9d86c581,"lime.app._Event_Dynamic_Void.removeAll","lime/app/Event.hx",163,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_41d084f43c5c5d14_82_dispatch,"lime.app._Event_Dynamic_Void","dispatch",0x820f94f6,"lime.app._Event_Dynamic_Void.dispatch","lime/_internal/macros/EventMacro.hx",82,0xc5a10671)
namespace lime{
namespace app{

void _Event_Dynamic_Void_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_1c30b4cf7548edbd_42_new)
...
void *_Event_Dynamic_Void_obj::_hx_vtable = 0;

Dynamic _Event_Dynamic_Void_obj::__Create(::hx::DynamicArray inArgs)
{
	::hx::ObjectPtr< _Event_Dynamic_Void_obj > _hx_result = new _Event_Dynamic_Void_obj();
	_hx_result->__construct();
	return _hx_result;
}

bool _Event_Dynamic_Void_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7e9bb82c;
}
...
void _Event_Dynamic_Void_obj::add( ::Dynamic listener,::hx::Null< bool >  __o_once,::hx::Null< int >  __o_priority){
            	...
            	HX_STACKFRAME(&_hx_pos_1c30b4cf7548edbd_58_add)
HXLINE(  60)		{
HXLINE(  60)			int _g = 0;
...
void _Event_Dynamic_Void_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_1c30b4cf7548edbd_82_cancel)
...
bool _Event_Dynamic_Void_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_1c30b4cf7548edbd_127_has)
HXLINE( 129)		{
HXLINE( 129)			int _g = 0;
...
void _Event_Dynamic_Void_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_1c30b4cf7548edbd_143_remove)
...
void _Event_Dynamic_Void_obj::removeAll(){
            	HX_STACKFRAME(&_hx_pos_1c30b4cf7548edbd_163_removeAll)
...
HX_DEFINE_DYNAMIC_FUNC0(_Event_Dynamic_Void_obj,removeAll,(void))

void _Event_Dynamic_Void_obj::dispatch( ::Dynamic a){
            	HX_STACKFRAME(&_hx_pos_41d084f43c5c5d14_82_dispatch)
...
::hx::ObjectPtr< _Event_Dynamic_Void_obj > _Event_Dynamic_Void_obj::__new() {
	::hx::ObjectPtr< _Event_Dynamic_Void_obj > __this = new _Event_Dynamic_Void_obj();
	__this->__construct();
	return __this;
}

::hx::ObjectPtr< _Event_Dynamic_Void_obj > _Event_Dynamic_Void_obj::__alloc(::hx::Ctx *_hx_ctx) {
	_Event_Dynamic_Void_obj *__this = (_Event_Dynamic_Void_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(_Event_Dynamic_Void_obj), true, "lime.app._Event_Dynamic_Void"));
	*(void **)__this = _Event_Dynamic_Void_obj::_hx_vtable;
	__this->__construct();
	return __this;
}
...
::hx::Val _Event_Dynamic_Void_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
...
::hx::Val _Event_Dynamic_Void_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
...
static ::hx::StorageInfo _Event_Dynamic_Void_obj_sMemberStorageInfo[] = {
	{::hx::fsBool,(int)offsetof(_Event_Dynamic_Void_obj,canceled),HX_("canceled",59,18,26,1f)},
	{::hx::fsObject /* ::Array< bool > */ ,(int)offsetof(_Event_Dynamic_Void_obj,_hx___repeat),HX_("__repeat",7b,02,ac,ae)},
	{::hx::fsObject /* ::Array< int > */ ,(int)offsetof(_Event_Dynamic_Void_obj,_hx___priorities),HX_("__priorities",e2,cb,e6,1c)},
	{::hx::fsObject /* ::Array< ::Dynamic> */ ,(int)offsetof(_Event_Dynamic_Void_obj,_hx___listeners),HX_("__listeners",5f,ae,ba,21)},
	{ ::hx::fsUnknown, 0, null()}
};
static ::hx::StaticInfo *_Event_Dynamic_Void_obj_sStaticStorageInfo = 0;
#endif

static ::String _Event_Dynamic_Void_obj_sMemberFields[] = {
...
{
	_Event_Dynamic_Void_obj _hx_dummy;
	_Event_Dynamic_Void_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("lime.app._Event_Dynamic_Void",b2,51,2a,32);
	...
	__mClass->mMembers = ::hx::Class_obj::dupFunctions(_Event_Dynamic_Void_obj_sMemberFields);
	__mClass->mCanCast = ::hx::TCanCast< _Event_Dynamic_Void_obj >;
#ifdef HXCPP_SCRIPTABLE
	__mClass->mMemberStorageInfo = _Event_Dynamic_Void_obj_sMemberStorageInfo;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mStaticStorageInfo = _Event_Dynamic_Void_obj_sStaticStorageInfo;
#endif

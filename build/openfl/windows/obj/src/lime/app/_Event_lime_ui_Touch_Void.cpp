...
HX_DEFINE_STACK_FRAME(_hx_pos_b42a541de25382ee_42_new,"lime.app._Event_lime_ui_Touch_Void","new",0xb34adbc5,"lime.app._Event_lime_ui_Touch_Void.new","lime/app/Event.hx",42,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_b42a541de25382ee_58_add,"lime.app._Event_lime_ui_Touch_Void","add",0xb340fd86,"lime.app._Event_lime_ui_Touch_Void.add","lime/app/Event.hx",58,0xbda45bec)
...
void _Event_lime_ui_Touch_Void_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b42a541de25382ee_42_new)
...
Dynamic _Event_lime_ui_Touch_Void_obj::__CreateEmpty() { return new _Event_lime_ui_Touch_Void_obj; }

void *_Event_lime_ui_Touch_Void_obj::_hx_vtable = 0;

Dynamic _Event_lime_ui_Touch_Void_obj::__Create(::hx::DynamicArray inArgs)
{
	::hx::ObjectPtr< _Event_lime_ui_Touch_Void_obj > _hx_result = new _Event_lime_ui_Touch_Void_obj();
	_hx_result->__construct();
	return _hx_result;
}

bool _Event_lime_ui_Touch_Void_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x649b134d;
}

void _Event_lime_ui_Touch_Void_obj::add( ::Dynamic listener,::hx::Null< bool >  __o_once,::hx::Null< int >  __o_priority){
            		bool once = __o_once.Default(false);
            		int priority = __o_priority.Default(0);
            	HX_STACKFRAME(&_hx_pos_b42a541de25382ee_58_add)
HXLINE(  60)		{
HXLINE(  60)			int _g = 0;
...
HX_DEFINE_DYNAMIC_FUNC3(_Event_lime_ui_Touch_Void_obj,add,(void))

void _Event_lime_ui_Touch_Void_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_b42a541de25382ee_82_cancel)
HXDLIN(  82)		this->canceled = true;
            	}


HX_DEFINE_DYNAMIC_FUNC0(_Event_lime_ui_Touch_Void_obj,cancel,(void))

bool _Event_lime_ui_Touch_Void_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_b42a541de25382ee_127_has)
HXLINE( 129)		{
HXLINE( 129)			int _g = 0;
...
HX_DEFINE_DYNAMIC_FUNC1(_Event_lime_ui_Touch_Void_obj,has,return )

void _Event_lime_ui_Touch_Void_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_b42a541de25382ee_143_remove)
...
HX_DEFINE_DYNAMIC_FUNC1(_Event_lime_ui_Touch_Void_obj,dispatch,(void))


::hx::ObjectPtr< _Event_lime_ui_Touch_Void_obj > _Event_lime_ui_Touch_Void_obj::__new() {
	::hx::ObjectPtr< _Event_lime_ui_Touch_Void_obj > __this = new _Event_lime_ui_Touch_Void_obj();
	__this->__construct();
	return __this;
}

::hx::ObjectPtr< _Event_lime_ui_Touch_Void_obj > _Event_lime_ui_Touch_Void_obj::__alloc(::hx::Ctx *_hx_ctx) {
	_Event_lime_ui_Touch_Void_obj *__this = (_Event_lime_ui_Touch_Void_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(_Event_lime_ui_Touch_Void_obj), true, "lime.app._Event_lime_ui_Touch_Void"));
	*(void **)__this = _Event_lime_ui_Touch_Void_obj::_hx_vtable;
	__this->__construct();
	return __this;
}

_Event_lime_ui_Touch_Void_obj::_Event_lime_ui_Touch_Void_obj()
{
}

void _Event_lime_ui_Touch_Void_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(_Event_lime_ui_Touch_Void);
...
void _Event_lime_ui_Touch_Void_obj::__Visit(HX_VISIT_PARAMS)
{
...
::hx::Val _Event_lime_ui_Touch_Void_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
...
::hx::Val _Event_lime_ui_Touch_Void_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
...
void _Event_lime_ui_Touch_Void_obj::__GetFields(Array< ::String> &outFields)
{
...
static ::hx::StorageInfo _Event_lime_ui_Touch_Void_obj_sMemberStorageInfo[] = {
	{::hx::fsBool,(int)offsetof(_Event_lime_ui_Touch_Void_obj,canceled),HX_("canceled",59,18,26,1f)},
	{::hx::fsObject /* ::Array< bool > */ ,(int)offsetof(_Event_lime_ui_Touch_Void_obj,_hx___repeat),HX_("__repeat",7b,02,ac,ae)},
	{::hx::fsObject /* ::Array< int > */ ,(int)offsetof(_Event_lime_ui_Touch_Void_obj,_hx___priorities),HX_("__priorities",e2,cb,e6,1c)},
	{::hx::fsObject /* ::Array< ::Dynamic> */ ,(int)offsetof(_Event_lime_ui_Touch_Void_obj,_hx___listeners),HX_("__listeners",5f,ae,ba,21)},
	{ ::hx::fsUnknown, 0, null()}
};
static ::hx::StaticInfo *_Event_lime_ui_Touch_Void_obj_sStaticStorageInfo = 0;
#endif

static ::String _Event_lime_ui_Touch_Void_obj_sMemberFields[] = {
...
::hx::Class _Event_lime_ui_Touch_Void_obj::__mClass;

void _Event_lime_ui_Touch_Void_obj::__register()
{
	_Event_lime_ui_Touch_Void_obj _hx_dummy;
	_Event_lime_ui_Touch_Void_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("lime.app._Event_lime_ui_Touch_Void",53,95,de,4e);
	...
	__mClass->mMembers = ::hx::Class_obj::dupFunctions(_Event_lime_ui_Touch_Void_obj_sMemberFields);
	__mClass->mCanCast = ::hx::TCanCast< _Event_lime_ui_Touch_Void_obj >;
#ifdef HXCPP_SCRIPTABLE
	__mClass->mMemberStorageInfo = _Event_lime_ui_Touch_Void_obj_sMemberStorageInfo;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mStaticStorageInfo = _Event_lime_ui_Touch_Void_obj_sStaticStorageInfo;
#endif

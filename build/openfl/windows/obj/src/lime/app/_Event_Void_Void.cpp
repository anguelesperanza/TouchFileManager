...
HX_DEFINE_STACK_FRAME(_hx_pos_610670bb4735c812_42_new,"lime.app._Event_Void_Void","new",0xd4bd07f3,"lime.app._Event_Void_Void.new","lime/app/Event.hx",42,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_610670bb4735c812_58_add,"lime.app._Event_Void_Void","add",0xd4b329b4,"lime.app._Event_Void_Void.add","lime/app/Event.hx",58,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_610670bb4735c812_82_cancel,"lime.app._Event_Void_Void","cancel",0x875173c7,"lime.app._Event_Void_Void.cancel","lime/app/Event.hx",82,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_610670bb4735c812_127_has,"lime.app._Event_Void_Void","has",0xd4b876ed,"lime.app._Event_Void_Void.has","lime/app/Event.hx",127,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_610670bb4735c812_143_remove,"lime.app._Event_Void_Void","remove",0xd3a62291,"lime.app._Event_Void_Void.remove","lime/app/Event.hx",143,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_610670bb4735c812_163_removeAll,"lime.app._Event_Void_Void","removeAll",0x5164bf10,"lime.app._Event_Void_Void.removeAll","lime/app/Event.hx",163,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_c8fc7e9f793fd9ba_82_dispatch,"lime.app._Event_Void_Void","dispatch",0x14a94247,"lime.app._Event_Void_Void.dispatch","lime/_internal/macros/EventMacro.hx",82,0xc5a10671)
namespace lime{
namespace app{

void _Event_Void_Void_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_610670bb4735c812_42_new)
...
bool _Event_Void_Void_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1892bbc7;
}
...
void _Event_Void_Void_obj::add( ::Dynamic listener,::hx::Null< bool >  __o_once,::hx::Null< int >  __o_priority){
            	...
            	HX_STACKFRAME(&_hx_pos_610670bb4735c812_58_add)
HXLINE(  60)		{
HXLINE(  60)			int _g = 0;
...
void _Event_Void_Void_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_610670bb4735c812_82_cancel)
...
bool _Event_Void_Void_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_610670bb4735c812_127_has)
HXLINE( 129)		{
HXLINE( 129)			int _g = 0;
...
void _Event_Void_Void_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_610670bb4735c812_143_remove)
...
void _Event_Void_Void_obj::removeAll(){
            	HX_STACKFRAME(&_hx_pos_610670bb4735c812_163_removeAll)
...
HX_DEFINE_DYNAMIC_FUNC0(_Event_Void_Void_obj,removeAll,(void))

void _Event_Void_Void_obj::dispatch(){
            	HX_STACKFRAME(&_hx_pos_c8fc7e9f793fd9ba_82_dispatch)
...
static ::hx::StorageInfo _Event_Void_Void_obj_sMemberStorageInfo[] = {
	{::hx::fsBool,(int)offsetof(_Event_Void_Void_obj,canceled),HX_("canceled",59,18,26,1f)},
	{::hx::fsObject /* ::Array< bool > */ ,(int)offsetof(_Event_Void_Void_obj,_hx___repeat),HX_("__repeat",7b,02,ac,ae)},
	{::hx::fsObject /* ::Array< int > */ ,(int)offsetof(_Event_Void_Void_obj,_hx___priorities),HX_("__priorities",e2,cb,e6,1c)},
	{::hx::fsObject /* ::Array< ::Dynamic> */ ,(int)offsetof(_Event_Void_Void_obj,_hx___listeners),HX_("__listeners",5f,ae,ba,21)},
	{ ::hx::fsUnknown, 0, null()}
};
...
{
	_Event_Void_Void_obj _hx_dummy;
	_Event_Void_Void_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("lime.app._Event_Void_Void",81,92,1f,73);

...
HX_DEFINE_STACK_FRAME(_hx_pos_68c0aff35b83ac66_42_new,"lime.app._Event_String_Void","new",0x6d330f56,"lime.app._Event_String_Void.new","lime/app/Event.hx",42,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_68c0aff35b83ac66_58_add,"lime.app._Event_String_Void","add",0x6d293117,"lime.app._Event_String_Void.add","lime/app/Event.hx",58,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_68c0aff35b83ac66_82_cancel,"lime.app._Event_String_Void","cancel",0xfe89ec44,"lime.app._Event_String_Void.cancel","lime/app/Event.hx",82,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_68c0aff35b83ac66_127_has,"lime.app._Event_String_Void","has",0x6d2e7e50,"lime.app._Event_String_Void.has","lime/app/Event.hx",127,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_68c0aff35b83ac66_143_remove,"lime.app._Event_String_Void","remove",0x4ade9b0e,"lime.app._Event_String_Void.remove","lime/app/Event.hx",143,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_68c0aff35b83ac66_163_removeAll,"lime.app._Event_String_Void","removeAll",0xd166f2b3,"lime.app._Event_String_Void.removeAll","lime/app/Event.hx",163,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_4ade5612dd03acc1_82_dispatch,"lime.app._Event_String_Void","dispatch",0x254e9404,"lime.app._Event_String_Void.dispatch","lime/_internal/macros/EventMacro.hx",82,0xc5a10671)
namespace lime{
namespace app{

void _Event_String_Void_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_68c0aff35b83ac66_42_new)
...
void *_Event_String_Void_obj::_hx_vtable = 0;
...
bool _Event_String_Void_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2fc3f32a;
}
...
void _Event_String_Void_obj::add( ::Dynamic listener,::hx::Null< bool >  __o_once,::hx::Null< int >  __o_priority){
            	...
            	HX_STACKFRAME(&_hx_pos_68c0aff35b83ac66_58_add)
HXLINE(  60)		{
HXLINE(  60)			int _g = 0;
...
bool _Event_String_Void_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_68c0aff35b83ac66_127_has)
HXLINE( 129)		{
HXLINE( 129)			int _g = 0;
...
void _Event_String_Void_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_68c0aff35b83ac66_143_remove)
...
void _Event_String_Void_obj::removeAll(){
            	HX_STACKFRAME(&_hx_pos_68c0aff35b83ac66_163_removeAll)
...
HX_DEFINE_DYNAMIC_FUNC0(_Event_String_Void_obj,removeAll,(void))

void _Event_String_Void_obj::dispatch(::String a){
            	HX_STACKFRAME(&_hx_pos_4ade5612dd03acc1_82_dispatch)
...
::hx::ObjectPtr< _Event_String_Void_obj > _Event_String_Void_obj::__new() {
	::hx::ObjectPtr< _Event_String_Void_obj > __this = new _Event_String_Void_obj();
	__this->__construct();
	return __this;
}

::hx::ObjectPtr< _Event_String_Void_obj > _Event_String_Void_obj::__alloc(::hx::Ctx *_hx_ctx) {
	_Event_String_Void_obj *__this = (_Event_String_Void_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(_Event_String_Void_obj), true, "lime.app._Event_String_Void"));
	*(void **)__this = _Event_String_Void_obj::_hx_vtable;
	__this->__construct();
	return __this;
}
...
static ::hx::StorageInfo _Event_String_Void_obj_sMemberStorageInfo[] = {
	{::hx::fsBool,(int)offsetof(_Event_String_Void_obj,canceled),HX_("canceled",59,18,26,1f)},
	{::hx::fsObject /* ::Array< bool > */ ,(int)offsetof(_Event_String_Void_obj,_hx___repeat),HX_("__repeat",7b,02,ac,ae)},
	{::hx::fsObject /* ::Array< int > */ ,(int)offsetof(_Event_String_Void_obj,_hx___priorities),HX_("__priorities",e2,cb,e6,1c)},
	{::hx::fsObject /* ::Array< ::Dynamic> */ ,(int)offsetof(_Event_String_Void_obj,_hx___listeners),HX_("__listeners",5f,ae,ba,21)},
	{ ::hx::fsUnknown, 0, null()}
};
...
{
	_Event_String_Void_obj _hx_dummy;
	_Event_String_Void_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("lime.app._Event_String_Void",64,6c,3f,e8);

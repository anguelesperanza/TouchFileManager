...
HX_DEFINE_STACK_FRAME(_hx_pos_516576a6efa98cd2_42_new,"lime.app._Event_Int_Float_Void","new",0x70f46217,"lime.app._Event_Int_Float_Void.new","lime/app/Event.hx",42,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_516576a6efa98cd2_58_add,"lime.app._Event_Int_Float_Void","add",0x70ea83d8,"lime.app._Event_Int_Float_Void.add","lime/app/Event.hx",58,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_516576a6efa98cd2_82_cancel,"lime.app._Event_Int_Float_Void","cancel",0xbc7a0823,"lime.app._Event_Int_Float_Void.cancel","lime/app/Event.hx",82,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_516576a6efa98cd2_127_has,"lime.app._Event_Int_Float_Void","has",0x70efd111,"lime.app._Event_Int_Float_Void.has","lime/app/Event.hx",127,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_516576a6efa98cd2_143_remove,"lime.app._Event_Int_Float_Void","remove",0x08ceb6ed,"lime.app._Event_Int_Float_Void.remove","lime/app/Event.hx",143,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_516576a6efa98cd2_163_removeAll,"lime.app._Event_Int_Float_Void","removeAll",0xd5a04c34,"lime.app._Event_Int_Float_Void.removeAll","lime/app/Event.hx",163,0xbda45bec)
...
void _Event_Int_Float_Void_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_42_new)
...
bool _Event_Int_Float_Void_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x68c1839f;
}
...
void _Event_Int_Float_Void_obj::add( ::Dynamic listener,::hx::Null< bool >  __o_once,::hx::Null< int >  __o_priority){
            	...
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_58_add)
HXLINE(  60)		{
HXLINE(  60)			int _g = 0;
...
void _Event_Int_Float_Void_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_82_cancel)
...
bool _Event_Int_Float_Void_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_127_has)
HXLINE( 129)		{
HXLINE( 129)			int _g = 0;
...
void _Event_Int_Float_Void_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_143_remove)
...
void _Event_Int_Float_Void_obj::removeAll(){
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_163_removeAll)
...
HX_DEFINE_DYNAMIC_FUNC0(_Event_Int_Float_Void_obj,removeAll,(void))
...
static ::hx::StorageInfo _Event_Int_Float_Void_obj_sMemberStorageInfo[] = {
	{::hx::fsBool,(int)offsetof(_Event_Int_Float_Void_obj,canceled),HX_("canceled",59,18,26,1f)},
	{::hx::fsObject /* ::Array< bool > */ ,(int)offsetof(_Event_Int_Float_Void_obj,_hx___repeat),HX_("__repeat",7b,02,ac,ae)},
	{::hx::fsObject /* ::Array< int > */ ,(int)offsetof(_Event_Int_Float_Void_obj,_hx___priorities),HX_("__priorities",e2,cb,e6,1c)},
	{::hx::fsObject /* ::Array< ::Dynamic> */ ,(int)offsetof(_Event_Int_Float_Void_obj,_hx___listeners),HX_("__listeners",5f,ae,ba,21)},
	{ ::hx::fsUnknown, 0, null()}
};
...
{
	_Event_Int_Float_Void_obj _hx_dummy;
	_Event_Int_Float_Void_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("lime.app._Event_Int_Float_Void",a5,0a,4e,10);

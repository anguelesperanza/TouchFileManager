...
static ::hx::StorageInfo Promise_openfl_display_BitmapData_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsBool,(int)offsetof(Promise_openfl_display_BitmapData_obj,isComplete),HX_("isComplete",c3,12,77,fa)},
	{::hx::fsBool,(int)offsetof(Promise_openfl_display_BitmapData_obj,isError),HX_("isError",7e,6f,af,0f)},
	{ ::hx::fsUnknown, 0, null()}
};

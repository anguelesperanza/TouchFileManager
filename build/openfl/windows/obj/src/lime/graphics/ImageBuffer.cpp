...
HXDLIN( 177)					_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 177)					_this->copyFromArray(array,null());
HXDLIN( 177)					this1 = _this;
            				}
            				else {
HXLINE( 177)					if (::hx::IsNotNull( vector )) {
HXLINE( 177)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 177)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 177)						_this1->byteOffset = 0;
HXDLIN( 177)						_this1->length = array1->get_length();
HXDLIN( 177)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 177)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 177)						_this1->copyFromArray(array1,null());
HXDLIN( 177)						this1 = _this1;
            					}
            					else {
HXLINE( 177)						if (::hx::IsNotNull( view )) {
HXLINE( 177)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 177)							int elementSize = _this2->bytesPerElement;
HXDLIN( 177)							if ((view->type == _this2->type)) {
HXLINE( 177)								int srcLength1 = srcData->length;
HXDLIN( 177)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 177)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 177)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE( 177)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN( 177)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 177)							_this2->byteOffset = 0;
HXDLIN( 177)							_this2->length = srcLength;
HXDLIN( 177)							this1 = _this2;
            						}
            						else {
HXLINE( 177)							if (::hx::IsNotNull( bytes )) {
HXLINE( 177)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 177)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 177)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 177)								int bufferByteLength = bytes->length;
HXDLIN( 177)								int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 177)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 177)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXLINE( 177)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 177)									int newRange = (in_byteOffset + newByteLength);
HXDLIN( 177)									if ((newRange > bufferByteLength)) {
HXLINE( 177)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN( 177)								_this3->buffer = bytes;
HXDLIN( 177)								_this3->byteOffset = in_byteOffset;
HXDLIN( 177)								_this3->byteLength = newByteLength;
HXDLIN( 177)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 177)								this1 = _this3;
            							}
            							else {

...
HXDLIN( 258)									_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
...
HXDLIN( 258)											_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
...
HXLINE( 789)						goto _hx_goto_11;
            					...
            					/* default */{
HXLINE( 793)						int rgba2 = 0;
HXDLIN( 793)						rgba2 = ((((((::hx::UShr(color,16) & 255) & 255) << 24) | (((::hx::UShr(color,8) & 255) & 255) << 16)) | (((color & 255) & 255) << 8)) | ((::hx::UShr(color,24) & 255) & 255));
HXDLIN( 793)						int rgba3 = rgba2;
HXLINE( 794)						return rgba3;
            					}
            					_hx_goto_11:;
            				}
            			}
...
HXLINE( 831)						goto _hx_goto_13;
            					...
            					/* default */{
HXLINE( 835)						int rgba2 = 0;
HXDLIN( 835)						rgba2 = ((((((::hx::UShr(color,16) & 255) & 255) << 24) | (((::hx::UShr(color,8) & 255) & 255) << 16)) | (((color & 255) & 255) << 8)) | ((::hx::UShr(color,24) & 255) & 255));
HXDLIN( 835)						int rgba3 = rgba2;
HXLINE( 836)						return rgba3;
            					}
            					_hx_goto_13:;
            				}
            			}
...
HXLINE(1099)				 ::Dynamic _hx_tmp1 =  ::Dynamic(this->buffer->_hx___srcBitmapData->__Field(HX_("merge",b8,a2,c6,05),::hx::paccDynamic));
HXDLIN(1099)				 ::Dynamic sourceImage1 = sourceImage->buffer->_hx___srcBitmapData;
HXDLIN(1099)				 ::Dynamic _hx_tmp2 = sourceRect->_hx___toFlashRectangle();
HXDLIN(1099)				_hx_tmp1(sourceImage1,_hx_tmp2,destPoint->_hx___toFlashPoint(),redMultiplier,greenMultiplier,blueMultiplier,alphaMultiplier);
            			}
            			break;
            			default:{
HXLINE(1103)				return;
...
HXDLIN(1199)						int argb2 = 0;
HXDLIN(1199)						argb2 = ((((((bgra & 255) & 255) << 24) | (((::hx::UShr(bgra,8) & 255) & 255) << 16)) | (((::hx::UShr(bgra,16) & 255) & 255) << 8)) | ((::hx::UShr(bgra,24) & 255) & 255));
HXLINE(1196)						argb = argb2;
HXLINE(1199)						goto _hx_goto_19;
            					}
            					/* default */{
HXLINE(1200)						int rgba1 = color;
HXDLIN(1200)						int argb3 = 0;
HXDLIN(1200)						argb3 = ((((((rgba1 & 255) & 255) << 24) | (((::hx::UShr(rgba1,24) & 255) & 255) << 16)) | (((::hx::UShr(rgba1,16) & 255) & 255) << 8)) | ((::hx::UShr(rgba1,8) & 255) & 255));
HXLINE(1196)						argb = argb3;
            					}
            					_hx_goto_19:;
            				}
...
HXDLIN(1236)						int argb2 = 0;
HXDLIN(1236)						argb2 = ((((((bgra & 255) & 255) << 24) | (((::hx::UShr(bgra,8) & 255) & 255) << 16)) | (((::hx::UShr(bgra,16) & 255) & 255) << 8)) | ((::hx::UShr(bgra,24) & 255) & 255));
HXLINE(1233)						argb = argb2;
HXLINE(1236)						goto _hx_goto_21;
            					}
            					/* default */{
HXLINE(1237)						int rgba1 = color;
HXDLIN(1237)						int argb3 = 0;
HXDLIN(1237)						argb3 = ((((((rgba1 & 255) & 255) << 24) | (((::hx::UShr(rgba1,24) & 255) & 255) << 16)) | (((::hx::UShr(rgba1,16) & 255) & 255) << 8)) | ((::hx::UShr(rgba1,8) & 255) & 255));
HXLINE(1233)						argb = argb3;
            					}
            					_hx_goto_21:;
            				}
...
HXDLIN(1378)						int argb1 = 0;
HXDLIN(1378)						argb1 = ((((((bgra & 255) & 255) << 24) | (((::hx::UShr(bgra,8) & 255) & 255) << 16)) | (((::hx::UShr(bgra,16) & 255) & 255) << 8)) | ((::hx::UShr(bgra,24) & 255) & 255));
HXLINE(1375)						_color = argb1;
HXLINE(1378)						goto _hx_goto_24;
            					}
            					/* default */{
HXLINE(1379)						int rgba1 = color;
HXDLIN(1379)						int argb2 = 0;
HXDLIN(1379)						argb2 = ((((((rgba1 & 255) & 255) << 24) | (((::hx::UShr(rgba1,24) & 255) & 255) << 16)) | (((::hx::UShr(rgba1,16) & 255) & 255) << 8)) | ((::hx::UShr(rgba1,8) & 255) & 255));
HXLINE(1375)						_color = argb2;
            					}
            					_hx_goto_24:;
            				}
HXLINE(1382)				int _mask;
HXDLIN(1382)				if (::hx::IsNull( format )) {
HXLINE(1386)					int rgba2 = mask;
HXDLIN(1386)					int argb3 = 0;
HXDLIN(1386)					argb3 = ((((((rgba2 & 255) & 255) << 24) | (((::hx::UShr(rgba2,24) & 255) & 255) << 16)) | (((::hx::UShr(rgba2,16) & 255) & 255) << 8)) | ((::hx::UShr(rgba2,8) & 255) & 255));
HXLINE(1382)					_mask = argb3;
            				}
            				else {
...
HXDLIN(1382)						goto _hx_goto_25;
            					...
            					if (  (_hx_switch_1==2) ){
HXLINE(1385)						int bgra1 = mask;
HXDLIN(1385)						int argb4 = 0;
HXDLIN(1385)						argb4 = ((((((bgra1 & 255) & 255) << 24) | (((::hx::UShr(bgra1,8) & 255) & 255) << 16)) | (((::hx::UShr(bgra1,16) & 255) & 255) << 8)) | ((::hx::UShr(bgra1,24) & 255) & 255));
HXLINE(1382)						_mask = argb4;
HXLINE(1385)						goto _hx_goto_25;
            					}
            					/* default */{
HXLINE(1386)						int rgba3 = mask;
HXDLIN(1386)						int argb5 = 0;
HXDLIN(1386)						argb5 = ((((((rgba3 & 255) & 255) << 24) | (((::hx::UShr(rgba3,24) & 255) & 255) << 16)) | (((::hx::UShr(rgba3,16) & 255) & 255) << 8)) | ((::hx::UShr(rgba3,8) & 255) & 255));
HXLINE(1382)						_mask = argb5;
            					}
            					_hx_goto_25:;
            				}
...
HXLINE(1392)				 ::Dynamic _hx_tmp2 =  ::Dynamic(this->buffer->_hx___srcBitmapData->__Field(HX_("threshold",ab,c3,a3,34),::hx::paccDynamic));
HXDLIN(1392)				 ::Dynamic _hx_tmp3 = sourceImage->buffer->get_src();
HXDLIN(1392)				 ::Dynamic _hx_tmp4 = sourceRect->_hx___toFlashRectangle();
HXDLIN(1392)				return ( (int)(_hx_tmp2(_hx_tmp3,_hx_tmp4,destPoint->_hx___toFlashPoint(),operation,threshold,_color,_mask,copySource)) );
            			}
            			break;
            			default:{
            			}
...
HXDLIN(1498)		 ::openfl::_Vector::IntVector vector = null();
...
HXDLIN(1498)				_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN(1498)				_this->copyFromArray(array,null());
HXDLIN(1498)				this1 = _this;
            			}
            			else {
HXLINE(1498)				if (::hx::IsNotNull( vector )) {
HXLINE(1498)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1498)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(1498)					_this1->byteOffset = 0;
HXDLIN(1498)					_this1->length = array1->get_length();
HXDLIN(1498)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN(1498)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN(1498)					_this1->copyFromArray(array1,null());
HXDLIN(1498)					this1 = _this1;
            				}
            				else {
HXLINE(1498)					if (::hx::IsNotNull( view )) {
HXLINE(1498)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN(1498)						int elementSize = _this2->bytesPerElement;
HXDLIN(1498)						if ((view->type == _this2->type)) {
HXLINE(1498)							int srcLength1 = srcData->length;
HXDLIN(1498)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(1498)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1498)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE(1498)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN(1498)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN(1498)						_this2->byteOffset = 0;
HXDLIN(1498)						_this2->length = srcLength;
HXDLIN(1498)						this1 = _this2;
            					}
            					else {
HXLINE(1498)						if (::hx::IsNotNull( buffer )) {
HXLINE(1498)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN(1498)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE(1498)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN(1498)							int bufferByteLength = buffer->length;
HXDLIN(1498)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN(1498)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE(1498)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE(1498)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN(1498)								int newRange = (in_byteOffset + newByteLength);
HXDLIN(1498)								if ((newRange > bufferByteLength)) {
HXLINE(1498)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN(1498)							_this3->buffer = buffer;
HXDLIN(1498)							_this3->byteOffset = in_byteOffset;
HXDLIN(1498)							_this3->byteLength = newByteLength;
HXDLIN(1498)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN(1498)							this1 = _this3;
            						}
            						else {
...
HXDLIN(1620)			 ::openfl::_Vector::IntVector vector = null();
...
HXDLIN(1620)					_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN(1620)					_this->copyFromArray(array,null());
HXDLIN(1620)					this1 = _this;
            				}
            				else {
HXLINE(1620)					if (::hx::IsNotNull( vector )) {
HXLINE(1620)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1620)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(1620)						_this1->byteOffset = 0;
HXDLIN(1620)						_this1->length = array1->get_length();
HXDLIN(1620)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN(1620)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN(1620)						_this1->copyFromArray(array1,null());
HXDLIN(1620)						this1 = _this1;
            					}
            					else {
HXLINE(1620)						if (::hx::IsNotNull( view )) {
HXLINE(1620)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN(1620)							int elementSize = _this2->bytesPerElement;
HXDLIN(1620)							if ((view->type == _this2->type)) {
HXLINE(1620)								int srcLength1 = srcData->length;
HXDLIN(1620)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(1620)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1620)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE(1620)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN(1620)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN(1620)							_this2->byteOffset = 0;
HXDLIN(1620)							_this2->length = srcLength;
HXDLIN(1620)							this1 = _this2;
            						}
            						else {
HXLINE(1620)							if (::hx::IsNotNull( buffer2 )) {
HXLINE(1620)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1620)								int in_byteOffset = 0;
HXDLIN(1620)								if ((in_byteOffset < 0)) {
HXLINE(1620)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN(1620)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE(1620)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN(1620)								int bufferByteLength = buffer2->length;
HXDLIN(1620)								int elementSize1 = _this3->bytesPerElement;
...
HXDLIN(1620)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE(1620)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXLINE(1620)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN(1620)									int newRange = (in_byteOffset + newByteLength);
HXDLIN(1620)									if ((newRange > bufferByteLength)) {
HXLINE(1620)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN(1620)								_this3->buffer = buffer2;
HXDLIN(1620)								_this3->byteOffset = in_byteOffset;
HXDLIN(1620)								_this3->byteLength = newByteLength;
HXDLIN(1620)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN(1620)								this1 = _this3;
            							}
            							else {
HXLINE(1620)								HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            							}
            						}
            					}
            				}
...
HXLINE(1856)			bool _hx_tmp1;
HXDLIN(1856)			if (!(value)) {
HXLINE(1856)				_hx_tmp1 = this->buffer->premultiplied;
            			}
            			else {
HXLINE(1856)				_hx_tmp1 = false;
            			}

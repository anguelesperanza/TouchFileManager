...
HXLINE( 174)						{
HXLINE( 174)							int _g3 = 0;
HXDLIN( 174)							int _g4 = image->width;
HXDLIN( 174)							while((_g3 < _g4)){
HXLINE( 174)								_g3 = (_g3 + 1);
HXDLIN( 174)								int x = (_g3 - 1);
...
HXLINE( 186)						{
HXLINE( 186)							int _g5 = 0;
HXDLIN( 186)							int _g6 = ::hx::Mod((image->width * 3),4);
HXDLIN( 186)							while((_g5 < _g6)){
HXLINE( 186)								_g5 = (_g5 + 1);
HXDLIN( 186)								int i1 = (_g5 - 1);
HXLINE( 188)								{
...
HXDLIN( 188)									data->b[(position - 1)] = ( (unsigned char)(0) );
            				...
            				break;
            				case (int)1: {
HXLINE( 117)					int _g7 = 0;
HXDLIN( 117)					int _g8 = image->height;
HXDLIN( 117)					while((_g7 < _g8)){
HXLINE( 117)						_g7 = (_g7 + 1);
HXDLIN( 117)						int y1 = (_g7 - 1);
HXLINE( 119)						readPosition = ((((image->height - 1) - y1) * 4) * image->width);
HXLINE( 121)						{
HXLINE( 121)							int _g9 = 0;
HXDLIN( 121)							int _g10 = image->width;
HXDLIN( 121)							while((_g9 < _g10)){
HXLINE( 121)								_g9 = (_g9 + 1);
HXDLIN( 121)								int x1 = (_g9 - 1);
...
HXLINE( 139)					{
HXLINE( 139)						int _g11 = 0;
HXDLIN( 139)						int _g12 = image->height;
HXDLIN( 139)						while((_g11 < _g12)){
HXLINE( 139)							_g11 = (_g11 + 1);
HXDLIN( 139)							int y2 = (_g11 - 1);
HXLINE( 141)							readPosition = ((((image->height - 1) - y2) * 4) * image->width);
HXLINE( 143)							{
HXLINE( 143)								int _g13 = 0;
HXDLIN( 143)								int _g14 = image->width;
HXDLIN( 143)								while((_g13 < _g14)){
HXLINE( 143)									_g13 = (_g13 + 1);
HXDLIN( 143)									int x2 = (_g13 - 1);

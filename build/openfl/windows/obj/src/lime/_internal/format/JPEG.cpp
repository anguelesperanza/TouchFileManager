...
HXDLIN(  33)				_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
...
HXDLIN(  33)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
...
HXDLIN(  33)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
...
HXDLIN(  33)							_this3->buffer = buffer1;
...
HXDLIN(  58)				_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
...
HXDLIN(  58)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
...
HXDLIN(  58)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
...
HXDLIN(  58)							_this3->buffer = buffer1;
...
HXLINE(  95)			::cpp::Function<  ::hx::Object *  ( ::hx::Object *,int,int, ::hx::Object *) > _hx_tmp1 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_image_encode;
HXDLIN(  95)			 ::lime::graphics::ImageBuffer image1 = image->buffer;
HXDLIN(  95)			return ( ( ::Dynamic)(_hx_tmp1(::hx::DynamicPtr(image1),1,quality,::hx::DynamicPtr(::haxe::io::Bytes_obj::alloc(0)))) );
            		}

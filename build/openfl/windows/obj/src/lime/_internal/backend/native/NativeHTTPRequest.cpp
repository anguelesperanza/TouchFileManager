...
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_403_localThreadPool_doWork,"lime._internal.backend.native.NativeHTTPRequest","localThreadPool_doWork",0x0add4afa,"lime._internal.backend.native.NativeHTTPRequest.localThreadPool_doWork","lime/_internal/backend/native/NativeHTTPRequest.hx",403,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_448_localThreadPool_onComplete,"lime._internal.backend.native.NativeHTTPRequest","localThreadPool_onComplete",0xf7b04ff6,"lime._internal.backend.native.NativeHTTPRequest.localThreadPool_onComplete","lime/_internal/backend/native/NativeHTTPRequest.hx",448,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_466_localThreadPool_onError,"lime._internal.backend.native.NativeHTTPRequest","localThreadPool_onError",0x7e9a446b,"lime._internal.backend.native.NativeHTTPRequest.localThreadPool_onError","lime/_internal/backend/native/NativeHTTPRequest.hx",466,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_489_localThreadPool_onProgress,"lime._internal.backend.native.NativeHTTPRequest","localThreadPool_onProgress",0xfe1346ea,"lime._internal.backend.native.NativeHTTPRequest.localThreadPool_onProgress","lime/_internal/backend/native/NativeHTTPRequest.hx",489,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_497_multiThreadPool_doWork,"lime._internal.backend.native.NativeHTTPRequest","multiThreadPool_doWork",0x3b867a2c,"lime._internal.backend.native.NativeHTTPRequest.multiThreadPool_doWork","lime/_internal/backend/native/NativeHTTPRequest.hx",497,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_536_multiThreadPool_onComplete,"lime._internal.backend.native.NativeHTTPRequest","multiThreadPool_onComplete",0xd0260028,"lime._internal.backend.native.NativeHTTPRequest.multiThreadPool_onComplete","lime/_internal/backend/native/NativeHTTPRequest.hx",536,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_559_multiThreadPool_onProgress,"lime._internal.backend.native.NativeHTTPRequest","multiThreadPool_onProgress",0xd688f71c,"lime._internal.backend.native.NativeHTTPRequest.multiThreadPool_onProgress","lime/_internal/backend/native/NativeHTTPRequest.hx",559,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_606_multiProgressTimer_onRun,"lime._internal.backend.native.NativeHTTPRequest","multiProgressTimer_onRun",0x7d995edc,"lime._internal.backend.native.NativeHTTPRequest.multiProgressTimer_onRun","lime/_internal/backend/native/NativeHTTPRequest.hx",606,0xfe6a4b7e)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
HXLINE( 167)			goto _hx_goto_4;
            		...
            		/* default */{
HXLINE( 177)			 ::lime::net::curl::CURL _hx_tmp1 = this->curl;
HXDLIN( 177)			_hx_tmp1->setOption(10036,::Std_obj::string( ::Dynamic(this->parent->__Field(HX_("method",e1,f6,5a,09),::hx::paccDynamic))));
...
HXLINE( 202)					::String _hx_tmp2 = ((HX_("",00,00,00,00) + ::Std_obj::string( ::Dynamic(header->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)))) + HX_(": ",a6,32,00,00));
HXDLIN( 202)					headers->push((_hx_tmp2 + ::Std_obj::string( ::Dynamic(header->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)))));
            				}
            			}
            		}
...
HXDLIN( 246)				::Array< ::String > _g3 = ::lime::_internal::backend::native::NativeHTTPRequest_obj::cookieList;
HXDLIN( 246)				while((_g2 < _g3->length)){
HXLINE( 246)					::String cookie = _g3->__get(_g2);
...
HXLINE( 256)		 ::Dynamic _hx_tmp3;
HXDLIN( 256)		if (::hx::IsNull( this->parent->__Field(HX_("userAgent",7a,f0,12,c8),::hx::paccDynamic) )) {
HXLINE( 256)			_hx_tmp3 = HX_("libcurl-agent/1.0",4d,41,cc,d3);
            		}
            		else {
HXLINE( 256)			_hx_tmp3 =  ::Dynamic(this->parent->__Field(HX_("userAgent",7a,f0,12,c8),::hx::paccDynamic));
            		}
HXDLIN( 256)		this->curl->setOption(10018,_hx_tmp3);
...
HXDLIN( 397)			int len = output->length;
HXDLIN( 397)			bool _hx_tmp;
HXDLIN( 397)			if ((len >= 0)) {
HXLINE( 397)				_hx_tmp = (len > output->length);
            			}
            			else {
HXLINE( 397)				_hx_tmp = true;
            			}
HXDLIN( 397)			if (_hx_tmp) {
HXLINE( 397)				HX_STACK_DO_THROW(::haxe::io::Error_obj::OutsideBounds_dyn());
            			}
HXDLIN( 397)			::Array< unsigned char > b1 = _this->b;
HXDLIN( 397)			::Array< unsigned char > b2 = output->b;
HXDLIN( 397)			{
HXLINE( 397)				int _g = 0;
HXDLIN( 397)				int _g1 = len;
...
HXLINE( 399)		return output->length;
            	}
...
void NativeHTTPRequest_obj::localThreadPool_doWork( ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_403_localThreadPool_doWork)
HXLINE( 404)		 ::lime::_internal::backend::native::NativeHTTPRequest instance = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(state->__Field(HX_("instance",95,1f,e1,59),::hx::paccDynamic)) );
HXLINE( 405)		::String path = ( (::String)(state->__Field(HX_("uri",6c,2b,59,00),::hx::paccDynamic)) );
HXLINE( 407)		int index = path.indexOf(HX_("?",3f,00,00,00),null());
HXLINE( 409)		if ((index > -1)) {
HXLINE( 411)			path = path.substring(0,index);
            		}
HXLINE( 421)		bool _hx_tmp;
HXDLIN( 421)		if (::hx::IsNotNull( path )) {
HXLINE( 421)			_hx_tmp = !(::sys::FileSystem_obj::exists(path));
            		}
            		else {
HXLINE( 421)			_hx_tmp = true;
            		}
HXDLIN( 421)		if (_hx_tmp) {
HXLINE( 423)			::lime::_internal::backend::native::NativeHTTPRequest_obj::localThreadPool->sendError( ::Dynamic(::hx::Anon_obj::Create(3)
...
HXLINE( 427)			instance->bytes = ::lime::utils::_Bytes::Bytes_Impl__obj::fromFile(path);
HXLINE( 429)			if (::hx::IsNotNull( instance->bytes )) {
HXLINE( 431)				::lime::_internal::backend::native::NativeHTTPRequest_obj::localThreadPool->sendProgress( ::Dynamic(::hx::Anon_obj::Create(4)
...
HXLINE( 438)				::lime::_internal::backend::native::NativeHTTPRequest_obj::localThreadPool->sendComplete( ::Dynamic(::hx::Anon_obj::Create(3)
            					->setFixed(0,HX_("promise",9b,cd,e9,f7),instance->promise)
            					->setFixed(1,HX_("result",dd,68,84,08),instance->bytes)
            					->setFixed(2,HX_("instance",95,1f,e1,59),instance)));
            			}
            			else {
HXLINE( 442)				::lime::_internal::backend::native::NativeHTTPRequest_obj::localThreadPool->sendError( ::Dynamic(::hx::Anon_obj::Create(3)
            					->setFixed(0,HX_("promise",9b,cd,e9,f7),instance->promise)
            					->setFixed(1,HX_("instance",95,1f,e1,59),instance)
            					->setFixed(2,HX_("error",c8,cb,29,73),(HX_("Cannot load file: ",5f,26,cd,00) + path))));
            			}
...
void NativeHTTPRequest_obj::localThreadPool_onComplete( ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_448_localThreadPool_onComplete)
HXLINE( 449)		 ::lime::app::Promise_haxe_io_Bytes promise = ( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),::hx::paccDynamic)) );
HXLINE( 450)		if (promise->get_isError()) {
HXLINE( 450)			return;
            		}
HXLINE( 451)		promise->complete(( ( ::haxe::io::Bytes)(state->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic)) ));
HXLINE( 453)		 ::lime::_internal::backend::native::NativeHTTPRequest instance = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(state->__Field(HX_("instance",95,1f,e1,59),::hx::paccDynamic)) );
HXLINE( 455)		if (::hx::IsNotNull( instance->timeout )) {
HXLINE( 457)			instance->timeout->stop();
HXLINE( 458)			instance->timeout = null();
            		}
HXLINE( 461)		instance->bytes = null();
HXLINE( 462)		instance->promise = null();
            	}
...
void NativeHTTPRequest_obj::localThreadPool_onError( ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_466_localThreadPool_onError)
HXLINE( 467)		 ::lime::app::Promise_haxe_io_Bytes promise = ( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),::hx::paccDynamic)) );
HXLINE( 468)		promise->error( ::Dynamic(state->__Field(HX_("error",c8,cb,29,73),::hx::paccDynamic)));
HXLINE( 470)		 ::lime::_internal::backend::native::NativeHTTPRequest instance = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(state->__Field(HX_("instance",95,1f,e1,59),::hx::paccDynamic)) );
HXLINE( 472)		if (::hx::IsNotNull( instance->timeout )) {
HXLINE( 474)			instance->timeout->stop();
HXLINE( 475)			instance->timeout = null();
            		}
HXLINE( 478)		instance->bytes = null();
HXLINE( 479)		instance->promise = null();
            	}
...
void NativeHTTPRequest_obj::localThreadPool_onProgress( ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_489_localThreadPool_onProgress)
HXLINE( 490)		 ::lime::app::Promise_haxe_io_Bytes promise = ( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),::hx::paccDynamic)) );
HXLINE( 491)		bool _hx_tmp;
HXDLIN( 491)		if (!(promise->get_isComplete())) {
HXLINE( 491)			_hx_tmp = promise->get_isError();
            		}
            		else {
...
HXLINE( 492)		promise->progress(( (int)(state->__Field(HX_("bytesLoaded",d0,66,ca,99),::hx::paccDynamic)) ),( (int)(state->__Field(HX_("bytesTotal",59,57,da,45),::hx::paccDynamic)) ));
            	}
...
void NativeHTTPRequest_obj::multiThreadPool_doWork( ::Dynamic _){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_497_multiThreadPool_doWork)
HXDLIN( 497)		while(true){
HXLINE( 500)			 ::lime::net::curl::CURL curl = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiAddHandle->pop(false).StaticCast<  ::lime::net::curl::CURL >();
HXLINE( 501)			if (::hx::IsNotNull( curl )) {
HXLINE( 501)				::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->addHandle(curl);
            			}
HXLINE( 504)			int code = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->wait(1000);
HXLINE( 506)			if ((code == 0)) {
HXLINE( 508)				::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->perform();
HXLINE( 509)				 ::lime::net::curl::CURLMultiMessage message = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->infoRead();
HXLINE( 511)				bool _hx_tmp;
HXDLIN( 511)				if (::hx::IsNull( message )) {
HXLINE( 511)					_hx_tmp = (::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->get_runningHandles() == 0);
            				}
            				else {
HXLINE( 511)					_hx_tmp = false;
            				}
HXDLIN( 511)				if (_hx_tmp) {
HXLINE( 513)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multiThreadPool->sendComplete(null());
HXLINE( 514)					goto _hx_goto_20;
            				}
HXLINE( 517)				while(::hx::IsNotNull( message )){
HXLINE( 519)					 ::lime::net::curl::CURL curl1 = message->curl;
HXLINE( 520)					 ::Dynamic status = curl1->getInfo(2097154);
HXLINE( 523)					::lime::_internal::backend::native::NativeHTTPRequest_obj::cookieList = ( (::Array< ::String >)(curl1->getInfo(4194332)) );
HXLINE( 525)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->removeHandle(curl1);
HXLINE( 526)					curl1->cleanup();
HXLINE( 528)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multiThreadPool->sendProgress( ::Dynamic(::hx::Anon_obj::Create(3)
...
HXLINE( 529)					message = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->infoRead();
            				}
            			}
            		}
            		_hx_goto_20:;
...
void NativeHTTPRequest_obj::multiThreadPool_onComplete( ::Dynamic _){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_536_multiThreadPool_onComplete)
HXLINE( 538)		 ::lime::net::curl::CURL curl = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiAddHandle->pop(false).StaticCast<  ::lime::net::curl::CURL >();
HXLINE( 540)		if (::hx::IsNotNull( curl )) {
HXLINE( 542)			::lime::_internal::backend::native::NativeHTTPRequest_obj::multiAddHandle->push(curl);
HXLINE( 543)			::lime::_internal::backend::native::NativeHTTPRequest_obj::multiThreadPool->queue(null());
            		}
            		else {
HXLINE( 547)			if (::hx::IsNotNull( ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiProgressTimer )) {
HXLINE( 549)				::lime::_internal::backend::native::NativeHTTPRequest_obj::multiProgressTimer->stop();
HXLINE( 550)				::lime::_internal::backend::native::NativeHTTPRequest_obj::multiProgressTimer = null();
            			}
HXLINE( 553)			::lime::_internal::backend::native::NativeHTTPRequest_obj::multiThreadPoolRunning = false;
            		}
            	}
...
void NativeHTTPRequest_obj::multiThreadPool_onProgress( ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_559_multiThreadPool_onProgress)
HXLINE( 560)		if (::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->exists( ::Dynamic(state->__Field(HX_("curl",ec,4a,c9,41),::hx::paccDynamic)))) {
HXLINE( 562)			 ::lime::_internal::backend::native::NativeHTTPRequest instance = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->get( ::Dynamic(state->__Field(HX_("curl",ec,4a,c9,41),::hx::paccDynamic)))) );
HXLINE( 563)			::lime::_internal::backend::native::NativeHTTPRequest_obj::activeInstances->remove(instance);
HXLINE( 564)			::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->remove( ::Dynamic(state->__Field(HX_("curl",ec,4a,c9,41),::hx::paccDynamic)));
HXLINE( 566)			instance->parent->__SetField(HX_("responseStatus",93,60,a4,78),state->__Field(HX_("status",32,e7,fb,05),::hx::paccDynamic),::hx::paccDynamic);
HXLINE( 568)			if (::hx::IsEq( state->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic),0 )) {
HXLINE( 570)				bool _hx_tmp;
HXDLIN( 570)				bool _hx_tmp1;
HXDLIN( 570)				if (::hx::IsGreaterEq( state->__Field(HX_("status",32,e7,fb,05),::hx::paccDynamic),200 )) {
HXLINE( 570)					_hx_tmp1 = ::hx::IsLess( state->__Field(HX_("status",32,e7,fb,05),::hx::paccDynamic),400 );
            				}
            				else {
HXLINE( 570)					_hx_tmp1 = false;
            				}
HXDLIN( 570)				if (!(_hx_tmp1)) {
HXLINE( 570)					_hx_tmp = ::hx::IsEq( state->__Field(HX_("status",32,e7,fb,05),::hx::paccDynamic),0 );
            				}
            				else {
HXLINE( 570)					_hx_tmp = true;
            				}
HXDLIN( 570)				if (_hx_tmp) {
HXLINE( 572)					if (!(instance->promise->get_isError())) {
HXLINE( 574)						 ::lime::app::Promise_haxe_io_Bytes instance1 = instance->promise;
HXDLIN( 574)						instance1->complete(instance->buildBuffer());
            					}
            				}
            				else {
HXLINE( 577)					if (::hx::IsNotNull( instance->bytes )) {
HXLINE( 579)						 ::lime::app::Promise_haxe_io_Bytes instance2 = instance->promise;
HXDLIN( 579)						instance2->error(instance->bytes->getString(0,instance->bytes->length,null()));
            					}
            					else {
HXLINE( 583)						instance->promise->error( ::Dynamic((HX_("Status ",8e,8c,bf,03) + state->__Field(HX_("status",32,e7,fb,05),::hx::paccDynamic))));
            					}
            				}
            			}
            			else {
HXLINE( 588)				 ::lime::app::Promise_haxe_io_Bytes instance3 = instance->promise;
HXDLIN( 588)				instance3->error(::lime::net::curl::CURL_obj::strerror(( (int)(state->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic)) )));
            			}
HXLINE( 591)			if (::hx::IsNotNull( instance->timeout )) {
HXLINE( 593)				instance->timeout->stop();
HXLINE( 594)				instance->timeout = null();
            			}
HXLINE( 597)			instance->bytes = null();
HXLINE( 598)			instance->promise = null();
            		}
HXLINE( 601)		state->__SetField(HX_("curl",ec,4a,c9,41),null(),::hx::paccDynamic);
            	}
...
void NativeHTTPRequest_obj::multiProgressTimer_onRun(){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_606_multiProgressTimer_onRun)
HXDLIN( 606)		int _g = 0;
HXDLIN( 606)		::Array< ::Dynamic> _g1 = ::lime::_internal::backend::native::NativeHTTPRequest_obj::activeInstances;
HXDLIN( 606)		while((_g < _g1->length)){
HXDLIN( 606)			 ::lime::_internal::backend::native::NativeHTTPRequest instance = _g1->__get(_g).StaticCast<  ::lime::_internal::backend::native::NativeHTTPRequest >();
HXDLIN( 606)			_g = (_g + 1);
HXLINE( 608)			bool _hx_tmp;
HXDLIN( 608)			if ((instance->bytesLoaded == instance->writeBytesLoaded)) {
HXLINE( 608)				_hx_tmp = (instance->bytesTotal != instance->writeBytesTotal);
            			}
            			else {
HXLINE( 608)				_hx_tmp = true;
            			}
HXDLIN( 608)			if (_hx_tmp) {
HXLINE( 610)				instance->bytesLoaded = instance->writeBytesLoaded;
HXLINE( 611)				instance->bytesTotal = instance->writeBytesTotal;
HXLINE( 612)				instance->promise->progress(instance->bytesLoaded,instance->bytesTotal);
            			}
            		}
            	}

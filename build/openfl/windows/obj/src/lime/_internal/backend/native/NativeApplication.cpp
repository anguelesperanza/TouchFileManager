...
HXLINE( 275)						bool _hx_tmp2;
HXDLIN( 275)						if (!(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier))) {
HXLINE( 275)							_hx_tmp2 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier));
            						}
            						else {
...
HXLINE( 465)				::lime::ui::Touch_obj::onStart->dispatch(touch);
            			...
            			break;
            			case (int)1: {
HXLINE( 468)				 ::lime::ui::Touch touch1 = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
HXLINE( 470)				if (::hx::IsNotNull( touch1 )) {
HXLINE( 472)					touch1->x = this->touchEventInfo->x;
HXLINE( 473)					touch1->y = this->touchEventInfo->y;
HXLINE( 474)					touch1->dx = this->touchEventInfo->dx;
HXLINE( 475)					touch1->dy = this->touchEventInfo->dy;
HXLINE( 476)					touch1->pressure = this->touchEventInfo->pressure;
HXLINE( 478)					::lime::ui::Touch_obj::onEnd->dispatch(touch1);
HXLINE( 480)					this->currentTouches->remove(this->touchEventInfo->id);
HXLINE( 481)					this->unusedTouchesPool->add(touch1);
            				}
            			}
            			break;
            			case (int)2: {
HXLINE( 485)				 ::lime::ui::Touch touch2 = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
HXLINE( 487)				if (::hx::IsNotNull( touch2 )) {
HXLINE( 489)					touch2->x = this->touchEventInfo->x;
HXLINE( 490)					touch2->y = this->touchEventInfo->y;
HXLINE( 491)					touch2->dx = this->touchEventInfo->dx;
HXLINE( 492)					touch2->dy = this->touchEventInfo->dy;
HXLINE( 493)					touch2->pressure = this->touchEventInfo->pressure;
HXLINE( 495)					::lime::ui::Touch_obj::onMove->dispatch(touch2);
            				}
            			}
            			break;
            			default:{
...
HXLINE( 597)				::Array< ::Dynamic> _g2 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 597)				{
HXLINE( 597)					int _g3 = 0;
HXDLIN( 597)					::Array< ::Dynamic> _g4 = ::haxe::Timer_obj::sRunningTimers;
HXDLIN( 597)					while((_g3 < _g4->length)){
HXLINE( 597)						 ::haxe::Timer v = _g4->__get(_g3).StaticCast<  ::haxe::Timer >();
HXDLIN( 597)						_g3 = (_g3 + 1);
HXDLIN( 597)						if (::hx::IsNotNull( v )) {
HXLINE( 597)							_g2->push(v);
            						}
            					}
            				}
HXDLIN( 597)				::haxe::Timer_obj::sRunningTimers = _g2;
            			}
            		}

...
HXDLIN( 352)					_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 352)					_this->copyFromArray(array,null());
HXDLIN( 352)					this1 = _this;
            				}
            				else {
HXLINE( 352)					if (::hx::IsNotNull( vector )) {
HXLINE( 352)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 352)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 352)						_this1->byteOffset = 0;
HXDLIN( 352)						_this1->length = array1->get_length();
HXDLIN( 352)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 352)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 352)						_this1->copyFromArray(array1,null());
HXDLIN( 352)						this1 = _this1;
            					}
            					else {
HXLINE( 352)						if (::hx::IsNotNull( view )) {
HXLINE( 352)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 352)							int elementSize = _this2->bytesPerElement;
HXDLIN( 352)							if ((view->type == _this2->type)) {
HXLINE( 352)								int srcLength1 = srcData->length;
HXDLIN( 352)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 352)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 352)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE( 352)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN( 352)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 352)							_this2->byteOffset = 0;
HXDLIN( 352)							_this2->length = srcLength;
HXDLIN( 352)							this1 = _this2;
            						}
            						else {
HXLINE( 352)							if (::hx::IsNotNull( buffer )) {
HXLINE( 352)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 352)								int in_byteOffset = 0;
HXDLIN( 352)								if ((in_byteOffset < 0)) {
HXLINE( 352)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 352)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 352)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 352)								int bufferByteLength = buffer->length;
HXDLIN( 352)								int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 352)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 352)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXLINE( 352)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 352)									int newRange = (in_byteOffset + newByteLength);
HXDLIN( 352)									if ((newRange > bufferByteLength)) {
HXLINE( 352)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN( 352)								_this3->buffer = buffer;
HXDLIN( 352)								_this3->byteOffset = in_byteOffset;
HXDLIN( 352)								_this3->byteLength = newByteLength;
HXDLIN( 352)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 352)								this1 = _this3;
            							}
            							else {
...
HXDLIN( 382)			 ::Dynamic elements1 = null();
HXDLIN( 382)			 ::haxe::io::Bytes buffer2 = ::haxe::io::Bytes_obj::alloc(0);
HXDLIN( 382)			::cpp::VirtualArray array2 = null();
HXDLIN( 382)			 ::openfl::_Vector::IntVector vector1 = null();
HXDLIN( 382)			 ::lime::utils::ArrayBufferView view1 = null();
HXDLIN( 382)			 ::Dynamic len1 = null();
HXDLIN( 382)			 ::lime::utils::ArrayBufferView this2;
HXDLIN( 382)			if (::hx::IsNotNull( elements1 )) {
HXLINE( 382)				this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements1,4);
            			}
            			else {
HXLINE( 382)				if (::hx::IsNotNull( array2 )) {
HXLINE( 382)					 ::lime::utils::ArrayBufferView _this4 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 382)					_this4->byteOffset = 0;
HXDLIN( 382)					_this4->length = array2->get_length();
HXDLIN( 382)					_this4->byteLength = (_this4->length * _this4->bytesPerElement);
HXDLIN( 382)					_this4->buffer = ::haxe::io::Bytes_obj::alloc(_this4->byteLength);
HXDLIN( 382)					_this4->copyFromArray(array2,null());
HXDLIN( 382)					this2 = _this4;
            				}
            				else {
HXLINE( 382)					if (::hx::IsNotNull( vector1 )) {
HXLINE( 382)						 ::lime::utils::ArrayBufferView _this5 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 382)						::cpp::VirtualArray array3 = ( (::cpp::VirtualArray)(vector1->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 382)						_this5->byteOffset = 0;
HXDLIN( 382)						_this5->length = array3->get_length();
HXDLIN( 382)						_this5->byteLength = (_this5->length * _this5->bytesPerElement);
HXDLIN( 382)						_this5->buffer = ::haxe::io::Bytes_obj::alloc(_this5->byteLength);
HXDLIN( 382)						_this5->copyFromArray(array3,null());
HXDLIN( 382)						this2 = _this5;
            					}
            					else {
HXLINE( 382)						if (::hx::IsNotNull( view1 )) {
HXLINE( 382)							 ::lime::utils::ArrayBufferView _this6 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 382)							 ::haxe::io::Bytes srcData1 = view1->buffer;
HXDLIN( 382)							int srcLength2 = view1->length;
HXDLIN( 382)							int srcByteOffset1 = view1->byteOffset;
HXDLIN( 382)							int srcElementSize1 = view1->bytesPerElement;
HXDLIN( 382)							int elementSize2 = _this6->bytesPerElement;
HXDLIN( 382)							if ((view1->type == _this6->type)) {
HXLINE( 382)								int srcLength3 = srcData1->length;
HXDLIN( 382)								int cloneLength1 = (srcLength3 - srcByteOffset1);
HXDLIN( 382)								_this6->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN( 382)								_this6->buffer->blit(0,srcData1,srcByteOffset1,cloneLength1);
            							}
            							else {
HXLINE( 382)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN( 382)							_this6->byteLength = (_this6->bytesPerElement * srcLength2);
HXDLIN( 382)							_this6->byteOffset = 0;
HXDLIN( 382)							_this6->length = srcLength2;
HXDLIN( 382)							this2 = _this6;
            						}
            						else {
HXLINE( 382)							if (::hx::IsNotNull( buffer2 )) {
HXLINE( 382)								 ::lime::utils::ArrayBufferView _this7 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 382)								int in_byteOffset1 = 0;
HXDLIN( 382)								if ((in_byteOffset1 < 0)) {
HXLINE( 382)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 382)								if ((::hx::Mod(in_byteOffset1,_this7->bytesPerElement) != 0)) {
HXLINE( 382)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 382)								int bufferByteLength1 = buffer2->length;
HXDLIN( 382)								int elementSize3 = _this7->bytesPerElement;
HXDLIN( 382)								int newByteLength1 = bufferByteLength1;
HXDLIN( 382)								if (::hx::IsNull( len1 )) {
HXLINE( 382)									newByteLength1 = (bufferByteLength1 - in_byteOffset1);
HXDLIN( 382)									if ((::hx::Mod(bufferByteLength1,_this7->bytesPerElement) != 0)) {
HXLINE( 382)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 382)									if ((newByteLength1 < 0)) {
HXLINE( 382)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
            								else {
HXLINE( 382)									newByteLength1 = (( (int)(len1) ) * _this7->bytesPerElement);
HXDLIN( 382)									int newRange1 = (in_byteOffset1 + newByteLength1);
HXDLIN( 382)									if ((newRange1 > bufferByteLength1)) {
HXLINE( 382)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN( 382)								_this7->buffer = buffer2;
HXDLIN( 382)								_this7->byteOffset = in_byteOffset1;
HXDLIN( 382)								_this7->byteLength = newByteLength1;
HXDLIN( 382)								_this7->length = ::Std_obj::_hx_int((( (Float)(newByteLength1) ) / ( (Float)(_this7->bytesPerElement) )));
HXDLIN( 382)								this2 = _this7;
            							}
            							else {
...
HXDLIN( 382)			imageBuffer = ( ( ::Dynamic)(imageBuffer1(::hx::DynamicPtr(imageBuffer2),::hx::DynamicPtr(rect),::hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this2,null(),null(),null(),null())))) );

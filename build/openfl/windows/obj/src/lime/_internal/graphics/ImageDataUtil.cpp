...
HXDLIN( 985)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 985)					_this1->byteOffset = 0;
HXDLIN( 985)					_this1->length = array1->get_length();
HXDLIN( 985)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 985)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 985)					_this1->copyFromArray(array1,null());
...
HXDLIN( 985)						int elementSize = _this2->bytesPerElement;
HXDLIN( 985)						if ((view->type == _this2->type)) {
HXLINE( 985)							int srcLength1 = srcData->length;
HXDLIN( 985)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 985)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 985)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 985)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 985)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 985)						_this2->byteOffset = 0;
HXDLIN( 985)						_this2->length = srcLength;
HXDLIN( 985)						this1 = _this2;
            					}
            					else {
HXLINE( 985)						if (::hx::IsNotNull( buffer1 )) {
HXLINE( 985)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 985)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 985)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 985)							int bufferByteLength = buffer1->length;
HXDLIN( 985)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 985)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 985)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 985)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 985)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 985)								if ((newRange > bufferByteLength)) {
HXLINE( 985)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 985)							_this3->buffer = buffer1;
HXDLIN( 985)							_this3->byteOffset = in_byteOffset;
HXDLIN( 985)							_this3->byteLength = newByteLength;
HXDLIN( 985)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 985)							this1 = _this3;
            						}
            						else {
...
HXDLIN(1074)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(1074)					_this1->byteOffset = 0;
HXDLIN(1074)					_this1->length = array1->get_length();
HXDLIN(1074)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN(1074)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN(1074)					_this1->copyFromArray(array1,null());
...
HXDLIN(1074)						int elementSize = _this2->bytesPerElement;
HXDLIN(1074)						if ((view->type == _this2->type)) {
HXLINE(1074)							int srcLength1 = srcData->length;
HXDLIN(1074)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(1074)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1074)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE(1074)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN(1074)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN(1074)						_this2->byteOffset = 0;
HXDLIN(1074)						_this2->length = srcLength;
HXDLIN(1074)						this1 = _this2;
            					}
            					else {
HXLINE(1074)						if (::hx::IsNotNull( buffer1 )) {
HXLINE(1074)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN(1074)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE(1074)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN(1074)							int bufferByteLength = buffer1->length;
HXDLIN(1074)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN(1074)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE(1074)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE(1074)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN(1074)								int newRange = (in_byteOffset + newByteLength);
HXDLIN(1074)								if ((newRange > bufferByteLength)) {
HXLINE(1074)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN(1074)							_this3->buffer = buffer1;
HXDLIN(1074)							_this3->byteOffset = in_byteOffset;
HXDLIN(1074)							_this3->byteLength = newByteLength;
HXDLIN(1074)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN(1074)							this1 = _this3;
            						}
            						else {

...
HXLINE(1718)			 ::lime::math::Rectangle fh1 = this->rect;
HXDLIN(1718)			fh1->x = (fh1->x + x);
HXLINE(1719)			 ::lime::math::Rectangle fh2 = this->rect;
HXDLIN(1719)			fh2->width = (fh2->width - ( (Float)(x) ));
            		}
HXLINE(1722)		if ((y < 0)) {
HXLINE(1724)			 ::lime::math::Rectangle fh3 = this->rect;
HXDLIN(1724)			fh3->y = (fh3->y + y);
HXLINE(1725)			if ((this->rect->y < 0)) {
HXLINE(1725)				this->rect->y = ( (Float)(0) );
            			}
            		}
            		else {
HXLINE(1729)			 ::lime::math::Rectangle fh4 = this->rect;
HXDLIN(1729)			fh4->y = (fh4->y + y);
HXLINE(1730)			 ::lime::math::Rectangle fh5 = this->rect;
HXDLIN(1730)			fh5->height = (fh5->height - ( (Float)(y) ));
            		}

...
HXDLIN( 106)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 106)					_this1->byteOffset = 0;
HXDLIN( 106)					_this1->length = array1->get_length();
HXDLIN( 106)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 106)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 106)					_this1->copyFromArray(array1,null());
...
HXDLIN( 106)						int elementSize = _this2->bytesPerElement;
HXDLIN( 106)						if ((view->type == _this2->type)) {
HXDLIN( 106)							int srcLength1 = srcData->length;
HXDLIN( 106)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 106)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 106)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXDLIN( 106)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 106)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 106)						_this2->byteOffset = 0;
HXDLIN( 106)						_this2->length = srcLength;
HXDLIN( 106)						this1 = _this2;
            					}
            					else {
HXDLIN( 106)						if (::hx::IsNotNull( buffer )) {
HXDLIN( 106)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 106)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXDLIN( 106)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 106)							int bufferByteLength = buffer->length;
HXDLIN( 106)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 106)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXDLIN( 106)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXDLIN( 106)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 106)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 106)								if ((newRange > bufferByteLength)) {
HXDLIN( 106)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 106)							_this3->buffer = buffer;
HXDLIN( 106)							_this3->byteOffset = in_byteOffset;
HXDLIN( 106)							_this3->byteLength = newByteLength;
HXDLIN( 106)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 106)							this1 = _this3;
            						}
            						else {
...
HXLINE( 117)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,5);
...
HXDLIN( 117)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 117)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 117)							int bufferByteLength = buffer->length;
HXDLIN( 117)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 117)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 117)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 117)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 117)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 117)								if ((newRange > bufferByteLength)) {
HXLINE( 117)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 117)							_this3->buffer = buffer;
HXDLIN( 117)							_this3->byteOffset = in_byteOffset;
HXDLIN( 117)							_this3->byteLength = newByteLength;
HXDLIN( 117)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 117)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 128)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 128)					_this1->byteOffset = 0;
HXDLIN( 128)					_this1->length = array1->get_length();
HXDLIN( 128)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 128)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 128)					_this1->copyFromArray(array1,null());
...
HXDLIN( 128)						int elementSize = _this2->bytesPerElement;
HXDLIN( 128)						if ((view->type == _this2->type)) {
HXLINE( 128)							int srcLength1 = srcData->length;
HXDLIN( 128)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 128)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 128)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 128)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 128)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 128)						_this2->byteOffset = 0;
HXDLIN( 128)						_this2->length = srcLength;
HXDLIN( 128)						this1 = _this2;
            					}
            					else {
HXLINE( 128)						if (::hx::IsNotNull( buffer )) {
HXLINE( 128)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,1);
...
HXDLIN( 128)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 128)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 128)							int bufferByteLength = buffer->length;
HXDLIN( 128)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 128)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 128)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 128)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 128)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 128)								if ((newRange > bufferByteLength)) {
HXLINE( 128)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 128)							_this3->buffer = buffer;
HXDLIN( 128)							_this3->byteOffset = in_byteOffset;
HXDLIN( 128)							_this3->byteLength = newByteLength;
HXDLIN( 128)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 128)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 139)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 139)					_this1->byteOffset = 0;
HXDLIN( 139)					_this1->length = array1->get_length();
HXDLIN( 139)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 139)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 139)					_this1->copyFromArray(array1,null());
...
HXDLIN( 139)						int elementSize = _this2->bytesPerElement;
HXDLIN( 139)						if ((view->type == _this2->type)) {
HXLINE( 139)							int srcLength1 = srcData->length;
HXDLIN( 139)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 139)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 139)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 139)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 139)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 139)						_this2->byteOffset = 0;
HXDLIN( 139)						_this2->length = srcLength;
HXDLIN( 139)						this1 = _this2;
            					}
            					else {
HXLINE( 139)						if (::hx::IsNotNull( buffer )) {
HXLINE( 139)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
...
HXDLIN( 139)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 139)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 139)							int bufferByteLength = buffer->length;
HXDLIN( 139)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 139)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 139)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 139)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 139)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 139)								if ((newRange > bufferByteLength)) {
HXLINE( 139)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 139)							_this3->buffer = buffer;
HXDLIN( 139)							_this3->byteOffset = in_byteOffset;
HXDLIN( 139)							_this3->byteLength = newByteLength;
HXDLIN( 139)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 139)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 150)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 150)					_this1->byteOffset = 0;
HXDLIN( 150)					_this1->length = array1->get_length();
HXDLIN( 150)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 150)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 150)					_this1->copyFromArray(array1,null());
...
HXDLIN( 150)						int elementSize = _this2->bytesPerElement;
HXDLIN( 150)						if ((view->type == _this2->type)) {
HXLINE( 150)							int srcLength1 = srcData->length;
HXDLIN( 150)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 150)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 150)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 150)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 150)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 150)						_this2->byteOffset = 0;
HXDLIN( 150)						_this2->length = srcLength;
HXDLIN( 150)						this1 = _this2;
            					}
            					else {
HXLINE( 150)						if (::hx::IsNotNull( buffer )) {
HXLINE( 150)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,2);
...
HXDLIN( 150)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 150)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 150)							int bufferByteLength = buffer->length;
HXDLIN( 150)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 150)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 150)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 150)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 150)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 150)								if ((newRange > bufferByteLength)) {
HXLINE( 150)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 150)							_this3->buffer = buffer;
HXDLIN( 150)							_this3->byteOffset = in_byteOffset;
HXDLIN( 150)							_this3->byteLength = newByteLength;
HXDLIN( 150)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 150)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 161)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 161)					_this1->byteOffset = 0;
HXDLIN( 161)					_this1->length = array1->get_length();
HXDLIN( 161)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 161)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 161)					_this1->copyFromArray(array1,null());
...
HXDLIN( 161)						int elementSize = _this2->bytesPerElement;
HXDLIN( 161)						if ((view->type == _this2->type)) {
HXLINE( 161)							int srcLength1 = srcData->length;
HXDLIN( 161)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 161)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 161)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 161)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 161)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 161)						_this2->byteOffset = 0;
HXDLIN( 161)						_this2->length = srcLength;
HXDLIN( 161)						this1 = _this2;
            					}
            					else {
HXLINE( 161)						if (::hx::IsNotNull( buffer )) {
HXLINE( 161)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,7);
...
HXDLIN( 161)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 161)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 161)							int bufferByteLength = buffer->length;
HXDLIN( 161)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 161)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 161)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 161)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 161)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 161)								if ((newRange > bufferByteLength)) {
HXLINE( 161)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 161)							_this3->buffer = buffer;
HXDLIN( 161)							_this3->byteOffset = in_byteOffset;
HXDLIN( 161)							_this3->byteLength = newByteLength;
HXDLIN( 161)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 161)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 172)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 172)					_this1->byteOffset = 0;
HXDLIN( 172)					_this1->length = array1->get_length();
HXDLIN( 172)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 172)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 172)					_this1->copyFromArray(array1,null());
...
HXDLIN( 172)						int elementSize = _this2->bytesPerElement;
HXDLIN( 172)						if ((view->type == _this2->type)) {
HXLINE( 172)							int srcLength1 = srcData->length;
HXDLIN( 172)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 172)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 172)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 172)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 172)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 172)						_this2->byteOffset = 0;
HXDLIN( 172)						_this2->length = srcLength;
HXDLIN( 172)						this1 = _this2;
            					}
            					else {
HXLINE( 172)						if (::hx::IsNotNull( buffer )) {
HXLINE( 172)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,3);
...
HXDLIN( 172)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 172)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 172)							int bufferByteLength = buffer->length;
HXDLIN( 172)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 172)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 172)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 172)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 172)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 172)								if ((newRange > bufferByteLength)) {
HXLINE( 172)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 172)							_this3->buffer = buffer;
HXDLIN( 172)							_this3->byteOffset = in_byteOffset;
HXDLIN( 172)							_this3->byteLength = newByteLength;
HXDLIN( 172)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 172)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 183)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 183)					_this1->byteOffset = 0;
HXDLIN( 183)					_this1->length = array1->get_length();
HXDLIN( 183)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 183)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 183)					_this1->copyFromArray(array1,null());
...
HXDLIN( 183)						int elementSize = _this2->bytesPerElement;
HXDLIN( 183)						if ((view->type == _this2->type)) {
HXLINE( 183)							int srcLength1 = srcData->length;
HXDLIN( 183)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 183)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 183)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 183)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 183)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 183)						_this2->byteOffset = 0;
HXDLIN( 183)						_this2->length = srcLength;
HXDLIN( 183)						this1 = _this2;
            					}
            					else {
HXLINE( 183)						if (::hx::IsNotNull( buffer )) {
HXLINE( 183)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 183)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 183)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 183)							int bufferByteLength = buffer->length;
HXDLIN( 183)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 183)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 183)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 183)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 183)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 183)								if ((newRange > bufferByteLength)) {
HXLINE( 183)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 183)							_this3->buffer = buffer;
HXDLIN( 183)							_this3->byteOffset = in_byteOffset;
HXDLIN( 183)							_this3->byteLength = newByteLength;
HXDLIN( 183)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 183)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 194)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 194)					_this1->byteOffset = 0;
HXDLIN( 194)					_this1->length = array1->get_length();
HXDLIN( 194)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 194)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 194)					_this1->copyFromArray(array1,null());
...
HXDLIN( 194)						int elementSize = _this2->bytesPerElement;
HXDLIN( 194)						if ((view->type == _this2->type)) {
HXLINE( 194)							int srcLength1 = srcData->length;
HXDLIN( 194)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 194)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 194)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 194)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 194)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 194)						_this2->byteOffset = 0;
HXDLIN( 194)						_this2->length = srcLength;
HXDLIN( 194)						this1 = _this2;
            					}
            					else {
HXLINE( 194)						if (::hx::IsNotNull( buffer )) {
HXLINE( 194)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,9);
...
HXDLIN( 194)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 194)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 194)							int bufferByteLength = buffer->length;
HXDLIN( 194)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 194)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 194)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 194)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 194)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 194)								if ((newRange > bufferByteLength)) {
HXLINE( 194)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 194)							_this3->buffer = buffer;
HXDLIN( 194)							_this3->byteOffset = in_byteOffset;
HXDLIN( 194)							_this3->byteLength = newByteLength;
HXDLIN( 194)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 194)							this1 = _this3;
            						}
            						else {

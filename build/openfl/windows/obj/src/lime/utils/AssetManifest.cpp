...
HXDLIN(  60)		::Array< ::String > rootPath1 = ::Array_obj< ::String >::__new(1)->init(0,rootPath);
...
HXLINE(  98)				_hx_tmp1 = ::hx::IsLessEq( manifestData->__Field(HX_("version",18,e7,f1,7c),::hx::paccDynamic),2 );
            			}
            			else {
...
HXLINE( 113)			_hx_tmp2 = (rootPath != HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 113)			_hx_tmp2 = false;
            		}
HXDLIN( 113)		if (_hx_tmp2) {
HXLINE( 115)			bool _hx_tmp3;
HXDLIN( 115)			if (::hx::IsNotNull( manifest->rootPath )) {
HXLINE( 115)				_hx_tmp3 = (manifest->rootPath == HX_("",00,00,00,00));
            			}
            			else {

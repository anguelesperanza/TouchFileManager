...
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_521_unloadLibrary,"lime.utils.Assets","unloadLibrary",0xc816d6c7,"lime.utils.Assets.unloadLibrary","lime/utils/Assets.hx",521,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_557___cacheBreak,"lime.utils.Assets","__cacheBreak",0xe7faf592,"lime.utils.Assets.__cacheBreak","lime/utils/Assets.hx",557,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_561___libraryNotFound,"lime.utils.Assets","__libraryNotFound",0x7dfa37b5,"lime.utils.Assets.__libraryNotFound","lime/utils/Assets.hx",561,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_579_library_onChange,"lime.utils.Assets","library_onChange",0x3a89dec8,"lime.utils.Assets.library_onChange","lime/utils/Assets.hx",579,0x95055f23)
...
HXLINE( 330)				goto _hx_goto_16;
            			...
            			if (  (_hx_switch_0==HX_("TEMPLATE",3a,78,cd,05)) ){
HXLINE( 339)				HX_STACK_DO_THROW((HX_("Not sure how to get template: ",a1,19,8c,ad) + id));
...
HXLINE( 354)					_hx_tmp1 = ::lime::utils::Assets_obj::cache->enabled;
            				}
            				else {
...
void Assets_obj::unloadLibrary(::String name){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_521_unloadLibrary)
HXLINE( 523)		bool _hx_tmp;
HXDLIN( 523)		if (::hx::IsNotNull( name )) {
HXLINE( 523)			_hx_tmp = (name == HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 523)			_hx_tmp = true;
            		}
HXDLIN( 523)		if (_hx_tmp) {
HXLINE( 525)			name = HX_("default",c1,d8,c3,9b);
            		}
HXLINE( 528)		 ::lime::utils::AssetLibrary library = ( ( ::lime::utils::AssetLibrary)(::lime::utils::Assets_obj::libraries->get(name)) );
HXLINE( 530)		if (::hx::IsNotNull( library )) {
HXLINE( 532)			::lime::utils::Assets_obj::cache->clear((name + HX_(":",3a,00,00,00)));
HXLINE( 533)			library->onChange->remove(::lime::utils::Assets_obj::library_onChange_dyn());
HXLINE( 534)			library->unload();
            		}
HXLINE( 537)		::lime::utils::Assets_obj::libraries->remove(name);
            	}
...
::String Assets_obj::_hx___cacheBreak(::String path){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_557___cacheBreak)
HXDLIN( 557)		return path;
            	}
...
::String Assets_obj::_hx___libraryNotFound(::String name){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_561___libraryNotFound)
HXLINE( 562)		bool _hx_tmp;
HXDLIN( 562)		if (::hx::IsNotNull( name )) {
HXLINE( 562)			_hx_tmp = (name == HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 562)			_hx_tmp = true;
            		}
HXDLIN( 562)		if (_hx_tmp) {
HXLINE( 564)			name = HX_("default",c1,d8,c3,9b);
            		}
HXLINE( 567)		bool _hx_tmp1;
HXDLIN( 567)		bool _hx_tmp2;
HXDLIN( 567)		if (::hx::IsNotNull( ::lime::app::Application_obj::current )) {
HXLINE( 567)			_hx_tmp2 = ::hx::IsNotNull( ::lime::app::Application_obj::current->_hx___preloader );
            		}
            		else {
HXLINE( 567)			_hx_tmp2 = false;
            		}
HXDLIN( 567)		if (_hx_tmp2) {
HXLINE( 567)			_hx_tmp1 = !(::lime::app::Application_obj::current->_hx___preloader->complete);
            		}
            		else {
HXLINE( 567)			_hx_tmp1 = false;
            		}
HXDLIN( 567)		if (_hx_tmp1) {
HXLINE( 569)			return ((HX_("There is no asset library named \"",a1,83,5f,51) + name) + HX_("\", or it is not yet preloaded",db,ac,d4,2f));
            		}
            		else {
HXLINE( 573)			return ((HX_("There is no asset library named \"",a1,83,5f,51) + name) + HX_("\"",22,00,00,00));
            		}
...
void Assets_obj::library_onChange(){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_579_library_onChange)
HXLINE( 580)		::lime::utils::Assets_obj::cache->clear(null());
HXLINE( 581)		::lime::utils::Assets_obj::onChange->dispatch();
            	}

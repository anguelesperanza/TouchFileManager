...
HXDLIN( 132)			while((_g2 < _g3->get_length())){
            				HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0, ::lime::utils::Preloader,_gthis, ::Dynamic,library1) HXARGC(2)
...
HXLINE( 152)						_gthis->onProgress->dispatch(_gthis->bytesLoaded,_gthis->bytesTotal);
            				...
            				HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_1, ::lime::utils::Preloader,_gthis, ::Dynamic,library1) HXARGC(1)
...
HXDLIN( 159)						_gthis1->bytesLoaded = ( (int)((_gthis1->bytesLoaded + library1->__Field(HX_("bytesTotal",59,57,da,45),::hx::paccDynamic))) );
            					}
            					else {
HXLINE( 163)						 ::lime::utils::Preloader _gthis2 = _gthis;
HXDLIN( 163)						int _gthis3 = _gthis2->bytesLoaded;
HXDLIN( 163)						int _hx_tmp = ::Std_obj::_hx_int(( (Float)(library1->__Field(HX_("bytesTotal",59,57,da,45),::hx::paccDynamic)) ));
...
HXLINE( 132)				 ::Dynamic library1 = _g3->__get(_g2);
...
HXLINE( 136)				library1->__Field(HX_("load",26,9a,b7,47),::hx::paccDynamic)()->__Field(HX_("onProgress",ec,cb,e1,63),::hx::paccDynamic)( ::Dynamic(new _hx_Closure_0(_gthis,library1)))->__Field(HX_("onComplete",f8,d4,7e,5d),::hx::paccDynamic)( ::Dynamic(new _hx_Closure_1(_gthis,library1)))->__Field(HX_("onError",29,6a,67,09),::hx::paccDynamic)( ::Dynamic(new _hx_Closure_2()));
            			}
            		}
HXLINE( 176)		{

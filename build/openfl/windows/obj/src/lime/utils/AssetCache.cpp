...
HXLINE(  65)				HX_STACK_DO_THROW(((HX_("Cannot cache non-Image asset: ",d6,62,c2,3a) + ::Std_obj::string(asset)) + HX_(" as Image",ad,d1,70,d4)));
            			}
...
HXLINE(  70)				HX_STACK_DO_THROW(((HX_("Cannot cache non-AudioBuffer asset: ",b1,96,a5,01) + ::Std_obj::string(asset)) + HX_(" as AudioBuffer",48,2a,fe,73)));
            			}
HXLINE(  72)			this->audio->set(id,( ( ::lime::media::AudioBuffer)(asset) ));
HXLINE(  69)			goto _hx_goto_2;
            		}
            		/* default */{
HXLINE(  75)			HX_STACK_DO_THROW((type + HX_(" assets are not cachable",f3,2d,ee,fa)));
            		}
            		_hx_goto_2:;
            	}
...
HXLINE( 101)			{
HXLINE( 101)				 ::Dynamic key2 = keys1;
HXDLIN( 101)				while(( (bool)(key2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 101)					::String key3 = ( (::String)(key2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 103)					if (::StringTools_obj::startsWith(key3,prefix)) {
HXLINE( 105)						this->font->remove(key3);
            					}
            				}
            			}
HXLINE( 109)			 ::Dynamic keys2 = this->image->keys();
HXLINE( 111)			{
HXLINE( 111)				 ::Dynamic key4 = keys2;
HXDLIN( 111)				while(( (bool)(key4->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 111)					::String key5 = ( (::String)(key4->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 113)					if (::StringTools_obj::startsWith(key5,prefix)) {
HXLINE( 115)						this->image->remove(key5);
            					}
            				}
            			}
            		}

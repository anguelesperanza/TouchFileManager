...
HXLINE( 213)			 ::Dynamic mode1 = displayInfo->__Field(HX_("currentMode",3c,ac,f2,80),::hx::paccDynamic);
HXLINE( 214)			 ::lime::_hx_system::DisplayMode currentMode =  ::lime::_hx_system::DisplayMode_obj::__alloc( HX_CTX ,( (int)(mode1->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic)) ),( (int)(mode1->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic)) ),( (int)(mode1->__Field(HX_("refreshRate",5b,e2,3f,40),::hx::paccDynamic)) ),( (int)(mode1->__Field(HX_("pixelFormat",5d,72,1b,6f),::hx::paccDynamic)) ));
HXLINE( 216)			{
HXLINE( 216)				int _g1 = 0;
HXDLIN( 216)				::Array< ::Dynamic> _g2 = display->supportedModes;
HXDLIN( 216)				while((_g1 < _g2->length)){
HXLINE( 216)					 ::lime::_hx_system::DisplayMode mode2 = _g2->__get(_g1).StaticCast<  ::lime::_hx_system::DisplayMode >();
HXDLIN( 216)					_g1 = (_g1 + 1);
HXLINE( 218)					bool _hx_tmp;
HXDLIN( 218)					bool _hx_tmp1;
HXDLIN( 218)					bool _hx_tmp2;
HXDLIN( 218)					if ((currentMode->pixelFormat == mode2->pixelFormat)) {
HXLINE( 218)						_hx_tmp2 = (currentMode->width == mode2->width);
            					}
            					else {
HXLINE( 218)						_hx_tmp2 = false;
            					}
HXDLIN( 218)					if (_hx_tmp2) {
HXLINE( 218)						_hx_tmp1 = (currentMode->height == mode2->height);
            					}
            					else {
HXLINE( 218)						_hx_tmp1 = false;
            					}
HXDLIN( 218)					if (_hx_tmp1) {
HXLINE( 218)						_hx_tmp = (currentMode->refreshRate == mode2->refreshRate);
            					}
            					else {
HXLINE( 218)						_hx_tmp = false;
            					}
HXDLIN( 218)					if (_hx_tmp) {
HXLINE( 223)						currentMode = mode2;
...
HXLINE( 683)			 ::haxe::io::Bytes arrayBuffer = ::haxe::io::Bytes_obj::alloc(2);
...
HXLINE( 684)				this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,4);
            			}
            			else {
...
HXDLIN( 684)					_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 684)					_this->copyFromArray(array,null());
HXDLIN( 684)					this1 = _this;
            				}
            				else {
HXLINE( 684)					if (::hx::IsNotNull( vector )) {
HXLINE( 684)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 684)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 684)						_this1->byteOffset = 0;
HXDLIN( 684)						_this1->length = array1->get_length();
HXDLIN( 684)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 684)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 684)						_this1->copyFromArray(array1,null());
HXDLIN( 684)						this1 = _this1;
            					}
            					else {
HXLINE( 684)						if (::hx::IsNotNull( view )) {
HXLINE( 684)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 684)							int elementSize = _this2->bytesPerElement;
HXDLIN( 684)							if ((view->type == _this2->type)) {
HXLINE( 684)								int srcLength1 = srcData->length;
HXDLIN( 684)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 684)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 684)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE( 684)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN( 684)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 684)							_this2->byteOffset = 0;
HXDLIN( 684)							_this2->length = srcLength;
HXDLIN( 684)							this1 = _this2;
            						}
            						else {
HXLINE( 684)							if (::hx::IsNotNull( arrayBuffer )) {
HXLINE( 684)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 684)								int in_byteOffset = 0;
HXDLIN( 684)								if ((in_byteOffset < 0)) {
HXLINE( 684)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 684)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 684)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 684)								int bufferByteLength = arrayBuffer->length;
HXDLIN( 684)								int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 684)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 684)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXLINE( 684)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 684)									int newRange = (in_byteOffset + newByteLength);
HXDLIN( 684)									if ((newRange > bufferByteLength)) {
HXLINE( 684)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN( 684)								_this3->buffer = arrayBuffer;
HXDLIN( 684)								_this3->byteOffset = in_byteOffset;
HXDLIN( 684)								_this3->byteLength = newByteLength;
HXDLIN( 684)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 684)								this1 = _this3;
            							}
            							else {
HXLINE( 684)								HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            							}
            						}
            					}
            				}
            			}
HXDLIN( 684)			 ::lime::utils::ArrayBufferView uint8Array = this1;
HXLINE( 685)			 ::Dynamic elements1 = null();
HXDLIN( 685)			::cpp::VirtualArray array2 = null();
...
HXDLIN( 685)			 ::lime::utils::ArrayBufferView this2;
HXDLIN( 685)			if (::hx::IsNotNull( elements1 )) {
HXLINE( 685)				this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements1,6);
            			}
            			else {
HXLINE( 685)				if (::hx::IsNotNull( array2 )) {
HXLINE( 685)					 ::lime::utils::ArrayBufferView _this4 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
HXDLIN( 685)					_this4->byteOffset = 0;
HXDLIN( 685)					_this4->length = array2->get_length();
HXDLIN( 685)					_this4->byteLength = (_this4->length * _this4->bytesPerElement);
HXDLIN( 685)					_this4->buffer = ::haxe::io::Bytes_obj::alloc(_this4->byteLength);
HXDLIN( 685)					_this4->copyFromArray(array2,null());
HXDLIN( 685)					this2 = _this4;
            				}
            				else {
HXLINE( 685)					if (::hx::IsNotNull( vector1 )) {
HXLINE( 685)						 ::lime::utils::ArrayBufferView _this5 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
HXDLIN( 685)						::cpp::VirtualArray array3 = ( (::cpp::VirtualArray)(vector1->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 685)						_this5->byteOffset = 0;
HXDLIN( 685)						_this5->length = array3->get_length();
HXDLIN( 685)						_this5->byteLength = (_this5->length * _this5->bytesPerElement);
HXDLIN( 685)						_this5->buffer = ::haxe::io::Bytes_obj::alloc(_this5->byteLength);
HXDLIN( 685)						_this5->copyFromArray(array3,null());
HXDLIN( 685)						this2 = _this5;
            					}
            					else {
HXLINE( 685)						if (::hx::IsNotNull( view1 )) {
HXLINE( 685)							 ::lime::utils::ArrayBufferView _this6 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
HXDLIN( 685)							 ::haxe::io::Bytes srcData1 = view1->buffer;
HXDLIN( 685)							int srcLength2 = view1->length;
HXDLIN( 685)							int srcByteOffset1 = view1->byteOffset;
HXDLIN( 685)							int srcElementSize1 = view1->bytesPerElement;
HXDLIN( 685)							int elementSize2 = _this6->bytesPerElement;
HXDLIN( 685)							if ((view1->type == _this6->type)) {
HXLINE( 685)								int srcLength3 = srcData1->length;
HXDLIN( 685)								int cloneLength1 = (srcLength3 - srcByteOffset1);
HXDLIN( 685)								_this6->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN( 685)								_this6->buffer->blit(0,srcData1,srcByteOffset1,cloneLength1);
            							}
            							else {
HXLINE( 685)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN( 685)							_this6->byteLength = (_this6->bytesPerElement * srcLength2);
HXDLIN( 685)							_this6->byteOffset = 0;
HXDLIN( 685)							_this6->length = srcLength2;
HXDLIN( 685)							this2 = _this6;
            						}
            						else {
HXLINE( 685)							if (::hx::IsNotNull( arrayBuffer )) {
HXLINE( 685)								 ::lime::utils::ArrayBufferView _this7 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
HXDLIN( 685)								int in_byteOffset1 = 0;
HXDLIN( 685)								if ((in_byteOffset1 < 0)) {
HXLINE( 685)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 685)								if ((::hx::Mod(in_byteOffset1,_this7->bytesPerElement) != 0)) {
HXLINE( 685)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 685)								int bufferByteLength1 = arrayBuffer->length;
HXDLIN( 685)								int elementSize3 = _this7->bytesPerElement;
HXDLIN( 685)								int newByteLength1 = bufferByteLength1;
HXDLIN( 685)								if (::hx::IsNull( len1 )) {
HXLINE( 685)									newByteLength1 = (bufferByteLength1 - in_byteOffset1);
HXDLIN( 685)									if ((::hx::Mod(bufferByteLength1,_this7->bytesPerElement) != 0)) {
HXLINE( 685)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 685)									if ((newByteLength1 < 0)) {
HXLINE( 685)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
            								else {
HXLINE( 685)									newByteLength1 = (( (int)(len1) ) * _this7->bytesPerElement);
HXDLIN( 685)									int newRange1 = (in_byteOffset1 + newByteLength1);
HXDLIN( 685)									if ((newRange1 > bufferByteLength1)) {
HXLINE( 685)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN( 685)								_this7->buffer = arrayBuffer;
HXDLIN( 685)								_this7->byteOffset = in_byteOffset1;
HXDLIN( 685)								_this7->byteLength = newByteLength1;
HXDLIN( 685)								_this7->length = ::Std_obj::_hx_int((( (Float)(newByteLength1) ) / ( (Float)(_this7->bytesPerElement) )));
HXDLIN( 685)								this2 = _this7;
            							}
            							else {
HXLINE( 685)								HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt16Array",0a,c7,2d,d5));
            							}
            						}
            					}
            				}
            			}
HXDLIN( 685)			 ::lime::utils::ArrayBufferView uint16array = this2;

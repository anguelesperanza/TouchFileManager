...
HX_DEFINE_STACK_FRAME(_hx_pos_39b0deb1236c4593_257_new,"lime.system.JNIMethod","new",0xca67a7f2,"lime.system.JNIMethod.new","lime/system/JNI.hx",257,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_39b0deb1236c4593_266_callMember,"lime.system.JNIMethod","callMember",0x1acfd846,"lime.system.JNIMethod.callMember","lime/system/JNI.hx",266,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_39b0deb1236c4593_275_callStatic,"lime.system.JNIMethod","callStatic",0x1c15d29a,"lime.system.JNIMethod.callStatic","lime/system/JNI.hx",275,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_39b0deb1236c4593_281_getMemberMethod,"lime.system.JNIMethod","getMemberMethod",0x7872cd23,"lime.system.JNIMethod.getMemberMethod","lime/system/JNI.hx",281,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_39b0deb1236c4593_293_getStaticMethod,"lime.system.JNIMethod","getStaticMethod",0xd67b3e77,"lime.system.JNIMethod.getStaticMethod","lime/system/JNI.hx",293,0x21970b7f)
namespace lime{
namespace _hx_system{

void JNIMethod_obj::__construct( ::Dynamic method){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_257_new)
HXDLIN( 257)		this->method = method;
            	}
...
bool JNIMethod_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JNIMethod_obj::callMember(::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_266_callMember)
...
HX_DEFINE_DYNAMIC_FUNC1(JNIMethod_obj,callMember,return )
 ...
 ::Dynamic JNIMethod_obj::callStatic(::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_275_callStatic)
...
HX_DEFINE_DYNAMIC_FUNC1(JNIMethod_obj,callStatic,return )
 ...
 ::Dynamic JNIMethod_obj::getMemberMethod(bool useArray){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_281_getMemberMethod)
HXDLIN( 281)		if (useArray) {
HXLINE( 283)			return this->callMember_dyn();
            		}
            		else {
HXLINE( 287)			return ::Reflect_obj::makeVarArgs(this->callMember_dyn());
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(JNIMethod_obj,getMemberMethod,return )
 ...
 ::Dynamic JNIMethod_obj::getStaticMethod(bool useArray){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_293_getStaticMethod)
HXDLIN( 293)		if (useArray) {
HXLINE( 295)			return this->callStatic_dyn();
            		}
            		else {
HXLINE( 299)			return ::Reflect_obj::makeVarArgs(this->callStatic_dyn());
            		}

...
HXLINE(  75)			 ::sys::thread::Deque _hx_tmp2 = this->_hx___workIncoming;
HXDLIN(  75)			_hx_tmp2->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::WORK_dyn(),state));
HXLINE(  76)			this->_hx___workQueued++;
HXLINE(  78)			bool _hx_tmp3;
HXDLIN(  78)			if ((this->currentThreads < this->maxThreads)) {
HXLINE(  78)				_hx_tmp3 = (this->currentThreads < (this->_hx___workQueued - this->_hx___workCompleted));
            			}
            			else {
...
HXLINE(  81)				::sys::thread::_Thread::HaxeThread_obj::create(this->_hx___doWork_dyn(),false);
            			}
...
HXLINE( 160)			if (::hx::IsPointerEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::WORK_dyn() )) {
HXLINE( 162)				this->runWork(message->state);
            			}
            			else {
HXLINE( 164)				if (::hx::IsPointerEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn() )) {
...
HXLINE( 194)							 ::sys::thread::Deque _hx_tmp2 = this->_hx___workIncoming;
HXDLIN( 194)							_hx_tmp2->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn(),null()));
            						}
HXLINE( 197)						if (::hx::IsPointerEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::COMPLETE_dyn() )) {
...
HXLINE( 216)				_hx_tmp4 = (this->minThreads <= 0);
            			}
            			else {
HXLINE( 216)				_hx_tmp4 = false;
            			}
HXDLIN( 216)			if (_hx_tmp4) {
HXLINE( 216)				_hx_tmp3 = ::hx::IsNotNull( ::lime::app::Application_obj::current );
            			}
            			else {

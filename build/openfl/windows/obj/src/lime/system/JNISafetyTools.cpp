...
HX_LOCAL_STACK_FRAME(_hx_pos_5786630d52b5ea59_354_onMainThread,"lime.system.JNISafetyTools","onMainThread",0x0513e4a6,"lime.system.JNISafetyTools.onMainThread","lime/system/JNI.hx",354,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_5786630d52b5ea59_343_boot,"lime.system.JNISafetyTools","boot",0x25fbcaf6,"lime.system.JNISafetyTools.boot","lime/system/JNI.hx",343,0x21970b7f)
namespace lime{
...
bool JNISafetyTools_obj::onMainThread(){
            	HX_STACKFRAME(&_hx_pos_5786630d52b5ea59_354_onMainThread)
HXDLIN( 354)		return ::hx::IsInstanceEq( ::sys::thread::_Thread::HaxeThread_obj::current(),::lime::_hx_system::JNISafetyTools_obj::mainThread );
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_5786630d52b5ea59_343_boot)
HXDLIN( 343)		mainThread = ::sys::thread::_Thread::HaxeThread_obj::current();
            	}
}

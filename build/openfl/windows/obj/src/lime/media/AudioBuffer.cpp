...
HXDLIN(  90)				_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN(  90)				_this->copyFromArray(array,null());
HXDLIN(  90)				this1 = _this;
            			}
            			else {
HXLINE(  90)				if (::hx::IsNotNull( vector )) {
HXLINE(  90)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(  90)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(  90)					_this1->byteOffset = 0;
HXDLIN(  90)					_this1->length = array1->get_length();
HXDLIN(  90)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN(  90)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN(  90)					_this1->copyFromArray(array1,null());
HXDLIN(  90)					this1 = _this1;
            				}
            				else {
HXLINE(  90)					if (::hx::IsNotNull( view )) {
HXLINE(  90)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN(  90)						int elementSize = _this2->bytesPerElement;
HXDLIN(  90)						if ((view->type == _this2->type)) {
HXLINE(  90)							int srcLength1 = srcData->length;
HXDLIN(  90)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(  90)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(  90)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE(  90)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN(  90)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN(  90)						_this2->byteOffset = 0;
HXDLIN(  90)						_this2->length = srcLength;
HXDLIN(  90)						this1 = _this2;
            					}
            					else {
HXLINE(  90)						if (::hx::IsNotNull( buffer )) {
HXLINE(  90)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN(  90)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE(  90)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN(  90)							int bufferByteLength = buffer->length;
HXDLIN(  90)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN(  90)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE(  90)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE(  90)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN(  90)								int newRange = (in_byteOffset + newByteLength);
HXDLIN(  90)								if ((newRange > bufferByteLength)) {
HXLINE(  90)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN(  90)							_this3->buffer = buffer;
HXDLIN(  90)							_this3->byteOffset = in_byteOffset;
HXDLIN(  90)							_this3->byteLength = newByteLength;
HXDLIN(  90)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN(  90)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 127)				_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 127)				_this->copyFromArray(array,null());
HXDLIN( 127)				this1 = _this;
            			}
            			else {
HXLINE( 127)				if (::hx::IsNotNull( vector )) {
HXLINE( 127)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 127)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 127)					_this1->byteOffset = 0;
HXDLIN( 127)					_this1->length = array1->get_length();
HXDLIN( 127)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 127)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 127)					_this1->copyFromArray(array1,null());
HXDLIN( 127)					this1 = _this1;
            				}
            				else {
HXLINE( 127)					if (::hx::IsNotNull( view )) {
HXLINE( 127)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 127)						int elementSize = _this2->bytesPerElement;
HXDLIN( 127)						if ((view->type == _this2->type)) {
HXLINE( 127)							int srcLength1 = srcData->length;
HXDLIN( 127)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 127)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 127)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 127)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 127)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 127)						_this2->byteOffset = 0;
HXDLIN( 127)						_this2->length = srcLength;
HXDLIN( 127)						this1 = _this2;
            					}
            					else {
HXLINE( 127)						if (::hx::IsNotNull( buffer )) {
HXLINE( 127)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 127)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 127)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 127)							int bufferByteLength = buffer->length;
HXDLIN( 127)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 127)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 127)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 127)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 127)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 127)								if ((newRange > bufferByteLength)) {
HXLINE( 127)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 127)							_this3->buffer = buffer;
HXDLIN( 127)							_this3->byteOffset = in_byteOffset;
HXDLIN( 127)							_this3->byteLength = newByteLength;
HXDLIN( 127)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 127)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 176)				_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 176)				_this->copyFromArray(array,null());
HXDLIN( 176)				this1 = _this;
            			}
            			else {
HXLINE( 176)				if (::hx::IsNotNull( vector )) {
HXLINE( 176)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 176)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 176)					_this1->byteOffset = 0;
HXDLIN( 176)					_this1->length = array1->get_length();
HXDLIN( 176)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 176)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 176)					_this1->copyFromArray(array1,null());
HXDLIN( 176)					this1 = _this1;
            				}
            				else {
HXLINE( 176)					if (::hx::IsNotNull( view )) {
HXLINE( 176)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 176)						int elementSize = _this2->bytesPerElement;
HXDLIN( 176)						if ((view->type == _this2->type)) {
HXLINE( 176)							int srcLength1 = srcData->length;
HXDLIN( 176)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 176)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 176)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 176)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 176)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 176)						_this2->byteOffset = 0;
HXDLIN( 176)						_this2->length = srcLength;
HXDLIN( 176)						this1 = _this2;
            					}
            					else {
HXLINE( 176)						if (::hx::IsNotNull( buffer )) {
HXLINE( 176)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 176)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 176)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 176)							int bufferByteLength = buffer->length;
HXDLIN( 176)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 176)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 176)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 176)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 176)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 176)								if ((newRange > bufferByteLength)) {
HXLINE( 176)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 176)							_this3->buffer = buffer;
HXDLIN( 176)							_this3->byteOffset = in_byteOffset;
HXDLIN( 176)							_this3->byteLength = newByteLength;
HXDLIN( 176)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 176)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 351)			goto _hx_goto_14;
            		...
            		/* default */{
HXLINE( 355)			int _g2 = ( (int)(bytes->b->__get(1)) );
HXDLIN( 355)			int _g3 = ( (int)(bytes->b->__get(2)) );
HXDLIN( 355)			switch((int)(( (int)(bytes->b->__get(0)) ))){
            				case (int)73: {
HXLINE( 355)					if ((_g2 == 68)) {
HXLINE( 355)						if ((_g3 == 51)) {
HXLINE( 357)							return HX_("audio/mp3",77,ba,40,54);
            						}
            					}
            				}

...
HXDLIN( 242)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 242)						_this1->byteOffset = 0;
HXDLIN( 242)						_this1->length = array1->get_length();
HXDLIN( 242)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 242)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 242)						_this1->copyFromArray(array1,null());
...
HXDLIN( 242)							int elementSize = _this2->bytesPerElement;
HXDLIN( 242)							if ((view->type == _this2->type)) {
HXLINE( 242)								int srcLength1 = srcData->length;
HXDLIN( 242)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 242)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 242)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE( 242)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN( 242)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 242)							_this2->byteOffset = 0;
HXDLIN( 242)							_this2->length = srcLength;
HXDLIN( 242)							this1 = _this2;
            						}
            						else {
HXLINE( 242)							if (::hx::IsNotNull( data )) {
HXLINE( 242)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 242)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 242)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 242)								int bufferByteLength = data->length;
HXDLIN( 242)								int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 242)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 242)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXLINE( 242)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 242)									int newRange = (in_byteOffset + newByteLength);
HXDLIN( 242)									if ((newRange > bufferByteLength)) {
HXLINE( 242)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN( 242)								_this3->buffer = data;
HXDLIN( 242)								_this3->byteOffset = in_byteOffset;
HXDLIN( 242)								_this3->byteLength = newByteLength;
HXDLIN( 242)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 242)								this1 = _this3;
            							}
            							else {
...
HXDLIN( 407)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 407)						_this1->byteOffset = 0;
HXDLIN( 407)						_this1->length = array1->get_length();
HXDLIN( 407)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 407)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 407)						_this1->copyFromArray(array1,null());
...
HXDLIN( 407)							int elementSize = _this2->bytesPerElement;
HXDLIN( 407)							if ((view->type == _this2->type)) {
HXLINE( 407)								int srcLength1 = srcData->length;
HXDLIN( 407)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 407)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 407)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE( 407)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN( 407)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 407)							_this2->byteOffset = 0;
HXDLIN( 407)							_this2->length = srcLength;
HXDLIN( 407)							this1 = _this2;
            						}
            						else {
HXLINE( 407)							if (::hx::IsNotNull( data )) {
HXLINE( 407)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 407)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 407)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 407)								int bufferByteLength = data->length;
HXDLIN( 407)								int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 407)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 407)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXLINE( 407)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 407)									int newRange = (in_byteOffset + newByteLength);
HXDLIN( 407)									if ((newRange > bufferByteLength)) {
HXLINE( 407)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN( 407)								_this3->buffer = data;
HXDLIN( 407)								_this3->byteOffset = in_byteOffset;
HXDLIN( 407)								_this3->byteLength = newByteLength;
HXDLIN( 407)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 407)								this1 = _this3;
            							}
            							else {

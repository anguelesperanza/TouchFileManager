...
HXDLIN( 955)		this->regDataPointer =  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,bytes,0);
            	}
...
HXDLIN( 994)				gl->uniform2fv(location,count,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            			...
            			break;
            			case (int)35665: {
HXLINE( 996)				int location1 = this->location;
HXDLIN( 996)				int count1 = this->regCount;
HXDLIN( 996)				int size1 = (this->regCount * 3);
HXDLIN( 996)				::lime::utils::_BytePointer::BytePointer_Impl__obj::set(this->regDataPointer,null(),this->regData,null(),(index * 4));
HXDLIN( 996)				gl->uniform3fv(location1,count1,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            			}
            			break;
            			case (int)35666: {
HXLINE( 998)				int location2 = this->location;
HXDLIN( 998)				int count2 = this->regCount;
HXDLIN( 998)				int size2 = (this->regCount * 4);
HXDLIN( 998)				::lime::utils::_BytePointer::BytePointer_Impl__obj::set(this->regDataPointer,null(),this->regData,null(),(index * 4));
HXDLIN( 998)				gl->uniform4fv(location2,count2,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            			}
            			break;
            			case (int)35674: {
HXLINE( 988)				int location3 = this->location;
HXDLIN( 988)				int count3 = this->size;
HXDLIN( 988)				int size3 = ((this->size * 2) * 2);
HXDLIN( 988)				::lime::utils::_BytePointer::BytePointer_Impl__obj::set(this->regDataPointer,null(),this->regData,null(),(index * 4));
HXDLIN( 988)				gl->uniformMatrix2fv(location3,count3,false,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            			}
            			break;
            			case (int)35675: {
HXLINE( 990)				int location4 = this->location;
HXDLIN( 990)				int count4 = this->size;
HXDLIN( 990)				int size4 = ((this->size * 3) * 3);
HXDLIN( 990)				::lime::utils::_BytePointer::BytePointer_Impl__obj::set(this->regDataPointer,null(),this->regData,null(),(index * 4));
HXDLIN( 990)				gl->uniformMatrix3fv(location4,count4,false,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            			}
            			break;
            			case (int)35676: {
HXLINE( 992)				int location5 = this->location;
HXDLIN( 992)				int count5 = this->size;
HXDLIN( 992)				int size5 = ((this->size * 4) * 4);
HXDLIN( 992)				::lime::utils::_BytePointer::BytePointer_Impl__obj::set(this->regDataPointer,null(),this->regData,null(),(index * 4));
HXDLIN( 992)				gl->uniformMatrix4fv(location5,count5,false,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            			}
            			break;
            			default:{
HXLINE(1000)				int location6 = this->location;
HXDLIN(1000)				int count6 = this->regCount;
HXDLIN(1000)				int size6 = (this->regCount * 4);
HXDLIN(1000)				::lime::utils::_BytePointer::BytePointer_Impl__obj::set(this->regDataPointer,null(),this->regData,null(),(index * 4));
HXDLIN(1000)				gl->uniform4fv(location6,count6,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            			}
            		}
            	}

...
HXLINE( 987)		::String swizzle = HX_("",00,00,00,00);
...
HXLINE(1011)		::String str = ::openfl::display3D::_internal::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXLINE(1013)		if ((this->d == 0)) {
HXLINE(1016)			str = (str + (this->n + offset));
            		}
            		else {
HXLINE(1021)			str = (str + this->o);
HXLINE(1022)			::String indexComponent = HX_("",00,00,00,00);
...
HXDLIN(1034)			::String indexRegister1 = (((indexRegister + this->n) + HX_(".",2e,00,00,00)) + indexComponent);
...
HXLINE( 966)		 ::openfl::display3D::_internal::_AGALConverter::SourceRegister sr =  ::openfl::display3D::_internal::_AGALConverter::SourceRegister_obj::__alloc( HX_CTX );

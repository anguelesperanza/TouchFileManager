...
HXLINE(  95)			::cpp::Int64 source1 = ::openfl::display3D::_internal::AGALConverter_obj::readUInt64(agal);
HXLINE(  96)			::cpp::Int64 source2 = ::openfl::display3D::_internal::AGALConverter_obj::readUInt64(agal);
...
HXLINE( 278)						_hx_tmp1 = ::hx::IsPointerNotEq( existingUsage,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_ARRAY_dyn() );
            					}
            					else {
...
HXLINE( 296)						map->addSR(sr2,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn(),2);
            				...
            				break;
            				case (int)24: {
HXLINE( 307)					 ::openfl::display3D::_internal::_AGALConverter::RegisterUsage existingUsage1 = map->getRegisterUsage(sr2);
HXLINE( 309)					bool _hx_tmp2;
HXDLIN( 309)					if (::hx::IsPointerNotEq( existingUsage1,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn() )) {
HXLINE( 309)						_hx_tmp2 = ::hx::IsPointerNotEq( existingUsage1,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_ARRAY_dyn() );
            					}
            					else {
...
HXLINE( 342)					 ::openfl::display3D::_internal::_AGALConverter::RegisterUsage existingUsage2 = map->getRegisterUsage(sr2);
HXLINE( 344)					bool _hx_tmp3;
HXDLIN( 344)					if (::hx::IsPointerNotEq( existingUsage2,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn() )) {
HXLINE( 344)						_hx_tmp3 = ::hx::IsPointerNotEq( existingUsage2,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_ARRAY_dyn() );
            					}
            					else {
...
HXLINE( 346)						{
HXLINE( 346)							::String x82 = (dr->toGLSL(null()) + HX_(" = ",63,7d,18,00));
HXDLIN( 346)							::String x83 = ((x82 + sr1->toGLSL(null(),null())) + HX_(" * ",d6,6c,18,00));
HXDLIN( 346)							::String x84 = ((x83 + sr2->toGLSL(false,null())) + HX_("; // m34",93,14,64,51));
HXDLIN( 346)							if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 346)								sb->flush();
            							}
HXDLIN( 346)							if (::hx::IsNull( sb->b )) {
HXLINE( 346)								sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x84));
            							}
            							else {
HXLINE( 346)								::Array< ::String > sb29 = sb->b;
HXDLIN( 346)								sb29->push(::Std_obj::string(x84));
            							}
            						}
...
HXLINE( 355)						{
HXLINE( 355)							::String x85 = ((dr->toGLSL(null()) + HX_(" = vec3(",a6,67,ad,0e)) + HX_("dot(",7f,f5,6d,42));
HXDLIN( 355)							::String x86 = ((x85 + sr1->toGLSL(true,null())) + HX_(",",2c,00,00,00));
HXDLIN( 355)							::String x87 = (((x86 + sr2->toGLSL(true,0)) + HX_("), ",dd,42,1f,00)) + HX_("dot(",7f,f5,6d,42));
HXDLIN( 355)							::String x88 = ((x87 + sr1->toGLSL(true,null())) + HX_(",",2c,00,00,00));
HXDLIN( 355)							::String x89 = (((x88 + sr2->toGLSL(true,1)) + HX_("),",e3,23,00,00)) + HX_("dot(",7f,f5,6d,42));
HXDLIN( 355)							::String x90 = ((x89 + sr1->toGLSL(true,null())) + HX_(",",2c,00,00,00));
HXDLIN( 355)							::String x91 = ((x90 + sr2->toGLSL(true,2)) + HX_(")); // m34",73,18,fb,e5));
HXDLIN( 355)							if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 355)								sb->flush();
            							}
HXDLIN( 355)							if (::hx::IsNull( sb->b )) {
HXLINE( 355)								sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x91));
            							}
            							else {
HXLINE( 355)								::Array< ::String > sb30 = sb->b;
HXDLIN( 355)								sb30->push(::Std_obj::string(x91));
            							}
            						}
...
HXLINE( 373)					{
HXLINE( 373)						::String x92 = ((HX_("if (any(lessThan(",0d,a8,4d,9b) + sr1->toGLSL(null(),null())) + HX_(", vec4(0)))) discard;",61,d7,c4,f0));
HXDLIN( 373)						if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 373)							sb->flush();
            						}
HXDLIN( 373)						if (::hx::IsNull( sb->b )) {
HXLINE( 373)							sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x92));
            						}
            						else {
HXLINE( 373)							::Array< ::String > sb31 = sb->b;
HXDLIN( 373)							sb31->push(::Std_obj::string(x92));
            						}
            					}
...
HXLINE( 390)								{
HXLINE( 390)									::String x93 = ((HX_("if (",25,e9,b4,45) + sampler->toGLSL()) + HX_("_alphaEnabled) {\n",68,cb,8a,22));
HXDLIN( 390)									if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 390)										sb->flush();
            									}
HXDLIN( 390)									if (::hx::IsNull( sb->b )) {
HXLINE( 390)										sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x93));
            									}
            									else {
HXLINE( 390)										::Array< ::String > sb32 = sb->b;
HXDLIN( 390)										sb32->push(::Std_obj::string(x93));
            									}
            								}
HXLINE( 391)								{
HXLINE( 391)									::String x94 = ((HX_("\t\t",e0,07,00,00) + dr->toGLSL(null())) + HX_(" = vec4(texture2D(",e0,3e,c1,08));
HXDLIN( 391)									::String x95 = ((x94 + sampler->toGLSL()) + HX_(", ",74,26,00,00));
HXDLIN( 391)									::String x96 = ((x95 + sr1->toGLSL(null(),null())) + HX_(").xyz, texture2D(",23,7d,b7,f4));
HXDLIN( 391)									::String x97 = ((x96 + sampler->toGLSL()) + HX_("_alpha, ",d3,3a,ce,eb));
HXDLIN( 391)									::String x98 = ((x97 + sr1->toGLSL(null(),null())) + HX_(").x); // tex + alpha\n",1f,b8,ed,c2));
HXDLIN( 391)									if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 391)										sb->flush();
            									}
HXDLIN( 391)									if (::hx::IsNull( sb->b )) {
HXLINE( 391)										sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x98));
            									}
            									else {
HXLINE( 391)										::Array< ::String > sb33 = sb->b;
HXDLIN( 391)										sb33->push(::Std_obj::string(x98));
            									}
            								}
HXLINE( 393)								{
...
HXLINE( 394)								{
HXLINE( 394)									::String x99 = ((HX_("\t\t",e0,07,00,00) + dr->toGLSL(null())) + HX_(" = texture2D(",3e,55,2e,2f));
HXDLIN( 394)									::String x100 = ((x99 + sampler->toGLSL()) + HX_(", ",74,26,00,00));
HXDLIN( 394)									::String x101 = ((x100 + sr1->toGLSL(null(),null())) + HX_("); // tex\n",15,c9,e1,b6));
HXDLIN( 394)									if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 394)										sb->flush();
            									}
HXDLIN( 394)									if (::hx::IsNull( sb->b )) {
HXLINE( 394)										sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x101));
            									}
            									else {
HXLINE( 394)										::Array< ::String > sb34 = sb->b;
HXDLIN( 394)										sb34->push(::Std_obj::string(x101));
            									}
            								}
HXLINE( 395)								{
...
HXLINE( 401)								{
HXLINE( 401)									::String x102 = (dr->toGLSL(null()) + HX_(" = texture2D(",3e,55,2e,2f));
HXDLIN( 401)									::String x103 = ((x102 + sampler->toGLSL()) + HX_(", ",74,26,00,00));
HXDLIN( 401)									::String x104 = ((x103 + sr1->toGLSL(null(),null())) + HX_("); // tex",55,61,13,1a));
HXDLIN( 401)									if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 401)										sb->flush();
            									}
HXDLIN( 401)									if (::hx::IsNull( sb->b )) {
HXLINE( 401)										sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x104));
            									}
            									else {
HXLINE( 401)										::Array< ::String > sb35 = sb->b;
HXDLIN( 401)										sb35->push(::Std_obj::string(x104));
            									}
            								}
            							}
            						}
...
HXLINE( 411)								{
HXLINE( 411)									::String x105 = ((HX_("if (",25,e9,b4,45) + sampler->toGLSL()) + HX_("_alphaEnabled) {\n",68,cb,8a,22));
...
HXLINE( 411)										::Array< ::String > sb36 = sb->b;
HXDLIN( 411)										sb36->push(::Std_obj::string(x105));
            									}
            								}
HXLINE( 412)								{
HXLINE( 412)									::String x106 = ((HX_("\t\t",e0,07,00,00) + dr->toGLSL(null())) + HX_(" = vec4(textureCube(",bd,62,16,95));
HXDLIN( 412)									::String x107 = ((x106 + sampler->toGLSL()) + HX_(", ",74,26,00,00));
HXDLIN( 412)									::String x108 = ((x107 + sr1->toGLSL(null(),null())) + HX_(").xyz, textureCube(",c0,f7,ca,19));
HXDLIN( 412)									::String x109 = ((x108 + sampler->toGLSL()) + HX_("_alpha, ",d3,3a,ce,eb));
HXDLIN( 412)									::String x110 = ((x109 + sr1->toGLSL(null(),null())) + HX_(").x); // tex + alpha\n",1f,b8,ed,c2));
HXDLIN( 412)									if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 412)										sb->flush();
            									}
HXDLIN( 412)									if (::hx::IsNull( sb->b )) {
HXLINE( 412)										sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x110));
            									}
            									else {
HXLINE( 412)										::Array< ::String > sb37 = sb->b;
HXDLIN( 412)										sb37->push(::Std_obj::string(x110));
            									}
            								}
HXLINE( 414)								{
...
HXLINE( 415)								{
HXLINE( 415)									::String x111 = ((HX_("\t\t",e0,07,00,00) + dr->toGLSL(null())) + HX_(" = textureCube(",9b,4c,bc,01));
HXDLIN( 415)									::String x112 = ((x111 + sampler->toGLSL()) + HX_(", ",74,26,00,00));
HXDLIN( 415)									::String x113 = ((x112 + sr1->toGLSL(null(),null())) + HX_("); // tex",55,61,13,1a));
HXDLIN( 415)									if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 415)										sb->flush();
            									}
HXDLIN( 415)									if (::hx::IsNull( sb->b )) {
HXLINE( 415)										sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x113));
            									}
            									else {
HXLINE( 415)										::Array< ::String > sb38 = sb->b;
HXDLIN( 415)										sb38->push(::Std_obj::string(x113));
            									}
            								}
HXLINE( 416)								{
...
HXLINE( 421)								{
HXLINE( 421)									::String x114 = (dr->toGLSL(null()) + HX_(" = textureCube(",9b,4c,bc,01));
HXDLIN( 421)									::String x115 = ((x114 + sampler->toGLSL()) + HX_(", ",74,26,00,00));
HXDLIN( 421)									::String x116 = ((x115 + sr1->toGLSL(null(),null())) + HX_("); // tex",55,61,13,1a));
HXDLIN( 421)									if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 421)										sb->flush();
            									}
HXDLIN( 421)									if (::hx::IsNull( sb->b )) {
HXLINE( 421)										sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x116));
            									}
            									else {
HXLINE( 421)										::Array< ::String > sb39 = sb->b;
HXDLIN( 421)										sb39->push(::Std_obj::string(x116));
            									}
            								}
...
HXLINE( 439)					{
HXLINE( 439)						::String x117 = (dr->toGLSL(null()) + HX_(" = vec4(greaterThanEqual(",aa,a3,51,ec));
HXDLIN( 439)						::String x118 = ((x117 + sr1->toGLSL(null(),null())) + HX_(", ",74,26,00,00));
HXDLIN( 439)						::String x119 = ((x118 + sr2->toGLSL(null(),null())) + HX_("))",e0,23,00,00));
HXDLIN( 439)						::String x120 = ((x119 + dr->getWriteMask()) + HX_("; // ste",e9,da,68,51));
HXDLIN( 439)						if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 439)							sb->flush();
            						}
HXDLIN( 439)						if (::hx::IsNull( sb->b )) {
HXLINE( 439)							sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x120));
            						}
            						else {
HXLINE( 439)							::Array< ::String > sb40 = sb->b;
HXDLIN( 439)							sb40->push(::Std_obj::string(x120));
            						}
            					}
...
HXLINE( 447)					{
HXLINE( 447)						::String x121 = (dr->toGLSL(null()) + HX_(" = vec4(lessThan(",69,ee,b4,35));
HXDLIN( 447)						::String x122 = ((x121 + sr1->toGLSL(null(),null())) + HX_(", ",74,26,00,00));
HXDLIN( 447)						::String x123 = ((x122 + sr2->toGLSL(null(),null())) + HX_("))",e0,23,00,00));
HXDLIN( 447)						::String x124 = ((x123 + dr->getWriteMask()) + HX_("; // slt",00,d4,68,51));
HXDLIN( 447)						if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 447)							sb->flush();
            						}
HXDLIN( 447)						if (::hx::IsNull( sb->b )) {
HXLINE( 447)							sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x124));
            						}
            						else {
HXLINE( 447)							::Array< ::String > sb41 = sb->b;
HXDLIN( 447)							sb41->push(::Std_obj::string(x124));
            						}
            					}
...
HXLINE( 455)					{
HXLINE( 455)						::String x125 = (dr->toGLSL(null()) + HX_(" = vec4(equal(",39,08,45,e1));
HXDLIN( 455)						::String x126 = ((x125 + sr1->toGLSL(null(),null())) + HX_(", ",74,26,00,00));
HXDLIN( 455)						::String x127 = ((x126 + sr2->toGLSL(null(),null())) + HX_("))",e0,23,00,00));
HXDLIN( 455)						::String x128 = ((x127 + dr->getWriteMask()) + HX_("; // seq",e4,cd,68,51));
HXDLIN( 455)						if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 455)							sb->flush();
            						}
HXDLIN( 455)						if (::hx::IsNull( sb->b )) {
HXLINE( 455)							sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x128));
            						}
            						else {
HXLINE( 455)							::Array< ::String > sb42 = sb->b;
HXDLIN( 455)							sb42->push(::Std_obj::string(x128));
            						}
            					}
...
HXLINE( 463)					{
HXLINE( 463)						::String x129 = (dr->toGLSL(null()) + HX_(" = vec4(notEqual(",42,aa,f1,97));
HXDLIN( 463)						::String x130 = ((x129 + sr1->toGLSL(null(),null())) + HX_(", ",74,26,00,00));
HXDLIN( 463)						::String x131 = ((x130 + sr2->toGLSL(null(),null())) + HX_("))",e0,23,00,00));
HXDLIN( 463)						::String x132 = ((x131 + dr->getWriteMask()) + HX_("; // sne",af,d5,68,51));
HXDLIN( 463)						if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 463)							sb->flush();
            						}
HXDLIN( 463)						if (::hx::IsNull( sb->b )) {
HXLINE( 463)							sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x132));
            						}
            						else {
HXLINE( 463)							::Array< ::String > sb43 = sb->b;
HXDLIN( 463)							sb43->push(::Std_obj::string(x132));
            						}
            					}
...
HXLINE( 479)			::String version1 = ( (::String)(::lime::graphics::opengl::GL_obj::context->getParameter(7938)) );
HXLINE( 480)			bool _hx_tmp4;
HXDLIN( 480)			if ((version1.indexOf(HX_("OpenGL ES",5f,cb,92,95),null()) <= -1)) {
HXLINE( 480)				_hx_tmp4 = (version1.indexOf(HX_("WebGL",99,9f,e9,5a),null()) > -1);
            			}
            			else {
HXLINE( 480)				_hx_tmp4 = true;
            			}
HXDLIN( 480)			::openfl::display3D::_internal::AGALConverter_obj::limitedProfile = _hx_tmp4;
            		}
HXLINE( 485)		 ::StringBuf glsl =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 486)		{
HXLINE( 486)			::String x133;
HXDLIN( 486)			if (::hx::IsPointerEq( programType,::openfl::display3D::_internal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE( 486)				x133 = HX_("vertex",64,db,47,a1);
            			}
            			else {
HXLINE( 486)				x133 = HX_("fragment",d0,5f,e5,ad);
            			}
HXDLIN( 486)			::String x134 = ((HX_("// AGAL ",af,bc,4a,8a) + x133) + HX_(" shader\n",25,c5,d4,85));
HXDLIN( 486)			if (::hx::IsNotNull( glsl->charBuf )) {
HXLINE( 486)				glsl->flush();
            			}
HXDLIN( 486)			if (::hx::IsNull( glsl->b )) {
HXLINE( 486)				glsl->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x134));
            			}
            			else {
HXLINE( 486)				::Array< ::String > glsl1 = glsl->b;
HXDLIN( 486)				glsl1->push(::Std_obj::string(x134));
            			}
            		}
...
HXLINE( 504)		{
HXLINE( 504)			::String x135 = map->toGLSL(false);
HXDLIN( 504)			if (::hx::IsNotNull( glsl->charBuf )) {
HXLINE( 504)				glsl->flush();
            			}
HXDLIN( 504)			if (::hx::IsNull( glsl->b )) {
HXLINE( 504)				glsl->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x135));
            			}
            			else {
HXLINE( 504)				::Array< ::String > glsl2 = glsl->b;
HXDLIN( 504)				glsl2->push(::Std_obj::string(x135));
            			}
            		}
...
HXLINE( 513)		{
HXLINE( 513)			::String x136 = map->toGLSL(true);
HXDLIN( 513)			if (::hx::IsNotNull( glsl->charBuf )) {
HXLINE( 513)				glsl->flush();
            			}
HXDLIN( 513)			if (::hx::IsNull( glsl->b )) {
HXLINE( 513)				glsl->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x136));
            			}
            			else {
HXLINE( 513)				::Array< ::String > glsl3 = glsl->b;
HXDLIN( 513)				glsl3->push(::Std_obj::string(x136));
            			}
            		}
HXLINE( 514)		{
HXLINE( 514)			::String x137 = sb->toString();
HXDLIN( 514)			if (::hx::IsNotNull( glsl->charBuf )) {
HXLINE( 514)				glsl->flush();
            			}
HXDLIN( 514)			if (::hx::IsNull( glsl->b )) {
HXLINE( 514)				glsl->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x137));
            			}
            			else {
HXLINE( 514)				::Array< ::String > glsl4 = glsl->b;
HXDLIN( 514)				glsl4->push(::Std_obj::string(x137));
            			}
            		}

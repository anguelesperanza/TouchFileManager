...
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_729_createCubeTexture,"openfl.display3D.Context3D","createCubeTexture",0xbb69e843,"openfl.display3D.Context3D.createCubeTexture","openfl/display3D/Context3D.hx",729,0xc899cbb9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_912_createTexture,"openfl.display3D.Context3D","createTexture",0xb63ed238,"openfl.display3D.Context3D.createTexture","openfl/display3D/Context3D.hx",912,0xc899cbb9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_997_createVideoTexture,"openfl.display3D.Context3D","createVideoTexture",0x922f1723,"openfl.display3D.Context3D.createVideoTexture","openfl/display3D/Context3D.hx",997,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_1023_dispose,"openfl.display3D.Context3D","dispose",0x8ad040d8,"openfl.display3D.Context3D.dispose","openfl/display3D/Context3D.hx",1023,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_1070_drawToBitmapData,"openfl.display3D.Context3D","drawToBitmapData",0x474f45df,"openfl.display3D.Context3D.drawToBitmapData","openfl/display3D/Context3D.hx",1070,0xc899cbb9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_1428_setProgramConstantsFromByteArray,"openfl.display3D.Context3D","setProgramConstantsFromByteArray",0xd8990de1,"openfl.display3D.Context3D.setProgramConstantsFromByteArray","openfl/display3D/Context3D.hx",1428,0xc899cbb9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_1585_setProgramConstantsFromVector,"openfl.display3D.Context3D","setProgramConstantsFromVector",0x057dbe53,"openfl.display3D.Context3D.setProgramConstantsFromVector","openfl/display3D/Context3D.hx",1585,0xc899cbb9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_2077___flushGLColor,"openfl.display3D.Context3D","__flushGLColor",0x63a1a6c1,"openfl.display3D.Context3D.__flushGLColor","openfl/display3D/Context3D.hx",2077,0xc899cbb9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_2690_get_enableErrorChecking,"openfl.display3D.Context3D","get_enableErrorChecking",0x0dbc654f,"openfl.display3D.Context3D.get_enableErrorChecking","openfl/display3D/Context3D.hx",2690,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_2695_set_enableErrorChecking,"openfl.display3D.Context3D","set_enableErrorChecking",0x101dce5b,"openfl.display3D.Context3D.set_enableErrorChecking","openfl/display3D/Context3D.hx",2695,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_2699_get_totalGPUMemory,"openfl.display3D.Context3D","get_totalGPUMemory",0x16e91319,"openfl.display3D.Context3D.get_totalGPUMemory","openfl/display3D/Context3D.hx",2699,0xc899cbb9)
...
HXDLIN( 632)					 ::openfl::_Vector::IntVector indexData =  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length1,fixed1,::Array_obj< int >::fromData( _hx_array_data_2fa0bfa7_5,6));
...
HX_DEFINE_DYNAMIC_FUNC6(Context3D_obj,configureBackBuffer,(void))
 ...
 ::openfl::display3D::textures::CubeTexture Context3D_obj::createCubeTexture(int size, ::Dynamic format,bool optimizeForRenderToTexture,::hx::Null< int >  __o_streamingLevels){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_729_createCubeTexture)
HXDLIN( 729)		return  ::openfl::display3D::textures::CubeTexture_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),size,format,optimizeForRenderToTexture,streamingLevels);
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(Context3D_obj,createRectangleTexture,return )
 ...
 ::openfl::display3D::textures::Texture Context3D_obj::createTexture(int width,int height, ::Dynamic format,bool optimizeForRenderToTexture,::hx::Null< int >  __o_streamingLevels){
            		int streamingLevels = __o_streamingLevels.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_912_createTexture)
HXDLIN( 912)		return  ::openfl::display3D::textures::Texture_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),width,height,format,optimizeForRenderToTexture,streamingLevels);
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Context3D_obj,createVertexBuffer,return )
 ...
 ::openfl::display3D::textures::VideoTexture Context3D_obj::createVideoTexture(){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_997_createVideoTexture)
HXDLIN( 997)		HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("Video textures are not supported on this platform",02,cd,86,ca),null()));
HXDLIN( 997)		return null();
            	}
...
void Context3D_obj::dispose(::hx::Null< bool >  __o_recreate){
            	...
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1023_dispose)
HXLINE(1026)		this->gl = null();
HXLINE(1027)		this->_hx___dispose();
            	}
...
void Context3D_obj::drawToBitmapData( ::openfl::display::BitmapData destination, ::openfl::geom::Rectangle srcRect, ::openfl::geom::Point destPoint){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1070_drawToBitmapData)
HXLINE(1072)		if (::hx::IsNull( destination )) {
HXLINE(1072)			return;
            		}
HXLINE(1074)		 ::lime::math::Rectangle sourceRect;
HXDLIN(1074)		if (::hx::IsNotNull( srcRect )) {
HXLINE(1074)			sourceRect = srcRect->_hx___toLimeRectangle();
            		}
            		else {
HXLINE(1074)			sourceRect =  ::lime::math::Rectangle_obj::__alloc( HX_CTX ,0,0,this->backBufferWidth,this->backBufferHeight);
            		}
HXLINE(1075)		 ::lime::math::Vector2 destVector;
HXDLIN(1075)		if (::hx::IsNotNull( destPoint )) {
HXLINE(1075)			destVector = destPoint->_hx___toLimeVector2();
            		}
            		else {
HXLINE(1075)			destVector =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,null(),null());
            		}
HXLINE(1077)		if (::hx::IsInstanceEq( this->_hx___stage->context3D,::hx::ObjectPtr<OBJ_>(this) )) {
HXLINE(1079)			if (::hx::IsNotNull( this->_hx___stage->window )) {
HXLINE(1081)				if (::hx::IsNotNull( this->_hx___stage3D )) {
HXLINE(1083)					Float xa = ( (Float)(::Std_obj::_hx_int(-(this->_hx___stage3D->get_x()))) );
HXDLIN(1083)					Float ya = ( (Float)(::Std_obj::_hx_int(-(this->_hx___stage3D->get_y()))) );
HXDLIN(1083)					destVector->x = xa;
HXDLIN(1083)					destVector->y = ya;
            				}
HXLINE(1086)				 ::lime::graphics::Image image = this->_hx___stage->window->readPixels(null());
HXLINE(1087)				destination->image->copyPixels(image,sourceRect,destVector,null(),null(),null());
            			}
            		}
            		else {
HXLINE(1090)			if (::hx::IsNotNull( this->_hx___backBufferTexture )) {
HXLINE(1092)				 ::openfl::display3D::textures::TextureBase cacheRenderToTexture = this->_hx___state->renderToTexture;
HXLINE(1093)				this->setRenderToBackBuffer();
HXLINE(1095)				this->_hx___flushGLFramebuffer();
HXLINE(1096)				this->_hx___flushGLViewport();
HXLINE(1100)				 ::Dynamic elements = ((this->backBufferWidth * this->backBufferHeight) * 4);
HXDLIN(1100)				 ::haxe::io::Bytes buffer = null();
HXDLIN(1100)				::cpp::VirtualArray array = null();
HXDLIN(1100)				 ::openfl::_Vector::IntVector vector = null();
HXDLIN(1100)				 ::lime::utils::ArrayBufferView view = null();
HXDLIN(1100)				 ::Dynamic len = null();
HXDLIN(1100)				 ::lime::utils::ArrayBufferView this1;
HXDLIN(1100)				if (::hx::IsNotNull( elements )) {
HXLINE(1100)					this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,4);
            				}
            				else {
HXLINE(1100)					if (::hx::IsNotNull( array )) {
HXLINE(1100)						 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1100)						_this->byteOffset = 0;
HXDLIN(1100)						_this->length = array->get_length();
HXDLIN(1100)						_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN(1100)						_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN(1100)						_this->copyFromArray(array,null());
HXDLIN(1100)						this1 = _this;
            					}
            					else {
HXLINE(1100)						if (::hx::IsNotNull( vector )) {
HXLINE(1100)							 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1100)							::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(1100)							_this1->byteOffset = 0;
HXDLIN(1100)							_this1->length = array1->get_length();
HXDLIN(1100)							_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN(1100)							_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN(1100)							_this1->copyFromArray(array1,null());
HXDLIN(1100)							this1 = _this1;
            						}
            						else {
HXLINE(1100)							if (::hx::IsNotNull( view )) {
HXLINE(1100)								 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1100)								 ::haxe::io::Bytes srcData = view->buffer;
HXDLIN(1100)								int srcLength = view->length;
HXDLIN(1100)								int srcByteOffset = view->byteOffset;
HXDLIN(1100)								int srcElementSize = view->bytesPerElement;
HXDLIN(1100)								int elementSize = _this2->bytesPerElement;
HXDLIN(1100)								if ((view->type == _this2->type)) {
HXLINE(1100)									int srcLength1 = srcData->length;
HXDLIN(1100)									int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(1100)									_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1100)									_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            								}
            								else {
HXLINE(1100)									HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            								}
HXDLIN(1100)								_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN(1100)								_this2->byteOffset = 0;
HXDLIN(1100)								_this2->length = srcLength;
HXDLIN(1100)								this1 = _this2;
            							}
            							else {
HXLINE(1100)								if (::hx::IsNotNull( buffer )) {
HXLINE(1100)									 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1100)									int in_byteOffset = 0;
HXDLIN(1100)									if ((in_byteOffset < 0)) {
HXLINE(1100)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN(1100)									if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE(1100)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN(1100)									int bufferByteLength = buffer->length;
HXDLIN(1100)									int elementSize1 = _this3->bytesPerElement;
HXDLIN(1100)									int newByteLength = bufferByteLength;
HXDLIN(1100)									if (::hx::IsNull( len )) {
HXLINE(1100)										newByteLength = (bufferByteLength - in_byteOffset);
HXDLIN(1100)										if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE(1100)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
HXDLIN(1100)										if ((newByteLength < 0)) {
HXLINE(1100)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
            									else {
HXLINE(1100)										newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN(1100)										int newRange = (in_byteOffset + newByteLength);
HXDLIN(1100)										if ((newRange > bufferByteLength)) {
HXLINE(1100)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
HXDLIN(1100)									_this3->buffer = buffer;
HXDLIN(1100)									_this3->byteOffset = in_byteOffset;
HXDLIN(1100)									_this3->byteLength = newByteLength;
HXDLIN(1100)									_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN(1100)									this1 = _this3;
            								}
            								else {
HXLINE(1100)									HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            								}
            							}
            						}
            					}
            				}
HXDLIN(1100)				 ::lime::utils::ArrayBufferView data = this1;
HXLINE(1101)				{
HXLINE(1101)					 ::lime::_internal::backend::native::NativeOpenGLRenderContext this2 = this->gl;
HXDLIN(1101)					int width = this->backBufferWidth;
HXDLIN(1101)					int height = this->backBufferHeight;
HXDLIN(1101)					int format = this->_hx___backBufferTexture->_hx___format;
HXDLIN(1101)					int type = this->gl->UNSIGNED_BYTE;
HXDLIN(1101)					{
HXLINE(1101)						::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),data,null(),0);
HXDLIN(1101)						this2->readPixels(0,0,width,height,format,type,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer));
            					}
            				}
HXLINE(1103)				 ::lime::graphics::Image image1 =  ::lime::graphics::Image_obj::__alloc( HX_CTX , ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,data,this->backBufferWidth,this->backBufferHeight,32,2),null(),null(),null(),null(),null(),null());
HXLINE(1104)				destination->image->copyPixels(image1,sourceRect,destVector,null(),null(),null());
HXLINE(1106)				if (::hx::IsNotNull( cacheRenderToTexture )) {
HXLINE(1108)					this->setRenderToTexture(cacheRenderToTexture,this->_hx___state->renderToTextureDepthStencil,this->_hx___state->renderToTextureAntiAlias,this->_hx___state->renderToTextureSurfaceSelector);
            				}
            			}
            		}
            	}
...
HXLINE(1220)		{
HXLINE(1220)			 ::lime::_internal::backend::native::NativeOpenGLRenderContext this1 = this->gl;
HXDLIN(1220)			int mode = this->gl->TRIANGLES;
HXDLIN(1220)			int type = this->gl->UNSIGNED_SHORT;
HXDLIN(1220)			this1->drawElements(mode,count,type,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt((firstIndex * 2)));
            		}
            	}
...
void Context3D_obj::setProgramConstantsFromByteArray( ::Dynamic programType,int firstRegister,int numRegisters, ::openfl::utils::ByteArrayData data,int byteArrayOffset){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1428_setProgramConstantsFromByteArray)
HXLINE(1430)		bool _hx_tmp;
HXDLIN(1430)		if ((numRegisters != 0)) {
HXLINE(1430)			_hx_tmp = ::hx::IsNull( this->_hx___state->program );
            		}
            		else {
...
HXLINE(1432)		bool _hx_tmp1;
HXDLIN(1432)		if (::hx::IsNotNull( this->_hx___state->program )) {
HXLINE(1432)			_hx_tmp1 = ::hx::IsEq( this->_hx___state->program->_hx___format,1 );
            		}
            		else {
HXLINE(1432)			_hx_tmp1 = false;
            		}
HXDLIN(1432)		if (!(_hx_tmp1)) {
HXLINE(1440)			if ((numRegisters == -1)) {
HXLINE(1442)				numRegisters = (::hx::UShr(::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(data),2) - byteArrayOffset);
            			}
HXLINE(1445)			bool isVertex = ::hx::IsEq( programType,1 );
HXLINE(1446)			 ::lime::utils::ArrayBufferView dest;
HXDLIN(1446)			if (isVertex) {
HXLINE(1446)				dest = this->_hx___vertexConstants;
            			}
            			else {
HXLINE(1446)				dest = this->_hx___fragmentConstants;
            			}
HXLINE(1448)			 ::haxe::io::Bytes bytes = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(data);
HXDLIN(1448)			 ::Dynamic byteOffset = 0;
HXDLIN(1448)			 ::Dynamic len = null();
HXDLIN(1448)			if (::hx::IsNull( byteOffset )) {
HXLINE(1448)				byteOffset = 0;
            			}
HXDLIN(1448)			 ::Dynamic elements = null();
HXDLIN(1448)			::cpp::VirtualArray array = null();
HXDLIN(1448)			 ::openfl::_Vector::FloatVector vector = null();
HXDLIN(1448)			 ::lime::utils::ArrayBufferView view = null();
HXDLIN(1448)			 ::Dynamic byteoffset = byteOffset;
HXDLIN(1448)			if (::hx::IsNull( byteoffset )) {
HXLINE(1448)				byteoffset = 0;
            			}
HXDLIN(1448)			 ::lime::utils::ArrayBufferView this1;
HXDLIN(1448)			if (::hx::IsNotNull( elements )) {
HXLINE(1448)				this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,8);
            			}
            			else {
HXLINE(1448)				if (::hx::IsNotNull( array )) {
HXLINE(1448)					 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN(1448)					_this->byteOffset = 0;
HXDLIN(1448)					_this->length = array->get_length();
HXDLIN(1448)					_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN(1448)					_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN(1448)					_this->copyFromArray(array,null());
HXDLIN(1448)					this1 = _this;
            				}
            				else {
HXLINE(1448)					if (::hx::IsNotNull( vector )) {
HXLINE(1448)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN(1448)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(1448)						_this1->byteOffset = 0;
HXDLIN(1448)						_this1->length = array1->get_length();
HXDLIN(1448)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN(1448)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN(1448)						_this1->copyFromArray(array1,null());
HXDLIN(1448)						this1 = _this1;
            					}
            					else {
HXLINE(1448)						if (::hx::IsNotNull( view )) {
HXLINE(1448)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN(1448)							 ::haxe::io::Bytes srcData = view->buffer;
HXDLIN(1448)							int srcLength = view->length;
HXDLIN(1448)							int srcByteOffset = view->byteOffset;
HXDLIN(1448)							int srcElementSize = view->bytesPerElement;
HXDLIN(1448)							int elementSize = _this2->bytesPerElement;
HXDLIN(1448)							if ((view->type == _this2->type)) {
HXLINE(1448)								int srcLength1 = srcData->length;
HXDLIN(1448)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(1448)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1448)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE(1448)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN(1448)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN(1448)							_this2->byteOffset = 0;
HXDLIN(1448)							_this2->length = srcLength;
HXDLIN(1448)							this1 = _this2;
            						}
            						else {
HXLINE(1448)							if (::hx::IsNotNull( bytes )) {
HXLINE(1448)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN(1448)								int in_byteOffset = ( (int)(byteoffset) );
HXDLIN(1448)								if ((in_byteOffset < 0)) {
HXLINE(1448)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN(1448)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE(1448)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN(1448)								int bufferByteLength = bytes->length;
HXDLIN(1448)								int elementSize1 = _this3->bytesPerElement;
HXDLIN(1448)								int newByteLength = bufferByteLength;
HXDLIN(1448)								if (::hx::IsNull( len )) {
HXLINE(1448)									newByteLength = (bufferByteLength - in_byteOffset);
HXDLIN(1448)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE(1448)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN(1448)									if ((newByteLength < 0)) {
HXLINE(1448)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
            								else {
HXLINE(1448)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN(1448)									int newRange = (in_byteOffset + newByteLength);
HXDLIN(1448)									if ((newRange > bufferByteLength)) {
HXLINE(1448)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN(1448)								_this3->buffer = bytes;
HXDLIN(1448)								_this3->byteOffset = in_byteOffset;
HXDLIN(1448)								_this3->byteLength = newByteLength;
HXDLIN(1448)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN(1448)								this1 = _this3;
            							}
            							else {
HXLINE(1448)								HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            							}
            						}
            					}
            				}
            			}
HXDLIN(1448)			 ::lime::utils::ArrayBufferView floatData = this1;
HXLINE(1449)			int outOffset = (firstRegister * 4);
HXLINE(1450)			int _hx_int = byteArrayOffset;
HXDLIN(1450)			Float inOffset;
HXDLIN(1450)			if ((_hx_int < 0)) {
HXLINE(1450)				inOffset = (((Float)4294967296.0) + _hx_int);
            			}
            			else {
HXLINE(1450)				inOffset = (_hx_int + ((Float)0.0));
            			}
HXDLIN(1450)			int int1 = 4;
HXDLIN(1450)			Float inOffset1;
HXDLIN(1450)			if ((int1 < 0)) {
HXLINE(1450)				inOffset1 = (((Float)4294967296.0) + int1);
            			}
            			else {
HXLINE(1450)				inOffset1 = (int1 + ((Float)0.0));
            			}
HXDLIN(1450)			int inOffset2 = ::Std_obj::_hx_int((inOffset / inOffset1));
HXLINE(1452)			{
HXLINE(1452)				int _g = 0;
HXDLIN(1452)				int _g1 = (numRegisters * 4);
HXDLIN(1452)				while((_g < _g1)){
HXLINE(1452)					_g = (_g + 1);
HXDLIN(1452)					int i = (_g - 1);
HXLINE(1454)					{
HXLINE(1454)						Float val =  ::__hxcpp_memory_get_float(floatData->buffer->b,(floatData->byteOffset + ((inOffset2 + i) * 4)));
HXDLIN(1454)						 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((outOffset + i) * 4)),val);
            					}
            				}
            			}
HXLINE(1457)			if (::hx::IsNotNull( this->_hx___state->program )) {
HXLINE(1459)				this->_hx___state->program->_hx___markDirty(isVertex,firstRegister,numRegisters);
            			}
            		}
            	}
...
HXLINE(1493)			 ::haxe::io::Bytes buffer = null();
HXDLIN(1493)			::cpp::VirtualArray array = null();
HXDLIN(1493)			 ::openfl::_Vector::FloatVector vector = null();
HXDLIN(1493)			 ::lime::utils::ArrayBufferView view = null();
HXDLIN(1493)			 ::Dynamic len = null();
HXDLIN(1493)			 ::lime::utils::ArrayBufferView data =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,16,8);
HXLINE(1494)			{
HXLINE(1496)				{
...
void Context3D_obj::setProgramConstantsFromVector( ::Dynamic programType,int firstRegister, ::openfl::_Vector::FloatVector data,::hx::Null< int >  __o_numRegisters){
            	...
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1585_setProgramConstantsFromVector)
HXLINE(1586)		if ((numRegisters == 0)) {
HXLINE(1586)			return;
            		}
HXLINE(1588)		bool _hx_tmp;
HXDLIN(1588)		if (::hx::IsNotNull( this->_hx___state->program )) {
HXLINE(1588)			_hx_tmp = ::hx::IsEq( this->_hx___state->program->_hx___format,1 );
            		}
            		else {
HXLINE(1588)			_hx_tmp = false;
            		}
HXDLIN(1588)		if (!(_hx_tmp)) {
HXLINE(1591)			if ((numRegisters == -1)) {
HXLINE(1593)				numRegisters = (data->get_length() >> 2);
            			}
HXLINE(1596)			bool isVertex = ::hx::IsEq( programType,1 );
HXLINE(1597)			 ::lime::utils::ArrayBufferView dest;
HXDLIN(1597)			if (isVertex) {
HXLINE(1597)				dest = this->_hx___vertexConstants;
            			}
            			else {
HXLINE(1597)				dest = this->_hx___fragmentConstants;
            			}
HXLINE(1598)			 ::openfl::_Vector::FloatVector source = data;
HXLINE(1600)			int sourceIndex = 0;
HXLINE(1601)			int destIndex = (firstRegister * 4);
HXLINE(1603)			{
HXLINE(1603)				int _g = 0;
HXDLIN(1603)				int _g1 = numRegisters;
...
HXDLIN(1605)						Float val = source->get((sourceIndex - 1));
HXDLIN(1605)						 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((destIndex - 1) * 4)),val);
            					}
HXLINE(1606)					{
HXLINE(1606)						destIndex = (destIndex + 1);
HXDLIN(1606)						sourceIndex = (sourceIndex + 1);
HXDLIN(1606)						Float val1 = source->get((sourceIndex - 1));
HXDLIN(1606)						 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((destIndex - 1) * 4)),val1);
            					}
HXLINE(1607)					{
HXLINE(1607)						destIndex = (destIndex + 1);
HXDLIN(1607)						sourceIndex = (sourceIndex + 1);
HXDLIN(1607)						Float val2 = source->get((sourceIndex - 1));
HXDLIN(1607)						 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((destIndex - 1) * 4)),val2);
            					}
HXLINE(1608)					{
HXLINE(1608)						destIndex = (destIndex + 1);
HXDLIN(1608)						sourceIndex = (sourceIndex + 1);
HXDLIN(1608)						Float val3 = source->get((sourceIndex - 1));
HXDLIN(1608)						 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((destIndex - 1) * 4)),val3);
            					}
            				}
            			}
HXLINE(1611)			if (::hx::IsNotNull( this->_hx___state->program )) {
HXLINE(1613)				this->_hx___state->program->_hx___markDirty(isVertex,firstRegister,numRegisters);
            			}
            		}
            	}
...
HXLINE(1898)			this->gl->disableVertexAttribArray(index);
HXLINE(1899)			this->_hx___bindGLArrayBuffer(null());
HXLINE(1900)			return;
            		}
HXLINE(1903)		this->_hx___bindGLArrayBuffer(buffer->_hx___id);
HXLINE(1904)		this->gl->enableVertexAttribArray(index);
HXLINE(1906)		int byteOffset = (bufferOffset * 4);
HXLINE(1908)		 ::Dynamic _hx_switch_0 = format;
            		if (  (_hx_switch_0==0) ){
HXLINE(1911)			 ::lime::_internal::backend::native::NativeOpenGLRenderContext this1 = this->gl;
HXDLIN(1911)			int type = this->gl->UNSIGNED_BYTE;
HXDLIN(1911)			int stride = buffer->_hx___stride;
HXDLIN(1911)			this1->vertexAttribPointer(index,4,type,true,stride,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt(byteOffset));
HXDLIN(1911)			goto _hx_goto_36;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(1923)			 ::lime::_internal::backend::native::NativeOpenGLRenderContext this2 = this->gl;
HXDLIN(1923)			int type1 = this->gl->FLOAT;
HXDLIN(1923)			int stride1 = buffer->_hx___stride;
HXDLIN(1923)			this2->vertexAttribPointer(index,1,type1,false,stride1,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt(byteOffset));
HXDLIN(1923)			goto _hx_goto_36;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(1920)			 ::lime::_internal::backend::native::NativeOpenGLRenderContext this3 = this->gl;
HXDLIN(1920)			int type2 = this->gl->FLOAT;
HXDLIN(1920)			int stride2 = buffer->_hx___stride;
HXDLIN(1920)			this3->vertexAttribPointer(index,2,type2,false,stride2,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt(byteOffset));
HXDLIN(1920)			goto _hx_goto_36;
            		}
            		if (  (_hx_switch_0==3) ){
HXLINE(1917)			 ::lime::_internal::backend::native::NativeOpenGLRenderContext this4 = this->gl;
HXDLIN(1917)			int type3 = this->gl->FLOAT;
HXDLIN(1917)			int stride3 = buffer->_hx___stride;
HXDLIN(1917)			this4->vertexAttribPointer(index,3,type3,false,stride3,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt(byteOffset));
HXDLIN(1917)			goto _hx_goto_36;
            		}
            		if (  (_hx_switch_0==4) ){
HXLINE(1914)			 ::lime::_internal::backend::native::NativeOpenGLRenderContext this5 = this->gl;
HXDLIN(1914)			int type4 = this->gl->FLOAT;
HXDLIN(1914)			int stride4 = buffer->_hx___stride;
HXDLIN(1914)			this5->vertexAttribPointer(index,4,type4,false,stride4,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt(byteOffset));
HXDLIN(1914)			goto _hx_goto_36;
            		}
            		/* default */{
...
HXLINE(1934)			this->gl->bindBuffer(this->gl->ARRAY_BUFFER,buffer);
...
HXLINE(1943)			this->gl->bindBuffer(this->gl->ELEMENT_ARRAY_BUFFER,buffer);
...
HXLINE(1952)			this->gl->bindFramebuffer(this->gl->FRAMEBUFFER,framebuffer);
...
HXLINE(1963)		this->gl->bindTexture(this->gl->TEXTURE_2D,texture);
...
HXLINE(1975)		this->gl->bindTexture(this->gl->TEXTURE_CUBE_MAP,texture);
...
HXLINE(1983)		 ::openfl::display3D::Context3D _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1983)		_hx_tmp->driverInfo = (_hx_tmp->driverInfo + HX_(" (Disposed)",7c,80,28,51));
...
HXLINE(2030)		this->gl->drawArrays(this->gl->TRIANGLES,firstIndex,count);
            	}
...
HXLINE(2040)			this->gl->colorMask(this->_hx___state->colorMaskRed,this->_hx___state->colorMaskGreen,this->_hx___state->colorMaskBlue,this->_hx___state->colorMaskAlpha);
...
HXLINE(2060)				 ::lime::_internal::backend::native::NativeOpenGLRenderContext this1 = this->gl;
HXDLIN(2060)				int sfactor = this->_hx___getGLBlend(this->_hx___state->blendSourceRGBFactor);
HXDLIN(2060)				this1->blendFunc(sfactor,this->_hx___getGLBlend(this->_hx___state->blendDestinationRGBFactor));
            			}
            			else {
HXLINE(2064)				 ::lime::_internal::backend::native::NativeOpenGLRenderContext this2 = this->gl;
HXDLIN(2064)				int srcRGB = this->_hx___getGLBlend(this->_hx___state->blendSourceRGBFactor);
...
HXDLIN(2064)				this2->blendFuncSeparate(srcRGB,dstRGB,srcAlpha,this->_hx___getGLBlend(this->_hx___state->blendDestinationAlphaFactor));
            			}
...
void Context3D_obj::_hx___flushGLColor(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_2077___flushGLColor)
HXDLIN(2077)		bool _hx_tmp;
HXDLIN(2077)		bool _hx_tmp1;
HXDLIN(2077)		bool _hx_tmp2;
HXDLIN(2077)		if ((this->_hx___contextState->colorMaskRed == this->_hx___state->colorMaskRed)) {
HXDLIN(2077)			_hx_tmp2 = (this->_hx___contextState->colorMaskGreen != this->_hx___state->colorMaskGreen);
            		}
            		else {
HXDLIN(2077)			_hx_tmp2 = true;
            		}
HXDLIN(2077)		if (!(_hx_tmp2)) {
HXDLIN(2077)			_hx_tmp1 = (this->_hx___contextState->colorMaskBlue != this->_hx___state->colorMaskBlue);
            		}
            		else {
HXDLIN(2077)			_hx_tmp1 = true;
            		}
HXDLIN(2077)		if (!(_hx_tmp1)) {
HXDLIN(2077)			_hx_tmp = (this->_hx___contextState->colorMaskAlpha != this->_hx___state->colorMaskAlpha);
            		}
            		else {
HXDLIN(2077)			_hx_tmp = true;
            		}
HXDLIN(2077)		if (_hx_tmp) {
HXLINE(2082)			this->gl->colorMask(this->_hx___state->colorMaskRed,this->_hx___state->colorMaskGreen,this->_hx___state->colorMaskBlue,this->_hx___state->colorMaskAlpha);
HXLINE(2083)			this->_hx___contextState->colorMaskRed = this->_hx___state->colorMaskRed;
HXLINE(2084)			this->_hx___contextState->colorMaskGreen = this->_hx___state->colorMaskGreen;
HXLINE(2085)			this->_hx___contextState->colorMaskBlue = this->_hx___state->colorMaskBlue;
HXLINE(2086)			this->_hx___contextState->colorMaskAlpha = this->_hx___state->colorMaskAlpha;
            		}
            	}
...
HXLINE(2102)				 ::Dynamic _hx_switch_0 = this->_hx___state->culling;
            				if (  (_hx_switch_0==0) ){
HXLINE(2106)					this->gl->cullFace(this->gl->BACK);
HXDLIN(2106)					goto _hx_goto_48;
            				}
            				if (  (_hx_switch_0==1) ){
HXLINE(2108)					this->gl->cullFace(this->gl->FRONT);
HXDLIN(2108)					goto _hx_goto_48;
            				}
            				if (  (_hx_switch_0==2) ){
HXLINE(2110)					this->gl->cullFace(this->gl->FRONT_AND_BACK);
HXDLIN(2110)					goto _hx_goto_48;
            				}
            				if (  (_hx_switch_0==3) ){
HXLINE(2104)					goto _hx_goto_48;
            				}
            				/* default */{
...
HXLINE(2127)			this->gl->depthMask(depthMask);
...
HXLINE(2133)			 ::Dynamic _hx_switch_0 = this->_hx___state->depthCompareMode;
            			if (  (_hx_switch_0==0) ){
HXLINE(2136)				this->gl->depthFunc(this->gl->ALWAYS);
HXDLIN(2136)				goto _hx_goto_50;
            			}
            			if (  (_hx_switch_0==1) ){
HXLINE(2138)				this->gl->depthFunc(this->gl->EQUAL);
HXDLIN(2138)				goto _hx_goto_50;
            			}
            			if (  (_hx_switch_0==2) ){
HXLINE(2140)				this->gl->depthFunc(this->gl->GREATER);
HXDLIN(2140)				goto _hx_goto_50;
            			}
            			if (  (_hx_switch_0==3) ){
HXLINE(2142)				this->gl->depthFunc(this->gl->GEQUAL);
HXDLIN(2142)				goto _hx_goto_50;
            			}
            			if (  (_hx_switch_0==4) ){
HXLINE(2144)				this->gl->depthFunc(this->gl->LESS);
HXDLIN(2144)				goto _hx_goto_50;
            			}
            			if (  (_hx_switch_0==5) ){
HXLINE(2146)				this->gl->depthFunc(this->gl->LEQUAL);
HXDLIN(2146)				goto _hx_goto_50;
            			}
            			if (  (_hx_switch_0==6) ){
HXLINE(2148)				this->gl->depthFunc(this->gl->NEVER);
HXDLIN(2148)				goto _hx_goto_50;
            			}
            			if (  (_hx_switch_0==7) ){
HXLINE(2150)				this->gl->depthFunc(this->gl->NOTEQUAL);
HXDLIN(2150)				goto _hx_goto_50;
            			}
            			/* default */{
...
HXLINE(2166)				 ::lime::graphics::opengl::GLObject framebuffer = this->_hx___state->renderToTexture->_hx___getGLFramebuffer(this->_hx___state->renderToTextureDepthStencil,this->_hx___state->renderToTextureAntiAlias,this->_hx___state->renderToTextureSurfaceSelector);
HXLINE(2168)				this->_hx___bindGLFramebuffer(framebuffer);
...
HXLINE(2282)				scissorY = ((contextHeight - scissorHeight) - scissorY);
            			}
...
HXLINE(2290)				this->gl->scissor(scissorX,scissorY,scissorWidth,scissorHeight);
...
HXLINE(2303)			{
HXLINE(2303)				 ::lime::_internal::backend::native::NativeOpenGLRenderContext this1 = this->gl;
HXDLIN(2303)				int face = this->_hx___getGLTriangleFace(this->_hx___state->stencilTriangleFace);
...
HXDLIN(2303)				this1->stencilOpSeparate(face,fail,zfail,this->_hx___getGLStencilAction(this->_hx___state->stencilPass));
            			}
...
HXLINE(2313)			this->gl->stencilMask(this->_hx___state->stencilWriteMask);
...
HXLINE(2322)			{
HXLINE(2322)				 ::lime::_internal::backend::native::NativeOpenGLRenderContext this2 = this->gl;
HXDLIN(2322)				int func = this->_hx___getGLCompareMode(this->_hx___state->stencilCompareMode);
HXDLIN(2322)				this2->stencilFunc(func,this->_hx___state->stencilReferenceValue,this->_hx___state->stencilReadMask);
            			}
...
HXLINE(2344)				this->gl->activeTexture((this->gl->TEXTURE0 + sampler));
...
HXLINE(2362)					this->gl->enable(this->gl->TEXTURE_2D);
...
HXLINE(2378)					this->gl->activeTexture(((this->gl->TEXTURE0 + sampler) + 4));
...
HXLINE(2392)						this->gl->uniform1i(this->_hx___state->program->_hx___agalAlphaSamplerEnabled->__get(sampler).StaticCast<  ::openfl::display3D::Uniform >()->location,1);
...
HXLINE(2404)							this->gl->uniform1i(this->_hx___state->program->_hx___agalAlphaSamplerEnabled->__get(sampler).StaticCast<  ::openfl::display3D::Uniform >()->location,0);
            						}
            					}
            				}
...
HXLINE(2432)				this->gl->viewport(x,y2,scaledBackBufferWidth,scaledBackBufferHeight);
            			}
            			else {
HXLINE(2436)				this->gl->viewport(0,0,this->backBufferWidth,this->backBufferHeight);
            			}
            		}
            		else {
...
HXLINE(2463)			this->gl->viewport(0,0,width,height);
            		}
            	}
...
HXDLIN(2535)			goto _hx_goto_65;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(2534)			return this->gl->FRONT;
HXDLIN(2534)			goto _hx_goto_65;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(2536)			return this->gl->FRONT_AND_BACK;
HXDLIN(2536)			goto _hx_goto_65;
            		}
            		if (  (_hx_switch_0==3) ){
HXLINE(2537)			return this->gl->NONE;
HXDLIN(2537)			goto _hx_goto_65;
            		}
            		/* default */{
...
HXLINE(2595)				this->gl->enable(this->gl->BLEND);
            			}
            			else {
HXLINE(2599)				this->gl->disable(this->gl->BLEND);
            			}
...
HXLINE(2609)			this->gl->blendEquation(value);
...
HXLINE(2620)				this->gl->enable(this->gl->CULL_FACE);
            			}
            			else {
HXLINE(2624)				this->gl->disable(this->gl->CULL_FACE);
            			}
...
HXLINE(2636)				this->gl->enable(this->gl->DEPTH_TEST);
            			}
            			else {
HXLINE(2640)				this->gl->disable(this->gl->DEPTH_TEST);
            			}
...
HXDLIN(2650)				this->gl->frontFace(mode);
            			}
...
HXLINE(2661)				this->gl->enable(this->gl->SCISSOR_TEST);
            			}
            			else {
HXLINE(2665)				this->gl->disable(this->gl->SCISSOR_TEST);
            			}
...
HXLINE(2677)				this->gl->enable(this->gl->STENCIL_TEST);
            			}
            			else {
HXLINE(2681)				this->gl->disable(this->gl->STENCIL_TEST);
            			}
...
bool Context3D_obj::get_enableErrorChecking(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_2690_get_enableErrorChecking)
HXDLIN(2690)		return this->_hx___enableErrorChecking;
            	}
...
bool Context3D_obj::set_enableErrorChecking(bool value){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_2695_set_enableErrorChecking)
HXDLIN(2695)		return (this->_hx___enableErrorChecking = value);
            	}
...
int Context3D_obj::get_totalGPUMemory(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_2699_get_totalGPUMemory)
HXLINE(2700)		if ((::openfl::display3D::Context3D_obj::_hx___glMemoryCurrentAvailable != -1)) {
HXLINE(2703)			int current = ( (int)(this->gl->getParameter(::openfl::display3D::Context3D_obj::_hx___glMemoryCurrentAvailable)) );
HXLINE(2704)			int total = ( (int)(this->gl->getParameter(::openfl::display3D::Context3D_obj::_hx___glMemoryTotalAvailable)) );
HXLINE(2706)			if ((total > 0)) {
HXLINE(2708)				return ((total - current) * 1024);
            			}
            		}
HXLINE(2711)		return 0;
            	}

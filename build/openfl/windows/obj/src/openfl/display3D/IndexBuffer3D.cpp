...
HXLINE(  83)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
HXDLIN(  83)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(  83)					_this1->byteOffset = 0;
HXDLIN(  83)					_this1->length = array1->get_length();
HXDLIN(  83)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN(  83)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN(  83)					_this1->copyFromArray(array1,null());
HXDLIN(  83)					this1 = _this1;
            				}
            				else {
HXLINE(  83)					if (::hx::IsNotNull( view )) {
HXLINE(  83)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
...
HXDLIN(  83)						int elementSize = _this2->bytesPerElement;
HXDLIN(  83)						if ((view->type == _this2->type)) {
HXLINE(  83)							int srcLength1 = srcData->length;
HXDLIN(  83)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(  83)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(  83)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE(  83)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN(  83)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN(  83)						_this2->byteOffset = 0;
HXDLIN(  83)						_this2->length = srcLength;
HXDLIN(  83)						this1 = _this2;
            					}
            					else {
HXLINE(  83)						if (::hx::IsNotNull( buffer )) {
HXLINE(  83)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
...
HXDLIN(  83)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE(  83)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN(  83)							int bufferByteLength = buffer->length;
HXDLIN(  83)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN(  83)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE(  83)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE(  83)								newByteLength = (count * _this3->bytesPerElement);
HXDLIN(  83)								int newRange = (in_byteOffset + newByteLength);
HXDLIN(  83)								if ((newRange > bufferByteLength)) {
HXLINE(  83)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN(  83)							_this3->buffer = buffer;
HXDLIN(  83)							_this3->byteOffset = in_byteOffset;
HXDLIN(  83)							_this3->byteLength = newByteLength;
HXDLIN(  83)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN(  83)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 130)					_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 130)					_this->copyFromArray(array,null());
HXDLIN( 130)					this1 = _this;
            				}
            				else {
HXLINE( 130)					if (::hx::IsNotNull( vector )) {
HXLINE( 130)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
HXDLIN( 130)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 130)						_this1->byteOffset = 0;
HXDLIN( 130)						_this1->length = array1->get_length();
HXDLIN( 130)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 130)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 130)						_this1->copyFromArray(array1,null());
HXDLIN( 130)						this1 = _this1;
            					}
            					else {
HXLINE( 130)						if (::hx::IsNotNull( view )) {
HXLINE( 130)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
...
HXDLIN( 130)							int elementSize = _this2->bytesPerElement;
HXDLIN( 130)							if ((view->type == _this2->type)) {
HXLINE( 130)								int srcLength1 = srcData->length;
HXDLIN( 130)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 130)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 130)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE( 130)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN( 130)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 130)							_this2->byteOffset = 0;
HXDLIN( 130)							_this2->length = srcLength;
HXDLIN( 130)							this1 = _this2;
            						}
            						else {
HXLINE( 130)							if (::hx::IsNotNull( buffer )) {
HXLINE( 130)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
HXDLIN( 130)								int in_byteOffset = 0;
HXDLIN( 130)								if ((in_byteOffset < 0)) {
HXLINE( 130)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 130)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 130)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 130)								int bufferByteLength = buffer->length;
HXDLIN( 130)								int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 130)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 130)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXLINE( 130)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 130)									int newRange = (in_byteOffset + newByteLength);
HXDLIN( 130)									if ((newRange > bufferByteLength)) {
HXLINE( 130)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN( 130)								_this3->buffer = buffer;
HXDLIN( 130)								_this3->byteOffset = in_byteOffset;
HXDLIN( 130)								_this3->byteLength = newByteLength;
HXDLIN( 130)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 130)								this1 = _this3;
            							}
            							else {
...
HXLINE( 134)				 ::lime::utils::ArrayBufferView _this4 = this->_hx___tempUInt16Array;
HXDLIN( 134)				::cpp::VirtualArray array2 = null();
HXDLIN( 134)				int offset = 0;
HXDLIN( 134)				bool _hx_tmp1;
HXDLIN( 134)				if (::hx::IsNotNull( existingUInt16Array )) {
HXLINE( 134)					_hx_tmp1 = ::hx::IsNull( array2 );
            				}
            				else {
HXLINE( 134)					_hx_tmp1 = false;
            				}
HXDLIN( 134)				if (_hx_tmp1) {
HXLINE( 134)					_this4->buffer->blit((offset * _this4->bytesPerElement),existingUInt16Array->buffer,existingUInt16Array->byteOffset,existingUInt16Array->byteLength);
            				}
            				else {
HXLINE( 134)					bool _hx_tmp2;
HXDLIN( 134)					if (::hx::IsNotNull( array2 )) {
HXLINE( 134)						_hx_tmp2 = ::hx::IsNull( existingUInt16Array );
            					}
            					else {
HXLINE( 134)						_hx_tmp2 = false;
            					}
HXDLIN( 134)					if (_hx_tmp2) {
HXLINE( 134)						_this4->copyFromArray(array2,offset);
            					}
            					else {

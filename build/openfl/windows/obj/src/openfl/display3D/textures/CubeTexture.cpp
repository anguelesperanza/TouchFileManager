...
HXDLIN( 215)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 215)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 215)							int srcLength1 = srcData->length;
...
HXDLIN( 215)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
...
HXDLIN( 215)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 215)							int in_byteOffset = ( (int)(byteoffset) );
HXDLIN( 215)							if ((in_byteOffset < 0)) {
HXDLIN( 215)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
...
HXDLIN( 215)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
...
HXDLIN( 215)							HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            						}
            					}
            				}
            			}
...
HXDLIN( 376)				::cpp::VirtualArray array2 = null();
...
HXLINE( 376)					if (::hx::IsNotNull( array2 )) {
HXLINE( 376)						 ::lime::utils::ArrayBufferView _this4 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 376)						_this4->byteOffset = 0;
HXDLIN( 376)						_this4->length = array2->get_length();
HXDLIN( 376)						_this4->byteLength = (_this4->length * _this4->bytesPerElement);
HXDLIN( 376)						_this4->buffer = ::haxe::io::Bytes_obj::alloc(_this4->byteLength);
HXDLIN( 376)						_this4->copyFromArray(array2,null());
HXDLIN( 376)						this2 = _this4;
            					}
            					else {
HXLINE( 376)						if (::hx::IsNotNull( vector1 )) {
HXLINE( 376)							 ::lime::utils::ArrayBufferView _this5 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 376)							::cpp::VirtualArray array3 = ( (::cpp::VirtualArray)(vector1->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 376)							_this5->byteOffset = 0;
HXDLIN( 376)							_this5->length = array3->get_length();
HXDLIN( 376)							_this5->byteLength = (_this5->length * _this5->bytesPerElement);
HXDLIN( 376)							_this5->buffer = ::haxe::io::Bytes_obj::alloc(_this5->byteLength);
HXDLIN( 376)							_this5->copyFromArray(array3,null());
HXDLIN( 376)							this2 = _this5;
            						}
            						else {
HXLINE( 376)							if (::hx::IsNotNull( view1 )) {
HXLINE( 376)								 ::lime::utils::ArrayBufferView _this6 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 376)								 ::haxe::io::Bytes srcData1 = view1->buffer;
HXDLIN( 376)								int srcLength2 = view1->length;
HXDLIN( 376)								int srcByteOffset1 = view1->byteOffset;
HXDLIN( 376)								int srcElementSize1 = view1->bytesPerElement;
HXDLIN( 376)								int elementSize2 = _this6->bytesPerElement;
HXDLIN( 376)								if ((view1->type == _this6->type)) {
HXLINE( 376)									int srcLength3 = srcData1->length;
HXDLIN( 376)									int cloneLength1 = (srcLength3 - srcByteOffset1);
HXDLIN( 376)									_this6->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN( 376)									_this6->buffer->blit(0,srcData1,srcByteOffset1,cloneLength1);
            								}
            								else {
HXLINE( 376)									HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            								}
HXDLIN( 376)								_this6->byteLength = (_this6->bytesPerElement * srcLength2);
HXDLIN( 376)								_this6->byteOffset = 0;
HXDLIN( 376)								_this6->length = srcLength2;
HXDLIN( 376)								this2 = _this6;
            							}
            							else {
HXLINE( 376)								if (::hx::IsNotNull( bytes )) {
HXLINE( 376)									 ::lime::utils::ArrayBufferView _this7 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 376)									int in_byteOffset1 = ( (int)(byteoffset1) );
HXDLIN( 376)									if ((in_byteOffset1 < 0)) {
HXLINE( 376)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 376)									if ((::hx::Mod(in_byteOffset1,_this7->bytesPerElement) != 0)) {
HXLINE( 376)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 376)									int bufferByteLength1 = bytes->length;
HXDLIN( 376)									int elementSize3 = _this7->bytesPerElement;
...
HXDLIN( 376)										if ((::hx::Mod(bufferByteLength1,_this7->bytesPerElement) != 0)) {
HXLINE( 376)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
...
HXLINE( 376)										newByteLength1 = (size * _this7->bytesPerElement);
HXDLIN( 376)										int newRange1 = (in_byteOffset1 + newByteLength1);
HXDLIN( 376)										if ((newRange1 > bufferByteLength1)) {
HXLINE( 376)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
HXDLIN( 376)									_this7->buffer = bytes;
HXDLIN( 376)									_this7->byteOffset = in_byteOffset1;
HXDLIN( 376)									_this7->byteLength = newByteLength1;
HXDLIN( 376)									_this7->length = ::Std_obj::_hx_int((( (Float)(newByteLength1) ) / ( (Float)(_this7->bytesPerElement) )));
HXDLIN( 376)									this2 = _this7;
            								}
            								else {
...
HXLINE( 382)				 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl3 = gl;
HXDLIN( 382)				int _gthis2 = _gthis->_hx___internalFormat;
HXLINE( 383)				 ::Dynamic elements2 = null();
HXDLIN( 383)				::cpp::VirtualArray array4 = null();
HXDLIN( 383)				 ::openfl::_Vector::IntVector vector2 = null();
HXDLIN( 383)				 ::lime::utils::ArrayBufferView view2 = null();
HXDLIN( 383)				 ::Dynamic byteoffset2 = 0;
HXDLIN( 383)				if (::hx::IsNull( byteoffset2 )) {
HXLINE( 383)					byteoffset2 = 0;
            				}
HXDLIN( 383)				 ::lime::utils::ArrayBufferView this3;
HXDLIN( 383)				if (::hx::IsNotNull( elements2 )) {
HXLINE( 383)					this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements2,4);
            				}
            				else {
HXLINE( 383)					if (::hx::IsNotNull( array4 )) {
HXLINE( 383)						 ::lime::utils::ArrayBufferView _this8 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 383)						_this8->byteOffset = 0;
HXDLIN( 383)						_this8->length = array4->get_length();
HXDLIN( 383)						_this8->byteLength = (_this8->length * _this8->bytesPerElement);
HXDLIN( 383)						_this8->buffer = ::haxe::io::Bytes_obj::alloc(_this8->byteLength);
HXDLIN( 383)						_this8->copyFromArray(array4,null());
HXDLIN( 383)						this3 = _this8;
            					}
            					else {
HXLINE( 383)						if (::hx::IsNotNull( vector2 )) {
HXLINE( 383)							 ::lime::utils::ArrayBufferView _this9 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 383)							::cpp::VirtualArray array5 = ( (::cpp::VirtualArray)(vector2->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 383)							_this9->byteOffset = 0;
HXDLIN( 383)							_this9->length = array5->get_length();
HXDLIN( 383)							_this9->byteLength = (_this9->length * _this9->bytesPerElement);
HXDLIN( 383)							_this9->buffer = ::haxe::io::Bytes_obj::alloc(_this9->byteLength);
HXDLIN( 383)							_this9->copyFromArray(array5,null());
HXDLIN( 383)							this3 = _this9;
            						}
            						else {
HXLINE( 383)							if (::hx::IsNotNull( view2 )) {
HXLINE( 383)								 ::lime::utils::ArrayBufferView _this10 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 383)								 ::haxe::io::Bytes srcData2 = view2->buffer;
HXDLIN( 383)								int srcLength4 = view2->length;
HXDLIN( 383)								int srcByteOffset2 = view2->byteOffset;
HXDLIN( 383)								int srcElementSize2 = view2->bytesPerElement;
HXDLIN( 383)								int elementSize4 = _this10->bytesPerElement;
HXDLIN( 383)								if ((view2->type == _this10->type)) {
HXLINE( 383)									int srcLength5 = srcData2->length;
HXDLIN( 383)									int cloneLength2 = (srcLength5 - srcByteOffset2);
HXDLIN( 383)									_this10->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength2);
HXDLIN( 383)									_this10->buffer->blit(0,srcData2,srcByteOffset2,cloneLength2);
            								}
            								else {
HXLINE( 383)									HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            								}
HXDLIN( 383)								_this10->byteLength = (_this10->bytesPerElement * srcLength4);
HXDLIN( 383)								_this10->byteOffset = 0;
HXDLIN( 383)								_this10->length = srcLength4;
HXDLIN( 383)								this3 = _this10;
            							}
            							else {
HXLINE( 383)								if (::hx::IsNotNull( bytes )) {
HXLINE( 383)									 ::lime::utils::ArrayBufferView _this11 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 383)									int in_byteOffset2 = ( (int)(byteoffset2) );
HXDLIN( 383)									if ((in_byteOffset2 < 0)) {
HXLINE( 383)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 383)									if ((::hx::Mod(in_byteOffset2,_this11->bytesPerElement) != 0)) {
HXLINE( 383)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 383)									int bufferByteLength2 = bytes->length;
HXDLIN( 383)									int elementSize5 = _this11->bytesPerElement;
...
HXDLIN( 383)										if ((::hx::Mod(bufferByteLength2,_this11->bytesPerElement) != 0)) {
HXLINE( 383)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
...
HXLINE( 383)										newByteLength2 = (blockLength * _this11->bytesPerElement);
HXDLIN( 383)										int newRange2 = (in_byteOffset2 + newByteLength2);
HXDLIN( 383)										if ((newRange2 > bufferByteLength2)) {
HXLINE( 383)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
HXDLIN( 383)									_this11->buffer = bytes;
HXDLIN( 383)									_this11->byteOffset = in_byteOffset2;
HXDLIN( 383)									_this11->byteLength = newByteLength2;
HXDLIN( 383)									_this11->length = ::Std_obj::_hx_int((( (Float)(newByteLength2) ) / ( (Float)(_this11->bytesPerElement) )));
HXDLIN( 383)									this3 = _this11;
            								}
            								else {
...
HXLINE( 382)				::lime::graphics::_WebGLRenderContext::WebGLRenderContext_Impl__obj::compressedTexImage2D(gl3,target,level,_gthis2,width,height,0,this3);
            			}
            		}
...
HXDLIN( 391)						_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 391)						_this->copyFromArray(array,null());
HXDLIN( 391)						this1 = _this;
            					}
            					else {
HXLINE( 391)						if (::hx::IsNotNull( vector )) {
HXLINE( 391)							 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)							::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 391)							_this1->byteOffset = 0;
HXDLIN( 391)							_this1->length = array1->get_length();
HXDLIN( 391)							_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 391)							_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 391)							_this1->copyFromArray(array1,null());
HXDLIN( 391)							this1 = _this1;
            						}
            						else {
HXLINE( 391)							if (::hx::IsNotNull( view )) {
HXLINE( 391)								 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 391)								int elementSize = _this2->bytesPerElement;
HXDLIN( 391)								if ((view->type == _this2->type)) {
HXLINE( 391)									int srcLength1 = srcData->length;
HXDLIN( 391)									int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 391)									_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 391)									_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            								}
            								else {
HXLINE( 391)									HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            								}
HXDLIN( 391)								_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 391)								_this2->byteOffset = 0;
HXDLIN( 391)								_this2->length = srcLength;
HXDLIN( 391)								this1 = _this2;
            							}
            							else {
HXLINE( 391)								if (::hx::IsNotNull( buffer )) {
HXLINE( 391)									 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)									int in_byteOffset = 0;
HXDLIN( 391)									if ((in_byteOffset < 0)) {
HXLINE( 391)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 391)									if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 391)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 391)									int bufferByteLength = buffer->length;
HXDLIN( 391)									int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 391)										if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
...
HXLINE( 391)										newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 391)										int newRange = (in_byteOffset + newByteLength);
HXDLIN( 391)										if ((newRange > bufferByteLength)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
HXDLIN( 391)									_this3->buffer = buffer;
HXDLIN( 391)									_this3->byteOffset = in_byteOffset;
HXDLIN( 391)									_this3->byteLength = newByteLength;
HXDLIN( 391)									_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 391)									this1 = _this3;
            								}
            								else {
...
HXDLIN( 391)				 ::lime::utils::ArrayBufferView data1 = this1;
HXLINE( 392)				{
...
HXLINE( 391)						 ::lime::utils::ArrayBufferView _this4 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)						_this4->byteOffset = 0;
HXDLIN( 391)						_this4->length = array2->get_length();
HXDLIN( 391)						_this4->byteLength = (_this4->length * _this4->bytesPerElement);
HXDLIN( 391)						_this4->buffer = ::haxe::io::Bytes_obj::alloc(_this4->byteLength);
HXDLIN( 391)						_this4->copyFromArray(array2,null());
HXDLIN( 391)						this2 = _this4;
            					}
            					else {
HXLINE( 391)						if (::hx::IsNotNull( vector1 )) {
HXLINE( 391)							 ::lime::utils::ArrayBufferView _this5 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)							::cpp::VirtualArray array3 = ( (::cpp::VirtualArray)(vector1->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 391)							_this5->byteOffset = 0;
HXDLIN( 391)							_this5->length = array3->get_length();
HXDLIN( 391)							_this5->byteLength = (_this5->length * _this5->bytesPerElement);
HXDLIN( 391)							_this5->buffer = ::haxe::io::Bytes_obj::alloc(_this5->byteLength);
HXDLIN( 391)							_this5->copyFromArray(array3,null());
HXDLIN( 391)							this2 = _this5;
            						}
            						else {
HXLINE( 391)							if (::hx::IsNotNull( view1 )) {
HXLINE( 391)								 ::lime::utils::ArrayBufferView _this6 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)								 ::haxe::io::Bytes srcData1 = view1->buffer;
HXDLIN( 391)								int srcLength2 = view1->length;
HXDLIN( 391)								int srcByteOffset1 = view1->byteOffset;
HXDLIN( 391)								int srcElementSize1 = view1->bytesPerElement;
HXDLIN( 391)								int elementSize2 = _this6->bytesPerElement;
HXDLIN( 391)								if ((view1->type == _this6->type)) {
HXLINE( 391)									int srcLength3 = srcData1->length;
HXDLIN( 391)									int cloneLength1 = (srcLength3 - srcByteOffset1);
HXDLIN( 391)									_this6->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN( 391)									_this6->buffer->blit(0,srcData1,srcByteOffset1,cloneLength1);
            								}
            								else {
HXLINE( 391)									HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            								}
HXDLIN( 391)								_this6->byteLength = (_this6->bytesPerElement * srcLength2);
HXDLIN( 391)								_this6->byteOffset = 0;
HXDLIN( 391)								_this6->length = srcLength2;
HXDLIN( 391)								this2 = _this6;
            							}
            							else {
HXLINE( 391)								if (::hx::IsNotNull( buffer1 )) {
HXLINE( 391)									 ::lime::utils::ArrayBufferView _this7 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)									int in_byteOffset1 = 0;
HXDLIN( 391)									if ((in_byteOffset1 < 0)) {
HXLINE( 391)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 391)									if ((::hx::Mod(in_byteOffset1,_this7->bytesPerElement) != 0)) {
HXLINE( 391)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 391)									int bufferByteLength1 = buffer1->length;
HXDLIN( 391)									int elementSize3 = _this7->bytesPerElement;
HXDLIN( 391)									int newByteLength1 = bufferByteLength1;
HXDLIN( 391)									if (::hx::IsNull( len1 )) {
HXLINE( 391)										newByteLength1 = (bufferByteLength1 - in_byteOffset1);
HXDLIN( 391)										if ((::hx::Mod(bufferByteLength1,_this7->bytesPerElement) != 0)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
HXDLIN( 391)										if ((newByteLength1 < 0)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
            									else {
HXLINE( 391)										newByteLength1 = (( (int)(len1) ) * _this7->bytesPerElement);
HXDLIN( 391)										int newRange1 = (in_byteOffset1 + newByteLength1);
HXDLIN( 391)										if ((newRange1 > bufferByteLength1)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
HXDLIN( 391)									_this7->buffer = buffer1;
HXDLIN( 391)									_this7->byteOffset = in_byteOffset1;
HXDLIN( 391)									_this7->byteLength = newByteLength1;
HXDLIN( 391)									_this7->length = ::Std_obj::_hx_int((( (Float)(newByteLength1) ) / ( (Float)(_this7->bytesPerElement) )));
HXDLIN( 391)									this2 = _this7;
            								}
            								else {
HXLINE( 391)									HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            								}
...
HXDLIN( 391)				 ::lime::utils::ArrayBufferView data2 = this2;
HXLINE( 392)				{
...
HXLINE( 391)						 ::lime::utils::ArrayBufferView _this8 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)						_this8->byteOffset = 0;
HXDLIN( 391)						_this8->length = array4->get_length();
HXDLIN( 391)						_this8->byteLength = (_this8->length * _this8->bytesPerElement);
HXDLIN( 391)						_this8->buffer = ::haxe::io::Bytes_obj::alloc(_this8->byteLength);
HXDLIN( 391)						_this8->copyFromArray(array4,null());
HXDLIN( 391)						this3 = _this8;
            					}
            					else {
HXLINE( 391)						if (::hx::IsNotNull( vector2 )) {
HXLINE( 391)							 ::lime::utils::ArrayBufferView _this9 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)							::cpp::VirtualArray array5 = ( (::cpp::VirtualArray)(vector2->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 391)							_this9->byteOffset = 0;
HXDLIN( 391)							_this9->length = array5->get_length();
HXDLIN( 391)							_this9->byteLength = (_this9->length * _this9->bytesPerElement);
HXDLIN( 391)							_this9->buffer = ::haxe::io::Bytes_obj::alloc(_this9->byteLength);
HXDLIN( 391)							_this9->copyFromArray(array5,null());
HXDLIN( 391)							this3 = _this9;
            						}
            						else {
HXLINE( 391)							if (::hx::IsNotNull( view2 )) {
HXLINE( 391)								 ::lime::utils::ArrayBufferView _this10 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)								 ::haxe::io::Bytes srcData2 = view2->buffer;
HXDLIN( 391)								int srcLength4 = view2->length;
HXDLIN( 391)								int srcByteOffset2 = view2->byteOffset;
HXDLIN( 391)								int srcElementSize2 = view2->bytesPerElement;
HXDLIN( 391)								int elementSize4 = _this10->bytesPerElement;
HXDLIN( 391)								if ((view2->type == _this10->type)) {
HXLINE( 391)									int srcLength5 = srcData2->length;
HXDLIN( 391)									int cloneLength2 = (srcLength5 - srcByteOffset2);
HXDLIN( 391)									_this10->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength2);
HXDLIN( 391)									_this10->buffer->blit(0,srcData2,srcByteOffset2,cloneLength2);
            								}
            								else {
HXLINE( 391)									HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            								}
HXDLIN( 391)								_this10->byteLength = (_this10->bytesPerElement * srcLength4);
HXDLIN( 391)								_this10->byteOffset = 0;
HXDLIN( 391)								_this10->length = srcLength4;
HXDLIN( 391)								this3 = _this10;
            							}
            							else {
HXLINE( 391)								if (::hx::IsNotNull( buffer2 )) {
HXLINE( 391)									 ::lime::utils::ArrayBufferView _this11 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)									int in_byteOffset2 = 0;
HXDLIN( 391)									if ((in_byteOffset2 < 0)) {
HXLINE( 391)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 391)									if ((::hx::Mod(in_byteOffset2,_this11->bytesPerElement) != 0)) {
HXLINE( 391)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 391)									int bufferByteLength2 = buffer2->length;
HXDLIN( 391)									int elementSize5 = _this11->bytesPerElement;
HXDLIN( 391)									int newByteLength2 = bufferByteLength2;
HXDLIN( 391)									if (::hx::IsNull( len2 )) {
HXLINE( 391)										newByteLength2 = (bufferByteLength2 - in_byteOffset2);
HXDLIN( 391)										if ((::hx::Mod(bufferByteLength2,_this11->bytesPerElement) != 0)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
HXDLIN( 391)										if ((newByteLength2 < 0)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
            									else {
HXLINE( 391)										newByteLength2 = (( (int)(len2) ) * _this11->bytesPerElement);
HXDLIN( 391)										int newRange2 = (in_byteOffset2 + newByteLength2);
HXDLIN( 391)										if ((newRange2 > bufferByteLength2)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
HXDLIN( 391)									_this11->buffer = buffer2;
HXDLIN( 391)									_this11->byteOffset = in_byteOffset2;
HXDLIN( 391)									_this11->byteLength = newByteLength2;
HXDLIN( 391)									_this11->length = ::Std_obj::_hx_int((( (Float)(newByteLength2) ) / ( (Float)(_this11->bytesPerElement) )));
HXDLIN( 391)									this3 = _this11;
            								}
            								else {
HXLINE( 391)									HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            								}
...
HXDLIN( 391)				 ::lime::utils::ArrayBufferView data3 = this3;
HXLINE( 392)				{
...
HXDLIN( 391)				::cpp::VirtualArray array6 = null();
...
HXLINE( 391)					if (::hx::IsNotNull( array6 )) {
HXLINE( 391)						 ::lime::utils::ArrayBufferView _this12 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)						_this12->byteOffset = 0;
HXDLIN( 391)						_this12->length = array6->get_length();
HXDLIN( 391)						_this12->byteLength = (_this12->length * _this12->bytesPerElement);
HXDLIN( 391)						_this12->buffer = ::haxe::io::Bytes_obj::alloc(_this12->byteLength);
HXDLIN( 391)						_this12->copyFromArray(array6,null());
HXDLIN( 391)						this4 = _this12;
            					}
            					else {
HXLINE( 391)						if (::hx::IsNotNull( vector3 )) {
HXLINE( 391)							 ::lime::utils::ArrayBufferView _this13 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)							::cpp::VirtualArray array7 = ( (::cpp::VirtualArray)(vector3->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 391)							_this13->byteOffset = 0;
HXDLIN( 391)							_this13->length = array7->get_length();
HXDLIN( 391)							_this13->byteLength = (_this13->length * _this13->bytesPerElement);
HXDLIN( 391)							_this13->buffer = ::haxe::io::Bytes_obj::alloc(_this13->byteLength);
HXDLIN( 391)							_this13->copyFromArray(array7,null());
HXDLIN( 391)							this4 = _this13;
            						}
            						else {
HXLINE( 391)							if (::hx::IsNotNull( view3 )) {
HXLINE( 391)								 ::lime::utils::ArrayBufferView _this14 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)								 ::haxe::io::Bytes srcData3 = view3->buffer;
HXDLIN( 391)								int srcLength6 = view3->length;
HXDLIN( 391)								int srcByteOffset3 = view3->byteOffset;
HXDLIN( 391)								int srcElementSize3 = view3->bytesPerElement;
HXDLIN( 391)								int elementSize6 = _this14->bytesPerElement;
HXDLIN( 391)								if ((view3->type == _this14->type)) {
HXLINE( 391)									int srcLength7 = srcData3->length;
HXDLIN( 391)									int cloneLength3 = (srcLength7 - srcByteOffset3);
HXDLIN( 391)									_this14->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength3);
HXDLIN( 391)									_this14->buffer->blit(0,srcData3,srcByteOffset3,cloneLength3);
            								}
            								else {
HXLINE( 391)									HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            								}
HXDLIN( 391)								_this14->byteLength = (_this14->bytesPerElement * srcLength6);
HXDLIN( 391)								_this14->byteOffset = 0;
HXDLIN( 391)								_this14->length = srcLength6;
HXDLIN( 391)								this4 = _this14;
            							}
            							else {
HXLINE( 391)								if (::hx::IsNotNull( buffer3 )) {
HXLINE( 391)									 ::lime::utils::ArrayBufferView _this15 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)									int in_byteOffset3 = 0;
HXDLIN( 391)									if ((in_byteOffset3 < 0)) {
HXLINE( 391)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 391)									if ((::hx::Mod(in_byteOffset3,_this15->bytesPerElement) != 0)) {
HXLINE( 391)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 391)									int bufferByteLength3 = buffer3->length;
HXDLIN( 391)									int elementSize7 = _this15->bytesPerElement;
HXDLIN( 391)									int newByteLength3 = bufferByteLength3;
HXDLIN( 391)									if (::hx::IsNull( len3 )) {
HXLINE( 391)										newByteLength3 = (bufferByteLength3 - in_byteOffset3);
HXDLIN( 391)										if ((::hx::Mod(bufferByteLength3,_this15->bytesPerElement) != 0)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
HXDLIN( 391)										if ((newByteLength3 < 0)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
            									else {
HXLINE( 391)										newByteLength3 = (( (int)(len3) ) * _this15->bytesPerElement);
HXDLIN( 391)										int newRange3 = (in_byteOffset3 + newByteLength3);
HXDLIN( 391)										if ((newRange3 > bufferByteLength3)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
HXDLIN( 391)									_this15->buffer = buffer3;
HXDLIN( 391)									_this15->byteOffset = in_byteOffset3;
HXDLIN( 391)									_this15->byteLength = newByteLength3;
HXDLIN( 391)									_this15->length = ::Std_obj::_hx_int((( (Float)(newByteLength3) ) / ( (Float)(_this15->bytesPerElement) )));
HXDLIN( 391)									this4 = _this15;
            								}
            								else {
HXLINE( 391)									HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            								}
...
HXDLIN( 391)				 ::lime::utils::ArrayBufferView data4 = this4;
HXLINE( 392)				{
...
HXDLIN( 391)				::cpp::VirtualArray array8 = null();
...
HXLINE( 391)					if (::hx::IsNotNull( array8 )) {
HXLINE( 391)						 ::lime::utils::ArrayBufferView _this16 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)						_this16->byteOffset = 0;
HXDLIN( 391)						_this16->length = array8->get_length();
HXDLIN( 391)						_this16->byteLength = (_this16->length * _this16->bytesPerElement);
HXDLIN( 391)						_this16->buffer = ::haxe::io::Bytes_obj::alloc(_this16->byteLength);
HXDLIN( 391)						_this16->copyFromArray(array8,null());
HXDLIN( 391)						this5 = _this16;
            					}
            					else {
HXLINE( 391)						if (::hx::IsNotNull( vector4 )) {
HXLINE( 391)							 ::lime::utils::ArrayBufferView _this17 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)							::cpp::VirtualArray array9 = ( (::cpp::VirtualArray)(vector4->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 391)							_this17->byteOffset = 0;
HXDLIN( 391)							_this17->length = array9->get_length();
HXDLIN( 391)							_this17->byteLength = (_this17->length * _this17->bytesPerElement);
HXDLIN( 391)							_this17->buffer = ::haxe::io::Bytes_obj::alloc(_this17->byteLength);
HXDLIN( 391)							_this17->copyFromArray(array9,null());
HXDLIN( 391)							this5 = _this17;
            						}
            						else {
HXLINE( 391)							if (::hx::IsNotNull( view4 )) {
HXLINE( 391)								 ::lime::utils::ArrayBufferView _this18 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)								 ::haxe::io::Bytes srcData4 = view4->buffer;
HXDLIN( 391)								int srcLength8 = view4->length;
HXDLIN( 391)								int srcByteOffset4 = view4->byteOffset;
HXDLIN( 391)								int srcElementSize4 = view4->bytesPerElement;
HXDLIN( 391)								int elementSize8 = _this18->bytesPerElement;
HXDLIN( 391)								if ((view4->type == _this18->type)) {
HXLINE( 391)									int srcLength9 = srcData4->length;
HXDLIN( 391)									int cloneLength4 = (srcLength9 - srcByteOffset4);
HXDLIN( 391)									_this18->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength4);
HXDLIN( 391)									_this18->buffer->blit(0,srcData4,srcByteOffset4,cloneLength4);
            								}
            								else {
HXLINE( 391)									HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            								}
HXDLIN( 391)								_this18->byteLength = (_this18->bytesPerElement * srcLength8);
HXDLIN( 391)								_this18->byteOffset = 0;
HXDLIN( 391)								_this18->length = srcLength8;
HXDLIN( 391)								this5 = _this18;
            							}
            							else {
HXLINE( 391)								if (::hx::IsNotNull( buffer4 )) {
HXLINE( 391)									 ::lime::utils::ArrayBufferView _this19 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)									int in_byteOffset4 = 0;
HXDLIN( 391)									if ((in_byteOffset4 < 0)) {
HXLINE( 391)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 391)									if ((::hx::Mod(in_byteOffset4,_this19->bytesPerElement) != 0)) {
HXLINE( 391)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 391)									int bufferByteLength4 = buffer4->length;
HXDLIN( 391)									int elementSize9 = _this19->bytesPerElement;
HXDLIN( 391)									int newByteLength4 = bufferByteLength4;
HXDLIN( 391)									if (::hx::IsNull( len4 )) {
HXLINE( 391)										newByteLength4 = (bufferByteLength4 - in_byteOffset4);
HXDLIN( 391)										if ((::hx::Mod(bufferByteLength4,_this19->bytesPerElement) != 0)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
HXDLIN( 391)										if ((newByteLength4 < 0)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
            									else {
HXLINE( 391)										newByteLength4 = (( (int)(len4) ) * _this19->bytesPerElement);
HXDLIN( 391)										int newRange4 = (in_byteOffset4 + newByteLength4);
HXDLIN( 391)										if ((newRange4 > bufferByteLength4)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
HXDLIN( 391)									_this19->buffer = buffer4;
HXDLIN( 391)									_this19->byteOffset = in_byteOffset4;
HXDLIN( 391)									_this19->byteLength = newByteLength4;
HXDLIN( 391)									_this19->length = ::Std_obj::_hx_int((( (Float)(newByteLength4) ) / ( (Float)(_this19->bytesPerElement) )));
HXDLIN( 391)									this5 = _this19;
            								}
            								else {
HXLINE( 391)									HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            								}
...
HXDLIN( 391)				 ::lime::utils::ArrayBufferView data5 = this5;
HXLINE( 392)				{
...
HXDLIN( 391)				::cpp::VirtualArray array10 = null();
...
HXLINE( 391)					if (::hx::IsNotNull( array10 )) {
HXLINE( 391)						 ::lime::utils::ArrayBufferView _this20 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)						_this20->byteOffset = 0;
HXDLIN( 391)						_this20->length = array10->get_length();
HXDLIN( 391)						_this20->byteLength = (_this20->length * _this20->bytesPerElement);
HXDLIN( 391)						_this20->buffer = ::haxe::io::Bytes_obj::alloc(_this20->byteLength);
HXDLIN( 391)						_this20->copyFromArray(array10,null());
HXDLIN( 391)						this6 = _this20;
            					}
            					else {
HXLINE( 391)						if (::hx::IsNotNull( vector5 )) {
HXLINE( 391)							 ::lime::utils::ArrayBufferView _this21 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)							::cpp::VirtualArray array11 = ( (::cpp::VirtualArray)(vector5->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 391)							_this21->byteOffset = 0;
HXDLIN( 391)							_this21->length = array11->get_length();
HXDLIN( 391)							_this21->byteLength = (_this21->length * _this21->bytesPerElement);
HXDLIN( 391)							_this21->buffer = ::haxe::io::Bytes_obj::alloc(_this21->byteLength);
HXDLIN( 391)							_this21->copyFromArray(array11,null());
HXDLIN( 391)							this6 = _this21;
            						}
            						else {
HXLINE( 391)							if (::hx::IsNotNull( view5 )) {
HXLINE( 391)								 ::lime::utils::ArrayBufferView _this22 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)								 ::haxe::io::Bytes srcData5 = view5->buffer;
HXDLIN( 391)								int srcLength10 = view5->length;
HXDLIN( 391)								int srcByteOffset5 = view5->byteOffset;
HXDLIN( 391)								int srcElementSize5 = view5->bytesPerElement;
HXDLIN( 391)								int elementSize10 = _this22->bytesPerElement;
HXDLIN( 391)								if ((view5->type == _this22->type)) {
HXLINE( 391)									int srcLength11 = srcData5->length;
HXDLIN( 391)									int cloneLength5 = (srcLength11 - srcByteOffset5);
HXDLIN( 391)									_this22->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength5);
HXDLIN( 391)									_this22->buffer->blit(0,srcData5,srcByteOffset5,cloneLength5);
            								}
            								else {
HXLINE( 391)									HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            								}
HXDLIN( 391)								_this22->byteLength = (_this22->bytesPerElement * srcLength10);
HXDLIN( 391)								_this22->byteOffset = 0;
HXDLIN( 391)								_this22->length = srcLength10;
HXDLIN( 391)								this6 = _this22;
            							}
            							else {
HXLINE( 391)								if (::hx::IsNotNull( buffer5 )) {
HXLINE( 391)									 ::lime::utils::ArrayBufferView _this23 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 391)									int in_byteOffset5 = 0;
HXDLIN( 391)									if ((in_byteOffset5 < 0)) {
HXLINE( 391)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 391)									if ((::hx::Mod(in_byteOffset5,_this23->bytesPerElement) != 0)) {
HXLINE( 391)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 391)									int bufferByteLength5 = buffer5->length;
HXDLIN( 391)									int elementSize11 = _this23->bytesPerElement;
HXDLIN( 391)									int newByteLength5 = bufferByteLength5;
HXDLIN( 391)									if (::hx::IsNull( len5 )) {
HXLINE( 391)										newByteLength5 = (bufferByteLength5 - in_byteOffset5);
HXDLIN( 391)										if ((::hx::Mod(bufferByteLength5,_this23->bytesPerElement) != 0)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
HXDLIN( 391)										if ((newByteLength5 < 0)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
            									else {
HXLINE( 391)										newByteLength5 = (( (int)(len5) ) * _this23->bytesPerElement);
HXDLIN( 391)										int newRange5 = (in_byteOffset5 + newByteLength5);
HXDLIN( 391)										if ((newRange5 > bufferByteLength5)) {
HXLINE( 391)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
HXDLIN( 391)									_this23->buffer = buffer5;
HXDLIN( 391)									_this23->byteOffset = in_byteOffset5;
HXDLIN( 391)									_this23->byteLength = newByteLength5;
HXDLIN( 391)									_this23->length = ::Std_obj::_hx_int((( (Float)(newByteLength5) ) / ( (Float)(_this23->bytesPerElement) )));
HXDLIN( 391)									this6 = _this23;
            								}
            								else {
HXLINE( 391)									HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            								}
...
HXDLIN( 391)				 ::lime::utils::ArrayBufferView data6 = this6;
HXLINE( 392)				{

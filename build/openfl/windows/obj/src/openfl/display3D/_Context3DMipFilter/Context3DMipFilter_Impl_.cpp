...
HX_LOCAL_STACK_FRAME(_hx_pos_21404597055dc685_33_fromString,"openfl.display3D._Context3DMipFilter.Context3DMipFilter_Impl_","fromString",0x2c85cd41,"openfl.display3D._Context3DMipFilter.Context3DMipFilter_Impl_.fromString","openfl/display3D/Context3DMipFilter.hx",33,0xd6fc0d97)
HX_LOCAL_STACK_FRAME(_hx_pos_21404597055dc685_44_toString,"openfl.display3D._Context3DMipFilter.Context3DMipFilter_Impl_","toString",0x68a9aa92,"openfl.display3D._Context3DMipFilter.Context3DMipFilter_Impl_.toString","openfl/display3D/Context3DMipFilter.hx",44,0xd6fc0d97)
HX_LOCAL_STACK_FRAME(_hx_pos_21404597055dc685_19_boot,"openfl.display3D._Context3DMipFilter.Context3DMipFilter_Impl_","boot",0x265df318,"openfl.display3D._Context3DMipFilter.Context3DMipFilter_Impl_.boot","openfl/display3D/Context3DMipFilter.hx",19,0xd6fc0d97)
HX_LOCAL_STACK_FRAME(_hx_pos_21404597055dc685_24_boot,"openfl.display3D._Context3DMipFilter.Context3DMipFilter_Impl_","boot",0x265df318,"openfl.display3D._Context3DMipFilter.Context3DMipFilter_Impl_.boot","openfl/display3D/Context3DMipFilter.hx",24,0xd6fc0d97)
HX_LOCAL_STACK_FRAME(_hx_pos_21404597055dc685_29_boot,"openfl.display3D._Context3DMipFilter.Context3DMipFilter_Impl_","boot",0x265df318,"openfl.display3D._Context3DMipFilter.Context3DMipFilter_Impl_.boot","openfl/display3D/Context3DMipFilter.hx",29,0xd6fc0d97)
namespace openfl{
namespace display3D{
...
bool Context3DMipFilter_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Context3DMipFilter_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_21404597055dc685_33_fromString)
...
::String Context3DMipFilter_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_21404597055dc685_44_toString)
HXDLIN(  44)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  46)			return HX_("miplinear",79,ca,7e,64);
HXDLIN(  46)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  47)			return HX_("mipnearest",4a,21,95,d0);
HXDLIN(  47)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  48)			return HX_("mipnone",4c,7e,07,76);
...
{
{
            	HX_STACKFRAME(&_hx_pos_21404597055dc685_19_boot)
HXDLIN(  19)		MIPLINEAR = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_21404597055dc685_24_boot)
HXDLIN(  24)		MIPNEAREST = 1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_21404597055dc685_29_boot)
HXDLIN(  29)		MIPNONE = 2;
            	}
}

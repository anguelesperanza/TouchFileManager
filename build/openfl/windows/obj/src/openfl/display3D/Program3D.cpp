...
HXLINE( 558)								{
HXLINE( 558)									int _g2 = 0;
HXDLIN( 558)									int _g3 = uniform->regCount;
HXDLIN( 558)									while((_g2 < _g3)){
HXLINE( 558)										_g2 = (_g2 + 1);
HXDLIN( 558)										int reg = (_g2 - 1);
HXLINE( 560)										 ::openfl::display3D::Program3D _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 560)										_hx_tmp1->_hx___agalSamplerUsageMask = (_hx_tmp1->_hx___agalSamplerUsageMask | (1 << (uniform->regIndex + reg)));
            									}
            								}
            							}
            							else {
...
HXLINE( 563)									_hx_tmp2 = ::StringTools_obj::endsWith(uniform->name,HX_("_alpha",9f,ee,7d,1d));
            								}
            								else {
...
HXLINE( 569)										_hx_tmp3 = ::StringTools_obj::endsWith(uniform->name,HX_("_alphaEnabled",a2,df,12,f4));
            									}
            									else {
...
HXLINE( 672)			{
HXLINE( 672)				 ::haxe::ds::_List::ListNode _g_head1 = this->_hx___agalAlphaSamplerUniforms->h;
HXDLIN( 672)				while(::hx::IsNotNull( _g_head1 )){
HXLINE( 672)					 ::openfl::display3D::Uniform val1 = ( ( ::openfl::display3D::Uniform)(_g_head1->item) );
HXDLIN( 672)					_g_head1 = _g_head1->next;
HXDLIN( 672)					 ::openfl::display3D::Uniform sampler1 = val1;
HXLINE( 674)					if ((sampler1->regCount == 1)) {
HXLINE( 676)						gl->uniform1i(sampler1->location,sampler1->regIndex);
            					}
            					else {
...
HXLINE( 878)			::String message1 = HX_("Error compiling fragment shader",4d,d0,be,e3);
HXLINE( 879)			message1 = (message1 + (HX_("\n",0a,00,00,00) + gl->getShaderInfoLog(this->_hx___glFragmentShader)));
HXLINE( 880)			message1 = (message1 + (HX_("\n",0a,00,00,00) + fragmentShaderSource));
HXLINE( 881)			::lime::utils::Log_obj::error(message1,::hx::SourceInfo(HX_("openfl/display3D/Program3D.hx",04,5b,98,0a),881,HX_("openfl.display3D.Program3D",7c,83,68,f5),HX_("__uploadFromGLSL",a9,36,31,0d)));
            		}
...
HXLINE( 904)			int _g1 = 0;
HXDLIN( 904)			::Array< ::String > _g2 = this->_hx___glslAttribNames;
HXDLIN( 904)			while((_g1 < _g2->length)){
HXLINE( 904)				::String name1 = _g2->__get(_g1);
HXDLIN( 904)				_g1 = (_g1 + 1);
HXLINE( 906)				bool _hx_tmp;
HXDLIN( 906)				if ((name1.indexOf(HX_("Position",c9,5c,ac,a4),null()) > -1)) {
HXLINE( 906)					_hx_tmp = ::StringTools_obj::startsWith(name1,HX_("openfl_",cf,ba,42,40));
            				}
            				else {
HXLINE( 906)					_hx_tmp = false;
            				}
HXDLIN( 906)				if (_hx_tmp) {
HXLINE( 908)					gl->bindAttribLocation(this->_hx___glProgram,0,name1);
...
HXLINE( 920)			::String message2 = HX_("Unable to initialize the shader program",f0,86,8b,39);
HXLINE( 921)			message2 = (message2 + (HX_("\n",0a,00,00,00) + gl->getProgramInfoLog(this->_hx___glProgram)));
HXLINE( 922)			::lime::utils::Log_obj::error(message2,::hx::SourceInfo(HX_("openfl/display3D/Program3D.hx",04,5b,98,0a),922,HX_("openfl.display3D.Program3D",7c,83,68,f5),HX_("__uploadFromGLSL",a9,36,31,0d)));
            		}
            	}

...
HX_LOCAL_STACK_FRAME(_hx_pos_f34d0745d06fd2f8_28_fromString,"openfl.display3D._Context3DProgramType.Context3DProgramType_Impl_","fromString",0x5dd12501,"openfl.display3D._Context3DProgramType.Context3DProgramType_Impl_.fromString","openfl/display3D/Context3DProgramType.hx",28,0xd8b3bd25)
HX_LOCAL_STACK_FRAME(_hx_pos_f34d0745d06fd2f8_38_toString,"openfl.display3D._Context3DProgramType.Context3DProgramType_Impl_","toString",0xfbdb9252,"openfl.display3D._Context3DProgramType.Context3DProgramType_Impl_.toString","openfl/display3D/Context3DProgramType.hx",38,0xd8b3bd25)
HX_LOCAL_STACK_FRAME(_hx_pos_f34d0745d06fd2f8_19_boot,"openfl.display3D._Context3DProgramType.Context3DProgramType_Impl_","boot",0x8910fad8,"openfl.display3D._Context3DProgramType.Context3DProgramType_Impl_.boot","openfl/display3D/Context3DProgramType.hx",19,0xd8b3bd25)
HX_LOCAL_STACK_FRAME(_hx_pos_f34d0745d06fd2f8_24_boot,"openfl.display3D._Context3DProgramType.Context3DProgramType_Impl_","boot",0x8910fad8,"openfl.display3D._Context3DProgramType.Context3DProgramType_Impl_.boot","openfl/display3D/Context3DProgramType.hx",24,0xd8b3bd25)
namespace openfl{
namespace display3D{
...
bool Context3DProgramType_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Context3DProgramType_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_f34d0745d06fd2f8_28_fromString)
...
::String Context3DProgramType_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_f34d0745d06fd2f8_38_toString)
HXDLIN(  38)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  40)			return HX_("fragment",d0,5f,e5,ad);
HXDLIN(  40)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  41)			return HX_("vertex",64,db,47,a1);
...
{
{
            	HX_STACKFRAME(&_hx_pos_f34d0745d06fd2f8_19_boot)
HXDLIN(  19)		FRAGMENT = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_f34d0745d06fd2f8_24_boot)
HXDLIN(  24)		VERTEX = 1;
            	}
}

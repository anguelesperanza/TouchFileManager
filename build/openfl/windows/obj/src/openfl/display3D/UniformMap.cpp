...
HXLINE(1059)				 ::openfl::display3D::Uniform uniform1 = _g3->__get(_g2).StaticCast<  ::openfl::display3D::Uniform >();
HXDLIN(1059)				_g2 = (_g2 + 1);
HXLINE(1061)				{
HXLINE(1061)					int _g4 = 0;
HXDLIN(1061)					int _g5 = uniform1->regCount;
HXDLIN(1061)					while((_g4 < _g5)){
HXLINE(1061)						_g4 = (_g4 + 1);
HXDLIN(1061)						int i = (_g4 - 1);
HXLINE(1063)						this->_hx___registerLookup->set((uniform1->regIndex + i),uniform1).StaticCast<  ::openfl::display3D::Uniform >();
            					}
            				}
            			}
            		}

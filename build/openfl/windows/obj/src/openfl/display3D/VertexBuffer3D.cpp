...
HXDLIN( 113)				_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 113)				_this->copyFromArray(array,null());
HXDLIN( 113)				this1 = _this;
            			}
            			else {
HXLINE( 113)				if (::hx::IsNotNull( vector )) {
HXLINE( 113)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 113)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 113)					_this1->byteOffset = 0;
HXDLIN( 113)					_this1->length = array1->get_length();
HXDLIN( 113)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 113)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 113)					_this1->copyFromArray(array1,null());
HXDLIN( 113)					this1 = _this1;
            				}
            				else {
HXLINE( 113)					if (::hx::IsNotNull( view )) {
HXLINE( 113)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 113)						int elementSize = _this2->bytesPerElement;
HXDLIN( 113)						if ((view->type == _this2->type)) {
HXLINE( 113)							int srcLength1 = srcData->length;
HXDLIN( 113)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 113)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 113)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 113)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 113)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 113)						_this2->byteOffset = 0;
HXDLIN( 113)						_this2->length = srcLength;
HXDLIN( 113)						this1 = _this2;
            					}
            					else {
HXLINE( 113)						if (::hx::IsNotNull( buffer )) {
HXLINE( 113)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 113)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 113)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 113)							int bufferByteLength = buffer->length;
HXDLIN( 113)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 113)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 113)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 113)								newByteLength = (length * _this3->bytesPerElement);
HXDLIN( 113)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 113)								if ((newRange > bufferByteLength)) {
HXLINE( 113)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 113)							_this3->buffer = buffer;
HXDLIN( 113)							_this3->byteOffset = in_byteOffset;
HXDLIN( 113)							_this3->byteLength = newByteLength;
HXDLIN( 113)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 113)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 168)					_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 168)					_this->copyFromArray(array,null());
HXDLIN( 168)					this1 = _this;
            				}
            				else {
HXLINE( 168)					if (::hx::IsNotNull( vector )) {
HXLINE( 168)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 168)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 168)						_this1->byteOffset = 0;
HXDLIN( 168)						_this1->length = array1->get_length();
HXDLIN( 168)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 168)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 168)						_this1->copyFromArray(array1,null());
HXDLIN( 168)						this1 = _this1;
            					}
            					else {
HXLINE( 168)						if (::hx::IsNotNull( view )) {
HXLINE( 168)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 168)							int elementSize = _this2->bytesPerElement;
HXDLIN( 168)							if ((view->type == _this2->type)) {
HXLINE( 168)								int srcLength1 = srcData->length;
HXDLIN( 168)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 168)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 168)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE( 168)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN( 168)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 168)							_this2->byteOffset = 0;
HXDLIN( 168)							_this2->length = srcLength;
HXDLIN( 168)							this1 = _this2;
            						}
            						else {
HXLINE( 168)							if (::hx::IsNotNull( buffer )) {
HXLINE( 168)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 168)								int in_byteOffset = 0;
HXDLIN( 168)								if ((in_byteOffset < 0)) {
HXLINE( 168)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 168)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 168)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 168)								int bufferByteLength = buffer->length;
HXDLIN( 168)								int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 168)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 168)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXLINE( 168)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 168)									int newRange = (in_byteOffset + newByteLength);
HXDLIN( 168)									if ((newRange > bufferByteLength)) {
HXLINE( 168)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN( 168)								_this3->buffer = buffer;
HXDLIN( 168)								_this3->byteOffset = in_byteOffset;
HXDLIN( 168)								_this3->byteLength = newByteLength;
HXDLIN( 168)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 168)								this1 = _this3;
            							}
            							else {
...
HXLINE( 172)				 ::lime::utils::ArrayBufferView _this4 = this->_hx___tempFloat32Array;
HXDLIN( 172)				::cpp::VirtualArray array2 = null();
HXDLIN( 172)				int offset = 0;
HXDLIN( 172)				bool _hx_tmp1;
HXDLIN( 172)				if (::hx::IsNotNull( existingFloat32Array )) {
HXLINE( 172)					_hx_tmp1 = ::hx::IsNull( array2 );
            				}
            				else {
HXLINE( 172)					_hx_tmp1 = false;
            				}
HXDLIN( 172)				if (_hx_tmp1) {
HXLINE( 172)					_this4->buffer->blit((offset * _this4->bytesPerElement),existingFloat32Array->buffer,existingFloat32Array->byteOffset,existingFloat32Array->byteLength);
            				}
            				else {
HXLINE( 172)					bool _hx_tmp2;
HXDLIN( 172)					if (::hx::IsNotNull( array2 )) {
HXLINE( 172)						_hx_tmp2 = ::hx::IsNull( existingFloat32Array );
            					}
            					else {
HXLINE( 172)						_hx_tmp2 = false;
            					}
HXDLIN( 172)					if (_hx_tmp2) {
HXLINE( 172)						_this4->copyFromArray(array2,offset);
            					}
            					else {

...
HXLINE( 481)			int a1 = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(bytes);
HXDLIN( 481)			bool aNeg1 = (a1 < 0);
HXDLIN( 481)			bool bNeg1 = (bytesLength < 0);
HXDLIN( 481)			if ((aNeg1 != bNeg1)) {
HXLINE( 481)				_hx_tmp1 = aNeg1;
            			}
            			else {
HXLINE( 481)				_hx_tmp1 = (a1 > bytesLength);
            			}
            		}
            		else {
...
HXLINE( 483)			 ::openfl::utils::ByteArrayData copy =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,bytesLength);
HXLINE( 484)			copy->writeBytes(bytes,bytes->position,bytesLength);
HXLINE( 485)			bytes = copy;
            		}
HXLINE( 489)		this->_hx___buffer = ::lime::media::AudioBuffer_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(bytes));
...
HXLINE( 580)			int a1 = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(bytes);
HXDLIN( 580)			bool aNeg1 = (a1 < 0);
HXDLIN( 580)			bool bNeg1 = (bytesLength < 0);
HXDLIN( 580)			if ((aNeg1 != bNeg1)) {
HXLINE( 580)				_hx_tmp = aNeg1;
            			}
            			else {
HXLINE( 580)				_hx_tmp = (a1 > bytesLength);
            			}
            		}
            		else {
...
HXLINE( 582)			 ::openfl::utils::ByteArrayData copy =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,bytesLength);
...
HXLINE( 591)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXLINE( 591)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXLINE( 591)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXLINE( 591)							HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            						}
            					}
            				}
            			}
...
HXLINE( 682)					::cpp::Int64 x = this->_hx___buffer->_hx___srcVorbisFile->pcmTotal(null());
HXDLIN( 682)					int _hx_tmp = _hx_int64_high(x);
HXDLIN( 682)					if ((_hx_tmp != (_hx_int64_low(x) >> 31))) {
HXLINE( 682)						HX_STACK_DO_THROW(HX_("Overflow",62,9f,ed,1a));
            					}
HXDLIN( 682)					int samples1 = _hx_int64_low(x);
HXLINE( 683)					return ::Std_obj::_hx_int(((( (Float)(samples1) ) / ( (Float)(this->_hx___buffer->sampleRate) )) * ( (Float)(1000) )));
            				}
            				else {
HXLINE( 687)					return 0;
            				}

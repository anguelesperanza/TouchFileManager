...
HX_LOCAL_STACK_FRAME(_hx_pos_1cbb708783dfd99e_463_get_numTiles,"openfl.display.Tilemap","get_numTiles",0x9e4ec312,"openfl.display.Tilemap.get_numTiles","openfl/display/Tilemap.hx",463,0xd55dffbc)
HX_LOCAL_STACK_FRAME(_hx_pos_1cbb708783dfd99e_468_get_tileset,"openfl.display.Tilemap","get_tileset",0x4d66c6e1,"openfl.display.Tilemap.get_tileset","openfl/display/Tilemap.hx",468,0xd55dffbc)
HX_LOCAL_STACK_FRAME(_hx_pos_1cbb708783dfd99e_472_set_tileset,"openfl.display.Tilemap","set_tileset",0x57d3cded,"openfl.display.Tilemap.set_tileset","openfl/display/Tilemap.hx",472,0xd55dffbc)
HX_LOCAL_STACK_FRAME(_hx_pos_1cbb708783dfd99e_490_get_width,"openfl.display.Tilemap","get_width",0x1d9f4673,"openfl.display.Tilemap.get_width","openfl/display/Tilemap.hx",490,0xd55dffbc)
HX_LOCAL_STACK_FRAME(_hx_pos_1cbb708783dfd99e_496_set_width,"openfl.display.Tilemap","set_width",0x00f0327f,"openfl.display.Tilemap.set_width","openfl/display/Tilemap.hx",496,0xd55dffbc)
namespace openfl{
namespace display{
...
HXLINE( 325)				 ::openfl::display::Tile tile1 = _g3->__get(_g2).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 325)				_g2 = (_g2 + 1);
HXLINE( 327)				this->addTile(tile1);
            			}
            		}
            	}
...
HXLINE( 415)			bool _hx_tmp5;
HXDLIN( 415)			if (::hx::IsNotNull( stack )) {
HXLINE( 415)				_hx_tmp5 = !(interactiveOnly);
            			}
            			else {
...
int Tilemap_obj::get_numTiles(){
            	HX_STACKFRAME(&_hx_pos_1cbb708783dfd99e_463_get_numTiles)
HXDLIN( 463)		return this->_hx___group->__length;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Tilemap_obj,get_numTiles,return )
 ...
 ::openfl::display::Tileset Tilemap_obj::get_tileset(){
            	HX_STACKFRAME(&_hx_pos_1cbb708783dfd99e_468_get_tileset)
HXDLIN( 468)		return this->_hx___tileset;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Tilemap_obj,get_tileset,return )
 ...
 ::openfl::display::Tileset Tilemap_obj::set_tileset( ::openfl::display::Tileset value){
            	HX_STACKFRAME(&_hx_pos_1cbb708783dfd99e_472_set_tileset)
HXLINE( 473)		if (::hx::IsInstanceNotEq( value,this->_hx___tileset )) {
HXLINE( 475)			this->_hx___tileset = value;
HXLINE( 476)			this->_hx___group->set_tileset(value);
HXLINE( 477)			this->_hx___group->_hx___dirty = true;
HXLINE( 480)			if (!(this->_hx___renderDirty)) {
HXLINE( 480)				this->_hx___renderDirty = true;
HXDLIN( 480)				this->_hx___setParentRenderDirty();
            			}
            		}
...
Float Tilemap_obj::get_width(){
            	HX_STACKFRAME(&_hx_pos_1cbb708783dfd99e_490_get_width)
HXDLIN( 490)		return (( (Float)(this->_hx___width) ) * ::Math_obj::abs(this->_hx___scaleX));
            	}


Float Tilemap_obj::set_width(Float value){
            	HX_STACKFRAME(&_hx_pos_1cbb708783dfd99e_496_set_width)
HXLINE( 497)		this->_hx___width = ::Std_obj::_hx_int(value);
HXLINE( 498)		return (( (Float)(this->_hx___width) ) * ::Math_obj::abs(this->_hx___scaleX));
            	}

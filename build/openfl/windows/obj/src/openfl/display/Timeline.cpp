...
HXDLIN( 147)					_g = (_g + 1);
HXLINE( 149)					 ::openfl::display::Timeline _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 149)					_hx_tmp1->_hx___totalFrames = (_hx_tmp1->_hx___totalFrames + scene->numFrames);
HXLINE( 150)					 ::openfl::display::Timeline _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 150)					_hx_tmp2->_hx___framesLoaded = (_hx_tmp2->_hx___framesLoaded + scene->numFrames);
...
HXLINE( 161)			_hx_tmp3 = (this->scripts->length > 0);
            		}
            		else {
...
HXDLIN( 164)				::Array< ::Dynamic> _g3 = this->scripts;
HXDLIN( 164)				while((_g2 < _g3->length)){
HXLINE( 164)					 ::openfl::display::FrameScript script = _g3->__get(_g2).StaticCast<  ::openfl::display::FrameScript >();

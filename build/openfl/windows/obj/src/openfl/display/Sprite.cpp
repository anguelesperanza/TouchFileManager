...
HXDLIN( 316)			bool _hx_tmp5;
HXDLIN( 316)			if (::hx::IsNull( this->hitArea )) {
HXLINE( 316)				_hx_tmp5 = ::hx::IsNotNull( this->_hx___graphics );
            			}
            			else {
HXLINE( 316)				_hx_tmp5 = false;
            			}
HXDLIN( 316)			if (_hx_tmp5) {
HXLINE( 316)				 ::openfl::display::Graphics _hx_tmp6 = this->_hx___graphics;
HXDLIN( 316)				_hx_tmp4 = _hx_tmp6->_hx___hitTest(x,y,shapeFlag,this->_hx___getRenderTransform());
            			}
            			else {
HXLINE( 316)				_hx_tmp4 = false;
            			}
HXDLIN( 316)			if (_hx_tmp4) {
HXLINE( 318)				bool _hx_tmp7;
HXDLIN( 318)				if (::hx::IsNotNull( stack )) {
HXLINE( 318)					if (interactiveOnly) {
HXLINE( 318)						_hx_tmp7 = this->mouseEnabled;
            					}
            					else {
HXLINE( 318)						_hx_tmp7 = true;
            					}
            				}
            				else {
HXLINE( 318)					_hx_tmp7 = false;
            				}
HXDLIN( 318)				if (_hx_tmp7) {

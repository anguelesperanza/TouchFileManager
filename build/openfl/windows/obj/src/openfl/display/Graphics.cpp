...
HXLINE( 309)					ratios->push(::Math_obj::ceil(((( (Float)(i1) ) / ( (Float)((colors->length - 1)) )) * ( (Float)(255) ))));
            				}
            			}
            		}
...
HXLINE( 557)			Float iT1 = (( (Float)(1) ) - ty);
HXDLIN( 557)			iy = ((((iT1 * iT1) * this->_hx___positionY) + (((( (Float)(2) ) * iT1) * ty) * controlY)) + ((ty * ty) * anchorY));
            		}
...
HXLINE( 769)						dataIndex = (dataIndex + 2);
            					...
            					break;
            					case (int)2: {
HXLINE( 772)						Float _hx_tmp1 = data->get(dataIndex);
HXDLIN( 772)						this->lineTo(_hx_tmp1,data->get((dataIndex + 1)));
HXLINE( 773)						dataIndex = (dataIndex + 2);
            					}
            					break;
            					case (int)3: {
HXLINE( 786)						Float _hx_tmp2 = data->get(dataIndex);
HXDLIN( 786)						Float _hx_tmp3 = data->get((dataIndex + 1));
HXDLIN( 786)						Float _hx_tmp4 = data->get((dataIndex + 2));
HXDLIN( 786)						this->curveTo(_hx_tmp2,_hx_tmp3,_hx_tmp4,data->get((dataIndex + 3)));
HXLINE( 787)						dataIndex = (dataIndex + 4);
            					}
            					break;
            					case (int)4: {
HXLINE( 776)						Float _hx_tmp5 = data->get((dataIndex + 2));
HXDLIN( 776)						this->moveTo(_hx_tmp5,data->get((dataIndex + 3)));
HXLINE( 777)						goto _hx_goto_18;
            					}
            					break;
            					case (int)5: {
HXLINE( 781)						Float _hx_tmp6 = data->get((dataIndex + 2));
HXDLIN( 781)						this->lineTo(_hx_tmp6,data->get((dataIndex + 3)));
HXLINE( 782)						goto _hx_goto_18;
            					}
            					break;
            					case (int)6: {
HXLINE( 790)						Float _hx_tmp7 = data->get(dataIndex);
HXDLIN( 790)						Float _hx_tmp8 = data->get((dataIndex + 1));
HXDLIN( 790)						Float _hx_tmp9 = data->get((dataIndex + 2));
HXDLIN( 790)						Float _hx_tmp10 = data->get((dataIndex + 3));
HXDLIN( 790)						Float _hx_tmp11 = data->get((dataIndex + 4));
HXDLIN( 790)						this->cubicCurveTo(_hx_tmp7,_hx_tmp8,_hx_tmp9,_hx_tmp10,_hx_tmp11,data->get((dataIndex + 5)));
...
HXLINE( 880)					ti = (i * 6);
HXLINE( 881)					Float _hx_tmp3 = transforms->get(ti);
HXDLIN( 881)					Float _hx_tmp4 = transforms->get((ti + 1));
HXDLIN( 881)					Float _hx_tmp5 = transforms->get((ti + 2));
HXDLIN( 881)					Float _hx_tmp6 = transforms->get((ti + 3));
HXDLIN( 881)					Float _hx_tmp7 = transforms->get((ti + 4));
HXDLIN( 881)					tileTransform->setTo(_hx_tmp3,_hx_tmp4,_hx_tmp5,_hx_tmp6,_hx_tmp7,transforms->get((ti + 5)));
            				}
            				else {
HXLINE( 883)					if (transformABCD) {
HXLINE( 885)						ti = (i * 4);
HXLINE( 886)						Float _hx_tmp8 = transforms->get(ti);
HXDLIN( 886)						Float _hx_tmp9 = transforms->get((ti + 1));
HXDLIN( 886)						Float _hx_tmp10 = transforms->get((ti + 2));
HXDLIN( 886)						tileTransform->setTo(_hx_tmp8,_hx_tmp9,_hx_tmp10,transforms->get((ti + 3)),tileRect->x,tileRect->y);
            					}
            					else {
...
HXLINE(1096)		{
HXLINE(1096)			int _g2 = 0;
HXDLIN(1096)			int _g3 = vertLength;
HXDLIN(1096)			while((_g2 < _g3)){
HXLINE(1096)				_g2 = (_g2 + 1);
HXDLIN(1096)				int i1 = (_g2 - 1);
HXLINE(1098)				x = vertices->get((i1 * 2));
HXLINE(1099)				y = vertices->get(((i1 * 2) + 1));
...
HXLINE(1256)			{
HXLINE(1256)				int _g2 = 0;
HXDLIN(1256)				int _g3 = colors->length;
HXDLIN(1256)				while((_g2 < _g3)){
HXLINE(1256)					_g2 = (_g2 + 1);
HXDLIN(1256)					int i1 = (_g2 - 1);
HXLINE(1258)					ratios->push(::Math_obj::ceil(((( (Float)(i1) ) / ( (Float)((colors->length - 1)) )) * ( (Float)(255) ))));
            				}
            			}
            		}
...
HXLINE(1662)			bool _hx_tmp3;
HXDLIN(1662)			if ((p3 < p4)) {
HXLINE(1662)				_hx_tmp3 = (p3 > p1);
            			}
            			else {
HXLINE(1662)				_hx_tmp3 = false;
            			}
HXDLIN(1662)			if (!(_hx_tmp3)) {
...
HXLINE(1674)				bool _hx_tmp4;
HXDLIN(1674)				if ((t > 0)) {
HXLINE(1674)					_hx_tmp4 = (t < 1);
            				}
            				else {
HXLINE(1674)					_hx_tmp4 = false;
            				}
HXDLIN(1674)				if (_hx_tmp4) {
...
HXLINE(1683)					bool _hx_tmp5;
HXDLIN(1683)					if ((t1 > 0)) {
HXLINE(1683)						_hx_tmp5 = (t1 < 1);
            					}
            					else {
HXLINE(1683)						_hx_tmp5 = false;
            					}
HXDLIN(1683)					if (_hx_tmp5) {
HXLINE(1685)						Float iT1 = (( (Float)(1) ) - t1);
HXDLIN(1685)						solutions->push(((((p1 * ((iT1 * iT1) * iT1)) + (((( (Float)(3) ) * p2) * t1) * (iT1 * iT1))) + (((( (Float)(3) ) * p3) * iT1) * (t1 * t1))) + (p4 * ((t1 * t1) * t1))));
            					}
HXLINE(1687)					bool _hx_tmp6;
HXDLIN(1687)					if ((t2 > 0)) {
HXLINE(1687)						_hx_tmp6 = (t2 < 1);
            					}
            					else {
HXLINE(1687)						_hx_tmp6 = false;
            					}
HXDLIN(1687)					if (_hx_tmp6) {
HXLINE(1689)						Float iT2 = (( (Float)(1) ) - t2);
HXDLIN(1689)						solutions->push(((((p1 * ((iT2 * iT2) * iT2)) + (((( (Float)(3) ) * p2) * t2) * (iT2 * iT2))) + (((( (Float)(3) ) * p3) * iT2) * (t2 * t2))) + (p4 * ((t2 * t2) * t2))));
            					}
            				}
            			}
            		}
...
HXLINE(1728)			 ::openfl::geom::Rectangle fh1 = this->_hx___bounds;
HXDLIN(1728)			fh1->height = (fh1->height + (this->_hx___bounds->y - y));
...
HXDLIN(1829)								data2->bPos = (data2->bPos + 2);
            							...
            							break;
            							case (int)1: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1829)								data3->iPos = (data3->iPos + 1);
HXDLIN(1829)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1829)								data4->fPos = (data4->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data5 = data;
HXDLIN(1829)								data5->oPos = (data5->oPos + 4);
HXDLIN(1829)								 ::openfl::display::_internal::DrawCommandReader data6 = data;
HXDLIN(1829)								data6->iiPos = (data6->iiPos + 2);
HXDLIN(1829)								 ::openfl::display::_internal::DrawCommandReader data7 = data;
HXDLIN(1829)								data7->ffPos = (data7->ffPos + 1);
HXDLIN(1829)								 ::openfl::display::_internal::DrawCommandReader data8 = data;
HXDLIN(1829)								data8->fPos = (data8->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data9 = data;
HXDLIN(1829)								data9->oPos = (data9->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data10 = data;
HXDLIN(1829)								data10->fPos = (data10->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data11 = data;
HXDLIN(1829)								data11->fPos = (data11->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data12 = data;
HXDLIN(1829)								data12->fPos = (data12->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data13 = data;
HXDLIN(1829)								data13->fPos = (data13->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data14 = data;
HXDLIN(1829)								data14->oPos = (data14->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data15 = data;
HXDLIN(1829)								data15->fPos = (data15->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data16 = data;
HXDLIN(1829)								data16->fPos = (data16->fPos + 5);
HXDLIN(1829)								 ::openfl::display::_internal::DrawCommandReader data17 = data;
HXDLIN(1829)								data17->oPos = (data17->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data18 = data;
HXDLIN(1829)								data18->oPos = (data18->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data19 = data;
HXDLIN(1829)								data19->oPos = (data19->oPos + 2);
HXDLIN(1829)								 ::openfl::display::_internal::DrawCommandReader data20 = data;
HXDLIN(1829)								data20->bPos = (data20->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data21 = data;
HXDLIN(1829)								data21->oPos = (data21->oPos + 4);
HXDLIN(1829)								 ::openfl::display::_internal::DrawCommandReader data22 = data;
HXDLIN(1829)								data22->iiPos = (data22->iiPos + 2);
HXDLIN(1829)								 ::openfl::display::_internal::DrawCommandReader data23 = data;
HXDLIN(1829)								data23->ffPos = (data23->ffPos + 1);
HXDLIN(1829)								 ::openfl::display::_internal::DrawCommandReader data24 = data;
HXDLIN(1829)								data24->fPos = (data24->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data25 = data;
HXDLIN(1829)								data25->oPos = (data25->oPos + 4);
HXDLIN(1829)								 ::openfl::display::_internal::DrawCommandReader data26 = data;
HXDLIN(1829)								data26->iPos = (data26->iPos + 1);
HXDLIN(1829)								 ::openfl::display::_internal::DrawCommandReader data27 = data;
HXDLIN(1829)								data27->fPos = (data27->fPos + 2);
HXDLIN(1829)								 ::openfl::display::_internal::DrawCommandReader data28 = data;
HXDLIN(1829)								data28->bPos = (data28->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data29 = data;
HXDLIN(1829)								data29->fPos = (data29->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data30 = data;
HXDLIN(1829)								data30->fPos = (data30->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data31 = data;
HXDLIN(1829)								data31->oPos = (data31->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1829)								 ::openfl::display::_internal::DrawCommandReader data32 = data;
HXDLIN(1829)								data32->oPos = (data32->oPos + 1);
            							}
            							break;
...
HXDLIN(1829)						 ::openfl::display::_internal::DrawCommandReader c = data;
...
HXLINE(1833)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data33 = data;
HXDLIN(1833)								data33->oPos = (data33->oPos + 2);
HXDLIN(1833)								 ::openfl::display::_internal::DrawCommandReader data34 = data;
HXDLIN(1833)								data34->bPos = (data34->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data35 = data;
HXDLIN(1833)								data35->iPos = (data35->iPos + 1);
HXDLIN(1833)								 ::openfl::display::_internal::DrawCommandReader data36 = data;
HXDLIN(1833)								data36->fPos = (data36->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data37 = data;
HXDLIN(1833)								data37->oPos = (data37->oPos + 4);
HXDLIN(1833)								 ::openfl::display::_internal::DrawCommandReader data38 = data;
HXDLIN(1833)								data38->iiPos = (data38->iiPos + 2);
HXDLIN(1833)								 ::openfl::display::_internal::DrawCommandReader data39 = data;
HXDLIN(1833)								data39->ffPos = (data39->ffPos + 1);
HXDLIN(1833)								 ::openfl::display::_internal::DrawCommandReader data40 = data;
HXDLIN(1833)								data40->fPos = (data40->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data41 = data;
HXDLIN(1833)								data41->oPos = (data41->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data42 = data;
HXDLIN(1833)								data42->fPos = (data42->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data43 = data;
HXDLIN(1833)								data43->fPos = (data43->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data44 = data;
HXDLIN(1833)								data44->fPos = (data44->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data45 = data;
HXDLIN(1833)								data45->fPos = (data45->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data46 = data;
HXDLIN(1833)								data46->oPos = (data46->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data47 = data;
HXDLIN(1833)								data47->fPos = (data47->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data48 = data;
HXDLIN(1833)								data48->fPos = (data48->fPos + 5);
HXDLIN(1833)								 ::openfl::display::_internal::DrawCommandReader data49 = data;
HXDLIN(1833)								data49->oPos = (data49->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data50 = data;
HXDLIN(1833)								data50->oPos = (data50->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data51 = data;
HXDLIN(1833)								data51->oPos = (data51->oPos + 2);
HXDLIN(1833)								 ::openfl::display::_internal::DrawCommandReader data52 = data;
HXDLIN(1833)								data52->bPos = (data52->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data53 = data;
HXDLIN(1833)								data53->oPos = (data53->oPos + 4);
HXDLIN(1833)								 ::openfl::display::_internal::DrawCommandReader data54 = data;
HXDLIN(1833)								data54->iiPos = (data54->iiPos + 2);
HXDLIN(1833)								 ::openfl::display::_internal::DrawCommandReader data55 = data;
HXDLIN(1833)								data55->ffPos = (data55->ffPos + 1);
HXDLIN(1833)								 ::openfl::display::_internal::DrawCommandReader data56 = data;
HXDLIN(1833)								data56->fPos = (data56->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data57 = data;
HXDLIN(1833)								data57->oPos = (data57->oPos + 4);
HXDLIN(1833)								 ::openfl::display::_internal::DrawCommandReader data58 = data;
HXDLIN(1833)								data58->iPos = (data58->iPos + 1);
HXDLIN(1833)								 ::openfl::display::_internal::DrawCommandReader data59 = data;
HXDLIN(1833)								data59->fPos = (data59->fPos + 2);
HXDLIN(1833)								 ::openfl::display::_internal::DrawCommandReader data60 = data;
HXDLIN(1833)								data60->bPos = (data60->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data61 = data;
HXDLIN(1833)								data61->fPos = (data61->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data62 = data;
HXDLIN(1833)								data62->fPos = (data62->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data63 = data;
HXDLIN(1833)								data63->oPos = (data63->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1833)								 ::openfl::display::_internal::DrawCommandReader data64 = data;
HXDLIN(1833)								data64->oPos = (data64->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXDLIN(1833)						 ::openfl::display::_internal::DrawCommandReader c1 = data;
HXLINE(1834)						graphicsData->push( ::openfl::display::GraphicsSolidFill_obj::__alloc( HX_CTX ,c1->buffer->i->__get(c1->iPos),1));
            					}
            					break;
            					case (int)2: {
HXLINE(1837)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data65 = data;
HXDLIN(1837)								data65->oPos = (data65->oPos + 2);
HXDLIN(1837)								 ::openfl::display::_internal::DrawCommandReader data66 = data;
HXDLIN(1837)								data66->bPos = (data66->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data67 = data;
HXDLIN(1837)								data67->iPos = (data67->iPos + 1);
HXDLIN(1837)								 ::openfl::display::_internal::DrawCommandReader data68 = data;
HXDLIN(1837)								data68->fPos = (data68->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data69 = data;
HXDLIN(1837)								data69->oPos = (data69->oPos + 4);
HXDLIN(1837)								 ::openfl::display::_internal::DrawCommandReader data70 = data;
HXDLIN(1837)								data70->iiPos = (data70->iiPos + 2);
HXDLIN(1837)								 ::openfl::display::_internal::DrawCommandReader data71 = data;
HXDLIN(1837)								data71->ffPos = (data71->ffPos + 1);
HXDLIN(1837)								 ::openfl::display::_internal::DrawCommandReader data72 = data;
HXDLIN(1837)								data72->fPos = (data72->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data73 = data;
HXDLIN(1837)								data73->oPos = (data73->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data74 = data;
HXDLIN(1837)								data74->fPos = (data74->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data75 = data;
HXDLIN(1837)								data75->fPos = (data75->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data76 = data;
HXDLIN(1837)								data76->fPos = (data76->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data77 = data;
HXDLIN(1837)								data77->fPos = (data77->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data78 = data;
HXDLIN(1837)								data78->oPos = (data78->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data79 = data;
HXDLIN(1837)								data79->fPos = (data79->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data80 = data;
HXDLIN(1837)								data80->fPos = (data80->fPos + 5);
HXDLIN(1837)								 ::openfl::display::_internal::DrawCommandReader data81 = data;
HXDLIN(1837)								data81->oPos = (data81->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data82 = data;
HXDLIN(1837)								data82->oPos = (data82->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data83 = data;
HXDLIN(1837)								data83->oPos = (data83->oPos + 2);
HXDLIN(1837)								 ::openfl::display::_internal::DrawCommandReader data84 = data;
HXDLIN(1837)								data84->bPos = (data84->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data85 = data;
HXDLIN(1837)								data85->oPos = (data85->oPos + 4);
HXDLIN(1837)								 ::openfl::display::_internal::DrawCommandReader data86 = data;
HXDLIN(1837)								data86->iiPos = (data86->iiPos + 2);
HXDLIN(1837)								 ::openfl::display::_internal::DrawCommandReader data87 = data;
HXDLIN(1837)								data87->ffPos = (data87->ffPos + 1);
HXDLIN(1837)								 ::openfl::display::_internal::DrawCommandReader data88 = data;
HXDLIN(1837)								data88->fPos = (data88->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data89 = data;
HXDLIN(1837)								data89->oPos = (data89->oPos + 4);
HXDLIN(1837)								 ::openfl::display::_internal::DrawCommandReader data90 = data;
HXDLIN(1837)								data90->iPos = (data90->iPos + 1);
HXDLIN(1837)								 ::openfl::display::_internal::DrawCommandReader data91 = data;
HXDLIN(1837)								data91->fPos = (data91->fPos + 2);
HXDLIN(1837)								 ::openfl::display::_internal::DrawCommandReader data92 = data;
HXDLIN(1837)								data92->bPos = (data92->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data93 = data;
HXDLIN(1837)								data93->fPos = (data93->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data94 = data;
HXDLIN(1837)								data94->fPos = (data94->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data95 = data;
HXDLIN(1837)								data95->oPos = (data95->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1837)								 ::openfl::display::_internal::DrawCommandReader data96 = data;
HXDLIN(1837)								data96->oPos = (data96->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXLINE(1770)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data97 = data;
HXDLIN(1770)								data97->oPos = (data97->oPos + 2);
HXDLIN(1770)								 ::openfl::display::_internal::DrawCommandReader data98 = data;
HXDLIN(1770)								data98->bPos = (data98->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data99 = data;
HXDLIN(1770)								data99->iPos = (data99->iPos + 1);
HXDLIN(1770)								 ::openfl::display::_internal::DrawCommandReader data100 = data;
HXDLIN(1770)								data100->fPos = (data100->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data101 = data;
HXDLIN(1770)								data101->oPos = (data101->oPos + 4);
HXDLIN(1770)								 ::openfl::display::_internal::DrawCommandReader data102 = data;
HXDLIN(1770)								data102->iiPos = (data102->iiPos + 2);
HXDLIN(1770)								 ::openfl::display::_internal::DrawCommandReader data103 = data;
HXDLIN(1770)								data103->ffPos = (data103->ffPos + 1);
HXDLIN(1770)								 ::openfl::display::_internal::DrawCommandReader data104 = data;
HXDLIN(1770)								data104->fPos = (data104->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data105 = data;
HXDLIN(1770)								data105->oPos = (data105->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data106 = data;
HXDLIN(1770)								data106->fPos = (data106->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data107 = data;
HXDLIN(1770)								data107->fPos = (data107->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data108 = data;
HXDLIN(1770)								data108->fPos = (data108->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data109 = data;
HXDLIN(1770)								data109->fPos = (data109->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data110 = data;
HXDLIN(1770)								data110->oPos = (data110->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data111 = data;
HXDLIN(1770)								data111->fPos = (data111->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data112 = data;
HXDLIN(1770)								data112->fPos = (data112->fPos + 5);
HXDLIN(1770)								 ::openfl::display::_internal::DrawCommandReader data113 = data;
HXDLIN(1770)								data113->oPos = (data113->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data114 = data;
HXDLIN(1770)								data114->oPos = (data114->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data115 = data;
HXDLIN(1770)								data115->oPos = (data115->oPos + 2);
HXDLIN(1770)								 ::openfl::display::_internal::DrawCommandReader data116 = data;
HXDLIN(1770)								data116->bPos = (data116->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data117 = data;
HXDLIN(1770)								data117->oPos = (data117->oPos + 4);
HXDLIN(1770)								 ::openfl::display::_internal::DrawCommandReader data118 = data;
HXDLIN(1770)								data118->iiPos = (data118->iiPos + 2);
HXDLIN(1770)								 ::openfl::display::_internal::DrawCommandReader data119 = data;
HXDLIN(1770)								data119->ffPos = (data119->ffPos + 1);
HXDLIN(1770)								 ::openfl::display::_internal::DrawCommandReader data120 = data;
HXDLIN(1770)								data120->fPos = (data120->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data121 = data;
HXDLIN(1770)								data121->oPos = (data121->oPos + 4);
HXDLIN(1770)								 ::openfl::display::_internal::DrawCommandReader data122 = data;
HXDLIN(1770)								data122->iPos = (data122->iPos + 1);
HXDLIN(1770)								 ::openfl::display::_internal::DrawCommandReader data123 = data;
HXDLIN(1770)								data123->fPos = (data123->fPos + 2);
HXDLIN(1770)								 ::openfl::display::_internal::DrawCommandReader data124 = data;
HXDLIN(1770)								data124->bPos = (data124->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data125 = data;
HXDLIN(1770)								data125->fPos = (data125->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data126 = data;
HXDLIN(1770)								data126->fPos = (data126->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data127 = data;
HXDLIN(1770)								data127->oPos = (data127->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1770)								 ::openfl::display::_internal::DrawCommandReader data128 = data;
HXDLIN(1770)								data128->oPos = (data128->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXDLIN(1770)						 ::openfl::display::_internal::DrawCommandReader c3 = data;
HXLINE(1771)						path->cubicCurveTo(c3->buffer->f->__get(c3->fPos),c3->buffer->f->__get((c3->fPos + 1)),c3->buffer->f->__get((c3->fPos + 2)),c3->buffer->f->__get((c3->fPos + 3)),c3->buffer->f->__get((c3->fPos + 4)),c3->buffer->f->__get((c3->fPos + 5)));
            					}
            					break;
            					case (int)5: {
HXLINE(1774)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data129 = data;
HXDLIN(1774)								data129->oPos = (data129->oPos + 2);
HXDLIN(1774)								 ::openfl::display::_internal::DrawCommandReader data130 = data;
HXDLIN(1774)								data130->bPos = (data130->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data131 = data;
HXDLIN(1774)								data131->iPos = (data131->iPos + 1);
HXDLIN(1774)								 ::openfl::display::_internal::DrawCommandReader data132 = data;
HXDLIN(1774)								data132->fPos = (data132->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data133 = data;
HXDLIN(1774)								data133->oPos = (data133->oPos + 4);
HXDLIN(1774)								 ::openfl::display::_internal::DrawCommandReader data134 = data;
HXDLIN(1774)								data134->iiPos = (data134->iiPos + 2);
HXDLIN(1774)								 ::openfl::display::_internal::DrawCommandReader data135 = data;
HXDLIN(1774)								data135->ffPos = (data135->ffPos + 1);
HXDLIN(1774)								 ::openfl::display::_internal::DrawCommandReader data136 = data;
HXDLIN(1774)								data136->fPos = (data136->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data137 = data;
HXDLIN(1774)								data137->oPos = (data137->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data138 = data;
HXDLIN(1774)								data138->fPos = (data138->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data139 = data;
HXDLIN(1774)								data139->fPos = (data139->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data140 = data;
HXDLIN(1774)								data140->fPos = (data140->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data141 = data;
HXDLIN(1774)								data141->fPos = (data141->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data142 = data;
HXDLIN(1774)								data142->oPos = (data142->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data143 = data;
HXDLIN(1774)								data143->fPos = (data143->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data144 = data;
HXDLIN(1774)								data144->fPos = (data144->fPos + 5);
HXDLIN(1774)								 ::openfl::display::_internal::DrawCommandReader data145 = data;
HXDLIN(1774)								data145->oPos = (data145->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data146 = data;
HXDLIN(1774)								data146->oPos = (data146->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data147 = data;
HXDLIN(1774)								data147->oPos = (data147->oPos + 2);
HXDLIN(1774)								 ::openfl::display::_internal::DrawCommandReader data148 = data;
HXDLIN(1774)								data148->bPos = (data148->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data149 = data;
HXDLIN(1774)								data149->oPos = (data149->oPos + 4);
HXDLIN(1774)								 ::openfl::display::_internal::DrawCommandReader data150 = data;
HXDLIN(1774)								data150->iiPos = (data150->iiPos + 2);
HXDLIN(1774)								 ::openfl::display::_internal::DrawCommandReader data151 = data;
HXDLIN(1774)								data151->ffPos = (data151->ffPos + 1);
HXDLIN(1774)								 ::openfl::display::_internal::DrawCommandReader data152 = data;
HXDLIN(1774)								data152->fPos = (data152->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data153 = data;
HXDLIN(1774)								data153->oPos = (data153->oPos + 4);
HXDLIN(1774)								 ::openfl::display::_internal::DrawCommandReader data154 = data;
HXDLIN(1774)								data154->iPos = (data154->iPos + 1);
HXDLIN(1774)								 ::openfl::display::_internal::DrawCommandReader data155 = data;
HXDLIN(1774)								data155->fPos = (data155->fPos + 2);
HXDLIN(1774)								 ::openfl::display::_internal::DrawCommandReader data156 = data;
HXDLIN(1774)								data156->bPos = (data156->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data157 = data;
HXDLIN(1774)								data157->fPos = (data157->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data158 = data;
HXDLIN(1774)								data158->fPos = (data158->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data159 = data;
HXDLIN(1774)								data159->oPos = (data159->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1774)								 ::openfl::display::_internal::DrawCommandReader data160 = data;
HXDLIN(1774)								data160->oPos = (data160->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXDLIN(1774)						 ::openfl::display::_internal::DrawCommandReader c4 = data;
HXLINE(1775)						path->curveTo(c4->buffer->f->__get(c4->fPos),c4->buffer->f->__get((c4->fPos + 1)),c4->buffer->f->__get((c4->fPos + 2)),c4->buffer->f->__get((c4->fPos + 3)));
            					}
            					break;
            					case (int)6: {
HXLINE(1786)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data161 = data;
HXDLIN(1786)								data161->oPos = (data161->oPos + 2);
HXDLIN(1786)								 ::openfl::display::_internal::DrawCommandReader data162 = data;
HXDLIN(1786)								data162->bPos = (data162->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data163 = data;
HXDLIN(1786)								data163->iPos = (data163->iPos + 1);
HXDLIN(1786)								 ::openfl::display::_internal::DrawCommandReader data164 = data;
HXDLIN(1786)								data164->fPos = (data164->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data165 = data;
HXDLIN(1786)								data165->oPos = (data165->oPos + 4);
HXDLIN(1786)								 ::openfl::display::_internal::DrawCommandReader data166 = data;
HXDLIN(1786)								data166->iiPos = (data166->iiPos + 2);
HXDLIN(1786)								 ::openfl::display::_internal::DrawCommandReader data167 = data;
HXDLIN(1786)								data167->ffPos = (data167->ffPos + 1);
HXDLIN(1786)								 ::openfl::display::_internal::DrawCommandReader data168 = data;
HXDLIN(1786)								data168->fPos = (data168->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data169 = data;
HXDLIN(1786)								data169->oPos = (data169->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data170 = data;
HXDLIN(1786)								data170->fPos = (data170->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data171 = data;
HXDLIN(1786)								data171->fPos = (data171->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data172 = data;
HXDLIN(1786)								data172->fPos = (data172->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data173 = data;
HXDLIN(1786)								data173->fPos = (data173->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data174 = data;
HXDLIN(1786)								data174->oPos = (data174->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data175 = data;
HXDLIN(1786)								data175->fPos = (data175->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data176 = data;
HXDLIN(1786)								data176->fPos = (data176->fPos + 5);
HXDLIN(1786)								 ::openfl::display::_internal::DrawCommandReader data177 = data;
HXDLIN(1786)								data177->oPos = (data177->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data178 = data;
HXDLIN(1786)								data178->oPos = (data178->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data179 = data;
HXDLIN(1786)								data179->oPos = (data179->oPos + 2);
HXDLIN(1786)								 ::openfl::display::_internal::DrawCommandReader data180 = data;
HXDLIN(1786)								data180->bPos = (data180->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data181 = data;
HXDLIN(1786)								data181->oPos = (data181->oPos + 4);
HXDLIN(1786)								 ::openfl::display::_internal::DrawCommandReader data182 = data;
HXDLIN(1786)								data182->iiPos = (data182->iiPos + 2);
HXDLIN(1786)								 ::openfl::display::_internal::DrawCommandReader data183 = data;
HXDLIN(1786)								data183->ffPos = (data183->ffPos + 1);
HXDLIN(1786)								 ::openfl::display::_internal::DrawCommandReader data184 = data;
HXDLIN(1786)								data184->fPos = (data184->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data185 = data;
HXDLIN(1786)								data185->oPos = (data185->oPos + 4);
HXDLIN(1786)								 ::openfl::display::_internal::DrawCommandReader data186 = data;
HXDLIN(1786)								data186->iPos = (data186->iPos + 1);
HXDLIN(1786)								 ::openfl::display::_internal::DrawCommandReader data187 = data;
HXDLIN(1786)								data187->fPos = (data187->fPos + 2);
HXDLIN(1786)								 ::openfl::display::_internal::DrawCommandReader data188 = data;
HXDLIN(1786)								data188->bPos = (data188->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data189 = data;
HXDLIN(1786)								data189->fPos = (data189->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data190 = data;
HXDLIN(1786)								data190->fPos = (data190->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data191 = data;
HXDLIN(1786)								data191->oPos = (data191->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1786)								 ::openfl::display::_internal::DrawCommandReader data192 = data;
HXDLIN(1786)								data192->oPos = (data192->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXDLIN(1786)						 ::openfl::display::_internal::DrawCommandReader c5 = data;
HXLINE(1787)						path->_hx___drawCircle(c5->buffer->f->__get(c5->fPos),c5->buffer->f->__get((c5->fPos + 1)),c5->buffer->f->__get((c5->fPos + 2)));
            					}
            					break;
            					case (int)7: {
HXLINE(1790)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data193 = data;
HXDLIN(1790)								data193->oPos = (data193->oPos + 2);
HXDLIN(1790)								 ::openfl::display::_internal::DrawCommandReader data194 = data;
HXDLIN(1790)								data194->bPos = (data194->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data195 = data;
HXDLIN(1790)								data195->iPos = (data195->iPos + 1);
HXDLIN(1790)								 ::openfl::display::_internal::DrawCommandReader data196 = data;
HXDLIN(1790)								data196->fPos = (data196->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data197 = data;
HXDLIN(1790)								data197->oPos = (data197->oPos + 4);
HXDLIN(1790)								 ::openfl::display::_internal::DrawCommandReader data198 = data;
HXDLIN(1790)								data198->iiPos = (data198->iiPos + 2);
HXDLIN(1790)								 ::openfl::display::_internal::DrawCommandReader data199 = data;
HXDLIN(1790)								data199->ffPos = (data199->ffPos + 1);
HXDLIN(1790)								 ::openfl::display::_internal::DrawCommandReader data200 = data;
HXDLIN(1790)								data200->fPos = (data200->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data201 = data;
HXDLIN(1790)								data201->oPos = (data201->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data202 = data;
HXDLIN(1790)								data202->fPos = (data202->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data203 = data;
HXDLIN(1790)								data203->fPos = (data203->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data204 = data;
HXDLIN(1790)								data204->fPos = (data204->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data205 = data;
HXDLIN(1790)								data205->fPos = (data205->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data206 = data;
HXDLIN(1790)								data206->oPos = (data206->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data207 = data;
HXDLIN(1790)								data207->fPos = (data207->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data208 = data;
HXDLIN(1790)								data208->fPos = (data208->fPos + 5);
HXDLIN(1790)								 ::openfl::display::_internal::DrawCommandReader data209 = data;
HXDLIN(1790)								data209->oPos = (data209->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data210 = data;
HXDLIN(1790)								data210->oPos = (data210->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data211 = data;
HXDLIN(1790)								data211->oPos = (data211->oPos + 2);
HXDLIN(1790)								 ::openfl::display::_internal::DrawCommandReader data212 = data;
HXDLIN(1790)								data212->bPos = (data212->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data213 = data;
HXDLIN(1790)								data213->oPos = (data213->oPos + 4);
HXDLIN(1790)								 ::openfl::display::_internal::DrawCommandReader data214 = data;
HXDLIN(1790)								data214->iiPos = (data214->iiPos + 2);
HXDLIN(1790)								 ::openfl::display::_internal::DrawCommandReader data215 = data;
HXDLIN(1790)								data215->ffPos = (data215->ffPos + 1);
HXDLIN(1790)								 ::openfl::display::_internal::DrawCommandReader data216 = data;
HXDLIN(1790)								data216->fPos = (data216->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data217 = data;
HXDLIN(1790)								data217->oPos = (data217->oPos + 4);
HXDLIN(1790)								 ::openfl::display::_internal::DrawCommandReader data218 = data;
HXDLIN(1790)								data218->iPos = (data218->iPos + 1);
HXDLIN(1790)								 ::openfl::display::_internal::DrawCommandReader data219 = data;
HXDLIN(1790)								data219->fPos = (data219->fPos + 2);
HXDLIN(1790)								 ::openfl::display::_internal::DrawCommandReader data220 = data;
HXDLIN(1790)								data220->bPos = (data220->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data221 = data;
HXDLIN(1790)								data221->fPos = (data221->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data222 = data;
HXDLIN(1790)								data222->fPos = (data222->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data223 = data;
HXDLIN(1790)								data223->oPos = (data223->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1790)								 ::openfl::display::_internal::DrawCommandReader data224 = data;
HXDLIN(1790)								data224->oPos = (data224->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXDLIN(1790)						 ::openfl::display::_internal::DrawCommandReader c6 = data;
HXLINE(1791)						path->_hx___drawEllipse(c6->buffer->f->__get(c6->fPos),c6->buffer->f->__get((c6->fPos + 1)),c6->buffer->f->__get((c6->fPos + 2)),c6->buffer->f->__get((c6->fPos + 3)));
            					}
            					break;
            					case (int)9: {
HXLINE(1794)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data225 = data;
HXDLIN(1794)								data225->oPos = (data225->oPos + 2);
HXDLIN(1794)								 ::openfl::display::_internal::DrawCommandReader data226 = data;
HXDLIN(1794)								data226->bPos = (data226->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data227 = data;
HXDLIN(1794)								data227->iPos = (data227->iPos + 1);
HXDLIN(1794)								 ::openfl::display::_internal::DrawCommandReader data228 = data;
HXDLIN(1794)								data228->fPos = (data228->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data229 = data;
HXDLIN(1794)								data229->oPos = (data229->oPos + 4);
HXDLIN(1794)								 ::openfl::display::_internal::DrawCommandReader data230 = data;
HXDLIN(1794)								data230->iiPos = (data230->iiPos + 2);
HXDLIN(1794)								 ::openfl::display::_internal::DrawCommandReader data231 = data;
HXDLIN(1794)								data231->ffPos = (data231->ffPos + 1);
HXDLIN(1794)								 ::openfl::display::_internal::DrawCommandReader data232 = data;
HXDLIN(1794)								data232->fPos = (data232->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data233 = data;
HXDLIN(1794)								data233->oPos = (data233->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data234 = data;
HXDLIN(1794)								data234->fPos = (data234->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data235 = data;
HXDLIN(1794)								data235->fPos = (data235->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data236 = data;
HXDLIN(1794)								data236->fPos = (data236->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data237 = data;
HXDLIN(1794)								data237->fPos = (data237->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data238 = data;
HXDLIN(1794)								data238->oPos = (data238->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data239 = data;
HXDLIN(1794)								data239->fPos = (data239->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data240 = data;
HXDLIN(1794)								data240->fPos = (data240->fPos + 5);
HXDLIN(1794)								 ::openfl::display::_internal::DrawCommandReader data241 = data;
HXDLIN(1794)								data241->oPos = (data241->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data242 = data;
HXDLIN(1794)								data242->oPos = (data242->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data243 = data;
HXDLIN(1794)								data243->oPos = (data243->oPos + 2);
HXDLIN(1794)								 ::openfl::display::_internal::DrawCommandReader data244 = data;
HXDLIN(1794)								data244->bPos = (data244->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data245 = data;
HXDLIN(1794)								data245->oPos = (data245->oPos + 4);
HXDLIN(1794)								 ::openfl::display::_internal::DrawCommandReader data246 = data;
HXDLIN(1794)								data246->iiPos = (data246->iiPos + 2);
HXDLIN(1794)								 ::openfl::display::_internal::DrawCommandReader data247 = data;
HXDLIN(1794)								data247->ffPos = (data247->ffPos + 1);
HXDLIN(1794)								 ::openfl::display::_internal::DrawCommandReader data248 = data;
HXDLIN(1794)								data248->fPos = (data248->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data249 = data;
HXDLIN(1794)								data249->oPos = (data249->oPos + 4);
HXDLIN(1794)								 ::openfl::display::_internal::DrawCommandReader data250 = data;
HXDLIN(1794)								data250->iPos = (data250->iPos + 1);
HXDLIN(1794)								 ::openfl::display::_internal::DrawCommandReader data251 = data;
HXDLIN(1794)								data251->fPos = (data251->fPos + 2);
HXDLIN(1794)								 ::openfl::display::_internal::DrawCommandReader data252 = data;
HXDLIN(1794)								data252->bPos = (data252->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data253 = data;
HXDLIN(1794)								data253->fPos = (data253->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data254 = data;
HXDLIN(1794)								data254->fPos = (data254->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data255 = data;
HXDLIN(1794)								data255->oPos = (data255->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1794)								 ::openfl::display::_internal::DrawCommandReader data256 = data;
HXDLIN(1794)								data256->oPos = (data256->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXDLIN(1794)						 ::openfl::display::_internal::DrawCommandReader c7 = data;
HXLINE(1795)						path->_hx___drawRect(c7->buffer->f->__get(c7->fPos),c7->buffer->f->__get((c7->fPos + 1)),c7->buffer->f->__get((c7->fPos + 2)),c7->buffer->f->__get((c7->fPos + 3)));
            					}
            					break;
            					case (int)10: {
HXLINE(1798)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data257 = data;
HXDLIN(1798)								data257->oPos = (data257->oPos + 2);
HXDLIN(1798)								 ::openfl::display::_internal::DrawCommandReader data258 = data;
HXDLIN(1798)								data258->bPos = (data258->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data259 = data;
HXDLIN(1798)								data259->iPos = (data259->iPos + 1);
HXDLIN(1798)								 ::openfl::display::_internal::DrawCommandReader data260 = data;
HXDLIN(1798)								data260->fPos = (data260->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data261 = data;
HXDLIN(1798)								data261->oPos = (data261->oPos + 4);
HXDLIN(1798)								 ::openfl::display::_internal::DrawCommandReader data262 = data;
HXDLIN(1798)								data262->iiPos = (data262->iiPos + 2);
HXDLIN(1798)								 ::openfl::display::_internal::DrawCommandReader data263 = data;
HXDLIN(1798)								data263->ffPos = (data263->ffPos + 1);
HXDLIN(1798)								 ::openfl::display::_internal::DrawCommandReader data264 = data;
HXDLIN(1798)								data264->fPos = (data264->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data265 = data;
HXDLIN(1798)								data265->oPos = (data265->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data266 = data;
HXDLIN(1798)								data266->fPos = (data266->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data267 = data;
HXDLIN(1798)								data267->fPos = (data267->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data268 = data;
HXDLIN(1798)								data268->fPos = (data268->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data269 = data;
HXDLIN(1798)								data269->fPos = (data269->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data270 = data;
HXDLIN(1798)								data270->oPos = (data270->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data271 = data;
HXDLIN(1798)								data271->fPos = (data271->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data272 = data;
HXDLIN(1798)								data272->fPos = (data272->fPos + 5);
HXDLIN(1798)								 ::openfl::display::_internal::DrawCommandReader data273 = data;
HXDLIN(1798)								data273->oPos = (data273->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data274 = data;
HXDLIN(1798)								data274->oPos = (data274->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data275 = data;
HXDLIN(1798)								data275->oPos = (data275->oPos + 2);
HXDLIN(1798)								 ::openfl::display::_internal::DrawCommandReader data276 = data;
HXDLIN(1798)								data276->bPos = (data276->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data277 = data;
HXDLIN(1798)								data277->oPos = (data277->oPos + 4);
HXDLIN(1798)								 ::openfl::display::_internal::DrawCommandReader data278 = data;
HXDLIN(1798)								data278->iiPos = (data278->iiPos + 2);
HXDLIN(1798)								 ::openfl::display::_internal::DrawCommandReader data279 = data;
HXDLIN(1798)								data279->ffPos = (data279->ffPos + 1);
HXDLIN(1798)								 ::openfl::display::_internal::DrawCommandReader data280 = data;
HXDLIN(1798)								data280->fPos = (data280->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data281 = data;
HXDLIN(1798)								data281->oPos = (data281->oPos + 4);
HXDLIN(1798)								 ::openfl::display::_internal::DrawCommandReader data282 = data;
HXDLIN(1798)								data282->iPos = (data282->iPos + 1);
HXDLIN(1798)								 ::openfl::display::_internal::DrawCommandReader data283 = data;
HXDLIN(1798)								data283->fPos = (data283->fPos + 2);
HXDLIN(1798)								 ::openfl::display::_internal::DrawCommandReader data284 = data;
HXDLIN(1798)								data284->bPos = (data284->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data285 = data;
HXDLIN(1798)								data285->fPos = (data285->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data286 = data;
HXDLIN(1798)								data286->fPos = (data286->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data287 = data;
HXDLIN(1798)								data287->oPos = (data287->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1798)								 ::openfl::display::_internal::DrawCommandReader data288 = data;
HXDLIN(1798)								data288->oPos = (data288->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXDLIN(1798)						 ::openfl::display::_internal::DrawCommandReader c8 = data;
HXLINE(1799)						Float _hx_tmp;
HXDLIN(1799)						if (::hx::IsNotNull( c8->buffer->o->__get(c8->oPos) )) {
HXLINE(1799)							_hx_tmp = ( (Float)(c8->buffer->o->__get(c8->oPos)) );
            						}
            						else {
HXLINE(1799)							_hx_tmp = c8->buffer->f->__get((c8->fPos + 4));
            						}
HXDLIN(1799)						path->_hx___drawRoundRect(c8->buffer->f->__get(c8->fPos),c8->buffer->f->__get((c8->fPos + 1)),c8->buffer->f->__get((c8->fPos + 2)),c8->buffer->f->__get((c8->fPos + 3)),c8->buffer->f->__get((c8->fPos + 4)),_hx_tmp);
            					}
            					break;
            					case (int)13: {
HXLINE(1825)						{
HXLINE(1825)							switch((int)(data->prev->_hx_getIndex())){
            								case (int)0: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data289 = data;
HXDLIN(1825)									data289->oPos = (data289->oPos + 2);
HXDLIN(1825)									 ::openfl::display::_internal::DrawCommandReader data290 = data;
HXDLIN(1825)									data290->bPos = (data290->bPos + 2);
            								}
            								break;
            								case (int)1: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data291 = data;
HXDLIN(1825)									data291->iPos = (data291->iPos + 1);
HXDLIN(1825)									 ::openfl::display::_internal::DrawCommandReader data292 = data;
HXDLIN(1825)									data292->fPos = (data292->fPos + 1);
            								}
            								break;
            								case (int)2: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data293 = data;
HXDLIN(1825)									data293->oPos = (data293->oPos + 4);
HXDLIN(1825)									 ::openfl::display::_internal::DrawCommandReader data294 = data;
HXDLIN(1825)									data294->iiPos = (data294->iiPos + 2);
HXDLIN(1825)									 ::openfl::display::_internal::DrawCommandReader data295 = data;
HXDLIN(1825)									data295->ffPos = (data295->ffPos + 1);
HXDLIN(1825)									 ::openfl::display::_internal::DrawCommandReader data296 = data;
HXDLIN(1825)									data296->fPos = (data296->fPos + 1);
            								}
            								break;
            								case (int)3: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data297 = data;
HXDLIN(1825)									data297->oPos = (data297->oPos + 1);
            								}
            								break;
            								case (int)4: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data298 = data;
HXDLIN(1825)									data298->fPos = (data298->fPos + 6);
            								}
            								break;
            								case (int)5: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data299 = data;
HXDLIN(1825)									data299->fPos = (data299->fPos + 4);
            								}
            								break;
            								case (int)6: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data300 = data;
HXDLIN(1825)									data300->fPos = (data300->fPos + 3);
            								}
            								break;
            								case (int)7: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data301 = data;
HXDLIN(1825)									data301->fPos = (data301->fPos + 4);
            								}
            								break;
            								case (int)8: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data302 = data;
HXDLIN(1825)									data302->oPos = (data302->oPos + 3);
            								}
            								break;
            								case (int)9: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data303 = data;
HXDLIN(1825)									data303->fPos = (data303->fPos + 4);
            								}
            								break;
            								case (int)10: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data304 = data;
HXDLIN(1825)									data304->fPos = (data304->fPos + 5);
HXDLIN(1825)									 ::openfl::display::_internal::DrawCommandReader data305 = data;
HXDLIN(1825)									data305->oPos = (data305->oPos + 1);
            								}
            								break;
            								case (int)12: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data306 = data;
HXDLIN(1825)									data306->oPos = (data306->oPos + 4);
            								}
            								break;
            								case (int)13: {
            								}
            								break;
            								case (int)14: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data307 = data;
HXDLIN(1825)									data307->oPos = (data307->oPos + 2);
HXDLIN(1825)									 ::openfl::display::_internal::DrawCommandReader data308 = data;
HXDLIN(1825)									data308->bPos = (data308->bPos + 2);
            								}
            								break;
            								case (int)15: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data309 = data;
HXDLIN(1825)									data309->oPos = (data309->oPos + 4);
HXDLIN(1825)									 ::openfl::display::_internal::DrawCommandReader data310 = data;
HXDLIN(1825)									data310->iiPos = (data310->iiPos + 2);
HXDLIN(1825)									 ::openfl::display::_internal::DrawCommandReader data311 = data;
HXDLIN(1825)									data311->ffPos = (data311->ffPos + 1);
HXDLIN(1825)									 ::openfl::display::_internal::DrawCommandReader data312 = data;
HXDLIN(1825)									data312->fPos = (data312->fPos + 1);
            								}
            								break;
            								case (int)16: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data313 = data;
HXDLIN(1825)									data313->oPos = (data313->oPos + 4);
HXDLIN(1825)									 ::openfl::display::_internal::DrawCommandReader data314 = data;
HXDLIN(1825)									data314->iPos = (data314->iPos + 1);
HXDLIN(1825)									 ::openfl::display::_internal::DrawCommandReader data315 = data;
HXDLIN(1825)									data315->fPos = (data315->fPos + 2);
HXDLIN(1825)									 ::openfl::display::_internal::DrawCommandReader data316 = data;
HXDLIN(1825)									data316->bPos = (data316->bPos + 1);
            								}
            								break;
            								case (int)17: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data317 = data;
HXDLIN(1825)									data317->fPos = (data317->fPos + 2);
            								}
            								break;
            								case (int)18: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data318 = data;
HXDLIN(1825)									data318->fPos = (data318->fPos + 2);
            								}
            								break;
            								case (int)19: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data319 = data;
HXDLIN(1825)									data319->oPos = (data319->oPos + 1);
            								}
            								break;
            								case (int)20: {
HXLINE(1825)									 ::openfl::display::_internal::DrawCommandReader data320 = data;
HXDLIN(1825)									data320->oPos = (data320->oPos + 1);
            								}
            								break;
            								case (int)21: case (int)22: {
            								}
...
HXLINE(1812)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data321 = data;
HXDLIN(1812)								data321->oPos = (data321->oPos + 2);
HXDLIN(1812)								 ::openfl::display::_internal::DrawCommandReader data322 = data;
HXDLIN(1812)								data322->bPos = (data322->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data323 = data;
HXDLIN(1812)								data323->iPos = (data323->iPos + 1);
HXDLIN(1812)								 ::openfl::display::_internal::DrawCommandReader data324 = data;
HXDLIN(1812)								data324->fPos = (data324->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data325 = data;
HXDLIN(1812)								data325->oPos = (data325->oPos + 4);
HXDLIN(1812)								 ::openfl::display::_internal::DrawCommandReader data326 = data;
HXDLIN(1812)								data326->iiPos = (data326->iiPos + 2);
HXDLIN(1812)								 ::openfl::display::_internal::DrawCommandReader data327 = data;
HXDLIN(1812)								data327->ffPos = (data327->ffPos + 1);
HXDLIN(1812)								 ::openfl::display::_internal::DrawCommandReader data328 = data;
HXDLIN(1812)								data328->fPos = (data328->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data329 = data;
HXDLIN(1812)								data329->oPos = (data329->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data330 = data;
HXDLIN(1812)								data330->fPos = (data330->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data331 = data;
HXDLIN(1812)								data331->fPos = (data331->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data332 = data;
HXDLIN(1812)								data332->fPos = (data332->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data333 = data;
HXDLIN(1812)								data333->fPos = (data333->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data334 = data;
HXDLIN(1812)								data334->oPos = (data334->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data335 = data;
HXDLIN(1812)								data335->fPos = (data335->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data336 = data;
HXDLIN(1812)								data336->fPos = (data336->fPos + 5);
HXDLIN(1812)								 ::openfl::display::_internal::DrawCommandReader data337 = data;
HXDLIN(1812)								data337->oPos = (data337->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data338 = data;
HXDLIN(1812)								data338->oPos = (data338->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data339 = data;
HXDLIN(1812)								data339->oPos = (data339->oPos + 2);
HXDLIN(1812)								 ::openfl::display::_internal::DrawCommandReader data340 = data;
HXDLIN(1812)								data340->bPos = (data340->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data341 = data;
HXDLIN(1812)								data341->oPos = (data341->oPos + 4);
HXDLIN(1812)								 ::openfl::display::_internal::DrawCommandReader data342 = data;
HXDLIN(1812)								data342->iiPos = (data342->iiPos + 2);
HXDLIN(1812)								 ::openfl::display::_internal::DrawCommandReader data343 = data;
HXDLIN(1812)								data343->ffPos = (data343->ffPos + 1);
HXDLIN(1812)								 ::openfl::display::_internal::DrawCommandReader data344 = data;
HXDLIN(1812)								data344->fPos = (data344->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data345 = data;
HXDLIN(1812)								data345->oPos = (data345->oPos + 4);
HXDLIN(1812)								 ::openfl::display::_internal::DrawCommandReader data346 = data;
HXDLIN(1812)								data346->iPos = (data346->iPos + 1);
HXDLIN(1812)								 ::openfl::display::_internal::DrawCommandReader data347 = data;
HXDLIN(1812)								data347->fPos = (data347->fPos + 2);
HXDLIN(1812)								 ::openfl::display::_internal::DrawCommandReader data348 = data;
HXDLIN(1812)								data348->bPos = (data348->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data349 = data;
HXDLIN(1812)								data349->fPos = (data349->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data350 = data;
HXDLIN(1812)								data350->fPos = (data350->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data351 = data;
HXDLIN(1812)								data351->oPos = (data351->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1812)								 ::openfl::display::_internal::DrawCommandReader data352 = data;
HXDLIN(1812)								data352->oPos = (data352->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXDLIN(1812)						 ::openfl::display::_internal::DrawCommandReader c9 = data;
...
HXLINE(1804)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data353 = data;
HXDLIN(1804)								data353->oPos = (data353->oPos + 2);
HXDLIN(1804)								 ::openfl::display::_internal::DrawCommandReader data354 = data;
HXDLIN(1804)								data354->bPos = (data354->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data355 = data;
HXDLIN(1804)								data355->iPos = (data355->iPos + 1);
HXDLIN(1804)								 ::openfl::display::_internal::DrawCommandReader data356 = data;
HXDLIN(1804)								data356->fPos = (data356->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data357 = data;
HXDLIN(1804)								data357->oPos = (data357->oPos + 4);
HXDLIN(1804)								 ::openfl::display::_internal::DrawCommandReader data358 = data;
HXDLIN(1804)								data358->iiPos = (data358->iiPos + 2);
HXDLIN(1804)								 ::openfl::display::_internal::DrawCommandReader data359 = data;
HXDLIN(1804)								data359->ffPos = (data359->ffPos + 1);
HXDLIN(1804)								 ::openfl::display::_internal::DrawCommandReader data360 = data;
HXDLIN(1804)								data360->fPos = (data360->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data361 = data;
HXDLIN(1804)								data361->oPos = (data361->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data362 = data;
HXDLIN(1804)								data362->fPos = (data362->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data363 = data;
HXDLIN(1804)								data363->fPos = (data363->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data364 = data;
HXDLIN(1804)								data364->fPos = (data364->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data365 = data;
HXDLIN(1804)								data365->fPos = (data365->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data366 = data;
HXDLIN(1804)								data366->oPos = (data366->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data367 = data;
HXDLIN(1804)								data367->fPos = (data367->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data368 = data;
HXDLIN(1804)								data368->fPos = (data368->fPos + 5);
HXDLIN(1804)								 ::openfl::display::_internal::DrawCommandReader data369 = data;
HXDLIN(1804)								data369->oPos = (data369->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data370 = data;
HXDLIN(1804)								data370->oPos = (data370->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data371 = data;
HXDLIN(1804)								data371->oPos = (data371->oPos + 2);
HXDLIN(1804)								 ::openfl::display::_internal::DrawCommandReader data372 = data;
HXDLIN(1804)								data372->bPos = (data372->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data373 = data;
HXDLIN(1804)								data373->oPos = (data373->oPos + 4);
HXDLIN(1804)								 ::openfl::display::_internal::DrawCommandReader data374 = data;
HXDLIN(1804)								data374->iiPos = (data374->iiPos + 2);
HXDLIN(1804)								 ::openfl::display::_internal::DrawCommandReader data375 = data;
HXDLIN(1804)								data375->ffPos = (data375->ffPos + 1);
HXDLIN(1804)								 ::openfl::display::_internal::DrawCommandReader data376 = data;
HXDLIN(1804)								data376->fPos = (data376->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data377 = data;
HXDLIN(1804)								data377->oPos = (data377->oPos + 4);
HXDLIN(1804)								 ::openfl::display::_internal::DrawCommandReader data378 = data;
HXDLIN(1804)								data378->iPos = (data378->iPos + 1);
HXDLIN(1804)								 ::openfl::display::_internal::DrawCommandReader data379 = data;
HXDLIN(1804)								data379->fPos = (data379->fPos + 2);
HXDLIN(1804)								 ::openfl::display::_internal::DrawCommandReader data380 = data;
HXDLIN(1804)								data380->bPos = (data380->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data381 = data;
HXDLIN(1804)								data381->fPos = (data381->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data382 = data;
HXDLIN(1804)								data382->fPos = (data382->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data383 = data;
HXDLIN(1804)								data383->oPos = (data383->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1804)								 ::openfl::display::_internal::DrawCommandReader data384 = data;
HXDLIN(1804)								data384->oPos = (data384->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXDLIN(1804)						 ::openfl::display::_internal::DrawCommandReader c10 = data;
            					}
            					break;
            					case (int)16: {
HXLINE(1819)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data385 = data;
HXDLIN(1819)								data385->oPos = (data385->oPos + 2);
HXDLIN(1819)								 ::openfl::display::_internal::DrawCommandReader data386 = data;
HXDLIN(1819)								data386->bPos = (data386->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data387 = data;
HXDLIN(1819)								data387->iPos = (data387->iPos + 1);
HXDLIN(1819)								 ::openfl::display::_internal::DrawCommandReader data388 = data;
HXDLIN(1819)								data388->fPos = (data388->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data389 = data;
HXDLIN(1819)								data389->oPos = (data389->oPos + 4);
HXDLIN(1819)								 ::openfl::display::_internal::DrawCommandReader data390 = data;
HXDLIN(1819)								data390->iiPos = (data390->iiPos + 2);
HXDLIN(1819)								 ::openfl::display::_internal::DrawCommandReader data391 = data;
HXDLIN(1819)								data391->ffPos = (data391->ffPos + 1);
HXDLIN(1819)								 ::openfl::display::_internal::DrawCommandReader data392 = data;
HXDLIN(1819)								data392->fPos = (data392->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data393 = data;
HXDLIN(1819)								data393->oPos = (data393->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data394 = data;
HXDLIN(1819)								data394->fPos = (data394->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data395 = data;
HXDLIN(1819)								data395->fPos = (data395->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data396 = data;
HXDLIN(1819)								data396->fPos = (data396->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data397 = data;
HXDLIN(1819)								data397->fPos = (data397->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data398 = data;
HXDLIN(1819)								data398->oPos = (data398->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data399 = data;
HXDLIN(1819)								data399->fPos = (data399->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data400 = data;
HXDLIN(1819)								data400->fPos = (data400->fPos + 5);
HXDLIN(1819)								 ::openfl::display::_internal::DrawCommandReader data401 = data;
HXDLIN(1819)								data401->oPos = (data401->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data402 = data;
HXDLIN(1819)								data402->oPos = (data402->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data403 = data;
HXDLIN(1819)								data403->oPos = (data403->oPos + 2);
HXDLIN(1819)								 ::openfl::display::_internal::DrawCommandReader data404 = data;
HXDLIN(1819)								data404->bPos = (data404->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data405 = data;
HXDLIN(1819)								data405->oPos = (data405->oPos + 4);
HXDLIN(1819)								 ::openfl::display::_internal::DrawCommandReader data406 = data;
HXDLIN(1819)								data406->iiPos = (data406->iiPos + 2);
HXDLIN(1819)								 ::openfl::display::_internal::DrawCommandReader data407 = data;
HXDLIN(1819)								data407->ffPos = (data407->ffPos + 1);
HXDLIN(1819)								 ::openfl::display::_internal::DrawCommandReader data408 = data;
HXDLIN(1819)								data408->fPos = (data408->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data409 = data;
HXDLIN(1819)								data409->oPos = (data409->oPos + 4);
HXDLIN(1819)								 ::openfl::display::_internal::DrawCommandReader data410 = data;
HXDLIN(1819)								data410->iPos = (data410->iPos + 1);
HXDLIN(1819)								 ::openfl::display::_internal::DrawCommandReader data411 = data;
HXDLIN(1819)								data411->fPos = (data411->fPos + 2);
HXDLIN(1819)								 ::openfl::display::_internal::DrawCommandReader data412 = data;
HXDLIN(1819)								data412->bPos = (data412->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data413 = data;
HXDLIN(1819)								data413->fPos = (data413->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data414 = data;
HXDLIN(1819)								data414->fPos = (data414->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data415 = data;
HXDLIN(1819)								data415->oPos = (data415->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1819)								 ::openfl::display::_internal::DrawCommandReader data416 = data;
HXDLIN(1819)								data416->oPos = (data416->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXDLIN(1819)						 ::openfl::display::_internal::DrawCommandReader c11 = data;
HXLINE(1820)						stroke =  ::openfl::display::GraphicsStroke_obj::__alloc( HX_CTX ,c11->buffer->o->__get(c11->oPos),c11->buffer->b->__get(c11->bPos),c11->buffer->o->__get((c11->oPos + 1)),c11->buffer->o->__get((c11->oPos + 2)),c11->buffer->o->__get((c11->oPos + 3)),c11->buffer->f->__get((c11->fPos + 1)),null());
HXLINE(1821)						stroke->fill =  ::openfl::display::GraphicsSolidFill_obj::__alloc( HX_CTX ,c11->buffer->i->__get(c11->iPos),c11->buffer->f->__get(c11->fPos));
...
HXLINE(1778)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data417 = data;
HXDLIN(1778)								data417->oPos = (data417->oPos + 2);
HXDLIN(1778)								 ::openfl::display::_internal::DrawCommandReader data418 = data;
HXDLIN(1778)								data418->bPos = (data418->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data419 = data;
HXDLIN(1778)								data419->iPos = (data419->iPos + 1);
HXDLIN(1778)								 ::openfl::display::_internal::DrawCommandReader data420 = data;
HXDLIN(1778)								data420->fPos = (data420->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data421 = data;
HXDLIN(1778)								data421->oPos = (data421->oPos + 4);
HXDLIN(1778)								 ::openfl::display::_internal::DrawCommandReader data422 = data;
HXDLIN(1778)								data422->iiPos = (data422->iiPos + 2);
HXDLIN(1778)								 ::openfl::display::_internal::DrawCommandReader data423 = data;
HXDLIN(1778)								data423->ffPos = (data423->ffPos + 1);
HXDLIN(1778)								 ::openfl::display::_internal::DrawCommandReader data424 = data;
HXDLIN(1778)								data424->fPos = (data424->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data425 = data;
HXDLIN(1778)								data425->oPos = (data425->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data426 = data;
HXDLIN(1778)								data426->fPos = (data426->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data427 = data;
HXDLIN(1778)								data427->fPos = (data427->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data428 = data;
HXDLIN(1778)								data428->fPos = (data428->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data429 = data;
HXDLIN(1778)								data429->fPos = (data429->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data430 = data;
HXDLIN(1778)								data430->oPos = (data430->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data431 = data;
HXDLIN(1778)								data431->fPos = (data431->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data432 = data;
HXDLIN(1778)								data432->fPos = (data432->fPos + 5);
HXDLIN(1778)								 ::openfl::display::_internal::DrawCommandReader data433 = data;
HXDLIN(1778)								data433->oPos = (data433->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data434 = data;
HXDLIN(1778)								data434->oPos = (data434->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data435 = data;
HXDLIN(1778)								data435->oPos = (data435->oPos + 2);
HXDLIN(1778)								 ::openfl::display::_internal::DrawCommandReader data436 = data;
HXDLIN(1778)								data436->bPos = (data436->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data437 = data;
HXDLIN(1778)								data437->oPos = (data437->oPos + 4);
HXDLIN(1778)								 ::openfl::display::_internal::DrawCommandReader data438 = data;
HXDLIN(1778)								data438->iiPos = (data438->iiPos + 2);
HXDLIN(1778)								 ::openfl::display::_internal::DrawCommandReader data439 = data;
HXDLIN(1778)								data439->ffPos = (data439->ffPos + 1);
HXDLIN(1778)								 ::openfl::display::_internal::DrawCommandReader data440 = data;
HXDLIN(1778)								data440->fPos = (data440->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data441 = data;
HXDLIN(1778)								data441->oPos = (data441->oPos + 4);
HXDLIN(1778)								 ::openfl::display::_internal::DrawCommandReader data442 = data;
HXDLIN(1778)								data442->iPos = (data442->iPos + 1);
HXDLIN(1778)								 ::openfl::display::_internal::DrawCommandReader data443 = data;
HXDLIN(1778)								data443->fPos = (data443->fPos + 2);
HXDLIN(1778)								 ::openfl::display::_internal::DrawCommandReader data444 = data;
HXDLIN(1778)								data444->bPos = (data444->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data445 = data;
HXDLIN(1778)								data445->fPos = (data445->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data446 = data;
HXDLIN(1778)								data446->fPos = (data446->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data447 = data;
HXDLIN(1778)								data447->oPos = (data447->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1778)								 ::openfl::display::_internal::DrawCommandReader data448 = data;
HXDLIN(1778)								data448->oPos = (data448->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXDLIN(1778)						 ::openfl::display::_internal::DrawCommandReader c12 = data;
HXLINE(1779)						path->lineTo(c12->buffer->f->__get(c12->fPos),c12->buffer->f->__get((c12->fPos + 1)));
            					}
            					break;
            					case (int)18: {
HXLINE(1782)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data449 = data;
HXDLIN(1782)								data449->oPos = (data449->oPos + 2);
HXDLIN(1782)								 ::openfl::display::_internal::DrawCommandReader data450 = data;
HXDLIN(1782)								data450->bPos = (data450->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data451 = data;
HXDLIN(1782)								data451->iPos = (data451->iPos + 1);
HXDLIN(1782)								 ::openfl::display::_internal::DrawCommandReader data452 = data;
HXDLIN(1782)								data452->fPos = (data452->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data453 = data;
HXDLIN(1782)								data453->oPos = (data453->oPos + 4);
HXDLIN(1782)								 ::openfl::display::_internal::DrawCommandReader data454 = data;
HXDLIN(1782)								data454->iiPos = (data454->iiPos + 2);
HXDLIN(1782)								 ::openfl::display::_internal::DrawCommandReader data455 = data;
HXDLIN(1782)								data455->ffPos = (data455->ffPos + 1);
HXDLIN(1782)								 ::openfl::display::_internal::DrawCommandReader data456 = data;
HXDLIN(1782)								data456->fPos = (data456->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data457 = data;
HXDLIN(1782)								data457->oPos = (data457->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data458 = data;
HXDLIN(1782)								data458->fPos = (data458->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data459 = data;
HXDLIN(1782)								data459->fPos = (data459->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data460 = data;
HXDLIN(1782)								data460->fPos = (data460->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data461 = data;
HXDLIN(1782)								data461->fPos = (data461->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data462 = data;
HXDLIN(1782)								data462->oPos = (data462->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data463 = data;
HXDLIN(1782)								data463->fPos = (data463->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data464 = data;
HXDLIN(1782)								data464->fPos = (data464->fPos + 5);
HXDLIN(1782)								 ::openfl::display::_internal::DrawCommandReader data465 = data;
HXDLIN(1782)								data465->oPos = (data465->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data466 = data;
HXDLIN(1782)								data466->oPos = (data466->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data467 = data;
HXDLIN(1782)								data467->oPos = (data467->oPos + 2);
HXDLIN(1782)								 ::openfl::display::_internal::DrawCommandReader data468 = data;
HXDLIN(1782)								data468->bPos = (data468->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data469 = data;
HXDLIN(1782)								data469->oPos = (data469->oPos + 4);
HXDLIN(1782)								 ::openfl::display::_internal::DrawCommandReader data470 = data;
HXDLIN(1782)								data470->iiPos = (data470->iiPos + 2);
HXDLIN(1782)								 ::openfl::display::_internal::DrawCommandReader data471 = data;
HXDLIN(1782)								data471->ffPos = (data471->ffPos + 1);
HXDLIN(1782)								 ::openfl::display::_internal::DrawCommandReader data472 = data;
HXDLIN(1782)								data472->fPos = (data472->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data473 = data;
HXDLIN(1782)								data473->oPos = (data473->oPos + 4);
HXDLIN(1782)								 ::openfl::display::_internal::DrawCommandReader data474 = data;
HXDLIN(1782)								data474->iPos = (data474->iPos + 1);
HXDLIN(1782)								 ::openfl::display::_internal::DrawCommandReader data475 = data;
HXDLIN(1782)								data475->fPos = (data475->fPos + 2);
HXDLIN(1782)								 ::openfl::display::_internal::DrawCommandReader data476 = data;
HXDLIN(1782)								data476->bPos = (data476->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data477 = data;
HXDLIN(1782)								data477->fPos = (data477->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data478 = data;
HXDLIN(1782)								data478->fPos = (data478->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data479 = data;
HXDLIN(1782)								data479->oPos = (data479->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1782)								 ::openfl::display::_internal::DrawCommandReader data480 = data;
HXDLIN(1782)								data480->oPos = (data480->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXDLIN(1782)						 ::openfl::display::_internal::DrawCommandReader c13 = data;
HXLINE(1783)						path->moveTo(c13->buffer->f->__get(c13->fPos),c13->buffer->f->__get((c13->fPos + 1)));
            					}
            					break;
            					default:{
HXLINE(1844)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data481 = data;
HXDLIN(1844)								data481->oPos = (data481->oPos + 2);
HXDLIN(1844)								 ::openfl::display::_internal::DrawCommandReader data482 = data;
HXDLIN(1844)								data482->bPos = (data482->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data483 = data;
HXDLIN(1844)								data483->iPos = (data483->iPos + 1);
HXDLIN(1844)								 ::openfl::display::_internal::DrawCommandReader data484 = data;
HXDLIN(1844)								data484->fPos = (data484->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data485 = data;
HXDLIN(1844)								data485->oPos = (data485->oPos + 4);
HXDLIN(1844)								 ::openfl::display::_internal::DrawCommandReader data486 = data;
HXDLIN(1844)								data486->iiPos = (data486->iiPos + 2);
HXDLIN(1844)								 ::openfl::display::_internal::DrawCommandReader data487 = data;
HXDLIN(1844)								data487->ffPos = (data487->ffPos + 1);
HXDLIN(1844)								 ::openfl::display::_internal::DrawCommandReader data488 = data;
HXDLIN(1844)								data488->fPos = (data488->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data489 = data;
HXDLIN(1844)								data489->oPos = (data489->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data490 = data;
HXDLIN(1844)								data490->fPos = (data490->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data491 = data;
HXDLIN(1844)								data491->fPos = (data491->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data492 = data;
HXDLIN(1844)								data492->fPos = (data492->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data493 = data;
HXDLIN(1844)								data493->fPos = (data493->fPos + 4);
            							}
            							break;
            							case (int)8: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data494 = data;
HXDLIN(1844)								data494->oPos = (data494->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data495 = data;
HXDLIN(1844)								data495->fPos = (data495->fPos + 4);
            							}
            							break;
            							case (int)10: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data496 = data;
HXDLIN(1844)								data496->fPos = (data496->fPos + 5);
HXDLIN(1844)								 ::openfl::display::_internal::DrawCommandReader data497 = data;
HXDLIN(1844)								data497->oPos = (data497->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data498 = data;
HXDLIN(1844)								data498->oPos = (data498->oPos + 4);
            							}
            							break;
            							case (int)13: {
            							}
            							break;
            							case (int)14: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data499 = data;
HXDLIN(1844)								data499->oPos = (data499->oPos + 2);
HXDLIN(1844)								 ::openfl::display::_internal::DrawCommandReader data500 = data;
HXDLIN(1844)								data500->bPos = (data500->bPos + 2);
            							}
            							break;
            							case (int)15: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data501 = data;
HXDLIN(1844)								data501->oPos = (data501->oPos + 4);
HXDLIN(1844)								 ::openfl::display::_internal::DrawCommandReader data502 = data;
HXDLIN(1844)								data502->iiPos = (data502->iiPos + 2);
HXDLIN(1844)								 ::openfl::display::_internal::DrawCommandReader data503 = data;
HXDLIN(1844)								data503->ffPos = (data503->ffPos + 1);
HXDLIN(1844)								 ::openfl::display::_internal::DrawCommandReader data504 = data;
HXDLIN(1844)								data504->fPos = (data504->fPos + 1);
            							}
            							break;
            							case (int)16: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data505 = data;
HXDLIN(1844)								data505->oPos = (data505->oPos + 4);
HXDLIN(1844)								 ::openfl::display::_internal::DrawCommandReader data506 = data;
HXDLIN(1844)								data506->iPos = (data506->iPos + 1);
HXDLIN(1844)								 ::openfl::display::_internal::DrawCommandReader data507 = data;
HXDLIN(1844)								data507->fPos = (data507->fPos + 2);
HXDLIN(1844)								 ::openfl::display::_internal::DrawCommandReader data508 = data;
HXDLIN(1844)								data508->bPos = (data508->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data509 = data;
HXDLIN(1844)								data509->fPos = (data509->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data510 = data;
HXDLIN(1844)								data510->fPos = (data510->fPos + 2);
            							}
            							break;
            							case (int)19: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data511 = data;
HXDLIN(1844)								data511->oPos = (data511->oPos + 1);
            							}
            							break;
            							case (int)20: {
HXLINE(1844)								 ::openfl::display::_internal::DrawCommandReader data512 = data;
HXDLIN(1844)								data512->oPos = (data512->oPos + 1);
            							}
            							break;
            							case (int)21: case (int)22: {
            							}
...
HXLINE(1915)			bool _hx_tmp3;
HXDLIN(1915)			if ((this->_hx___width < 1)) {
HXLINE(1915)				_hx_tmp3 = (this->_hx___height >= 1);
            			}
            			else {
HXLINE(1915)				_hx_tmp3 = true;
            			}
HXDLIN(1915)			if (_hx_tmp3) {
...
HXLINE(1921)		bool _hx_tmp4;
HXDLIN(1921)		if (::hx::IsNotNull( ::openfl::display::Graphics_obj::maxTextureWidth )) {
HXLINE(1921)			_hx_tmp4 = ::hx::IsGreater( width,::openfl::display::Graphics_obj::maxTextureWidth );
            		}
            		else {
...
HXLINE(1927)		bool _hx_tmp5;
HXDLIN(1927)		if (::hx::IsNotNull( ::openfl::display::Graphics_obj::maxTextureWidth )) {
HXLINE(1927)			_hx_tmp5 = ::hx::IsGreater( height,::openfl::display::Graphics_obj::maxTextureHeight );
            		}
            		else {
HXLINE(1927)			_hx_tmp5 = false;
            		}
HXDLIN(1927)		if (_hx_tmp5) {
...
HXDLIN(1983)		Float _hx_tmp6;
HXDLIN(1983)		if ((norm == 0)) {
HXLINE(1983)			_hx_tmp6 = -(_this->tx);
            		}
            		else {
HXLINE(1983)			_hx_tmp6 = ((((Float)1.0) / norm) * ((_this->c * (_this->ty - ty)) + (_this->d * (tx - _this->tx))));
            		}
HXDLIN(1983)		this->_hx___renderTransform->tx = _hx_tmp6;
...
HXDLIN(1984)		Float _hx_tmp7;
HXDLIN(1984)		if ((norm1 == 0)) {
HXLINE(1984)			_hx_tmp7 = -(_this1->ty);
            		}
            		else {
HXLINE(1984)			_hx_tmp7 = ((((Float)1.0) / norm1) * ((_this1->a * (ty - _this1->ty)) + (_this1->b * (_this1->tx - tx))));
            		}
HXDLIN(1984)		this->_hx___renderTransform->ty = _hx_tmp7;
HXLINE(1991)		int newWidth = ::Math_obj::ceil((width + ((Float)1.0)));
HXLINE(1992)		int newHeight = ::Math_obj::ceil((height + ((Float)1.0)));
HXLINE(1995)		bool _hx_tmp8;
HXDLIN(1995)		if ((newWidth == this->_hx___width)) {
HXLINE(1995)			_hx_tmp8 = (newHeight != this->_hx___height);
            		}
            		else {
HXLINE(1995)			_hx_tmp8 = true;
            		}
HXDLIN(1995)		if (_hx_tmp8) {

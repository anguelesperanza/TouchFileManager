...
HXLINE( 200)				 ::openfl::errors::ArgumentError error1 =  ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("Error #3783: A Stage object cannot be added as the child of another object.",fa,51,93,42));
HXLINE( 201)				error1->errorID = 3783;
HXLINE( 202)				HX_STACK_DO_THROW(error1);
            			}
            		}
...
HXLINE( 208)			HX_STACK_DO_THROW((HX_("Invalid index position ",80,59,50,86) + index));
            		}
...
HXLINE( 454)					_hx_tmp1 = ::hx::IsInstanceEq( this->stage->get_focus(),child );
            				}
            				else {
...
HXLINE( 459)				 ::openfl::events::Event event1 =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("removedFromStage",34,21,76,ba),false,false);
HXLINE( 460)				child->_hx___dispatchWithCapture(event1);
HXLINE( 461)				child->_hx___dispatchChildren(event1);
...
HXLINE( 790)				_hx_tmp2 = !(this->mouseEnabled);
            			}
            			else {
...
HXLINE( 791)		bool _hx_tmp3;
HXDLIN( 791)		if (::hx::IsNotNull( this->get_mask() )) {
HXLINE( 791)			_hx_tmp3 = !(this->get_mask()->_hx___hitTestMask(x,y));
            		}
            		else {
HXLINE( 791)			_hx_tmp3 = false;
            		}
HXDLIN( 791)		if (_hx_tmp3) {
...
HXLINE( 811)				_hx_tmp4 = !(this->mouseChildren);
            			}
            			else {
...
HXLINE( 837)						bool _hx_tmp5;
HXDLIN( 837)						if (!(interactive)) {
HXLINE( 837)							if (this->mouseEnabled) {
HXLINE( 837)								_hx_tmp5 = !(hitTest);
            							}
            							else {
HXLINE( 837)								_hx_tmp5 = false;
            							}
            						}
            						else {
HXLINE( 837)							_hx_tmp5 = true;
            						}
HXDLIN( 837)						if (_hx_tmp5) {
...
HXLINE( 843)								bool _hx_tmp6;
HXDLIN( 843)								if (interactive) {
HXLINE( 843)									_hx_tmp6 = (stack->length > length);
            								}
            								else {
HXLINE( 843)									_hx_tmp6 = false;
            								}
...
HXLINE( 860)			bool hitTest1 = false;

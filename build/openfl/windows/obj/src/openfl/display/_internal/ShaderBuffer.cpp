...
HXLINE( 172)				 ::openfl::display::_internal::ShaderBuffer _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 188)				 ::openfl::display::_internal::ShaderBuffer _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
...
HXDLIN( 199)						_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 199)						_this->copyFromArray(array,null());
HXDLIN( 199)						this1 = _this;
            					}
            					else {
HXLINE( 199)						if (::hx::IsNotNull( vector )) {
HXLINE( 199)							 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 199)							::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 199)							_this1->byteOffset = 0;
HXDLIN( 199)							_this1->length = array1->get_length();
HXDLIN( 199)							_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 199)							_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 199)							_this1->copyFromArray(array1,null());
HXDLIN( 199)							this1 = _this1;
            						}
            						else {
HXLINE( 199)							if (::hx::IsNotNull( view )) {
HXLINE( 199)								 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 199)								int elementSize = _this2->bytesPerElement;
HXDLIN( 199)								if ((view->type == _this2->type)) {
HXLINE( 199)									int srcLength1 = srcData->length;
HXDLIN( 199)									int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 199)									_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 199)									_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            								}
            								else {
HXLINE( 199)									HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            								}
HXDLIN( 199)								_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 199)								_this2->byteOffset = 0;
HXDLIN( 199)								_this2->length = srcLength;
HXDLIN( 199)								this1 = _this2;
            							}
            							else {
HXLINE( 199)								if (::hx::IsNotNull( buffer )) {
HXLINE( 199)									 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 199)									if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 199)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 199)									int bufferByteLength = buffer->length;
HXDLIN( 199)									int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 199)										if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 199)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
...
HXLINE( 199)										newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 199)										int newRange = (in_byteOffset + newByteLength);
HXDLIN( 199)										if ((newRange > bufferByteLength)) {
HXLINE( 199)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
HXDLIN( 199)									_this3->buffer = buffer;
HXDLIN( 199)									_this3->byteOffset = in_byteOffset;
HXDLIN( 199)									_this3->byteLength = newByteLength;
HXDLIN( 199)									_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 199)									this1 = _this3;
            								}
            								else {
...
HXDLIN( 203)					 ::haxe::io::Bytes buffer1 = null();
HXDLIN( 203)					::cpp::VirtualArray array2 = null();
HXDLIN( 203)					 ::openfl::_Vector::FloatVector vector1 = null();
HXDLIN( 203)					 ::lime::utils::ArrayBufferView view1 = null();
HXDLIN( 203)					 ::Dynamic len1 = null();
...
HXLINE( 203)						if (::hx::IsNotNull( array2 )) {
HXLINE( 203)							 ::lime::utils::ArrayBufferView _this4 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 203)							_this4->byteOffset = 0;
HXDLIN( 203)							_this4->length = array2->get_length();
HXDLIN( 203)							_this4->byteLength = (_this4->length * _this4->bytesPerElement);
HXDLIN( 203)							_this4->buffer = ::haxe::io::Bytes_obj::alloc(_this4->byteLength);
HXDLIN( 203)							_this4->copyFromArray(array2,null());
HXDLIN( 203)							this2 = _this4;
            						}
            						else {
HXLINE( 203)							if (::hx::IsNotNull( vector1 )) {
HXLINE( 203)								 ::lime::utils::ArrayBufferView _this5 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 203)								::cpp::VirtualArray array3 = ( (::cpp::VirtualArray)(vector1->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 203)								_this5->byteOffset = 0;
HXDLIN( 203)								_this5->length = array3->get_length();
HXDLIN( 203)								_this5->byteLength = (_this5->length * _this5->bytesPerElement);
HXDLIN( 203)								_this5->buffer = ::haxe::io::Bytes_obj::alloc(_this5->byteLength);
HXDLIN( 203)								_this5->copyFromArray(array3,null());
HXDLIN( 203)								this2 = _this5;
            							}
            							else {
HXLINE( 203)								if (::hx::IsNotNull( view1 )) {
HXLINE( 203)									 ::lime::utils::ArrayBufferView _this6 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 203)									 ::haxe::io::Bytes srcData1 = view1->buffer;
HXDLIN( 203)									int srcLength2 = view1->length;
HXDLIN( 203)									int srcByteOffset1 = view1->byteOffset;
HXDLIN( 203)									int srcElementSize1 = view1->bytesPerElement;
HXDLIN( 203)									int elementSize2 = _this6->bytesPerElement;
HXDLIN( 203)									if ((view1->type == _this6->type)) {
HXLINE( 203)										int srcLength3 = srcData1->length;
HXDLIN( 203)										int cloneLength1 = (srcLength3 - srcByteOffset1);
HXDLIN( 203)										_this6->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN( 203)										_this6->buffer->blit(0,srcData1,srcByteOffset1,cloneLength1);
            									}
            									else {
HXLINE( 203)										HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            									}
HXDLIN( 203)									_this6->byteLength = (_this6->bytesPerElement * srcLength2);
HXDLIN( 203)									_this6->byteOffset = 0;
HXDLIN( 203)									_this6->length = srcLength2;
HXDLIN( 203)									this2 = _this6;
            								}
            								else {
HXLINE( 203)									if (::hx::IsNotNull( buffer1 )) {
HXLINE( 203)										 ::lime::utils::ArrayBufferView _this7 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 203)										int in_byteOffset1 = 0;
HXDLIN( 203)										if ((in_byteOffset1 < 0)) {
HXLINE( 203)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
HXDLIN( 203)										if ((::hx::Mod(in_byteOffset1,_this7->bytesPerElement) != 0)) {
HXLINE( 203)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
HXDLIN( 203)										int bufferByteLength1 = buffer1->length;
HXDLIN( 203)										int elementSize3 = _this7->bytesPerElement;
HXDLIN( 203)										int newByteLength1 = bufferByteLength1;
HXDLIN( 203)										if (::hx::IsNull( len1 )) {
HXLINE( 203)											newByteLength1 = (bufferByteLength1 - in_byteOffset1);
HXDLIN( 203)											if ((::hx::Mod(bufferByteLength1,_this7->bytesPerElement) != 0)) {
HXLINE( 203)												HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            											}
HXDLIN( 203)											if ((newByteLength1 < 0)) {
HXLINE( 203)												HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            											}
            										}
            										else {
HXLINE( 203)											newByteLength1 = (( (int)(len1) ) * _this7->bytesPerElement);
HXDLIN( 203)											int newRange1 = (in_byteOffset1 + newByteLength1);
HXDLIN( 203)											if ((newRange1 > bufferByteLength1)) {
HXLINE( 203)												HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            											}
            										}
HXDLIN( 203)										_this7->buffer = buffer1;
HXDLIN( 203)										_this7->byteOffset = in_byteOffset1;
HXDLIN( 203)										_this7->byteLength = newByteLength1;
HXDLIN( 203)										_this7->length = ::Std_obj::_hx_int((( (Float)(newByteLength1) ) / ( (Float)(_this7->bytesPerElement) )));
HXDLIN( 203)										this2 = _this7;
            									}
            									else {
...
HXLINE( 204)					{
HXLINE( 204)						 ::lime::utils::ArrayBufferView view2 = this->paramData;
HXDLIN( 204)						::cpp::VirtualArray array4 = null();
HXDLIN( 204)						int offset = 0;
HXDLIN( 204)						bool _hx_tmp3;
HXDLIN( 204)						if (::hx::IsNotNull( view2 )) {
HXLINE( 204)							_hx_tmp3 = ::hx::IsNull( array4 );
            						}
            						else {
HXLINE( 204)							_hx_tmp3 = false;
            						}
HXDLIN( 204)						if (_hx_tmp3) {
HXLINE( 204)							data->buffer->blit((offset * data->bytesPerElement),view2->buffer,view2->byteOffset,view2->byteLength);
            						}
            						else {
HXLINE( 204)							bool _hx_tmp4;
HXDLIN( 204)							if (::hx::IsNotNull( array4 )) {
HXLINE( 204)								_hx_tmp4 = ::hx::IsNull( view2 );
            							}
            							else {
HXLINE( 204)								_hx_tmp4 = false;
            							}
HXDLIN( 204)							if (_hx_tmp4) {
HXLINE( 204)								data->copyFromArray(array4,offset);
            							}
            							else {
...
HXLINE( 225)					{
HXLINE( 225)						int _g10 = 0;
HXDLIN( 225)						int _g11 = length1;
HXDLIN( 225)						while((_g10 < _g11)){
HXLINE( 225)							_g10 = (_g10 + 1);
HXDLIN( 225)							int j = (_g10 - 1);
HXLINE( 227)							{
...
HXLINE( 236)						{
HXLINE( 236)							int _g12 = 0;
HXDLIN( 236)							int _g13 = length1;
HXDLIN( 236)							while((_g12 < _g13)){
HXLINE( 236)								_g12 = (_g12 + 1);
HXDLIN( 236)								int j1 = (_g12 - 1);
HXLINE( 238)								{
...
HXLINE( 247)						{
HXLINE( 247)							int _g14 = 0;
HXDLIN( 247)							int _g15 = length1;
HXDLIN( 247)							while((_g14 < _g15)){
HXLINE( 247)								_g14 = (_g14 + 1);
HXDLIN( 247)								int j2 = (_g14 - 1);
HXLINE( 249)								{

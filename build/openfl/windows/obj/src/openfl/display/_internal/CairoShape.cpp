...
HXLINE(  52)					_hx_tmp4 = (transform->b == 0);
            				}
            				else {
HXLINE(  52)					_hx_tmp4 = false;
            				}
HXDLIN(  52)				if (_hx_tmp4) {
HXLINE(  52)					_hx_tmp3 = (transform->c == 0);
            				}
            				else {
...
HXLINE( 127)						_hx_tmp5 = (centerHeight != 0);
            					}
            					else {
...
HXLINE( 142)						bool _hx_tmp6;
HXDLIN( 142)						if ((centerWidth == 0)) {
HXLINE( 142)							_hx_tmp6 = (centerHeight != 0);
            						}
            						else {
...
HXLINE( 150)								_hx_tmp7 = (centerWidth != 0);
            							}
            							else {
HXLINE( 150)								_hx_tmp7 = false;
            							}
...
HXLINE( 163)					 ::openfl::geom::Matrix renderTransform1 = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 164)					renderTransform1->scale((( (Float)(1) ) / graphics->_hx___bitmapScale),(( (Float)(1) ) / graphics->_hx___bitmapScale));
HXLINE( 165)					renderTransform1->concat(transform);
HXLINE( 167)					renderer->applyMatrix(renderTransform1,cairo);
...
HXLINE( 180)					::openfl::geom::Matrix_obj::_hx___pool->release(renderTransform1);
            				}
...
HXDLIN( 191)					_hx_tmp2 = ::hx::IsNotNull( bitmap->_hx___bitmapData );
            				}
            				else {
HXDLIN( 191)					_hx_tmp2 = false;
            				}
HXDLIN( 191)				if (_hx_tmp2) {
HXDLIN( 191)					_hx_tmp1 = bitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
...
HXDLIN( 191)							_hx_tmp4 = bitmap->smoothing;
            						}
            						else {
HXDLIN( 191)							_hx_tmp4 = false;
            						}
HXDLIN( 191)						if (_hx_tmp4) {
HXDLIN( 191)							_hx_tmp3 = 1;
            						}
            						else {
HXDLIN( 191)							_hx_tmp3 = 3;
            						}
HXDLIN( 191)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp3);

...
HXLINE(  76)				_hx_tmp2 = ::hx::IsNull( bitmap->_hx___graphics );
            			}
            			else {
...
HXLINE(  76)					_hx_tmp3 = (bitmap->_hx___worldAlpha <= 0);
            				}
            				else {
...
HXLINE(  76)						_hx_tmp6 = !(bitmap->_hx___isCacheBitmapRender);
            					}
            					else {
HXLINE(  76)						_hx_tmp6 = false;
            					}
HXDLIN(  76)					if (_hx_tmp6) {
HXLINE(  76)						_hx_tmp5 = (bitmap->get_width() > 0);
            					}
            					else {
HXLINE(  76)						_hx_tmp5 = false;
            					}
HXDLIN(  76)					if (_hx_tmp5) {
HXLINE(  76)						_hx_tmp4 = (bitmap->get_height() > 0);
            					}
            					else {
...
HXDLIN(  76)						Float _hx_tmp7 = bitmap->get_width();
HXDLIN(  76)						rect->setTo(( (Float)(0) ),( (Float)(0) ),_hx_tmp7,bitmap->get_height());

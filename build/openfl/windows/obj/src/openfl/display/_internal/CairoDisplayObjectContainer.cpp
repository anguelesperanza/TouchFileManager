...
HXLINE(  18)						_hx_tmp3 = ::hx::IsNotNull( bitmap->_hx___bitmapData );
            					}
            					else {
HXLINE(  18)						_hx_tmp3 = false;
            					}
HXDLIN(  18)					if (_hx_tmp3) {
HXLINE(  18)						_hx_tmp2 = bitmap->_hx___bitmapData->_hx___isValid;
            					}
            					else {
...
HXLINE(  18)								_hx_tmp5 = bitmap->smoothing;
            							}
            							else {
HXLINE(  18)								_hx_tmp5 = false;
            							}
HXDLIN(  18)							if (_hx_tmp5) {
HXLINE(  18)								_hx_tmp4 = 1;
            							}
            							else {
HXLINE(  18)								_hx_tmp4 = 3;
            							}
HXDLIN(  18)							::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp4);
...
HXLINE(  20)			_hx_tmp6 = !(displayObjectContainer->_hx___isCacheBitmapRender);
            		}
            		else {
HXLINE(  20)			_hx_tmp6 = false;
            		}

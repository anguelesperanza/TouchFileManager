...
HXLINE(  71)			 ::Dynamic _hx_tmp3 = ::hx::ClassOf< ::openfl::display::_internal::Context3DTilemap >();
...
HXLINE( 126)				 ::openfl::display::Tile tile1 = tiles->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 126)				_g = (_g + 1);
HXLINE( 128)				Float _hx_tmp1 = -(tile1->get_originX());
HXDLIN( 128)				tileTransform->setTo(( (Float)(1) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ),_hx_tmp1,-(tile1->get_originY()));
HXLINE( 129)				tileTransform->concat(tile1->get_matrix());
...
HXLINE( 138)				if (::hx::IsNotNull( tile1->get_tileset() )) {
HXLINE( 138)					tileset = tile1->get_tileset();
            				}
            				else {
HXLINE( 138)					tileset = defaultTileset;
            				}
HXLINE( 140)				alpha = (tile1->get_alpha() * worldAlpha);
HXLINE( 141)				visible = tile1->get_visible();
HXLINE( 142)				tile1->_hx___dirty = false;
HXLINE( 144)				bool _hx_tmp2;
HXDLIN( 144)				if (visible) {
HXLINE( 144)					_hx_tmp2 = (alpha <= 0);
            				}
            				else {
...
HXLINE( 148)					if (::hx::IsNotNull( tile1->get_colorTransform() )) {
HXLINE( 150)						if (::hx::IsNull( defaultColorTransform )) {
HXLINE( 152)							colorTransform = tile1->get_colorTransform();
            						}
            						else {
...
HXDLIN( 162)							colorTransform->redMultiplier = (defaultColorTransform1 * tile1->get_colorTransform()->redMultiplier);
HXLINE( 163)							Float defaultColorTransform2 = defaultColorTransform->greenMultiplier;
HXDLIN( 163)							colorTransform->greenMultiplier = (defaultColorTransform2 * tile1->get_colorTransform()->greenMultiplier);
HXLINE( 164)							Float defaultColorTransform3 = defaultColorTransform->blueMultiplier;
HXDLIN( 164)							colorTransform->blueMultiplier = (defaultColorTransform3 * tile1->get_colorTransform()->blueMultiplier);
HXLINE( 165)							Float defaultColorTransform4 = defaultColorTransform->alphaMultiplier;
HXDLIN( 165)							colorTransform->alphaMultiplier = (defaultColorTransform4 * tile1->get_colorTransform()->alphaMultiplier);
HXLINE( 166)							Float defaultColorTransform5 = defaultColorTransform->redOffset;
HXDLIN( 166)							colorTransform->redOffset = (defaultColorTransform5 + tile1->get_colorTransform()->redOffset);
HXLINE( 167)							Float defaultColorTransform6 = defaultColorTransform->greenOffset;
HXDLIN( 167)							colorTransform->greenOffset = (defaultColorTransform6 + tile1->get_colorTransform()->greenOffset);
HXLINE( 168)							Float defaultColorTransform7 = defaultColorTransform->blueOffset;
HXDLIN( 168)							colorTransform->blueOffset = (defaultColorTransform7 + tile1->get_colorTransform()->blueOffset);
HXLINE( 169)							Float defaultColorTransform8 = defaultColorTransform->alphaOffset;
HXDLIN( 169)							colorTransform->alphaOffset = (defaultColorTransform8 + tile1->get_colorTransform()->alphaOffset);
            						}
            					}
            					else {
...
HXLINE( 180)				if ((tile1->__length > 0)) {
HXLINE( 182)					::openfl::display::_internal::Context3DTilemap_obj::buildBufferTileContainer(tilemap,( ( ::openfl::display::TileContainer)(tile1) ),renderer,tileTransform,tileset,alphaEnabled,alpha,colorTransformEnabled,colorTransform,cacheBitmapData,rect,matrix,false);
            				}
            				else {
HXLINE( 187)					if (::hx::IsNull( tileset )) {
HXLINE( 187)						continue;
            					}
HXLINE( 189)					id = tile1->get_id();
HXLINE( 191)					bitmapData = tileset->_hx___bitmapData;
HXLINE( 192)					if (::hx::IsNull( bitmapData )) {
HXLINE( 192)						continue;
            					}
HXLINE( 194)					if ((id == -1)) {
HXLINE( 196)						tileRect = tile1->_hx___rect;
HXLINE( 197)						bool _hx_tmp3;
HXDLIN( 197)						bool _hx_tmp4;
HXDLIN( 197)						if (::hx::IsNotNull( tileRect )) {
HXLINE( 197)							_hx_tmp4 = (tileRect->width <= 0);
            						}
            						else {
HXLINE( 197)							_hx_tmp4 = true;
            						}
HXDLIN( 197)						if (!(_hx_tmp4)) {
HXLINE( 197)							_hx_tmp3 = (tileRect->height <= 0);
            						}
            						else {
...
HXLINE( 256)						{
HXLINE( 256)							 ::lime::utils::ArrayBufferView this17 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 256)							 ::__hxcpp_memory_set_float(this17->buffer->b,(this17->byteOffset + (((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * 0)) + alphaPosition) * 4)),alpha);
            						}
HXDLIN( 256)						{
HXLINE( 256)							 ::lime::utils::ArrayBufferView this18 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 256)							 ::__hxcpp_memory_set_float(this18->buffer->b,(this18->byteOffset + (((vertexOffset + ::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex) + alphaPosition) * 4)),alpha);
            						}
HXDLIN( 256)						{
HXLINE( 256)							 ::lime::utils::ArrayBufferView this19 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 256)							 ::__hxcpp_memory_set_float(this19->buffer->b,(this19->byteOffset + (((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * 2)) + alphaPosition) * 4)),alpha);
            						}
HXDLIN( 256)						{
HXLINE( 256)							 ::lime::utils::ArrayBufferView this20 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 256)							 ::__hxcpp_memory_set_float(this20->buffer->b,(this20->byteOffset + (((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * 3)) + alphaPosition) * 4)),alpha);
            						}
            					}
HXLINE( 260)					if (colorTransformEnabled) {
HXLINE( 262)						if (::hx::IsNotNull( colorTransform )) {
HXLINE( 264)							int _g1 = 0;
HXDLIN( 264)							while((_g1 < 4)){
HXLINE( 264)								_g1 = (_g1 + 1);
HXDLIN( 264)								int i = (_g1 - 1);
HXLINE( 266)								{
HXLINE( 266)									 ::lime::utils::ArrayBufferView this21 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 266)									Float val = colorTransform->redMultiplier;
HXDLIN( 266)									 ::__hxcpp_memory_set_float(this21->buffer->b,(this21->byteOffset + (((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) * 4)),val);
            								}
HXLINE( 267)								{
HXLINE( 267)									 ::lime::utils::ArrayBufferView this22 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 267)									Float val1 = colorTransform->greenMultiplier;
HXDLIN( 267)									 ::__hxcpp_memory_set_float(this22->buffer->b,(this22->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 1) * 4)),val1);
            								}
HXLINE( 268)								{
HXLINE( 268)									 ::lime::utils::ArrayBufferView this23 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 268)									Float val2 = colorTransform->blueMultiplier;
HXDLIN( 268)									 ::__hxcpp_memory_set_float(this23->buffer->b,(this23->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 2) * 4)),val2);
            								}
HXLINE( 269)								{
HXLINE( 269)									 ::lime::utils::ArrayBufferView this24 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 269)									Float val3 = colorTransform->alphaMultiplier;
HXDLIN( 269)									 ::__hxcpp_memory_set_float(this24->buffer->b,(this24->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 3) * 4)),val3);
            								}
HXLINE( 271)								{
HXLINE( 271)									 ::lime::utils::ArrayBufferView this25 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 271)									Float val4 = colorTransform->redOffset;
HXDLIN( 271)									 ::__hxcpp_memory_set_float(this25->buffer->b,(this25->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 4) * 4)),val4);
            								}
HXLINE( 272)								{
HXLINE( 272)									 ::lime::utils::ArrayBufferView this26 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 272)									Float val5 = colorTransform->greenOffset;
HXDLIN( 272)									 ::__hxcpp_memory_set_float(this26->buffer->b,(this26->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 5) * 4)),val5);
            								}
HXLINE( 273)								{
HXLINE( 273)									 ::lime::utils::ArrayBufferView this27 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 273)									Float val6 = colorTransform->blueOffset;
HXDLIN( 273)									 ::__hxcpp_memory_set_float(this27->buffer->b,(this27->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 6) * 4)),val6);
            								}
HXLINE( 274)								{
HXLINE( 274)									 ::lime::utils::ArrayBufferView this28 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 274)									Float val7 = colorTransform->alphaOffset;
HXDLIN( 274)									 ::__hxcpp_memory_set_float(this28->buffer->b,(this28->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 7) * 4)),val7);
            								}
            							}
            						}
            						else {
HXLINE( 279)							int _g2 = 0;
HXDLIN( 279)							while((_g2 < 4)){
HXLINE( 279)								_g2 = (_g2 + 1);
HXDLIN( 279)								int i1 = (_g2 - 1);
HXLINE( 281)								{
HXLINE( 281)									 ::lime::utils::ArrayBufferView this29 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 281)									 ::__hxcpp_memory_set_float(this29->buffer->b,(this29->byteOffset + (((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) * 4)),1);
            								}
HXLINE( 282)								{
HXLINE( 282)									 ::lime::utils::ArrayBufferView this30 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 282)									 ::__hxcpp_memory_set_float(this30->buffer->b,(this30->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 1) * 4)),1);
            								}
HXLINE( 283)								{
HXLINE( 283)									 ::lime::utils::ArrayBufferView this31 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 283)									 ::__hxcpp_memory_set_float(this31->buffer->b,(this31->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 2) * 4)),1);
            								}
HXLINE( 284)								{
HXLINE( 284)									 ::lime::utils::ArrayBufferView this32 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 284)									 ::__hxcpp_memory_set_float(this32->buffer->b,(this32->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 3) * 4)),1);
            								}
HXLINE( 286)								{
HXLINE( 286)									 ::lime::utils::ArrayBufferView this33 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 286)									 ::__hxcpp_memory_set_float(this33->buffer->b,(this33->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 4) * 4)),0);
            								}
HXLINE( 287)								{
HXLINE( 287)									 ::lime::utils::ArrayBufferView this34 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 287)									 ::__hxcpp_memory_set_float(this34->buffer->b,(this34->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 5) * 4)),0);
            								}
HXLINE( 288)								{
HXLINE( 288)									 ::lime::utils::ArrayBufferView this35 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 288)									 ::__hxcpp_memory_set_float(this35->buffer->b,(this35->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 6) * 4)),0);
            								}
HXLINE( 289)								{
HXLINE( 289)									 ::lime::utils::ArrayBufferView this36 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 289)									 ::__hxcpp_memory_set_float(this36->buffer->b,(this36->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 7) * 4)),0);
            								}
            							}
            						}
            					}
HXLINE( 294)					 ::Dynamic _hx_tmp5 = ::hx::ClassOf< ::openfl::display::_internal::Context3DTilemap >();
...
HXLINE( 383)				 ::Dynamic _hx_tmp2 = ::hx::ClassOf< ::openfl::display::_internal::Context3DTilemap >();
...
HXLINE( 450)				_hx_tmp1 = ::hx::IsNull( tilemap->_hx___graphics );
            			}
            			else {
...
HXLINE( 450)					_hx_tmp2 = (tilemap->_hx___worldAlpha <= 0);
            				}
            				else {
...
HXLINE( 450)						_hx_tmp5 = !(tilemap->_hx___isCacheBitmapRender);
            					}
            					else {
HXLINE( 450)						_hx_tmp5 = false;
            					}
HXDLIN( 450)					if (_hx_tmp5) {
HXLINE( 450)						_hx_tmp4 = (tilemap->get_width() > 0);
            					}
            					else {
HXLINE( 450)						_hx_tmp4 = false;
            					}
HXDLIN( 450)					if (_hx_tmp4) {
HXLINE( 450)						_hx_tmp3 = (tilemap->get_height() > 0);
            					}
            					else {
...
HXDLIN( 450)						Float _hx_tmp6 = tilemap->get_width();
HXDLIN( 450)						rect->setTo(( (Float)(0) ),( (Float)(0) ),_hx_tmp6,tilemap->get_height());
...
HXDLIN( 467)			bool _hx_tmp3;
HXDLIN( 467)			if (::hx::IsNotNull( tilemap->opaqueBackground )) {
HXLINE( 467)				_hx_tmp3 = !(tilemap->_hx___isCacheBitmapRender);
            			}
            			else {
HXLINE( 467)				_hx_tmp3 = false;
            			}
HXDLIN( 467)			if (_hx_tmp3) {
HXLINE( 467)				_hx_tmp2 = (tilemap->get_width() > 0);
            			}
            			else {
HXLINE( 467)				_hx_tmp2 = false;
            			}
HXDLIN( 467)			if (_hx_tmp2) {
HXLINE( 467)				_hx_tmp1 = (tilemap->get_height() > 0);
            			}
            			else {
...
HXLINE( 489)				 ::openfl::display::Tile tile1 = tiles->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 489)				_g = (_g + 1);
HXLINE( 491)				if (::hx::IsNotNull( tile1->get_tileset() )) {
HXLINE( 491)					tileset = tile1->get_tileset();
            				}
            				else {
HXLINE( 491)					tileset = defaultTileset;
            				}
HXLINE( 493)				alpha = (tile1->get_alpha() * worldAlpha);
HXLINE( 494)				visible = tile1->get_visible();
...
HXLINE( 497)				if (::hx::IsNotNull( tile1->get_shader() )) {
HXLINE( 497)					shader = tile1->get_shader();
            				}
            				else {
HXLINE( 497)					shader = defaultShader;
            				}
HXLINE( 499)				if (blendModeEnabled) {
HXLINE( 501)					if (::hx::IsNotNull( tile1->_hx___blendMode )) {
HXLINE( 501)						blendMode = tile1->_hx___blendMode;
            					}
            					else {
HXLINE( 501)						blendMode = defaultBlendMode;
            					}
            				}
HXLINE( 504)				if ((tile1->__length > 0)) {
HXLINE( 506)					::openfl::display::_internal::Context3DTilemap_obj::renderTileContainer(tilemap,renderer,( ( ::openfl::display::TileContainer)(tile1) ),shader,tileset,alpha,blendModeEnabled,blendMode,cacheBitmapData);
            				}
            				else {
HXLINE( 510)					if (::hx::IsNull( tileset )) {
HXLINE( 510)						continue;
            					}
HXLINE( 512)					id = tile1->get_id();
HXLINE( 514)					bitmapData = tileset->_hx___bitmapData;
HXLINE( 515)					if (::hx::IsNull( bitmapData )) {
HXLINE( 515)						continue;
            					}
HXLINE( 517)					if ((id == -1)) {
HXLINE( 519)						tileRect = tile1->_hx___rect;
HXLINE( 520)						bool _hx_tmp1;
HXDLIN( 520)						bool _hx_tmp2;
HXDLIN( 520)						if (::hx::IsNotNull( tileRect )) {
HXLINE( 520)							_hx_tmp2 = (tileRect->width <= 0);
            						}
            						else {
HXLINE( 520)							_hx_tmp2 = true;
            						}
HXDLIN( 520)						if (!(_hx_tmp2)) {
HXLINE( 520)							_hx_tmp1 = (tileRect->height <= 0);
            						}
            						else {
...
HXLINE( 528)							_hx_tmp4 = ::hx::IsNotNull( ::openfl::display::_internal::Context3DTilemap_obj::currentBitmapData );
            						}
            						else {
HXLINE( 528)							_hx_tmp4 = false;
            						}
            					}
            					else {
HXLINE( 528)						_hx_tmp4 = true;
            					}
HXDLIN( 528)					if (!(_hx_tmp4)) {
HXLINE( 528)						_hx_tmp3 = ::hx::IsNotEq( ::openfl::display::_internal::Context3DTilemap_obj::currentBlendMode,blendMode );
            					}
            					else {

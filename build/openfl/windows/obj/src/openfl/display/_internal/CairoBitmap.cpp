...
HXLINE(  81)					_hx_tmp3 = ::hx::IsNotNull( _hx___cacheBitmap->_hx___bitmapData );
            				}
            				else {
HXLINE(  81)					_hx_tmp3 = false;
            				}
HXDLIN(  81)				if (_hx_tmp3) {
HXLINE(  81)					_hx_tmp2 = _hx___cacheBitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
...
HXDLIN(  81)						int _hx_tmp4;
HXDLIN(  81)						bool _hx_tmp5;
HXDLIN(  81)						if (renderer->_hx___allowSmoothing) {
HXLINE(  81)							_hx_tmp5 = _hx___cacheBitmap->smoothing;
            						}
            						else {
HXLINE(  81)							_hx_tmp5 = false;
            						}
HXDLIN(  81)						if (_hx_tmp5) {
HXLINE(  81)							_hx_tmp4 = 1;
            						}
            						else {
HXLINE(  81)							_hx_tmp4 = 3;
            						}
HXDLIN(  81)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp4);
...
HXLINE(  86)				Float alpha1 = renderer->_hx___getAlpha(bitmap->_hx___worldAlpha);
HXDLIN(  86)				bool _hx_tmp6;
HXDLIN(  86)				bool _hx_tmp7;
HXDLIN(  86)				if ((alpha1 > 0)) {
HXLINE(  86)					_hx_tmp7 = ::hx::IsNotNull( bitmap->_hx___bitmapData );
            				}
            				else {
HXLINE(  86)					_hx_tmp7 = false;
            				}
HXDLIN(  86)				if (_hx_tmp7) {
HXLINE(  86)					_hx_tmp6 = bitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
HXLINE(  86)					_hx_tmp6 = false;
            				}
HXDLIN(  86)				if (_hx_tmp6) {
HXLINE(  86)					 ::lime::graphics::cairo::Cairo cairo1 = renderer->cairo;
HXDLIN(  86)					renderer->_hx___setBlendMode(bitmap->_hx___worldBlendMode);
HXDLIN(  86)					renderer->_hx___pushMaskObject(bitmap,null());
HXDLIN(  86)					renderer->applyMatrix(bitmap->_hx___renderTransform,cairo1);
HXDLIN(  86)					 ::Dynamic surface1 = bitmap->_hx___bitmapData->getSurface();
HXDLIN(  86)					if (::hx::IsNotNull( surface1 )) {
HXLINE(  86)						 ::Dynamic pattern1 = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(surface1);
HXDLIN(  86)						int _hx_tmp8;
HXDLIN(  86)						bool _hx_tmp9;
HXDLIN(  86)						if (renderer->_hx___allowSmoothing) {
HXLINE(  86)							_hx_tmp9 = bitmap->smoothing;
            						}
            						else {
HXLINE(  86)							_hx_tmp9 = false;
            						}
HXDLIN(  86)						if (_hx_tmp9) {
HXLINE(  86)							_hx_tmp8 = 1;
            						}
            						else {
HXLINE(  86)							_hx_tmp8 = 3;
            						}
HXDLIN(  86)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern1,_hx_tmp8);
HXDLIN(  86)						cairo1->set_source(pattern1);
HXDLIN(  86)						if ((alpha1 == 1)) {
HXLINE(  86)							cairo1->paint();
            						}
            						else {
HXLINE(  86)							cairo1->paintWithAlpha(alpha1);
            						}
            					}

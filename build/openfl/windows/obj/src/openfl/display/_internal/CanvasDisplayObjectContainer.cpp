...
HXLINE(  35)			int _g2 = 0;
HXDLIN(  35)			::Array< ::Dynamic> _g3 = displayObjectContainer->_hx___children;
HXDLIN(  35)			while((_g2 < _g3->length)){
HXLINE(  35)				 ::openfl::display::DisplayObject child1 = _g3->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  35)				_g2 = (_g2 + 1);
HXLINE(  37)				renderer->_hx___renderDrawable(child1);
            			}
            		}

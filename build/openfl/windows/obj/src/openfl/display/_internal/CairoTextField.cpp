...
HX_LOCAL_STACK_FRAME(_hx_pos_a654946cfcca811d_455_renderDrawable,"openfl.display._internal.CairoTextField","renderDrawable",0x65cf17c1,"openfl.display._internal.CairoTextField.renderDrawable","openfl/display/_internal/CairoTextField.hx",455,0xd777675a)
HX_LOCAL_STACK_FRAME(_hx_pos_a654946cfcca811d_475_renderDrawableMask,"openfl.display._internal.CairoTextField","renderDrawableMask",0x842bf94d,"openfl.display._internal.CairoTextField.renderDrawableMask","openfl/display/_internal/CairoTextField.hx",475,0xd777675a)
...
HXLINE(  95)		Float pixelRatio = renderer->_hx___pixelRatio;
HXLINE(  98)		graphics->_hx___update(renderer->_hx___worldTransform,pixelRatio);
...
HXLINE( 127)				_hx_tmp5 = !(graphics->_hx___softwareDirty);
            			}
            			else {
...
HXLINE( 125)					_hx_tmp3 = ::hx::IsNotNull( graphics->_hx___bitmap );
            				}
            				else {
...
HXLINE( 125)			_hx_tmp2 = !(renderable);
            		}
            		else {
...
HXLINE( 139)				_hx_tmp6 = ::hx::IsGreater( bitmapWidth,::openfl::display::Graphics_obj::maxTextureWidth );
            			}
            			else {
...
HXLINE( 144)			bool _hx_tmp7;
HXDLIN( 144)			if (::hx::IsNotNull( ::openfl::display::Graphics_obj::maxTextureHeight )) {
HXLINE( 144)				_hx_tmp7 = ::hx::IsGreater( bitmapHeight,::openfl::display::Graphics_obj::maxTextureHeight );
            			}
            			else {
HXLINE( 144)				_hx_tmp7 = false;
            			}
...
HXLINE( 150)			 ::Dynamic surface1 = bitmap->getSurface();
HXLINE( 151)			graphics->_hx___cairo =  ::lime::graphics::cairo::Cairo_obj::__alloc( HX_CTX ,surface1);
...
HXLINE( 162)				_hx_tmp8 = (textEngine->sharpness == 400);
            			}
            			else {
...
HXLINE( 197)			int _hx_tmp9 = ::Std_obj::_hx_int((bounds->width - ( (Float)(1) )));
HXDLIN( 197)			cairo->rectangle(((Float)0.5),((Float)0.5),( (Float)(_hx_tmp9) ),( (Float)(::Std_obj::_hx_int((bounds->height - ( (Float)(1) )))) ));
            		}
            		else {
...
HXLINE( 217)			int color1 = textEngine->borderColor;
HXLINE( 218)			Float r1 = (( (Float)(::hx::UShr((color1 & 16711680),16)) ) / ( (Float)(255) ));
HXLINE( 219)			Float g1 = (( (Float)(::hx::UShr((color1 & 65280),8)) ) / ( (Float)(255) ));
HXLINE( 220)			Float b1 = (( (Float)((color1 & 255)) ) / ( (Float)(255) ));
HXLINE( 222)			cairo->setSourceRGB(r1,g1,b1);
HXLINE( 223)			cairo->set_lineWidth(( (Float)(1) ));
HXLINE( 224)			cairo->stroke();
            		}
HXLINE( 227)		bool _hx_tmp10;
HXDLIN( 227)		if (::hx::IsNotNull( textEngine->text )) {
HXLINE( 227)			_hx_tmp10 = (textEngine->text != HX_("",00,00,00,00));
            		}
            		else {
...
HXDLIN( 229)			int _hx_tmp11;
HXDLIN( 229)			if (textField->get_border()) {
HXLINE( 229)				_hx_tmp11 = 1;
            			}
            			else {
HXLINE( 229)				_hx_tmp11 = 0;
            			}
HXDLIN( 229)			Float bounds2 = bounds->height;
HXDLIN( 229)			int _hx_tmp12;
HXDLIN( 229)			if (textField->get_border()) {
HXLINE( 229)				_hx_tmp12 = 1;
            			}
            			else {
HXLINE( 229)				_hx_tmp12 = 0;
            			}
HXDLIN( 229)			cairo->rectangle(( (Float)(0) ),( (Float)(0) ),(bounds1 - ( (Float)(_hx_tmp11) )),(bounds2 - ( (Float)(_hx_tmp12) )));
...
HXLINE( 249)					color2 = group1->format->color;
HXLINE( 250)					r2 = (( (Float)(::hx::UShr((( (int)(color2) ) & 16711680),16)) ) / ( (Float)(255) ));
HXLINE( 251)					g2 = (( (Float)(::hx::UShr((( (int)(color2) ) & 65280),8)) ) / ( (Float)(255) ));
HXLINE( 252)					b2 = (( (Float)((( (int)(color2) ) & 255)) ) / ( (Float)(255) ));
HXLINE( 254)					cairo->setSourceRGB(r2,g2,b2);
HXLINE( 256)					font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(group1->format);
HXLINE( 258)					bool _hx_tmp13;
HXDLIN( 258)					if (::hx::IsNotNull( font )) {
HXLINE( 258)						_hx_tmp13 = ::hx::IsNotNull( group1->format->size );
            					}
            					else {
...
HXDLIN( 292)							::Array< ::Dynamic> _g3 = group1->positions;
HXDLIN( 292)							while((_g2 < _g3->length)){
HXLINE( 292)								 ::openfl::text::_internal::GlyphPosition position = _g3->__get(_g2).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN( 292)								_g2 = (_g2 + 1);
HXLINE( 294)								bool _hx_tmp14;
HXDLIN( 294)								if (::hx::IsNotNull( position )) {
HXLINE( 294)									_hx_tmp14 = (position->glyph == 0);
            								}
            								else {
HXLINE( 294)									_hx_tmp14 = true;
            								}
...
HXLINE( 303)						bool _hx_tmp15;
HXDLIN( 303)						if ((textField->_hx___caretIndex > -1)) {
HXLINE( 303)							_hx_tmp15 = textEngine->selectable;
            						}
            						else {
...
HXLINE( 307)									_hx_tmp17 = (group1->startIndex <= textField->_hx___caretIndex);
            								}
            								else {
HXLINE( 307)									_hx_tmp17 = false;
            								}
HXDLIN( 307)								if (_hx_tmp17) {
HXLINE( 307)									_hx_tmp16 = (group1->endIndex >= textField->_hx___caretIndex);
            								}
            								else {
...
HXDLIN( 313)										int _g5 = (textField->_hx___caretIndex - group1->startIndex);
HXDLIN( 313)										while((_g4 < _g5)){
HXLINE( 313)											_g4 = (_g4 + 1);
HXDLIN( 313)											int i1 = (_g4 - 1);
HXLINE( 315)											if ((group1->positions->length <= i1)) {
HXLINE( 315)												goto _hx_goto_4;
            											}
HXLINE( 316)											Float advance1;
HXDLIN( 316)											bool advance2;
HXDLIN( 316)											if ((i1 >= 0)) {
HXLINE( 316)												advance2 = (i1 < group1->positions->length);
            											}
            											else {
HXLINE( 316)												advance2 = false;
            											}
HXDLIN( 316)											if (advance2) {
HXLINE( 316)												advance1 = group1->positions->__get(i1).StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
            											}
            											else {
...
HXLINE( 319)									Float scrollY1 = ((Float)0.0);
HXLINE( 321)									{
HXLINE( 321)										int _g6 = textField->get_scrollV();
HXDLIN( 321)										int _g7 = (group1->lineIndex + 1);
HXDLIN( 321)										while((_g6 < _g7)){
HXLINE( 321)											_g6 = (_g6 + 1);
HXDLIN( 321)											int i2 = (_g6 - 1);
HXLINE( 323)											scrollY1 = (scrollY1 + textEngine->lineHeights->get((i2 - 1)));
            										}
            									}
HXLINE( 326)									Float _hx_tmp18 = (::Math_obj::floor((group1->offsetX + advance)) + ((Float)0.5));
HXDLIN( 326)									Float _hx_tmp19 = (_hx_tmp18 - ( (Float)(textField->get_scrollH()) ));
HXDLIN( 326)									cairo->moveTo((_hx_tmp19 - bounds->x),((scrollY1 + ((Float)2.5)) - bounds->y));
HXLINE( 327)									cairo->set_lineWidth(( (Float)(1) ));
HXLINE( 328)									Float _hx_tmp20 = (::Math_obj::floor((group1->offsetX + advance)) + ((Float)0.5));
HXDLIN( 328)									Float _hx_tmp21 = (_hx_tmp20 - ( (Float)(textField->get_scrollH()) ));
HXDLIN( 328)									Float _hx_tmp22 = (_hx_tmp21 - bounds->x);
HXLINE( 332)									Float _hx_tmp23 = ((scrollY1 + ::openfl::text::_internal::TextEngine_obj::getFormatHeight(textField->get_defaultTextFormat())) - ( (Float)(1) ));
HXLINE( 328)									cairo->lineTo(_hx_tmp22,(_hx_tmp23 - bounds->y));
HXLINE( 336)									cairo->stroke();
            								}
            							}
            							else {
HXLINE( 339)								bool _hx_tmp24;
HXDLIN( 339)								bool _hx_tmp25;
HXDLIN( 339)								bool _hx_tmp26;
HXDLIN( 339)								bool _hx_tmp27;
HXDLIN( 339)								if ((group1->startIndex <= textField->_hx___caretIndex)) {
HXLINE( 339)									_hx_tmp27 = (group1->endIndex >= textField->_hx___caretIndex);
            								}
            								else {
HXLINE( 339)									_hx_tmp27 = false;
            								}
HXDLIN( 339)								if (!(_hx_tmp27)) {
HXLINE( 340)									if ((group1->startIndex <= textField->_hx___selectionIndex)) {
HXLINE( 339)										_hx_tmp26 = (group1->endIndex >= textField->_hx___selectionIndex);
            									}
            									else {
HXLINE( 339)										_hx_tmp26 = false;
            									}
            								}
            								else {
HXLINE( 339)									_hx_tmp26 = true;
            								}
HXDLIN( 339)								if (!(_hx_tmp26)) {
HXLINE( 341)									if ((group1->startIndex > textField->_hx___caretIndex)) {
HXLINE( 339)										_hx_tmp25 = (group1->endIndex < textField->_hx___selectionIndex);
            									}
            									else {
HXLINE( 339)										_hx_tmp25 = false;
            									}
            								}
            								else {
HXLINE( 339)									_hx_tmp25 = true;
            								}
HXDLIN( 339)								if (!(_hx_tmp25)) {
HXLINE( 342)									if ((group1->startIndex > textField->_hx___selectionIndex)) {
HXLINE( 339)										_hx_tmp24 = (group1->endIndex < textField->_hx___caretIndex);
            									}
            									else {
HXLINE( 339)										_hx_tmp24 = false;
            									}
            								}
            								else {
HXLINE( 339)									_hx_tmp24 = true;
            								}
HXDLIN( 339)								if (_hx_tmp24) {
...
HXLINE( 359)									if ((glyphs->length < (selectionEnd - selectionStart))) {
HXLINE( 361)										selectionEnd = (selectionStart + glyphs->length);
            									}
HXLINE( 364)									 ::openfl::geom::Rectangle end;
HXDLIN( 364)									 ::openfl::geom::Rectangle start = textField->getCharBoundaries(selectionStart);
HXLINE( 368)									if ((selectionEnd >= group1->endIndex)) {
HXLINE( 370)										end = textField->getCharBoundaries((group1->endIndex - 1));
HXLINE( 372)										if (::hx::IsNotNull( end )) {
HXLINE( 374)											 ::openfl::geom::Rectangle end1 = end;
HXDLIN( 374)											end1->x = (end1->x + (end->width + 2));
            										}
            									}
            									else {
HXLINE( 379)										end = textField->getCharBoundaries(selectionEnd);
            									}
HXLINE( 382)									bool _hx_tmp28;
HXDLIN( 382)									if (::hx::IsNotNull( start )) {
HXLINE( 382)										_hx_tmp28 = ::hx::IsNotNull( end );
            									}
            									else {
HXLINE( 382)										_hx_tmp28 = false;
            									}
HXDLIN( 382)									if (_hx_tmp28) {
HXLINE( 384)										cairo->setSourceRGB(( (Float)(0) ),( (Float)(0) ),( (Float)(0) ));
HXLINE( 385)										cairo->rectangle(((scrollX + start->x) - bounds->x),(start->y + scrollY),(end->x - start->x),group1->height);
HXLINE( 386)										cairo->fill();
HXLINE( 387)										cairo->setSourceRGB(( (Float)(1) ),( (Float)(1) ),( (Float)(1) ));
HXLINE( 391)										::Array< ::Dynamic> selectedGylphs = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 393)										selectionStart = (selectionStart - group1->startIndex);
HXLINE( 394)										selectionEnd = (selectionEnd - group1->startIndex);
HXLINE( 395)										{
HXLINE( 395)											int _g8 = selectionStart;
HXDLIN( 395)											int _g9 = selectionEnd;
HXDLIN( 395)											while((_g8 < _g9)){
HXLINE( 395)												_g8 = (_g8 + 1);
HXDLIN( 395)												int i3 = (_g8 - 1);
HXLINE( 396)												selectedGylphs->push(glyphs->__get(i3).StaticCast<  ::lime::graphics::cairo::CairoGlyph >());
            											}
            										}
HXLINE( 397)										cairo->showGlyphs(selectedGylphs);
            									}
            								}
            							}
            						}
HXLINE( 404)						if (( (bool)(group1->format->underline) )) {
HXLINE( 408)							cairo->newPath();
HXLINE( 409)							cairo->set_lineWidth(( (Float)(1) ));
HXLINE( 410)							int descent = ::Math_obj::floor((group1->ascent * ((Float)0.185)));
HXLINE( 411)							Float x1 = ((group1->offsetX + scrollX) - bounds->x);
HXLINE( 412)							Float y1 = ((::Math_obj::ceil((((group1->offsetY + scrollY) + group1->ascent) - bounds->y)) + descent) + ((Float)0.5));
HXLINE( 413)							cairo->moveTo(x1,y1);
HXLINE( 414)							cairo->lineTo((x1 + group1->width),y1);
HXLINE( 415)							cairo->stroke();
HXLINE( 416)							cairo->closePath();
            						}
            					}
            				}
            				_hx_goto_2:;
...
HXLINE( 421)			bool _hx_tmp29;
HXDLIN( 421)			bool _hx_tmp30;
HXDLIN( 421)			if ((textField->_hx___caretIndex > -1)) {
HXLINE( 421)				_hx_tmp30 = textEngine->selectable;
            			}
            			else {
HXLINE( 421)				_hx_tmp30 = false;
            			}
HXDLIN( 421)			if (_hx_tmp30) {
HXLINE( 421)				_hx_tmp29 = textField->_hx___showCursor;
            			}
            			else {
HXLINE( 421)				_hx_tmp29 = false;
            			}
HXDLIN( 421)			if (_hx_tmp29) {
HXLINE( 423)				Float scrollX1;
HXDLIN( 423)				if (useTextBounds1) {
HXLINE( 423)					scrollX1 = ( (Float)(0) );
            				}
            				else {
HXLINE( 423)					scrollX1 = cursorOffsetX;
            				}
HXDLIN( 423)				Float scrollX2 = (-(textField->get_scrollH()) + scrollX1);
HXLINE( 424)				Float scrollY2 = ((Float)0.0);
HXLINE( 426)				{
HXLINE( 426)					int _g10 = 0;
HXDLIN( 426)					int _g11 = (textField->get_scrollV() - 1);
HXDLIN( 426)					while((_g10 < _g11)){
HXLINE( 426)						_g10 = (_g10 + 1);
HXDLIN( 426)						int i4 = (_g10 - 1);
HXLINE( 428)						scrollY2 = (scrollY2 + textEngine->lineHeights->get(i4));
            					}
            				}
HXLINE( 431)				 ::Dynamic color3 = textField->get_defaultTextFormat()->color;
HXLINE( 432)				Float r3 = (( (Float)(::hx::UShr((( (int)(color3) ) & 16711680),16)) ) / ( (Float)(255) ));
HXLINE( 433)				Float g3 = (( (Float)(::hx::UShr((( (int)(color3) ) & 65280),8)) ) / ( (Float)(255) ));
HXLINE( 434)				Float b3 = (( (Float)((( (int)(color3) ) & 255)) ) / ( (Float)(255) ));
HXLINE( 436)				cairo->setSourceRGB(r3,g3,b3);
HXLINE( 438)				cairo->newPath();
HXLINE( 439)				cairo->moveTo((scrollX2 + ((Float)2.5)),(scrollY2 + ((Float)2.5)));
HXLINE( 440)				cairo->set_lineWidth(( (Float)(1) ));
HXLINE( 441)				cairo->lineTo((scrollX2 + ((Float)2.5)),((scrollY2 + ::openfl::text::_internal::TextEngine_obj::getFormatHeight(textField->get_defaultTextFormat())) - ( (Float)(1) )));
HXLINE( 442)				cairo->stroke();
HXLINE( 443)				cairo->closePath();
            			}
            		}
HXLINE( 446)		graphics->_hx___bitmap->image->dirty = true;
HXLINE( 447)		graphics->_hx___bitmap->image->version++;
HXLINE( 448)		textField->_hx___dirty = false;
HXLINE( 449)		graphics->_hx___softwareDirty = false;
HXLINE( 450)		graphics->set___dirty(false);
            	}
...
void CairoTextField_obj::renderDrawable( ::openfl::text::TextField textField, ::openfl::display::CairoRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_a654946cfcca811d_455_renderDrawable)
HXLINE( 457)		renderer->_hx___updateCacheBitmap(textField,textField->_hx___dirty);
HXLINE( 459)		bool _hx_tmp;
HXDLIN( 459)		if (::hx::IsNotNull( textField->_hx___cacheBitmap )) {
HXLINE( 459)			_hx_tmp = !(textField->_hx___isCacheBitmapRender);
            		}
            		else {
HXLINE( 459)			_hx_tmp = false;
            		}
HXDLIN( 459)		if (_hx_tmp) {
HXLINE( 461)			 ::openfl::display::Bitmap bitmap = textField->_hx___cacheBitmap;
HXDLIN( 461)			if (bitmap->_hx___renderable) {
HXLINE( 461)				Float alpha = renderer->_hx___getAlpha(bitmap->_hx___worldAlpha);
HXDLIN( 461)				bool _hx_tmp1;
HXDLIN( 461)				bool _hx_tmp2;
HXDLIN( 461)				if ((alpha > 0)) {
HXLINE( 461)					_hx_tmp2 = ::hx::IsNotNull( bitmap->_hx___bitmapData );
            				}
            				else {
HXLINE( 461)					_hx_tmp2 = false;
            				}
HXDLIN( 461)				if (_hx_tmp2) {
HXLINE( 461)					_hx_tmp1 = bitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
HXLINE( 461)					_hx_tmp1 = false;
            				}
HXDLIN( 461)				if (_hx_tmp1) {
HXLINE( 461)					 ::lime::graphics::cairo::Cairo cairo = renderer->cairo;
HXDLIN( 461)					renderer->_hx___setBlendMode(bitmap->_hx___worldBlendMode);
HXDLIN( 461)					renderer->_hx___pushMaskObject(bitmap,null());
HXDLIN( 461)					renderer->applyMatrix(bitmap->_hx___renderTransform,cairo);
HXDLIN( 461)					 ::Dynamic surface = bitmap->_hx___bitmapData->getSurface();
HXDLIN( 461)					if (::hx::IsNotNull( surface )) {
HXLINE( 461)						 ::Dynamic pattern = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(surface);
HXDLIN( 461)						int _hx_tmp3;
HXDLIN( 461)						bool _hx_tmp4;
HXDLIN( 461)						if (renderer->_hx___allowSmoothing) {
HXLINE( 461)							_hx_tmp4 = bitmap->smoothing;
            						}
            						else {
HXLINE( 461)							_hx_tmp4 = false;
            						}
HXDLIN( 461)						if (_hx_tmp4) {
HXLINE( 461)							_hx_tmp3 = 1;
            						}
            						else {
HXLINE( 461)							_hx_tmp3 = 3;
            						}
HXDLIN( 461)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp3);
HXDLIN( 461)						cairo->set_source(pattern);
HXDLIN( 461)						if ((alpha == 1)) {
HXLINE( 461)							cairo->paint();
            						}
            						else {
HXLINE( 461)							cairo->paintWithAlpha(alpha);
            						}
            					}
HXDLIN( 461)					renderer->_hx___popMaskObject(bitmap,null());
HXDLIN( 461)					renderer->_hx___setBlendMode(10);
            				}
            			}
            		}
            		else {
HXLINE( 465)			::openfl::display::_internal::CairoTextField_obj::render(textField,renderer,textField->_hx___worldTransform);
HXLINE( 466)			::openfl::display::_internal::CairoDisplayObject_obj::render(textField,renderer);
            		}
HXLINE( 469)		renderer->_hx___renderEvent(textField);
            	}
...
void CairoTextField_obj::renderDrawableMask( ::openfl::text::TextField textField, ::openfl::display::CairoRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_a654946cfcca811d_475_renderDrawableMask)
HXDLIN( 475)		if (::hx::IsNotNull( textField->_hx___graphics )) {
HXDLIN( 475)			::openfl::display::_internal::CairoGraphics_obj::renderMask(textField->_hx___graphics,renderer);
            		}
            	}

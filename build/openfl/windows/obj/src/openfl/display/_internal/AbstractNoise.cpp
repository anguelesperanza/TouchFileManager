...
HXLINE(  72)			int dest1 = bitmap->getPixel32(px,(height - py));
HXLINE(  73)			int dest_r1 = ((dest1 >> 16) & 255);
HXLINE(  74)			int dest_g1 = ((dest1 >> 8) & 255);
HXLINE(  75)			int dest_b1 = (dest1 & 255);
HXLINE(  77)			Float u1 = (( (Float)((height - py)) ) / ( (Float)(stitch_h) ));
HXLINE(  78)			Float uu1 = (u1 * u1);
HXLINE(  80)			r = this->mixI(dest_r1,r,u1);
HXLINE(  81)			g = this->mixI(dest_g1,g,u1);
HXLINE(  82)			b = this->mixI(dest_b1,b,u1);
            		}

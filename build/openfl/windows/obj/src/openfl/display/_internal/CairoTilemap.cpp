...
HXLINE(  80)				 ::openfl::display::Tile tile1 = tiles->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN(  80)				_g = (_g + 1);
HXLINE(  82)				Float _hx_tmp = -(tile1->get_originX());
HXDLIN(  82)				tileTransform->setTo(( (Float)(1) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ),_hx_tmp,-(tile1->get_originY()));
HXLINE(  83)				tileTransform->concat(tile1->get_matrix());
HXLINE(  84)				tileTransform->concat(parentTransform);
HXLINE(  86)				if (::hx::IsNotNull( tile1->get_tileset() )) {
HXLINE(  86)					tileset = tile1->get_tileset();
            				}
            				else {
HXLINE(  86)					tileset = defaultTileset;
            				}
HXLINE(  88)				alpha = (tile1->get_alpha() * worldAlpha);
HXLINE(  89)				visible = tile1->get_visible();
...
HXLINE(  96)					if (::hx::IsNotNull( tile1->_hx___blendMode )) {
HXLINE(  96)						blendMode = tile1->_hx___blendMode;
            					}
            					else {
HXLINE(  96)						blendMode = defaultBlendMode;
            					}
            				}
HXLINE(  99)				if ((tile1->__length > 0)) {
HXLINE( 101)					::openfl::display::_internal::CairoTilemap_obj::renderTileContainer(( ( ::openfl::display::TileContainer)(tile1) ),renderer,tileTransform,tileset,smooth,alphaEnabled,alpha,blendModeEnabled,blendMode,cacheBitmapData,surface,pattern,rect,matrix);
            				}
            				else {
HXLINE( 106)					if (::hx::IsNull( tileset )) {
HXLINE( 106)						continue;
            					}
HXLINE( 108)					id = tile1->get_id();
HXLINE( 110)					if ((id == -1)) {
HXLINE( 112)						tileRect = tile1->_hx___rect;
HXLINE( 113)						bool _hx_tmp2;
HXDLIN( 113)						bool _hx_tmp3;
HXDLIN( 113)						if (::hx::IsNotNull( tileRect )) {
HXLINE( 113)							_hx_tmp3 = (tileRect->width <= 0);
            						}
            						else {
HXLINE( 113)							_hx_tmp3 = true;
            						}
HXDLIN( 113)						if (!(_hx_tmp3)) {
HXLINE( 113)							_hx_tmp2 = (tileRect->height <= 0);
            						}
            						else {
...
HXLINE( 131)							_hx_tmp4 = 3;
            						}
HXDLIN( 131)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp4);
...
HXLINE( 179)					_hx_tmp2 = ::hx::IsNotNull( bitmap->_hx___bitmapData );
            				}
            				else {
HXLINE( 179)					_hx_tmp2 = false;
            				}
HXDLIN( 179)				if (_hx_tmp2) {
HXLINE( 179)					_hx_tmp1 = bitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
...
HXLINE( 179)							_hx_tmp4 = bitmap->smoothing;
            						}
            						else {
HXLINE( 179)							_hx_tmp4 = false;
            						}
HXDLIN( 179)						if (_hx_tmp4) {
HXLINE( 179)							_hx_tmp3 = 1;
            						}
            						else {
HXLINE( 179)							_hx_tmp3 = 3;
            						}
HXDLIN( 179)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp3);

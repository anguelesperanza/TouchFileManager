...
HXDLIN( 122)					_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
...
HXDLIN( 122)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 122)						_this1->byteOffset = 0;
HXDLIN( 122)						_this1->length = array1->get_length();
HXDLIN( 122)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 122)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 122)						_this1->copyFromArray(array1,null());
...
HXLINE( 122)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 122)								int in_byteOffset = 0;
HXDLIN( 122)								if ((in_byteOffset < 0)) {
HXLINE( 122)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 122)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 122)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 122)								int bufferByteLength = buffer->length;
HXDLIN( 122)								int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 122)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 122)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXLINE( 122)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 122)									int newRange = (in_byteOffset + newByteLength);
HXDLIN( 122)									if ((newRange > bufferByteLength)) {
HXLINE( 122)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN( 122)								_this3->buffer = buffer;
HXDLIN( 122)								_this3->byteOffset = in_byteOffset;
HXDLIN( 122)								_this3->byteLength = newByteLength;
HXDLIN( 122)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 122)								this1 = _this3;
            							}
            							else {
...
HXLINE( 127)				 ::haxe::io::Bytes buffer1 = null();
HXDLIN( 127)				::cpp::VirtualArray array2 = null();
HXDLIN( 127)				 ::openfl::_Vector::FloatVector vector1 = null();
HXDLIN( 127)				 ::lime::utils::ArrayBufferView view1 = null();
HXDLIN( 127)				 ::Dynamic len1 = null();
HXDLIN( 127)				 ::lime::utils::ArrayBufferView this2;
HXDLIN( 127)				if (::hx::IsNotNull( vertexLength )) {
HXLINE( 127)					this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,vertexLength,8);
            				}
            				else {
HXLINE( 127)					if (::hx::IsNotNull( array2 )) {
HXLINE( 127)						 ::lime::utils::ArrayBufferView _this4 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 127)						_this4->byteOffset = 0;
HXDLIN( 127)						_this4->length = array2->get_length();
HXDLIN( 127)						_this4->byteLength = (_this4->length * _this4->bytesPerElement);
HXDLIN( 127)						_this4->buffer = ::haxe::io::Bytes_obj::alloc(_this4->byteLength);
HXDLIN( 127)						_this4->copyFromArray(array2,null());
HXDLIN( 127)						this2 = _this4;
            					}
            					else {
HXLINE( 127)						if (::hx::IsNotNull( vector1 )) {
HXLINE( 127)							 ::lime::utils::ArrayBufferView _this5 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 127)							::cpp::VirtualArray array3 = ( (::cpp::VirtualArray)(vector1->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 127)							_this5->byteOffset = 0;
HXDLIN( 127)							_this5->length = array3->get_length();
HXDLIN( 127)							_this5->byteLength = (_this5->length * _this5->bytesPerElement);
HXDLIN( 127)							_this5->buffer = ::haxe::io::Bytes_obj::alloc(_this5->byteLength);
HXDLIN( 127)							_this5->copyFromArray(array3,null());
HXDLIN( 127)							this2 = _this5;
            						}
            						else {
HXLINE( 127)							if (::hx::IsNotNull( view1 )) {
HXLINE( 127)								 ::lime::utils::ArrayBufferView _this6 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 127)								 ::haxe::io::Bytes srcData1 = view1->buffer;
HXDLIN( 127)								int srcLength2 = view1->length;
HXDLIN( 127)								int srcByteOffset1 = view1->byteOffset;
HXDLIN( 127)								int srcElementSize1 = view1->bytesPerElement;
HXDLIN( 127)								int elementSize2 = _this6->bytesPerElement;
HXDLIN( 127)								if ((view1->type == _this6->type)) {
HXLINE( 127)									int srcLength3 = srcData1->length;
HXDLIN( 127)									int cloneLength1 = (srcLength3 - srcByteOffset1);
HXDLIN( 127)									_this6->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN( 127)									_this6->buffer->blit(0,srcData1,srcByteOffset1,cloneLength1);
            								}
            								else {
HXLINE( 127)									HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            								}
HXDLIN( 127)								_this6->byteLength = (_this6->bytesPerElement * srcLength2);
HXDLIN( 127)								_this6->byteOffset = 0;
HXDLIN( 127)								_this6->length = srcLength2;
HXDLIN( 127)								this2 = _this6;
            							}
            							else {
HXLINE( 127)								if (::hx::IsNotNull( buffer1 )) {
HXLINE( 127)									 ::lime::utils::ArrayBufferView _this7 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 127)									int in_byteOffset1 = 0;
HXDLIN( 127)									if ((in_byteOffset1 < 0)) {
HXLINE( 127)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 127)									if ((::hx::Mod(in_byteOffset1,_this7->bytesPerElement) != 0)) {
HXLINE( 127)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 127)									int bufferByteLength1 = buffer1->length;
HXDLIN( 127)									int elementSize3 = _this7->bytesPerElement;
HXDLIN( 127)									int newByteLength1 = bufferByteLength1;
HXDLIN( 127)									if (::hx::IsNull( len1 )) {
HXLINE( 127)										newByteLength1 = (bufferByteLength1 - in_byteOffset1);
HXDLIN( 127)										if ((::hx::Mod(bufferByteLength1,_this7->bytesPerElement) != 0)) {
HXLINE( 127)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
HXDLIN( 127)										if ((newByteLength1 < 0)) {
HXLINE( 127)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
            									else {
HXLINE( 127)										newByteLength1 = (( (int)(len1) ) * _this7->bytesPerElement);
HXDLIN( 127)										int newRange1 = (in_byteOffset1 + newByteLength1);
HXDLIN( 127)										if ((newRange1 > bufferByteLength1)) {
HXLINE( 127)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
HXDLIN( 127)									_this7->buffer = buffer1;
HXDLIN( 127)									_this7->byteOffset = in_byteOffset1;
HXDLIN( 127)									_this7->byteLength = newByteLength1;
HXDLIN( 127)									_this7->length = ::Std_obj::_hx_int((( (Float)(newByteLength1) ) / ( (Float)(_this7->bytesPerElement) )));
HXDLIN( 127)									this2 = _this7;
            								}
            								else {
...
HXLINE( 128)				{
HXLINE( 128)					 ::lime::utils::ArrayBufferView _this8 = this->vertexBufferData;
HXDLIN( 128)					::cpp::VirtualArray array4 = null();
HXDLIN( 128)					int offset = 0;
HXDLIN( 128)					bool _hx_tmp;
HXDLIN( 128)					if (::hx::IsNotNull( cacheBufferData )) {
HXLINE( 128)						_hx_tmp = ::hx::IsNull( array4 );
            					}
            					else {
HXLINE( 128)						_hx_tmp = false;
            					}
HXDLIN( 128)					if (_hx_tmp) {
HXLINE( 128)						_this8->buffer->blit((offset * _this8->bytesPerElement),cacheBufferData->buffer,cacheBufferData->byteOffset,cacheBufferData->byteLength);
            					}
            					else {
HXLINE( 128)						bool _hx_tmp1;
HXDLIN( 128)						if (::hx::IsNotNull( array4 )) {
HXLINE( 128)							_hx_tmp1 = ::hx::IsNull( cacheBufferData );
            						}
            						else {
HXLINE( 128)							_hx_tmp1 = false;
            						}
HXDLIN( 128)						if (_hx_tmp1) {
HXLINE( 128)							_this8->copyFromArray(array4,offset);
            						}
            						else {

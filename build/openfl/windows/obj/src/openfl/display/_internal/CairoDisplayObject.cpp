...
HXLINE(  61)					_hx_tmp2 = ::hx::IsNotNull( bitmap->_hx___bitmapData );
            				}
            				else {
HXLINE(  61)					_hx_tmp2 = false;
            				}
HXDLIN(  61)				if (_hx_tmp2) {
HXLINE(  61)					_hx_tmp1 = bitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
...
HXDLIN(  61)						int _hx_tmp3;
HXDLIN(  61)						bool _hx_tmp4;
HXDLIN(  61)						if (renderer->_hx___allowSmoothing) {
HXLINE(  61)							_hx_tmp4 = bitmap->smoothing;
            						}
            						else {
HXLINE(  61)							_hx_tmp4 = false;
            						}
HXDLIN(  61)						if (_hx_tmp4) {
HXLINE(  61)							_hx_tmp3 = 1;
            						}
            						else {
HXLINE(  61)							_hx_tmp3 = 3;
            						}
HXDLIN(  61)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp3);

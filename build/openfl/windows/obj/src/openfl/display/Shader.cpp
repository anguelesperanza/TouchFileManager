...
HXLINE( 549)							parameter1->index = gl->getUniformLocation(this->glProgram,parameter1->name);
            						}
            						else {
HXLINE( 553)							parameter1->index = gl->getAttribLocation(this->glProgram,parameter1->name);
            						}
            					}
            				}
HXLINE( 557)				{
...
HXLINE( 561)							parameter2->index = gl->getUniformLocation(this->glProgram,parameter2->name);
            						}
            						else {
HXLINE( 565)							parameter2->index = gl->getAttribLocation(this->glProgram,parameter2->name);
            						}
            					}
            				}
            			}
...
HXDLIN( 700)									_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 700)									_this->copyFromArray(array,null());
HXDLIN( 700)									this1 = _this;
            								}
            								else {
HXLINE( 700)									if (::hx::IsNotNull( vector )) {
HXLINE( 700)										 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 700)										::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 700)										_this1->byteOffset = 0;
HXDLIN( 700)										_this1->length = array1->get_length();
HXDLIN( 700)										_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 700)										_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 700)										_this1->copyFromArray(array1,null());
HXDLIN( 700)										this1 = _this1;
            									}
            									else {
HXLINE( 700)										if (::hx::IsNotNull( view )) {
HXLINE( 700)											 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 700)											int elementSize = _this2->bytesPerElement;
HXDLIN( 700)											if ((view->type == _this2->type)) {
HXLINE( 700)												int srcLength1 = srcData->length;
HXDLIN( 700)												int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 700)												_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 700)												_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            											}
            											else {
HXLINE( 700)												HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            											}
HXDLIN( 700)											_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 700)											_this2->byteOffset = 0;
HXDLIN( 700)											_this2->length = srcLength;
HXDLIN( 700)											this1 = _this2;
            										}
            										else {
HXLINE( 700)											if (::hx::IsNotNull( buffer )) {
HXLINE( 700)												 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 700)												int in_byteOffset = 0;
HXDLIN( 700)												if ((in_byteOffset < 0)) {
HXLINE( 700)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
HXDLIN( 700)												if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 700)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
HXDLIN( 700)												int bufferByteLength = buffer->length;
HXDLIN( 700)												int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 700)													if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 700)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
...
HXLINE( 700)													newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 700)													int newRange = (in_byteOffset + newByteLength);
HXDLIN( 700)													if ((newRange > bufferByteLength)) {
HXLINE( 700)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
            												}
HXDLIN( 700)												_this3->buffer = buffer;
HXDLIN( 700)												_this3->byteOffset = in_byteOffset;
HXDLIN( 700)												_this3->byteLength = newByteLength;
HXDLIN( 700)												_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 700)												this1 = _this3;
            											}
            											else {

...
HXDLIN( 252)		bool _hx_tmp8;
HXDLIN( 252)		if (!(displayObject->get_cacheAsBitmap())) {
HXLINE( 253)			if ((renderer->_hx___type != HX_("opengl",6f,64,94,21))) {
HXLINE( 252)				_hx_tmp8 = !(colorTransform->_hx___isDefault(true));
            			}
            			else {
HXLINE( 252)				_hx_tmp8 = false;
            			}
            		}
            		else {
HXLINE( 252)			_hx_tmp8 = true;
            		}
HXDLIN( 252)		if (!(_hx_tmp8)) {
HXLINE( 254)			if ((renderer->_hx___type == HX_("opengl",6f,64,94,21))) {
HXLINE( 252)				_hx_tmp7 = ::hx::IsNotNull( displayObject->get_scale9Grid() );
            			}
            			else {
...
HXLINE( 268)				_hx_tmp9 = hardwareDirty;
            			}
            			else {
...
HXLINE( 284)						_hx_tmp10 = (renderType == HX_("cairo",88,30,19,41));
            					}
            					else {
HXLINE( 284)						_hx_tmp10 = true;
            					}
            				}
            				else {
...
HXLINE( 285)					_hx_tmp11 = (renderType == HX_("opengl",6f,64,94,21));
            				}
            				else {
...
HXLINE( 292)			bool _hx_tmp12;
HXDLIN( 292)			if ((renderer->_hx___type == HX_("dom",82,42,4c,00))) {
HXLINE( 292)				_hx_tmp12 = !(hasFilters);
            			}
            			else {
...
HXLINE( 298)			bool _hx_tmp13;
HXDLIN( 298)			if (hasFilters) {
HXLINE( 298)				_hx_tmp13 = !(needRender);
            			}
            			else {
...
HXLINE( 318)					_hx_tmp16 = (bitmapMatrix->b != displayObject->_hx___cacheBitmapMatrix->b);
            				}
            				else {
HXLINE( 318)					_hx_tmp16 = true;
            				}
HXDLIN( 318)				if (!(_hx_tmp16)) {
HXLINE( 318)					_hx_tmp15 = (bitmapMatrix->c != displayObject->_hx___cacheBitmapMatrix->c);
            				}
            				else {
HXLINE( 318)					_hx_tmp15 = true;
            				}
HXDLIN( 318)				if (!(_hx_tmp15)) {
HXLINE( 317)					_hx_tmp14 = (bitmapMatrix->d != displayObject->_hx___cacheBitmapMatrix->d);
            				}
            				else {
...
HXDLIN( 326)			bool _hx_tmp20;
HXDLIN( 326)			if (!(needRender)) {
HXLINE( 326)				_hx_tmp20 = (renderer->_hx___type != HX_("opengl",6f,64,94,21));
            			}
            			else {
HXLINE( 326)				_hx_tmp20 = false;
            			}
HXDLIN( 326)			if (_hx_tmp20) {
HXLINE( 326)				_hx_tmp19 = ::hx::IsNotNull( displayObject->_hx___cacheBitmapData );
            			}
            			else {
HXLINE( 326)				_hx_tmp19 = false;
            			}
HXDLIN( 326)			if (_hx_tmp19) {
HXLINE( 326)				_hx_tmp18 = ::hx::IsNotNull( displayObject->_hx___cacheBitmapData->image );
            			}
            			else {
HXLINE( 326)				_hx_tmp18 = false;
            			}
HXDLIN( 326)			if (_hx_tmp18) {
HXLINE( 326)				_hx_tmp17 = (displayObject->_hx___cacheBitmapData->image->version < displayObject->_hx___cacheBitmapData->_hx___textureVersion);
            			}
            			else {
...
HXLINE( 367)			bool _hx_tmp21;
HXDLIN( 367)			if (!(updateTransform)) {
HXLINE( 367)				_hx_tmp21 = needRender;
            			}
            			else {
HXLINE( 367)				_hx_tmp21 = true;
            			}
HXDLIN( 367)			if (_hx_tmp21) {
...
HXLINE( 381)					bool _hx_tmp22;
HXDLIN( 381)					if ((filterWidth <= displayObject->_hx___cacheBitmapData->width)) {
HXLINE( 381)						_hx_tmp22 = (filterHeight > displayObject->_hx___cacheBitmapData->height);
            					}
            					else {
HXLINE( 381)						_hx_tmp22 = true;
            					}
HXDLIN( 381)					if (_hx_tmp22) {
...
HXLINE( 405)				bool _hx_tmp23;
HXDLIN( 405)				if ((filterWidth >= ((Float)0.5))) {
HXLINE( 405)					_hx_tmp23 = (filterHeight >= ((Float)0.5));
            				}
            				else {
...
HXLINE( 413)					bool _hx_tmp24;
HXDLIN( 413)					bool _hx_tmp25;
HXDLIN( 413)					if (::hx::IsNotNull( displayObject->_hx___cacheBitmapData )) {
HXLINE( 413)						_hx_tmp25 = (bitmapWidth > displayObject->_hx___cacheBitmapData->width);
            					}
            					else {
HXLINE( 413)						_hx_tmp25 = true;
            					}
HXDLIN( 413)					if (!(_hx_tmp25)) {
HXLINE( 413)						_hx_tmp24 = (bitmapHeight > displayObject->_hx___cacheBitmapData->height);
            					}
            					else {
...
HXLINE( 466)				_hx_tmp26 = needRender;
            			}
            			else {
HXLINE( 466)				_hx_tmp26 = true;
            			}
...
HXLINE( 501)				bool _hx_tmp27;
HXDLIN( 501)				if (::hx::IsNotNull( displayObject->_hx___cacheBitmapRenderer )) {
HXLINE( 501)					_hx_tmp27 = (renderType != displayObject->_hx___cacheBitmapRenderer->_hx___type);
            				}
            				else {
HXLINE( 501)					_hx_tmp27 = true;
            				}
HXDLIN( 501)				if (_hx_tmp27) {
...
HXLINE( 601)						bool _hx_tmp28;
HXDLIN( 601)						bool _hx_tmp29;
HXDLIN( 601)						if (::hx::IsNotNull( displayObject->_hx___cacheBitmapData2 )) {
HXLINE( 601)							_hx_tmp29 = (bitmapWidth > displayObject->_hx___cacheBitmapData2->width);
            						}
            						else {
HXLINE( 601)							_hx_tmp29 = true;
            						}
HXDLIN( 601)						if (!(_hx_tmp29)) {
HXLINE( 601)							_hx_tmp28 = (bitmapHeight > displayObject->_hx___cacheBitmapData2->height);
            						}
            						else {
...
HXLINE( 623)							bool _hx_tmp30;
HXDLIN( 623)							bool _hx_tmp31;
HXDLIN( 623)							if (::hx::IsNotNull( displayObject->_hx___cacheBitmapData3 )) {
HXLINE( 623)								_hx_tmp31 = (bitmapWidth > displayObject->_hx___cacheBitmapData3->width);
            							}
            							else {
HXLINE( 623)								_hx_tmp31 = true;
            							}
HXDLIN( 623)							if (!(_hx_tmp31)) {
HXLINE( 623)								_hx_tmp30 = (bitmapHeight > displayObject->_hx___cacheBitmapData3->height);
            							}
            							else {
...
HXLINE( 729)							bool _hx_tmp32;
HXDLIN( 729)							bool _hx_tmp33;
HXDLIN( 729)							bool _hx_tmp34;
HXDLIN( 729)							if (::hx::IsNotNull( displayObject->_hx___cacheBitmapData2 )) {
HXLINE( 729)								_hx_tmp34 = ::hx::IsNull( displayObject->_hx___cacheBitmapData2->image );
            							}
            							else {
HXLINE( 729)								_hx_tmp34 = true;
            							}
HXDLIN( 729)							if (!(_hx_tmp34)) {
HXLINE( 729)								_hx_tmp33 = (bitmapWidth > displayObject->_hx___cacheBitmapData2->width);
            							}
            							else {
HXLINE( 729)								_hx_tmp33 = true;
            							}
HXDLIN( 729)							if (!(_hx_tmp33)) {
HXLINE( 729)								_hx_tmp32 = (bitmapHeight > displayObject->_hx___cacheBitmapData2->height);
            							}
            							else {
...
HXLINE( 749)							bool _hx_tmp35;
HXDLIN( 749)							bool _hx_tmp36;
HXDLIN( 749)							bool _hx_tmp37;
HXDLIN( 749)							if (::hx::IsNotNull( displayObject->_hx___cacheBitmapData3 )) {
HXLINE( 749)								_hx_tmp37 = ::hx::IsNull( displayObject->_hx___cacheBitmapData3->image );
            							}
            							else {
HXLINE( 749)								_hx_tmp37 = true;
            							}
HXDLIN( 749)							if (!(_hx_tmp37)) {
HXLINE( 749)								_hx_tmp36 = (bitmapWidth > displayObject->_hx___cacheBitmapData3->width);
            							}
            							else {
HXLINE( 749)								_hx_tmp36 = true;
            							}
HXDLIN( 749)							if (!(_hx_tmp36)) {
HXLINE( 749)								_hx_tmp35 = (bitmapHeight > displayObject->_hx___cacheBitmapData3->height);
            							}
            							else {
...
HXLINE( 779)									 ::openfl::geom::ColorTransform _hx_tmp38;
HXDLIN( 779)									if (::hx::IsNotNull( displayObject->_hx___objectTransform )) {
HXLINE( 779)										_hx_tmp38 = displayObject->_hx___objectTransform->_hx___colorTransform;
            									}
            									else {
HXLINE( 779)										_hx_tmp38 = null();
            									}
HXLINE( 778)									lastBitmap->draw(bitmap31,null(),_hx_tmp38,null(),null(),null());
            								}
HXLINE( 781)								filter4->_hx___renderDirty = false;
HXLINE( 783)								bool _hx_tmp39;
HXDLIN( 783)								if (needSecondBitmapData1) {
HXLINE( 783)									_hx_tmp39 = ::hx::IsInstanceEq( lastBitmap,bitmap21 );
            								}
            								else {
HXLINE( 783)									_hx_tmp39 = false;
            								}
HXDLIN( 783)								if (_hx_tmp39) {
...
HXLINE( 819)			bool _hx_tmp40;
HXDLIN( 819)			if (!(updateTransform)) {
HXLINE( 819)				_hx_tmp40 = needRender;
            			}
            			else {
HXLINE( 819)				_hx_tmp40 = true;
            			}
HXDLIN( 819)			if (_hx_tmp40) {
...
HXLINE( 846)		bool _hx_tmp41;
HXDLIN( 846)		if (updated) {
HXLINE( 846)			_hx_tmp41 = (displayObject->_hx___drawableType == 7);
            		}
            		else {
HXLINE( 846)			_hx_tmp41 = false;
            		}
HXDLIN( 846)		if (_hx_tmp41) {

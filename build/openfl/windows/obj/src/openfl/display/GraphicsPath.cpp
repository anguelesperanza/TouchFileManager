...
HXDLIN(  86)			::Array< Float > array1 = null();
HXDLIN(  86)			this->data =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,array1,true);
            		}
...
HXDLIN( 117)			::Array< Float > array1 = null();
HXDLIN( 117)			this->data =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,array1,true);
            		}
...
HXDLIN( 170)			::Array< Float > array1 = null();
HXDLIN( 170)			this->data =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,array1,true);
            		}
...
HXDLIN( 187)			::Array< Float > array1 = null();
HXDLIN( 187)			this->data =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,array1,true);
            		}

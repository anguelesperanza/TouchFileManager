...
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1008___setBlendMode,"openfl.display.OpenGLRenderer","__setBlendMode",0xc7ebe4e4,"openfl.display.OpenGLRenderer.__setBlendMode","openfl/display/OpenGLRenderer.hx",1008,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1045___setRenderTarget,"openfl.display.OpenGLRenderer","__setRenderTarget",0xe23db0b7,"openfl.display.OpenGLRenderer.__setRenderTarget","openfl/display/OpenGLRenderer.hx",1045,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1056___setShaderBuffer,"openfl.display.OpenGLRenderer","__setShaderBuffer",0x2c781375,"openfl.display.OpenGLRenderer.__setShaderBuffer","openfl/display/OpenGLRenderer.hx",1056,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1062___suspendClipAndMask,"openfl.display.OpenGLRenderer","__suspendClipAndMask",0x40692e69,"openfl.display.OpenGLRenderer.__suspendClipAndMask","openfl/display/OpenGLRenderer.hx",1062,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1077___updateShaderBuffer,"openfl.display.OpenGLRenderer","__updateShaderBuffer",0x07dc8fc0,"openfl.display.OpenGLRenderer.__updateShaderBuffer","openfl/display/OpenGLRenderer.hx",1077,0x89bd8a40)
...
HXLINE( 218)						_hx_tmp3 = 4;
            					}
            					else {
HXLINE( 218)						_hx_tmp3 = 5;
            					}
...
HXLINE( 220)						_hx_tmp5 = 2;
            					}
            					else {
HXLINE( 220)						_hx_tmp5 = 0;
            					}
...
HXLINE( 353)		if (::hx::IsInstanceEq( this->_hx___currentShader,shader )) {
HXLINE( 353)			return;
            		}
...
HXLINE( 517)		 ::lime::utils::ArrayBufferView _hx_tmp4;
HXDLIN( 517)		if (this->_hx___flipped) {
HXLINE( 517)			_hx_tmp4 = this->_hx___projectionFlipped;
            		}
            		else {
HXLINE( 517)			_hx_tmp4 = this->_hx___projection;
            		}
HXDLIN( 517)		::lime::math::_Matrix4::Matrix4_Impl__obj::append(this->_hx___matrix,_hx_tmp4);
HXLINE( 519)		{
...
HXLINE( 632)				_hx_tmp1 = (object->_hx___renderTransform->c != 0);
            			}
            			else {
...
HXLINE( 686)				_hx_tmp1 = (object->_hx___renderTransform->c != 0);
            			}
            			else {
...
HXDLIN( 945)			_hx_tmp1 = ::Math_obj::round((((( (Float)(0) ) * _this1->b) + (( (Float)(0) ) * _this1->d)) + _this1->ty));
            		}
            		else {
...
HXDLIN( 946)			_hx_tmp2 = ::Math_obj::round(((((( (Float)(w) ) * _this2->a) + (( (Float)(0) ) * _this2->c)) + _this2->tx) - ( (Float)(this->_hx___offsetX) )));
            		}
            		else {
...
HXDLIN( 947)			_hx_tmp3 = ::Math_obj::round(((((( (Float)(0) ) * _this3->b) + (( (Float)(h) ) * _this3->d)) + _this3->ty) - ( (Float)(this->_hx___offsetY) )));
            		}
            		else {
...
HXLINE( 994)			if ((width < 0)) {
HXLINE( 994)				width = 0;
            			}
HXLINE( 995)			if ((height < 0)) {
HXLINE( 995)				height = 0;
            			}
HXLINE( 998)			::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)(x) ),( (Float)(y) ),( (Float)(width) ),( (Float)(height) ));
HXLINE( 999)			this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
            		}
            		else {
HXLINE(1003)			this->_hx___context3D->setScissorRectangle(null());
            		}
            	}
...
void OpenGLRenderer_obj::_hx___setBlendMode( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1008___setBlendMode)
...
HXDLIN(1017)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(1031)			this->_hx___context3D->setBlendFactors(2,2);
HXLINE(1032)			this->_hx___context3D->_hx___setGLBlendEquation(32775);
HXLINE(1030)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==8) ){
HXLINE(1035)			this->_hx___context3D->setBlendFactors(2,2);
HXLINE(1036)			this->_hx___context3D->_hx___setGLBlendEquation(32776);
HXLINE(1034)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==9) ){
HXLINE(1020)			this->_hx___context3D->setBlendFactors(1,5);
HXDLIN(1020)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==12) ){
HXLINE(1023)			this->_hx___context3D->setBlendFactors(2,6);
HXDLIN(1023)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==14) ){
HXLINE(1026)			this->_hx___context3D->setBlendFactors(2,2);
HXLINE(1027)			this->_hx___context3D->_hx___setGLBlendEquation(this->_hx___gl->FUNC_REVERSE_SUBTRACT);
HXLINE(1025)			goto _hx_goto_35;
            		}
            		/* default */{
HXLINE(1040)			this->_hx___context3D->setBlendFactors(2,5);
            		}
            		_hx_goto_35:;
            	}
...
void OpenGLRenderer_obj::_hx___setRenderTarget( ::openfl::display::BitmapData renderTarget){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1045___setRenderTarget)
HXLINE(1046)		this->_hx___defaultRenderTarget = renderTarget;
HXLINE(1047)		this->_hx___flipped = ::hx::IsNull( renderTarget );
HXLINE(1049)		if (::hx::IsNotNull( renderTarget )) {
HXLINE(1051)			this->_hx___resize(renderTarget->width,renderTarget->height);
            		}
            	}
...
void OpenGLRenderer_obj::_hx___setShaderBuffer( ::openfl::display::_internal::ShaderBuffer shaderBuffer){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1056___setShaderBuffer)
HXLINE(1057)		this->setShader(shaderBuffer->shader);
HXLINE(1058)		this->_hx___currentShaderBuffer = shaderBuffer;
            	}
...
void OpenGLRenderer_obj::_hx___suspendClipAndMask(){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1062___suspendClipAndMask)
HXLINE(1063)		if ((this->_hx___stencilReference > 0)) {
HXLINE(1065)			this->_hx___context3D->setStencilActions(null(),null(),null(),null(),null());
HXLINE(1066)			this->_hx___context3D->setStencilReferenceValue(0,0,0);
            		}
HXLINE(1069)		if ((this->_hx___numClipRects > 0)) {
HXLINE(1071)			this->_hx___scissorRect(null());
            		}
            	}
...
void OpenGLRenderer_obj::_hx___updateShaderBuffer(int bufferOffset){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1077___updateShaderBuffer)
HXDLIN(1077)		bool _hx_tmp;
HXDLIN(1077)		if (::hx::IsNotNull( this->_hx___currentShader )) {
HXDLIN(1077)			_hx_tmp = ::hx::IsNotNull( this->_hx___currentShaderBuffer );
            		}
            		else {
HXDLIN(1077)			_hx_tmp = false;
            		}
HXDLIN(1077)		if (_hx_tmp) {
HXLINE(1079)			this->_hx___currentShader->_hx___updateFromBuffer(this->_hx___currentShaderBuffer,bufferOffset);
            		}
            	}

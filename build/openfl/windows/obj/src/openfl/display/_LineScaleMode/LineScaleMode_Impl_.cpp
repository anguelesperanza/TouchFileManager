...
HX_LOCAL_STACK_FRAME(_hx_pos_ea842eab153a573b_50_fromInt,"openfl.display._LineScaleMode.LineScaleMode_Impl_","fromInt",0x4a6a68e6,"openfl.display._LineScaleMode.LineScaleMode_Impl_.fromInt","openfl/display/LineScaleMode.hx",50,0x274c8551)
HX_LOCAL_STACK_FRAME(_hx_pos_ea842eab153a573b_55_fromString,"openfl.display._LineScaleMode.LineScaleMode_Impl_","fromString",0x5d04613a,"openfl.display._LineScaleMode.LineScaleMode_Impl_.fromString","openfl/display/LineScaleMode.hx",55,0x274c8551)
HX_LOCAL_STACK_FRAME(_hx_pos_ea842eab153a573b_67_toInt,"openfl.display._LineScaleMode.LineScaleMode_Impl_","toInt",0x2c0c4735,"openfl.display._LineScaleMode.LineScaleMode_Impl_.toInt","openfl/display/LineScaleMode.hx",67,0x274c8551)
HX_LOCAL_STACK_FRAME(_hx_pos_ea842eab153a573b_72_toString,"openfl.display._LineScaleMode.LineScaleMode_Impl_","toString",0x67991e4b,"openfl.display._LineScaleMode.LineScaleMode_Impl_.toString","openfl/display/LineScaleMode.hx",72,0x274c8551)
HX_LOCAL_STACK_FRAME(_hx_pos_ea842eab153a573b_22_boot,"openfl.display._LineScaleMode.LineScaleMode_Impl_","boot",0xe0c8d651,"openfl.display._LineScaleMode.LineScaleMode_Impl_.boot","openfl/display/LineScaleMode.hx",22,0x274c8551)
HX_LOCAL_STACK_FRAME(_hx_pos_ea842eab153a573b_28_boot,"openfl.display._LineScaleMode.LineScaleMode_Impl_","boot",0xe0c8d651,"openfl.display._LineScaleMode.LineScaleMode_Impl_.boot","openfl/display/LineScaleMode.hx",28,0x274c8551)
HX_LOCAL_STACK_FRAME(_hx_pos_ea842eab153a573b_35_boot,"openfl.display._LineScaleMode.LineScaleMode_Impl_","boot",0xe0c8d651,"openfl.display._LineScaleMode.LineScaleMode_Impl_.boot","openfl/display/LineScaleMode.hx",35,0x274c8551)
HX_LOCAL_STACK_FRAME(_hx_pos_ea842eab153a573b_46_boot,"openfl.display._LineScaleMode.LineScaleMode_Impl_","boot",0xe0c8d651,"openfl.display._LineScaleMode.LineScaleMode_Impl_.boot","openfl/display/LineScaleMode.hx",46,0x274c8551)
namespace openfl{
namespace display{
...
bool LineScaleMode_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic LineScaleMode_Impl__obj::fromInt( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_ea842eab153a573b_50_fromInt)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineScaleMode_Impl__obj,fromInt,return )
 ...
 ::Dynamic LineScaleMode_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_ea842eab153a573b_55_fromString)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineScaleMode_Impl__obj,fromString,return )
 ...
 ::Dynamic LineScaleMode_Impl__obj::toInt( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_ea842eab153a573b_67_toInt)
...
::String LineScaleMode_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_ea842eab153a573b_72_toString)
HXDLIN(  72)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  74)			return HX_("horizontal",e4,fc,c3,15);
HXDLIN(  74)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  75)			return HX_("none",b8,12,0a,49);
HXDLIN(  75)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  76)			return HX_("normal",27,72,69,30);
HXDLIN(  76)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==3) ){
HXLINE(  77)			return HX_("vertical",76,bc,15,6a);
...
{
{
            	HX_STACKFRAME(&_hx_pos_ea842eab153a573b_22_boot)
HXDLIN(  22)		HORIZONTAL = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ea842eab153a573b_28_boot)
HXDLIN(  28)		NONE = 1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ea842eab153a573b_35_boot)
HXDLIN(  35)		NORMAL = 2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_ea842eab153a573b_46_boot)

...
bool Application_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::ui::Window Application_obj::createWindow( ::Dynamic attributes){
            		HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0, ::lime::ui::Window,window1, ::openfl::display::Application,_g) HXARGC(0)
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_548c78caa19a1a14_55_createWindow)
HXLINE(  55)			_g->_hx___onWindowClose(window1);
            		}
...
HXLINE(  53)		this->_hx___windowByID->set(window->id,( ( ::lime::ui::Window)(window) ));
HXLINE(  55)		 ::openfl::display::Application _g = ::hx::ObjectPtr<OBJ_>(this);

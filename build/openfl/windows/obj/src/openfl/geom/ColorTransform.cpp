...
HXDLIN( 294)			bool _hx_tmp9;
HXDLIN( 294)			bool _hx_tmp10;
HXDLIN( 294)			if ((this->redMultiplier == 1)) {
HXLINE( 294)				_hx_tmp10 = (this->greenMultiplier == 1);
            			}
            			else {
HXLINE( 294)				_hx_tmp10 = false;
            			}
HXDLIN( 294)			if (_hx_tmp10) {
HXLINE( 294)				_hx_tmp9 = (this->blueMultiplier == 1);
            			}
            			else {
HXLINE( 294)				_hx_tmp9 = false;
            			}
HXDLIN( 294)			if (_hx_tmp9) {
HXLINE( 294)				_hx_tmp8 = (this->alphaMultiplier == 1);
            			}
            			else {
HXLINE( 294)				_hx_tmp8 = false;
            			}
HXDLIN( 294)			if (_hx_tmp8) {
HXLINE( 294)				_hx_tmp7 = (this->redOffset == 0);
            			}
            			else {
HXLINE( 294)				_hx_tmp7 = false;
            			}
HXDLIN( 294)			if (_hx_tmp7) {
HXLINE( 294)				_hx_tmp6 = (this->greenOffset == 0);
            			}
            			else {
HXLINE( 294)				_hx_tmp6 = false;
            			}
HXDLIN( 294)			if (_hx_tmp6) {
HXLINE( 294)				_hx_tmp5 = (this->blueOffset == 0);
            			}
            			else {
...
HXDLIN( 335)			::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,20,8);
            		}
HXLINE( 338)		{

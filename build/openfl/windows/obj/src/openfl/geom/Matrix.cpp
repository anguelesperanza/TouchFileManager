...
HXDLIN( 707)			this->_hx___array =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,9,8);
            		}
...
HXLINE( 724)			{
HXLINE( 724)				 ::lime::utils::ArrayBufferView this10 = this->_hx___array;
HXDLIN( 724)				Float val6 = this->a;
HXDLIN( 724)				 ::__hxcpp_memory_set_float(this10->buffer->b,this10->byteOffset,val6);
            			}
HXLINE( 725)			{
HXLINE( 725)				 ::lime::utils::ArrayBufferView this11 = this->_hx___array;
HXDLIN( 725)				Float val7 = this->c;
HXDLIN( 725)				 ::__hxcpp_memory_set_float(this11->buffer->b,(this11->byteOffset + 4),val7);
            			}
HXLINE( 726)			{
HXLINE( 726)				 ::lime::utils::ArrayBufferView this12 = this->_hx___array;
HXDLIN( 726)				Float val8 = this->tx;
HXDLIN( 726)				 ::__hxcpp_memory_set_float(this12->buffer->b,(this12->byteOffset + 8),val8);
            			}
HXLINE( 727)			{
HXLINE( 727)				 ::lime::utils::ArrayBufferView this13 = this->_hx___array;
HXDLIN( 727)				Float val9 = this->b;
HXDLIN( 727)				 ::__hxcpp_memory_set_float(this13->buffer->b,(this13->byteOffset + 12),val9);
            			}
HXLINE( 728)			{
HXLINE( 728)				 ::lime::utils::ArrayBufferView this14 = this->_hx___array;
HXDLIN( 728)				Float val10 = this->d;
HXDLIN( 728)				 ::__hxcpp_memory_set_float(this14->buffer->b,(this14->byteOffset + 16),val10);
            			}
HXLINE( 729)			{
HXLINE( 729)				 ::lime::utils::ArrayBufferView this15 = this->_hx___array;
HXDLIN( 729)				Float val11 = this->ty;
HXDLIN( 729)				 ::__hxcpp_memory_set_float(this15->buffer->b,(this15->byteOffset + 20),val11);
            			}
HXLINE( 730)			{
HXLINE( 730)				 ::lime::utils::ArrayBufferView this16 = this->_hx___array;
HXDLIN( 730)				 ::__hxcpp_memory_set_float(this16->buffer->b,(this16->byteOffset + 24),0);
            			}
HXLINE( 731)			{
HXLINE( 731)				 ::lime::utils::ArrayBufferView this17 = this->_hx___array;
HXDLIN( 731)				 ::__hxcpp_memory_set_float(this17->buffer->b,(this17->byteOffset + 28),0);
            			}
HXLINE( 732)			{
HXLINE( 732)				 ::lime::utils::ArrayBufferView this18 = this->_hx___array;
HXDLIN( 732)				 ::__hxcpp_memory_set_float(this18->buffer->b,(this18->byteOffset + 32),1);
            			}
            		}

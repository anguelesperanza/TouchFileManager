...
HXLINE( 285)				_hx_tmp2 = (rect->y > this->y);
            			}
            			else {
HXLINE( 285)				_hx_tmp2 = false;
            			}
HXDLIN( 285)			if (_hx_tmp2) {
HXLINE( 285)				Float _hx_tmp3 = rect->get_right();
HXDLIN( 285)				_hx_tmp1 = (_hx_tmp3 < this->get_right());
            			}
            			else {
HXLINE( 285)				_hx_tmp1 = false;
            			}
HXDLIN( 285)			if (_hx_tmp1) {
HXLINE( 285)				Float _hx_tmp4 = rect->get_bottom();
HXDLIN( 285)				return (_hx_tmp4 < this->get_bottom());
            			}
            			else {
...
HXLINE( 289)				_hx_tmp6 = (rect->y >= this->y);
            			}
            			else {
HXLINE( 289)				_hx_tmp6 = false;
            			}
HXDLIN( 289)			if (_hx_tmp6) {
HXLINE( 289)				Float _hx_tmp7 = rect->get_right();
HXDLIN( 289)				_hx_tmp5 = (_hx_tmp7 <= this->get_right());
            			}
            			else {
HXLINE( 289)				_hx_tmp5 = false;
            			}
HXDLIN( 289)			if (_hx_tmp5) {
HXLINE( 289)				Float _hx_tmp8 = rect->get_bottom();
HXDLIN( 289)				return (_hx_tmp8 <= this->get_bottom());
            			}
            			else {
...
HXLINE( 540)				_hx_tmp1 = (toUnion->height == 0);
            			}
            			else {

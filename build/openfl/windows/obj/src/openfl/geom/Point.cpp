...
HXLINE( 182)			 ::openfl::geom::Point _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 182)			_hx_tmp1->x = (_hx_tmp1->x * norm);
HXLINE( 183)			 ::openfl::geom::Point _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 183)			_hx_tmp2->y = (_hx_tmp2->y * norm);
            		}
            	}

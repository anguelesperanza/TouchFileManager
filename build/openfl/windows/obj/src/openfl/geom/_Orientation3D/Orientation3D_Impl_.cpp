...
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_64_fromString,"openfl.geom._Orientation3D.Orientation3D_Impl_","fromString",0xa47116a0,"openfl.geom._Orientation3D.Orientation3D_Impl_.fromString","openfl/geom/Orientation3D.hx",64,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_75_toString,"openfl.geom._Orientation3D.Orientation3D_Impl_","toString",0xf11d8e31,"openfl.geom._Orientation3D.Orientation3D_Impl_.toString","openfl/geom/Orientation3D.hx",75,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_32_boot,"openfl.geom._Orientation3D.Orientation3D_Impl_","boot",0xe951db37,"openfl.geom._Orientation3D.Orientation3D_Impl_.boot","openfl/geom/Orientation3D.hx",32,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_48_boot,"openfl.geom._Orientation3D.Orientation3D_Impl_","boot",0xe951db37,"openfl.geom._Orientation3D.Orientation3D_Impl_.boot","openfl/geom/Orientation3D.hx",48,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_60_boot,"openfl.geom._Orientation3D.Orientation3D_Impl_","boot",0xe951db37,"openfl.geom._Orientation3D.Orientation3D_Impl_.boot","openfl/geom/Orientation3D.hx",60,0xf4ac08f1)
namespace openfl{
namespace geom{
...
bool Orientation3D_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Orientation3D_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_64_fromString)
...
::String Orientation3D_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_75_toString)
HXDLIN(  75)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  77)			return HX_("axisAngle",72,2f,86,7c);
HXDLIN(  77)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  78)			return HX_("eulerAngles",89,d7,c4,64);
HXDLIN(  78)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  79)			return HX_("quaternion",1e,0d,ca,1b);
...
{
{
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_32_boot)
HXDLIN(  32)		AXIS_ANGLE = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_48_boot)
HXDLIN(  48)		EULER_ANGLES = 1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_60_boot)

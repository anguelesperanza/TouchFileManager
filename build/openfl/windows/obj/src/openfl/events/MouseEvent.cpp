...
HX_DEFINE_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_634_new,"openfl.events.MouseEvent","new",0x5c6da59e,"openfl.events.MouseEvent.new","openfl/events/MouseEvent.hx",634,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_655_clone,"openfl.events.MouseEvent","clone",0x3e8b341b,"openfl.events.MouseEvent.clone","openfl/events/MouseEvent.hx",655,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_666_toString,"openfl.events.MouseEvent","toString",0x2fb13aae,"openfl.events.MouseEvent.toString","openfl/events/MouseEvent.hx",666,0xd3783172)
...
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_676_updateAfterEvent,"openfl.events.MouseEvent","updateAfterEvent",0xc76737c9,"openfl.events.MouseEvent.updateAfterEvent","openfl/events/MouseEvent.hx",676,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_690___init,"openfl.events.MouseEvent","__init",0x61a823b2,"openfl.events.MouseEvent.__init","openfl/events/MouseEvent.hx",690,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_680___create,"openfl.events.MouseEvent","__create",0x1b813c1e,"openfl.events.MouseEvent.__create","openfl/events/MouseEvent.hx",680,0xd3783172)
...
void MouseEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< Float >  __o_localX,::hx::Null< Float >  __o_localY, ::openfl::display::InteractiveObject relatedObject,::hx::Null< bool >  __o_ctrlKey,::hx::Null< bool >  __o_altKey,::hx::Null< bool >  __o_shiftKey,::hx::Null< bool >  __o_buttonDown,::hx::Null< int >  __o_delta,::hx::Null< bool >  __o_commandKey,::hx::Null< int >  __o_clickCount){
            	...
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_634_new)
HXLINE( 635)		super::__construct(type,bubbles,cancelable);
HXLINE( 637)		this->shiftKey = shiftKey;
HXLINE( 638)		this->altKey = altKey;
HXLINE( 639)		this->ctrlKey = ctrlKey;
HXLINE( 640)		this->bubbles = bubbles;
HXLINE( 641)		this->relatedObject = relatedObject;
HXLINE( 642)		this->delta = delta;
HXLINE( 643)		this->localX = localX;
HXLINE( 644)		this->localY = localY;
HXLINE( 645)		this->buttonDown = buttonDown;
HXLINE( 646)		this->commandKey = commandKey;
HXLINE( 647)		this->clickCount = clickCount;
HXLINE( 649)		this->isRelatedObjectInaccessible = false;
HXLINE( 650)		this->stageX = ::Math_obj::NaN;
HXLINE( 651)		this->stageY = ::Math_obj::NaN;
            	}
...
bool MouseEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event MouseEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_655_clone)
HXLINE( 656)		 ::openfl::events::MouseEvent event =  ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->localX,this->localY,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
HXLINE( 658)		event->target = this->target;
HXLINE( 659)		event->currentTarget = this->currentTarget;
HXLINE( 660)		event->eventPhase = this->eventPhase;
HXLINE( 661)		return event;
            	}


::String MouseEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_666_toString)
HXDLIN( 666)		return this->_hx___formatToString(HX_("MouseEvent",d5,bf,42,8a),::Array_obj< ::String >::fromData( _hx_array_data_094f3eac_3,11));
            	}


void MouseEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_676_updateAfterEvent)
            	}
...
void MouseEvent_obj::_hx___init(){
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_690___init)
HXLINE( 691)		this->super::_hx___init();
HXLINE( 692)		this->shiftKey = false;
HXLINE( 693)		this->altKey = false;
HXLINE( 694)		this->ctrlKey = false;
HXLINE( 695)		this->bubbles = false;
HXLINE( 696)		this->relatedObject = null();
HXLINE( 697)		this->delta = 0;
HXLINE( 698)		this->localX = ( (Float)(0) );
HXLINE( 699)		this->localY = ( (Float)(0) );
HXLINE( 700)		this->buttonDown = false;
HXLINE( 701)		this->commandKey = false;
HXLINE( 702)		this->clickCount = 0;
HXLINE( 704)		this->isRelatedObjectInaccessible = false;
HXLINE( 705)		this->stageX = ::Math_obj::NaN;
HXLINE( 706)		this->stageY = ::Math_obj::NaN;
            	}
...
bool MouseEvent_obj::_hx___shiftKey;
 ...
 ::openfl::events::MouseEvent MouseEvent_obj::_hx___create(::String type,int button,Float stageX,Float stageY, ::openfl::geom::Point local, ::openfl::display::InteractiveObject target,::hx::Null< int >  __o_delta){
            		int delta = __o_delta.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_680___create)
HXLINE( 681)		 ::openfl::events::MouseEvent event =  ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,type,true,false,local->x,local->y,null(),::openfl::events::MouseEvent_obj::_hx___ctrlKey,::openfl::events::MouseEvent_obj::_hx___altKey,::openfl::events::MouseEvent_obj::_hx___shiftKey,::openfl::events::MouseEvent_obj::_hx___buttonDown,delta,::openfl::events::MouseEvent_obj::_hx___commandKey,null());
HXLINE( 682)		event->stageX = stageX;
HXLINE( 683)		event->stageY = stageY;
HXLINE( 684)		event->target = target;
HXLINE( 686)		return event;
            	}

...
HXLINE( 180)				{
HXLINE( 180)					int _g2 = ::Std_obj::_hx_int(sourceRect->x);
HXDLIN( 180)					int _g3 = ::Std_obj::_hx_int(sourceRect->width);
HXDLIN( 180)					while((_g2 < _g3)){
HXLINE( 180)						_g2 = (_g2 + 1);
HXDLIN( 180)						int column = (_g2 - 1);
...
HXDLIN( 185)									sourcePixel = (((((r & 255) << 24) | ((g & 255) << 16)) | ((b & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 3))) & 255)) ) & 255));
            								...
            								break;
            								case (int)1: {
HXLINE( 185)									int r1 = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 1))) & 255)) );
HXDLIN( 185)									int g1 = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 2))) & 255)) );
HXDLIN( 185)									int b1 = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 3))) & 255)) );
HXDLIN( 185)									sourcePixel = (((((r1 & 255) << 24) | ((g1 & 255) << 16)) | ((b1 & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + sourceOffset)) & 255)) ) & 255));
            								}
            								break;
            								case (int)2: {
HXLINE( 185)									int r2 = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 2))) & 255)) );
HXDLIN( 185)									int g2 = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 1))) & 255)) );
HXDLIN( 185)									int b2 = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + sourceOffset)) & 255)) );
HXDLIN( 185)									sourcePixel = (((((r2 & 255) << 24) | ((g2 & 255) << 16)) | ((b2 & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 3))) & 255)) ) & 255));
            								}
            								break;
            							}
...
HXDLIN( 185)										int r3 = ( (int)(( ::__hxcpp_memory_get_byte(this1->buffer->b,(this1->byteOffset + ::Math_obj::round((( (Float)((::hx::UShr(sourcePixel,24) & 255)) ) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & 255)) );
HXDLIN( 185)										 ::lime::utils::ArrayBufferView this2 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 185)										int g3 = ( (int)(( ::__hxcpp_memory_get_byte(this2->buffer->b,(this2->byteOffset + ::Math_obj::round((( (Float)((::hx::UShr(sourcePixel,16) & 255)) ) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & 255)) );
HXDLIN( 185)										 ::lime::utils::ArrayBufferView this3 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 185)										sourcePixel = (((((r3 & 255) << 24) | ((g3 & 255) << 16)) | ((( (int)(( ::__hxcpp_memory_get_byte(this3->buffer->b,(this3->byteOffset + ::Math_obj::round((( (Float)((::hx::UShr(sourcePixel,8) & 255)) ) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & 255)) ) & 255) << 8)) | ((sourcePixel & 255) & 255));
            									}
            								}
            							}
            						}
...
HXLINE( 211)										 ::lime::utils::ArrayBufferView this4 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___alpha16;
HXDLIN( 211)										::lime::math::_RGBA::RGBA_Impl__obj::a16 = ( (int)( ::__hxcpp_memory_get_ui32(this4->buffer->b,(this4->byteOffset + ((destPixel & 255) * 4)))) );
...
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),val3);
            								...
            								case (int)1: {
HXLINE( 211)									{
HXLINE( 211)										int val4 = (destPixel & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),val4);
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val5 = (::hx::UShr(destPixel,24) & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 1)),val5);
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val6 = (::hx::UShr(destPixel,16) & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),val6);
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val7 = (::hx::UShr(destPixel,8) & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),val7);
            									}
            								}
            								break;
            								case (int)2: {
HXLINE( 211)									{
HXLINE( 211)										int val8 = (::hx::UShr(destPixel,8) & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),val8);
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val9 = (::hx::UShr(destPixel,16) & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 1)),val9);
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val10 = (::hx::UShr(destPixel,24) & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),val10);
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val11 = (destPixel & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),val11);
            									}
            								}
            								break;
            							}

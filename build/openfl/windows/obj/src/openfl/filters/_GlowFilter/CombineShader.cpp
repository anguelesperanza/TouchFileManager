...
HX_DEFINE_STACK_FRAME(_hx_pos_bfba60fe12c23493_611_new,"openfl.filters._GlowFilter.CombineShader","new",0x929ab2fb,"openfl.filters._GlowFilter.CombineShader.new","openfl/filters/GlowFilter.hx",611,0x5f568606)
static const Float _hx_array_data_1cf91989_1[] = {
	(Float)0,(Float)0,
};
namespace openfl{
namespace filters{
...
void CombineShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_bfba60fe12c23493_611_new)
...
HXLINE( 612)		super::__construct(null());
HXLINE( 614)		this->offset->value = ::Array_obj< Float >::fromData( _hx_array_data_1cf91989_1,2);
HXLINE( 584)		this->_hx___isGenerated = true;
HXDLIN( 584)		this->_hx___initGL();
            	}
...
::hx::ObjectPtr< CombineShader_obj > CombineShader_obj::__alloc(::hx::Ctx *_hx_ctx) {
	CombineShader_obj *__this = (CombineShader_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(CombineShader_obj), true, "openfl.filters._GlowFilter.CombineShader"));
...
void CombineShader_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(CombineShader);
...
void CombineShader_obj::__Visit(HX_VISIT_PARAMS)
{
...
::hx::Val CombineShader_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
...
::hx::Val CombineShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
...
void CombineShader_obj::__GetFields(Array< ::String> &outFields)
{
...
static ::hx::StorageInfo CombineShader_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::openfl::display::ShaderParameter_Float */ ,(int)offsetof(CombineShader_obj,offset),HX_("offset",93,97,3f,60)},
	{::hx::fsObject /*  ::openfl::display::ShaderInput_openfl_display_BitmapData */ ,(int)offsetof(CombineShader_obj,sourceBitmap),HX_("sourceBitmap",2a,cb,12,e7)},
	{ ::hx::fsUnknown, 0, null()}
};
static ::hx::StaticInfo *CombineShader_obj_sStaticStorageInfo = 0;
#endif

static ::String CombineShader_obj_sMemberFields[] = {
...
void CombineShader_obj::__register()
{
	...
	__mClass->mName = HX_("openfl.filters._GlowFilter.CombineShader",89,19,f9,1c);
	...
	__mClass->mMembers = ::hx::Class_obj::dupFunctions(CombineShader_obj_sMemberFields);

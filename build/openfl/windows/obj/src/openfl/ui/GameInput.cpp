...
HXLINE( 163)			 ::openfl::ui::GameInputControl control2 = ( ( ::openfl::ui::GameInputControl)(device->_hx___axis->get(axis)) );
HXLINE( 164)			control2->value = value;
HXLINE( 165)			control2->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),null(),null()));
            		}
            	}
...
HXLINE( 185)			 ::openfl::ui::GameInputControl control2 = ( ( ::openfl::ui::GameInputControl)(device->_hx___button->get(button)) );
HXLINE( 186)			control2->value = ( (Float)(1) );
HXLINE( 187)			control2->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),null(),null()));
            		}
            	}
...
HXLINE( 207)			 ::openfl::ui::GameInputControl control2 = ( ( ::openfl::ui::GameInputControl)(device->_hx___button->get(button)) );
HXLINE( 208)			control2->value = ( (Float)(0) );
HXLINE( 209)			control2->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),null(),null()));
            		}
            	}

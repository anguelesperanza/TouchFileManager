...
HXLINE( 153)			 ::Dynamic _hx_tmp3 = this->_hx___hbBuffer;
HXDLIN( 153)			Float _hx_tmp4 = (uintptr_t)this->text.wc_str();
HXDLIN( 153)			::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::addUTF16(_hx_tmp3,_hx_tmp4,this->text.length,0,-1);
...
HXLINE( 161)			bool _hx_tmp5;
HXDLIN( 161)			if (::hx::IsNotNull( _info )) {
HXLINE( 161)				_hx_tmp5 = ::hx::IsNotNull( _positions );
            			}
            			else {
...
HXLINE( 173)						{
HXLINE( 173)							int _g2 = (lastCluster + 1);
HXDLIN( 173)							int _g3 = info->cluster;
HXDLIN( 173)							while((_g2 < _g3)){
HXLINE( 173)								_g2 = (_g2 + 1);
HXDLIN( 173)								int j = (_g2 - 1);
HXLINE( 177)								::Array< ::Dynamic> _hx_tmp6 = this->get_positions();
HXDLIN( 177)								 ::lime::math::Vector2 _hx_tmp7 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0);
HXDLIN( 177)								_hx_tmp6->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,0,_hx_tmp7, ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0)));
            							}
            						}
HXLINE( 180)						::Array< ::Dynamic> _hx_tmp8 = this->get_positions();
HXDLIN( 180)						int info1 = info->codepoint;
HXDLIN( 180)						 ::lime::math::Vector2 _hx_tmp9 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,((( (Float)(position->xAdvance) ) / ( (Float)(64) )) + this->letterSpacing),(( (Float)(position->yAdvance) ) / ( (Float)(64) )));
HXDLIN( 180)						_hx_tmp8->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,info1,_hx_tmp9, ::lime::math::Vector2_obj::__alloc( HX_CTX ,(( (Float)(position->xOffset) ) / ( (Float)(64) )),(( (Float)(position->yOffset) ) / ( (Float)(64) )))));

...
HXDLIN(  80)					::cpp::VirtualArray _g_args = ::cpp::VirtualArray_obj::__new(0);
...
HXLINE(  92)			{
HXLINE(  92)				int deleteCount1 = textFormatRanges->get_length();
HXDLIN(  92)				textFormatRanges->_hx___tempIndex = 0;
HXDLIN(  92)				{
HXLINE(  92)					int _g_current1 = 0;
HXDLIN(  92)					::cpp::VirtualArray _g_args1 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(  92)					while((_g_current1 < _g_args1->get_length())){
HXLINE(  92)						_g_current1 = (_g_current1 + 1);
HXDLIN(  92)						 ::Dynamic item1 = _g_args1->__get((_g_current1 - 1));
HXDLIN(  92)						textFormatRanges->insertAt(textFormatRanges->_hx___tempIndex,( ( ::openfl::text::_internal::TextFormatRange)(item1) ));
HXDLIN(  92)						textFormatRanges->_hx___tempIndex++;
            					}
            				}
HXDLIN(  92)				textFormatRanges->splice(textFormatRanges->_hx___tempIndex,deleteCount1);
            			}
...
HXLINE( 217)										_hx_tmp3 = ::hx::IsEq( firstChar,45 );
            									}
            									else {
...
HXLINE( 190)									_hx_tmp4 = !(noLineBreak);
            								}
            								else {
...
HXLINE( 178)									_hx_tmp5 = !(noLineBreak);
            								}
            								else {
...
HXDLIN( 268)										while((_g1 < values->length)){
HXLINE( 268)											::String stop = values->__get(_g1);

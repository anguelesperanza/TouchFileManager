...
HXDLIN( 172)				int _g3 = found->length;
HXDLIN( 172)				while((_g2 < _g3)){
HXLINE( 172)					_g2 = (_g2 + 1);
HXDLIN( 172)					int i1 = (_g2 - 1);
HXLINE( 174)					this->intelligentCSSPush(::Array_obj< ::Dynamic>::__new(1)->init(0,base),found->__get(i1).StaticCast<  ::haxe::ds::StringMap >(),null());
            				}
            			}
...
HXLINE( 279)					 ::Dynamic _hx_tmp2 = rule1->get(HX_("value",71,7f,b8,31));
HXDLIN( 279)					if (::hx::IsNotEq( _hx_tmp2,rule2->get(HX_("value",71,7f,b8,31)) )) {
...
HXLINE( 325)				 ::haxe::ds::StringMap cobj = objectArray->__get(i1).StaticCast<  ::haxe::ds::StringMap >();
...
HXLINE( 363)				 ::Dynamic _hx_tmp1 = objectArray->__get(j).StaticCast<  ::haxe::ds::StringMap >()->get(HX_("selector",1f,33,6d,b1));
HXDLIN( 363)				if (::hx::IsEq( _hx_tmp1,minimalObject->get(HX_("selector",1f,33,6d,b1)) )) {
...
HXDLIN( 380)					int _g3 = mRules->length;
HXDLIN( 380)					while((_g2 < _g3)){
HXLINE( 380)						_g2 = (_g2 + 1);
HXDLIN( 380)						int i1 = (_g2 - 1);
HXLINE( 382)						 ::haxe::ds::StringMap rule = mRules->__get(i1).StaticCast<  ::haxe::ds::StringMap >();
...
HXLINE( 405)				::cpp::VirtualArray _hx_tmp2 = ::hx::TCast< ::cpp::VirtualArray >::cast(cssObject->get(HX_("subStyles",c2,23,1f,1c)));
HXLINE( 404)				cssObject->set(HX_("value",71,7f,b8,31),_hx_tmp2->concat(( (::cpp::VirtualArray)(minimalObject->get(HX_("subStyles",c2,23,1f,1c))) )));
            			}
            		}
            	}
...
HXDLIN( 600)		 ::haxe::ds::StringMap ret = _g6;

...
HXLINE(  75)			 ::haxe::ds::StringMap formatMap1 =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  76)			formatMap1->set(wordKey,getPositions->get_positions());
HXLINE(  78)			this->_hx___shortWordMap->set(formatKey,formatMap1);
            		}
...
HXLINE( 110)				 ::openfl::text::_internal::CacheMeasurement measurement1 =  ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions());
HXLINE( 111)				formatMap->set(hash,measurement1);
            			}
            		}
            		else {
HXLINE( 116)			 ::haxe::ds::IntMap formatMap1 =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 117)			 ::openfl::text::_internal::CacheMeasurement measurement2 =  ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions());
HXLINE( 118)			measurement2->hash = hash;
HXLINE( 119)			formatMap1->set(hash,measurement2);
HXLINE( 120)			this->_hx___longWordMap->set(formatKey,formatMap1);
            		}
...
HXLINE(  26)				_g = (_g + 1);
HXDLIN(  26)				int i1 = (_g - 1);
HXLINE(  28)				chr = key.charCodeAt(i1);

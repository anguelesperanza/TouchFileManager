...
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_119_fromBytes,"openfl.text.Font","fromBytes",0x95ccba25,"openfl.text.Font.fromBytes","openfl/text/Font.hx",119,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_140_fromFile,"openfl.text.Font","fromFile",0x919e3202,"openfl.text.Font.fromFile","openfl/text/Font.hx",140,0x076bbaac)
...
HXLINE(  86)						_allFonts->push(::openfl::text::Font_obj::fromFile((::lime::_hx_system::System_obj::get_fontsDirectory() + file)));
            					}
            				}
            			}
HXLINE(  93)			::String alternateFontsDirectory = ((HX_("",00,00,00,00) + ::Sys_obj::getEnv(HX_("LocalAppData",60,61,db,d1))) + HX_("\\Microsoft\\Windows\\Fonts",01,0e,94,9c));
HXLINE(  94)			if (::sys::FileSystem_obj::exists(alternateFontsDirectory)) {
HXLINE(  96)				files = ::sys::FileSystem_obj::readDirectory(alternateFontsDirectory);
HXLINE(  97)				{
HXLINE(  97)					int _g1 = 0;
HXDLIN(  97)					while((_g1 < files->length)){
HXLINE(  97)						::String file1 = files->__get(_g1);
HXDLIN(  97)						_g1 = (_g1 + 1);
HXLINE(  99)						if ((file1.toLowerCase().indexOf(HX_(".ttf",78,3b,c0,1e),null()) != -1)) {
HXLINE(  99)							_allFonts->push(::openfl::text::Font_obj::fromFile((alternateFontsDirectory + file1)));
            						}
            					}
            				}
            			}
HXLINE( 104)			return _allFonts;
            		}
HXLINE( 107)		return ::openfl::text::Font_obj::_hx___registeredFonts;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,enumerateFonts,return )
 ...
 ::openfl::text::Font Font_obj::fromBytes( ::openfl::utils::ByteArrayData bytes){
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_119_fromBytes)
HXLINE( 120)		 ::openfl::text::Font font =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
HXLINE( 122)		font->_hx___fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(bytes));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,fromBytes,return )
 ...
 ::openfl::text::Font Font_obj::fromFile(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_140_fromFile)
HXLINE( 141)		if (::hx::IsNull( path )) {

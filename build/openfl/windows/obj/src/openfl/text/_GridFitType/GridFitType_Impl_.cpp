...
HX_LOCAL_STACK_FRAME(_hx_pos_31a37265e1649dc6_45_fromString,"openfl.text._GridFitType.GridFitType_Impl_","fromString",0xec7a2309,"openfl.text._GridFitType.GridFitType_Impl_.fromString","openfl/text/GridFitType.hx",45,0x99326c1c)
HX_LOCAL_STACK_FRAME(_hx_pos_31a37265e1649dc6_56_toString,"openfl.text._GridFitType.GridFitType_Impl_","toString",0x85ab7e5a,"openfl.text._GridFitType.GridFitType_Impl_.toString","openfl/text/GridFitType.hx",56,0x99326c1c)
HX_LOCAL_STACK_FRAME(_hx_pos_31a37265e1649dc6_20_boot,"openfl.text._GridFitType.GridFitType_Impl_","boot",0xa66842e0,"openfl.text._GridFitType.GridFitType_Impl_.boot","openfl/text/GridFitType.hx",20,0x99326c1c)
HX_LOCAL_STACK_FRAME(_hx_pos_31a37265e1649dc6_30_boot,"openfl.text._GridFitType.GridFitType_Impl_","boot",0xa66842e0,"openfl.text._GridFitType.GridFitType_Impl_.boot","openfl/text/GridFitType.hx",30,0x99326c1c)
HX_LOCAL_STACK_FRAME(_hx_pos_31a37265e1649dc6_41_boot,"openfl.text._GridFitType.GridFitType_Impl_","boot",0xa66842e0,"openfl.text._GridFitType.GridFitType_Impl_.boot","openfl/text/GridFitType.hx",41,0x99326c1c)
namespace openfl{
namespace text{
...
bool GridFitType_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic GridFitType_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_31a37265e1649dc6_45_fromString)
...
::String GridFitType_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_31a37265e1649dc6_56_toString)
HXDLIN(  56)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  58)			return HX_("none",b8,12,0a,49);
HXDLIN(  58)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  59)			return HX_("pixel",86,c6,a3,c2);
HXDLIN(  59)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  60)			return HX_("subpixel",06,ad,95,a4);
...
{
{
            	HX_STACKFRAME(&_hx_pos_31a37265e1649dc6_20_boot)
HXDLIN(  20)		NONE = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_31a37265e1649dc6_30_boot)
HXDLIN(  30)		PIXEL = 1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_31a37265e1649dc6_41_boot)

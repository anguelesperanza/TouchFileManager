...
HXLINE(1279)				HX_STACK_DO_THROW(::haxe::io::Error_obj::OutsideBounds_dyn());
            			}
...
HXLINE(1353)				return ::haxe::Unserializer_obj::run(data);
            			...
            			break;
            			case (int)12: {
HXLINE(1356)				::String data1 = this->readUTF();
HXLINE(1357)				return  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,data1)->doParse();
            			}
            			break;
            			default:{
...
HXLINE(1607)		::cpp::Int64 int64 = ::haxe::io::FPHelper_obj::doubleToI64(value);
...
HXDLIN(1686)				::String value1 = ::haxe::format::JsonPrinter_obj::print(object,replacer,space);
HXLINE(1687)				this->writeUTF(value1);
            			}
            			break;
            			default:{
HXLINE(1690)				return;

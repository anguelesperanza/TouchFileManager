...
HXLINE( 104)					if (::StringTools_obj::startsWith(key3,prefix)) {
HXLINE( 106)						this->removeFont(key3);
            					}
            				}
            			}
HXLINE( 110)			 ::Dynamic keys2 = this->sound->keys();
HXLINE( 112)			{
HXLINE( 112)				 ::Dynamic key4 = keys2;
HXDLIN( 112)				while(( (bool)(key4->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 112)					::String key5 = ( (::String)(key4->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 114)					if (::StringTools_obj::startsWith(key5,prefix)) {
HXLINE( 116)						this->removeSound(key5);
            					}
            				}
            			}
            		}

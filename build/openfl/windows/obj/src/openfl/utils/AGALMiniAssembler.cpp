...
HXDLIN( 518)							int int1 = relsel;
HXDLIN( 518)							Float _hx_tmp15;
HXDLIN( 518)							if ((int1 < 0)) {
HXLINE( 518)								_hx_tmp15 = (((Float)4294967296.0) + int1);
            							}
            							else {
HXLINE( 518)								_hx_tmp15 = (int1 + ((Float)0.0));
            							}
...
HXDLIN( 518)							int int2 = regidx;
HXDLIN( 518)							Float _hx_tmp18;
HXDLIN( 518)							if ((int2 < 0)) {
HXLINE( 518)								_hx_tmp18 = (((Float)4294967296.0) + int2);
            							}
            							else {
HXLINE( 518)								_hx_tmp18 = (int2 + ((Float)0.0));
            							}
...
HXLINE( 548)							{
HXLINE( 548)								int _g2 = 0;
HXDLIN( 548)								int _g3 = optsLength;
HXDLIN( 548)								while((_g2 < _g3)){
HXLINE( 548)									_g2 = (_g2 + 1);
HXDLIN( 548)									int k1 = (_g2 - 1);
...
HXDLIN( 640)				int _g5 = agalLength;
HXDLIN( 640)				while((_g4 < _g5)){
HXLINE( 640)					_g4 = (_g4 + 1);
HXDLIN( 640)					int index = (_g4 - 1);
...
HXLINE( 667)			::String _hx_tmp25 = ((HX_("AGALMiniAssembler.assemble time: ",4b,2c,a6,f9) + (( (Float)((::openfl::Lib_obj::getTimer() - start)) ) / ( (Float)(1000) ))) + HX_("s",73,00,00,00));
HXDLIN( 667)			::lime::utils::Log_obj::info(_hx_tmp25,::hx::SourceInfo(HX_("openfl/utils/AGALMiniAssembler.hx",83,ff,5e,12),667,HX_("openfl.utils.AGALMiniAssembler",1d,f7,bb,62),HX_("assemble",12,a9,1b,c5)));
            		}
...
HXDLIN( 675)			 ::openfl::utils::_AGALMiniAssembler::Register v2 =  ::openfl::utils::_AGALMiniAssembler::Register_obj::__alloc( HX_CTX ,HX_("va",2b,67,00,00),HX_("vertex attribute",60,ec,e8,40),0,v,66);
...
HXDLIN( 676)			 ::openfl::utils::_AGALMiniAssembler::Register v4 =  ::openfl::utils::_AGALMiniAssembler::Register_obj::__alloc( HX_CTX ,HX_("vc",2d,67,00,00),HX_("vertex constant",a0,79,46,53),1,v3,66);
...
HXDLIN( 677)			 ::openfl::utils::_AGALMiniAssembler::Register v6 =  ::openfl::utils::_AGALMiniAssembler::Register_obj::__alloc( HX_CTX ,HX_("vt",3e,67,00,00),HX_("vertex temporary",d5,c5,fd,1d),2,v5,67);
...
HXDLIN( 678)			 ::openfl::utils::_AGALMiniAssembler::Register v8 =  ::openfl::utils::_AGALMiniAssembler::Register_obj::__alloc( HX_CTX ,HX_("vo",39,67,00,00),HX_("vertex output",3d,00,1e,e4),3,v7,65);
...
HXDLIN( 679)			 ::openfl::utils::_AGALMiniAssembler::Register v10 =  ::openfl::utils::_AGALMiniAssembler::Register_obj::__alloc( HX_CTX ,HX_("vi",33,67,00,00),HX_("varying",70,bc,7b,e7),4,v9,99);
...
HXDLIN( 680)			 ::openfl::utils::_AGALMiniAssembler::Register v12 =  ::openfl::utils::_AGALMiniAssembler::Register_obj::__alloc( HX_CTX ,HX_("fc",3d,59,00,00),HX_("fragment constant",b4,07,43,d0),1,v11,34);
...
HXDLIN( 681)			 ::openfl::utils::_AGALMiniAssembler::Register v14 =  ::openfl::utils::_AGALMiniAssembler::Register_obj::__alloc( HX_CTX ,HX_("ft",4e,59,00,00),HX_("fragment temporary",41,89,fd,fd),2,v13,35);
...
HXDLIN( 682)			 ::openfl::utils::_AGALMiniAssembler::Register v16 =  ::openfl::utils::_AGALMiniAssembler::Register_obj::__alloc( HX_CTX ,HX_("fs",4d,59,00,00),HX_("texture sampler",c3,a4,85,37),5,v15,34);
...
HXDLIN( 683)			 ::openfl::utils::_AGALMiniAssembler::Register v18 =  ::openfl::utils::_AGALMiniAssembler::Register_obj::__alloc( HX_CTX ,HX_("fo",49,59,00,00),HX_("fragment output",51,21,41,79),3,v17,33);
...
HXDLIN( 684)			 ::openfl::utils::_AGALMiniAssembler::Register v20 =  ::openfl::utils::_AGALMiniAssembler::Register_obj::__alloc( HX_CTX ,HX_("fd",3e,59,00,00),HX_("fragment depth output",ce,1a,fc,b5),6,v19,33);
...
HXDLIN( 685)			 ::openfl::utils::_AGALMiniAssembler::Register v22 =  ::openfl::utils::_AGALMiniAssembler::Register_obj::__alloc( HX_CTX ,HX_("iid",84,08,50,00),HX_("instance id",86,af,f1,28),7,v21,66);
...
HXDLIN( 688)			 ::openfl::utils::_AGALMiniAssembler::Register v23 = ( ( ::openfl::utils::_AGALMiniAssembler::Register)(::openfl::utils::AGALMiniAssembler_obj::REGMAP->get(HX_("vo",39,67,00,00))) );
...
HXDLIN( 689)			 ::openfl::utils::_AGALMiniAssembler::Register v24 = ( ( ::openfl::utils::_AGALMiniAssembler::Register)(::openfl::utils::AGALMiniAssembler_obj::REGMAP->get(HX_("vi",33,67,00,00))) );
...
HXDLIN( 690)			 ::openfl::utils::_AGALMiniAssembler::Register v25 = ( ( ::openfl::utils::_AGALMiniAssembler::Register)(::openfl::utils::AGALMiniAssembler_obj::REGMAP->get(HX_("vi",33,67,00,00))) );
...
HXDLIN( 691)			 ::openfl::utils::_AGALMiniAssembler::Register v26 = ( ( ::openfl::utils::_AGALMiniAssembler::Register)(::openfl::utils::AGALMiniAssembler_obj::REGMAP->get(HX_("fo",49,59,00,00))) );
...
HXDLIN( 692)			 ::openfl::utils::_AGALMiniAssembler::Register v27 = ( ( ::openfl::utils::_AGALMiniAssembler::Register)(::openfl::utils::AGALMiniAssembler_obj::REGMAP->get(HX_("fd",3e,59,00,00))) );
...
HXDLIN( 693)			 ::openfl::utils::_AGALMiniAssembler::Register v28 = ( ( ::openfl::utils::_AGALMiniAssembler::Register)(::openfl::utils::AGALMiniAssembler_obj::REGMAP->get(HX_("vi",33,67,00,00))) );

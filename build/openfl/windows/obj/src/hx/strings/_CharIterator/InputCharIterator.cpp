...
HXLINE( 286)								HX_STACK_DO_THROW(((((HX_("Valid UTF-8 byte expected at position [",6f,4c,4a,03) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte1) + HX_("]!",24,51,00,00)));
            							}
            						}
            					}
...
HXLINE( 286)						HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte) + HX_("]!",24,51,00,00)));
            					}
...
HXDLIN( 286)					if (isBit6Set) {
HXLINE( 286)						int byte3 = this->input->readByte();
HXDLIN( 286)						this->byteIndex++;
HXDLIN( 286)						if ((1 != ((byte3 >> 7) & 1))) {
HXLINE( 286)							HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte3) + HX_("]!",24,51,00,00)));
            						}
HXDLIN( 286)						if ((1 == ((byte3 >> 6) & 1))) {
HXLINE( 286)							HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte3) + HX_("]!",24,51,00,00)));
            						}
HXDLIN( 286)						int byte31 = (byte3 & -129);
HXDLIN( 286)						result = (result + (byte31 << (6 * (totalBytes - 3))));
HXDLIN( 286)						if (isBit5Set) {
HXLINE( 286)							int byte4 = this->input->readByte();
HXDLIN( 286)							this->byteIndex++;
HXDLIN( 286)							if ((1 != ((byte4 >> 7) & 1))) {
HXLINE( 286)								HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte4) + HX_("]!",24,51,00,00)));
            							}
HXDLIN( 286)							if ((1 == ((byte4 >> 6) & 1))) {
HXLINE( 286)								HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte4) + HX_("]!",24,51,00,00)));
            							}
HXDLIN( 286)							int byte41 = (byte4 & -129);
HXDLIN( 286)							result = (result + (byte41 << (6 * (totalBytes - 4))));
            						}
            					}
...
HXLINE( 286)						int byte11 = this->input->readByte();
HXDLIN( 286)						this->byteIndex++;
HXDLIN( 286)						if ((byte11 <= 127)) {
HXLINE( 286)							_hx_tmp = byte11;
            						}
            						else {
HXLINE( 286)							byte11 = (byte11 & -129);
HXDLIN( 286)							byte11 = (byte11 & -65);
HXDLIN( 286)							int totalBytes1 = 2;
HXDLIN( 286)							bool isBit6Set1 = (1 == ((byte11 >> 5) & 1));
HXDLIN( 286)							bool isBit5Set1 = false;
HXDLIN( 286)							if (isBit6Set1) {
HXLINE( 286)								byte11 = (byte11 & -33);
HXDLIN( 286)								totalBytes1 = (totalBytes1 + 1);
HXDLIN( 286)								isBit5Set1 = (1 == ((byte11 >> 4) & 1));
HXDLIN( 286)								if (isBit5Set1) {
HXLINE( 286)									byte11 = (byte11 & -17);
HXDLIN( 286)									totalBytes1 = (totalBytes1 + 1);
HXDLIN( 286)									if ((1 == ((byte11 >> 3) & 1))) {
HXLINE( 286)										HX_STACK_DO_THROW(((((HX_("Valid UTF-8 byte expected at position [",6f,4c,4a,03) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte11) + HX_("]!",24,51,00,00)));
            									}
            								}
            							}
HXDLIN( 286)							int result1 = (byte11 << (6 * (totalBytes1 - 1)));
HXDLIN( 286)							int byte5 = this->input->readByte();
HXDLIN( 286)							this->byteIndex++;
HXDLIN( 286)							if ((1 != ((byte5 >> 7) & 1))) {
HXLINE( 286)								HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte5) + HX_("]!",24,51,00,00)));
            							}
HXDLIN( 286)							if ((1 == ((byte5 >> 6) & 1))) {
HXLINE( 286)								HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte5) + HX_("]!",24,51,00,00)));
            							}
HXDLIN( 286)							int byte21 = (byte5 & -129);
HXDLIN( 286)							result1 = (result1 + (byte21 << (6 * (totalBytes1 - 2))));
HXDLIN( 286)							if (isBit6Set1) {
HXLINE( 286)								int byte6 = this->input->readByte();
HXDLIN( 286)								this->byteIndex++;
HXDLIN( 286)								if ((1 != ((byte6 >> 7) & 1))) {
HXLINE( 286)									HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte6) + HX_("]!",24,51,00,00)));
            								}
HXDLIN( 286)								if ((1 == ((byte6 >> 6) & 1))) {
HXLINE( 286)									HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte6) + HX_("]!",24,51,00,00)));
            								}
HXDLIN( 286)								int byte32 = (byte6 & -129);
HXDLIN( 286)								result1 = (result1 + (byte32 << (6 * (totalBytes1 - 3))));
HXDLIN( 286)								if (isBit5Set1) {
HXLINE( 286)									int byte7 = this->input->readByte();
HXDLIN( 286)									this->byteIndex++;
HXDLIN( 286)									if ((1 != ((byte7 >> 7) & 1))) {
HXLINE( 286)										HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte7) + HX_("]!",24,51,00,00)));
            									}
HXDLIN( 286)									if ((1 == ((byte7 >> 6) & 1))) {
HXLINE( 286)										HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte7) + HX_("]!",24,51,00,00)));
            									}
HXDLIN( 286)									int byte42 = (byte7 & -129);
HXDLIN( 286)									result1 = (result1 + (byte42 << (6 * (totalBytes1 - 4))));
            								}
            							}
HXDLIN( 286)							bool _hx_tmp2;
HXDLIN( 286)							if ((this->index == 0)) {
HXLINE( 286)								_hx_tmp2 = (result1 == 65279);
            							}
            							else {
...
HXLINE( 337)					HX_STACK_DO_THROW(((((HX_("Valid UTF-8 byte expected at position [",6f,4c,4a,03) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte1) + HX_("]!",24,51,00,00)));
            				}
            			}
            		}
...
HXLINE( 346)			HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte) + HX_("]!",24,51,00,00)));
            		}
...
HXLINE( 353)			int byte3 = this->input->readByte();
HXDLIN( 353)			this->byteIndex++;
HXDLIN( 353)			if ((1 != ((byte3 >> 7) & 1))) {
HXLINE( 353)				HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte3) + HX_("]!",24,51,00,00)));
            			}
HXDLIN( 353)			if ((1 == ((byte3 >> 6) & 1))) {
HXLINE( 353)				HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte3) + HX_("]!",24,51,00,00)));
            			}
HXDLIN( 353)			int byte31 = (byte3 & -129);
HXLINE( 354)			result = (result + (byte31 << (6 * (totalBytes - 3))));
HXLINE( 359)			if (isBit5Set) {
HXLINE( 360)				int byte4 = this->input->readByte();
HXDLIN( 360)				this->byteIndex++;
HXDLIN( 360)				if ((1 != ((byte4 >> 7) & 1))) {
HXLINE( 360)					HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte4) + HX_("]!",24,51,00,00)));
            				}
HXDLIN( 360)				if ((1 == ((byte4 >> 6) & 1))) {
HXLINE( 360)					HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte4) + HX_("]!",24,51,00,00)));
            				}
HXDLIN( 360)				int byte41 = (byte4 & -129);
HXLINE( 361)				result = (result + (byte41 << (6 * (totalBytes - 4))));
            			}
            		}
...
HXLINE( 379)			HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte) + HX_("]!",24,51,00,00)));
            		}
HXLINE( 381)		if ((1 == ((byte >> 6) & 1))) {
HXLINE( 382)			HX_STACK_DO_THROW(((((HX_("Valid UTF-8 multi-sequence byte expected at position [",c8,79,bd,80) + this->byteIndex) + HX_("] but found byte with value [",6a,c4,be,83)) + byte) + HX_("]!",24,51,00,00)));
            		}

...
HXLINE( 119)								_hx_tmp3 = (chars->length > (i + 2));
            							}
            							else {
...
HXLINE( 133)						int chNext1;
HXDLIN( 133)						if ((i < lastIndex)) {
HXLINE( 133)							chNext1 = chars->__get((i + 1));
            						}
            						else {
HXLINE( 133)							chNext1 = -1;
            						}
HXLINE( 134)						bool _hx_tmp5;
HXDLIN( 134)						if ((chNext1 > 47)) {
HXLINE( 134)							_hx_tmp5 = (chNext1 < 58);
            						}
            						else {
...
HXLINE( 190)				_hx_tmp4 = ::hx::IsNotNull( initialState->bgcolor );
            			}
            			else {
HXLINE( 190)				_hx_tmp4 = true;
            			}
HXDLIN( 190)			if (!(_hx_tmp4)) {
HXLINE( 190)				_hx_tmp3 = initialState->bold;
            			}
            			else {
HXLINE( 190)				_hx_tmp3 = true;
            			}
HXDLIN( 190)			if (!(_hx_tmp3)) {
HXLINE( 190)				_hx_tmp2 = initialState->underline;
            			}
            			else {
...
HXLINE( 191)			 ::hx::strings::StringBuilder _hx_tmp5 = sb->add(((HX_("<span ",5a,3c,d0,7e) + styleOrClassAttribute) + HX_("=\"",45,35,00,00)));
HXDLIN( 191)			_hx_tmp5->add(initialState->toCSS(renderMethod))->add(HX_("\">",dc,1d,00,00));
            		}
...
HXDLIN( 200)			if ((ch == 27)) {
HXLINE( 200)				_hx_tmp7 = (i < strLenMinus11);
            			}
            			else {
HXLINE( 200)				_hx_tmp7 = false;
            			}
HXDLIN( 200)			if (_hx_tmp7) {
HXLINE( 200)				_hx_tmp6 = (( (int)(( (::String)(str) ).charCodeAt((i + 1))) ) == 91);
            			}
            			else {
...
HXDLIN( 226)							bool _hx_tmp10;
HXDLIN( 226)							bool _hx_tmp11;
HXDLIN( 226)							if (::hx::IsNull( effectiveState->fgcolor )) {
HXLINE( 226)								_hx_tmp11 = ::hx::IsNotNull( effectiveState->bgcolor );
            							}
            							else {
HXLINE( 226)								_hx_tmp11 = true;
            							}
HXDLIN( 226)							if (!(_hx_tmp11)) {
HXLINE( 226)								_hx_tmp10 = effectiveState->bold;
            							}
            							else {
HXLINE( 226)								_hx_tmp10 = true;
            							}
HXDLIN( 226)							if (!(_hx_tmp10)) {
HXLINE( 226)								_hx_tmp9 = effectiveState->underline;
            							}
            							else {
HXLINE( 226)								_hx_tmp9 = true;
            							}
HXDLIN( 226)							if (!(_hx_tmp9)) {
HXLINE( 226)								_hx_tmp8 = effectiveState->blink;
            							}
            							else {
HXLINE( 226)								_hx_tmp8 = true;
            							}
HXDLIN( 226)							if (_hx_tmp8) {
HXLINE( 227)								sb->add(HX_("</span>",e1,60,34,0b));
            							}
HXLINE( 228)							bool _hx_tmp12;
HXDLIN( 228)							bool _hx_tmp13;
HXDLIN( 228)							bool _hx_tmp14;
HXDLIN( 228)							bool _hx_tmp15;
HXDLIN( 228)							if (::hx::IsNull( currentState->fgcolor )) {
HXLINE( 228)								_hx_tmp15 = ::hx::IsNotNull( currentState->bgcolor );
            							}
            							else {
HXLINE( 228)								_hx_tmp15 = true;
            							}
HXDLIN( 228)							if (!(_hx_tmp15)) {
HXLINE( 228)								_hx_tmp14 = currentState->bold;
            							}
            							else {
HXLINE( 228)								_hx_tmp14 = true;
            							}
HXDLIN( 228)							if (!(_hx_tmp14)) {
HXLINE( 228)								_hx_tmp13 = currentState->underline;
            							}
            							else {
HXLINE( 228)								_hx_tmp13 = true;
            							}
HXDLIN( 228)							if (!(_hx_tmp13)) {
HXLINE( 228)								_hx_tmp12 = currentState->blink;
            							}
            							else {
HXLINE( 228)								_hx_tmp12 = true;
            							}
HXDLIN( 228)							if (_hx_tmp12) {
HXLINE( 229)								 ::hx::strings::StringBuilder _hx_tmp16 = sb->add(((HX_("<span ",5a,3c,d0,7e) + styleOrClassAttribute) + HX_("=\"",45,35,00,00)));
HXDLIN( 229)								_hx_tmp16->add(currentState->toCSS(renderMethod))->add(HX_("\">",dc,1d,00,00));
            							}
...
HXLINE( 240)					 ::hx::strings::StringBuilder _hx_tmp17 = sb->addChar(27)->add(HX_("[",5b,00,00,00));
HXDLIN( 240)					_hx_tmp17->add(::Std_obj::string(lookAhead));
            				}
            			}
            			else {
...
HXLINE( 246)		bool _hx_tmp18;
HXDLIN( 246)		bool _hx_tmp19;
HXDLIN( 246)		bool _hx_tmp20;
HXDLIN( 246)		bool _hx_tmp21;
HXDLIN( 246)		if (::hx::IsNull( effectiveState->fgcolor )) {
HXLINE( 246)			_hx_tmp21 = ::hx::IsNotNull( effectiveState->bgcolor );
            		}
            		else {
HXLINE( 246)			_hx_tmp21 = true;
            		}
HXDLIN( 246)		if (!(_hx_tmp21)) {
HXLINE( 246)			_hx_tmp20 = effectiveState->bold;
            		}
            		else {
HXLINE( 246)			_hx_tmp20 = true;
            		}
HXDLIN( 246)		if (!(_hx_tmp20)) {
HXLINE( 246)			_hx_tmp19 = effectiveState->underline;
            		}
            		else {
HXLINE( 246)			_hx_tmp19 = true;
            		}
HXDLIN( 246)		if (!(_hx_tmp19)) {
HXLINE( 246)			_hx_tmp18 = effectiveState->blink;
            		}
            		else {
HXLINE( 246)			_hx_tmp18 = true;
            		}
HXDLIN( 246)		if (_hx_tmp18) {
...
HXLINE( 276)		::String _hx_tmp1 = ::Std_obj::string(str);
HXDLIN( 276)		return (_hx_tmp1 + ::Std_obj::string(suffix));
            	}
...
HXLINE( 344)			int _hx_tmp3;
HXDLIN( 344)			if (::hx::IsNull( str )) {
HXLINE( 344)				_hx_tmp3 = 0;
            			}
            			else {
HXLINE( 344)				_hx_tmp3 = ( (::String)(str) ).length;
            			}
HXDLIN( 344)			_hx_tmp = (pos >= _hx_tmp3);
            		}
            		else {
...
HXLINE( 406)					_hx_tmp2 = (_hx_char < 14);
            				}
            				else {
HXLINE( 406)					_hx_tmp2 = false;
            				}
HXDLIN( 406)				if (!(_hx_tmp2)) {
HXLINE( 406)					_hx_tmp1 = (_hx_char == 32);
            				}
            				else {
...
HXLINE( 502)					_hx_tmp2 = ::hx::IsNull( candidate );
            				}
            				else {
...
HXLINE( 502)						_hx_tmp1 = (searchIn.indexOf(candidate,null()) > -1);
            					}
            				}
...
HXLINE( 533)					_hx_tmp2 = ::hx::IsNull( searchFor1 );
            				}
            				else {
...
HXLINE( 533)						_hx_tmp1 = (searchIn.indexOf(searchFor1,null()) > -1);
            					}
            				}
...
HXLINE( 563)					_hx_tmp2 = ::hx::IsNull( candidate );
            				}
            				else {
...
HXLINE( 563)						_hx_tmp1 = (searchIn.indexOf(candidate,null()) > -1);
            					}
            				}
...
HXLINE( 594)					_hx_tmp2 = ::hx::IsNull( searchFor1 );
            				}
            				else {
...
HXLINE( 594)						_hx_tmp1 = (searchIn.indexOf(searchFor1,null()) > -1);
            					}
            				}
...
HXLINE( 856)				int _hx_tmp1 = ( (int)(str.charCodeAt(i)) );
HXDLIN( 856)				if ((_hx_tmp1 != ( (int)(other.charCodeAt(i)) ))) {
HXLINE( 857)					return i;
            				}
            			}
            		}
...
HXLINE( 881)			HX_STACK_DO_THROW((HX_("[maxLength] must not be smaller than ",68,6f,69,ad) + ellipsisLen));
            		}
...
HXLINE( 907)			HX_STACK_DO_THROW((HX_("[maxLength] must not be smaller than ",68,6f,69,ad) + ellipsisLen));
            		}
...
HXLINE( 936)			HX_STACK_DO_THROW((HX_("[maxLength] must not be smaller than ",68,6f,69,ad) + ellipsisLen));
            		}
...
HXLINE( 993)					_hx_tmp1 = ::hx::strings::Strings_obj::endsWith(searchIn,candidate);
            				}
            				else {
...
HXLINE(1019)					_hx_tmp1 = ::hx::strings::Strings_obj::endsWith(searchIn,( (::String)(::hx::strings::Strings_obj::toLowerCase8(candidate)) ));
            				}
            				else {
...
HXLINE(1168)						_g2 = (rightLastMatchAt + 1);
            					}
            					else {
HXLINE(1168)						_g2 = 0;
            					}
HXDLIN(1168)					int _g3 = rightChars->length;
HXDLIN(1168)					while((_g2 < _g3)){
HXLINE(1168)						_g2 = (_g2 + 1);
HXDLIN(1168)						int rightIdx = (_g2 - 1);
...
HXLINE(1172)								_hx_tmp2 = (rightLastMatchAt == (rightIdx - 1));
            							}
            							else {
HXLINE(1172)								_hx_tmp2 = false;
            							}
...
HXLINE(1241)				{
HXLINE(1241)					int _g4 = 1;
HXDLIN(1241)					int _g5 = (leftLen + 1);
HXDLIN(1241)					while((_g4 < _g5)){
HXLINE(1241)						_g4 = (_g4 + 1);
HXDLIN(1241)						int leftIdx1 = (_g4 - 1);
HXLINE(1242)						int leftIdxMinus1 = (leftIdx1 - 1);
...
HXLINE(1244)						int _hx_tmp = ( (int)(min((costs->__get(leftIdxMinus1) + 1),(prevCosts->__get(leftIdx1) + 1))) );
HXDLIN(1244)						costs[leftIdx1] = ( (int)(min(_hx_tmp,(prevCosts->__get(leftIdxMinus1) + cost))) );
            					}
            				}
HXLINE(1247)				::Array< int > tmp1 = prevCosts;
HXLINE(1248)				prevCosts = costs;
HXLINE(1249)				costs = tmp1;
            			}
            		}
...
HXDLIN(1288)					int _g3 = rightLen;
HXDLIN(1288)					while((_g2 < _g3)){
HXLINE(1288)						_g2 = (_g2 + 1);
HXDLIN(1288)						int rightIdx = (_g2 - 1);
...
HXLINE(1292)							bool _hx_tmp2;
HXDLIN(1292)							if (((leftIdx + currLen) < leftLen)) {
HXLINE(1292)								_hx_tmp2 = ((rightIdx + currLen) >= rightLen);
            							}
            							else {
...
HXLINE(1363)			 ::haxe::io::Bytes _hx_tmp1;
HXDLIN(1363)			if (::hx::IsNull( str )) {
HXLINE(1363)				_hx_tmp1 = null();
            			}
            			else {
HXLINE(1363)				_hx_tmp1 = ::haxe::io::Bytes_obj::ofString(str,null());
            			}
HXDLIN(1363)			return ::haxe::crypto::Crc32_obj::make(_hx_tmp1);
            		}
            		else {
HXLINE(1326)			switch((int)(algo->_hx_getIndex())){
            				case (int)1: {
HXLINE(1328)					 ::haxe::io::Bytes _hx_tmp2;
HXDLIN(1328)					if (::hx::IsNull( str )) {
HXLINE(1328)						_hx_tmp2 = null();
            					}
            					else {
HXLINE(1328)						_hx_tmp2 = ::haxe::io::Bytes_obj::ofString(str,null());
            					}
HXDLIN(1328)					return ::haxe::crypto::Adler32_obj::make(_hx_tmp2);
            				}
            				break;
            				case (int)2: {
HXLINE(1331)					 ::haxe::io::Bytes _hx_tmp3;
HXDLIN(1331)					if (::hx::IsNull( str )) {
HXLINE(1331)						_hx_tmp3 = null();
            					}
            					else {
HXLINE(1331)						_hx_tmp3 = ::haxe::io::Bytes_obj::ofString(str,null());
            					}
HXDLIN(1331)					return ::haxe::crypto::Crc32_obj::make(_hx_tmp3);
            				}
            				break;
            				case (int)3: {
...
HXLINE(1337)					return hc;
            				...
            				break;
            				case (int)4: {
HXLINE(1340)					int hc1 = 0;
HXLINE(1341)					{
HXLINE(1341)						int _g2 = 0;
HXDLIN(1341)						::Array< int > _g3 = ::hx::strings::Strings_obj::toChars(str);
HXDLIN(1341)						while((_g2 < _g3->length)){
HXLINE(1341)							int ch1 = _g3->__get(_g2);
HXDLIN(1341)							_g2 = (_g2 + 1);
HXLINE(1342)							hc1 = (((hc1 << 5) - hc1) + ch1);
            						}
            					}
HXLINE(1343)					return hc1;
            				}
            				break;
            				case (int)5: {
HXLINE(1346)					int hc2 = 0;
HXLINE(1347)					{
HXLINE(1347)						int _g4 = 0;
HXDLIN(1347)						::Array< int > _g5 = ::hx::strings::Strings_obj::toChars(str);
HXDLIN(1347)						while((_g4 < _g5->length)){
HXLINE(1347)							int ch2 = _g5->__get(_g4);
HXDLIN(1347)							_g4 = (_g4 + 1);
HXLINE(1348)							hc2 = ((((hc2 << 6) + (hc2 << 16)) - hc2) + ch2);
            						}
            					}
HXLINE(1349)					return hc2;
            				}
            				break;
            				default:{
HXLINE(1363)					 ::haxe::io::Bytes _hx_tmp4;
HXDLIN(1363)					if (::hx::IsNull( str )) {
HXLINE(1363)						_hx_tmp4 = null();
            					}
            					else {
HXLINE(1363)						_hx_tmp4 = ::haxe::io::Bytes_obj::ofString(str,null());
            					}
HXDLIN(1363)					return ::haxe::crypto::Crc32_obj::make(_hx_tmp4);
            				}
            			}
            		}
...
HXLINE(1404)					HX_STACK_DO_THROW((HX_("Invalid HTML value ",db,ee,a4,9e) + match));
            				}
...
HXLINE(1444)							sb->add(HX_("&nbsp;",64,13,c2,c8));
            					...
            					break;
            					case (int)34: {
HXLINE(1450)						::String _hx_tmp1;
HXDLIN(1450)						if (escapeQuotes) {
HXLINE(1450)							_hx_tmp1 = HX_("&quot;",2c,d9,81,8f);
            						}
            						else {
HXLINE(1450)							_hx_tmp1 = HX_("\"",22,00,00,00);
            						}
HXDLIN(1450)						sb->add(_hx_tmp1);
            					}
            					break;
            					case (int)38: {
HXLINE(1447)						sb->add(HX_("&amp;",dd,d4,aa,21));
            					...
            					break;
            					case (int)39: {
HXLINE(1454)						::String _hx_tmp2;
HXDLIN(1454)						if (escapeQuotes) {
HXLINE(1454)							_hx_tmp2 = HX_("&#039;",62,26,77,78);
            						}
            						else {
HXLINE(1454)							_hx_tmp2 = HX_("'",27,00,00,00);
            						}
HXDLIN(1454)						sb->add(_hx_tmp2);
            					}
            					break;
            					case (int)60: {
...
HXLINE(1464)							 ::hx::strings::StringBuilder _hx_tmp3 = sb->add(HX_("&#",3d,21,00,00));
HXDLIN(1464)							_hx_tmp3->add(::Std_obj::string(ch))->add(HX_(";",3b,00,00,00));
            						}
            						else {
...
HXLINE(1503)			HX_STACK_DO_THROW(HX_("Absolute value of [pos] must be <= str.length",8f,67,7d,63));
            		}
...
HXLINE(1670)			bool _hx_tmp1;
HXDLIN(1670)			if ((startAt > 0)) {
HXLINE(1670)				_hx_tmp1 = (startAt < strLen);
            			}
            			else {
...
HXLINE(1750)					_hx_tmp1 = (this1 < 58);
            				}
            				else {
HXLINE(1750)					_hx_tmp1 = false;
            				}
...
HXLINE(2086)			HX_STACK_DO_THROW(HX_("[separator] must not be null",ad,ff,54,c9));
            		}
...
HXLINE(2234)			HX_STACK_DO_THROW(HX_("[pos] must be smaller than -1 * str.length",44,b5,28,65));
            		}
...
HXLINE(2508)			int _hx_tmp2;
HXDLIN(2508)			if (::hx::IsNull( searchIn )) {
HXLINE(2508)				_hx_tmp2 = 0;
            			}
            			else {
HXLINE(2508)				_hx_tmp2 = ( (::String)(searchIn) ).length;
            			}
HXDLIN(2508)			if ((_hx_tmp2 > 1)) {
...
HXLINE(2515)		::String _hx_tmp3 = (::Std_obj::string(::hx::strings::Strings_obj::substr8(searchIn,0,foundAt)) + replaceWith);
HXDLIN(2515)		int _hx_tmp4;
HXDLIN(2515)		if (::hx::IsNull( searchFor )) {
HXLINE(2515)			_hx_tmp4 = 0;
            		}
            		else {
HXLINE(2515)			_hx_tmp4 = searchFor.length;
            		}
HXDLIN(2515)		return (_hx_tmp3 + ::Std_obj::string(::hx::strings::Strings_obj::substr8(searchIn,(foundAt + _hx_tmp4),null())));
            	}
...
HXLINE(2543)			int _hx_tmp2;
HXDLIN(2543)			if (::hx::IsNull( searchIn )) {
HXLINE(2543)				_hx_tmp2 = 0;
            			}
            			else {
HXLINE(2543)				_hx_tmp2 = ( (::String)(searchIn) ).length;
            			}
HXDLIN(2543)			if ((_hx_tmp2 > 1)) {
...
HXLINE(2550)		::String _hx_tmp3 = (::Std_obj::string(::hx::strings::Strings_obj::substr8(searchIn,0,foundAt)) + replaceWith);
HXDLIN(2550)		int _hx_tmp4;
HXDLIN(2550)		if (::hx::IsNull( searchFor )) {
HXLINE(2550)			_hx_tmp4 = 0;
            		}
            		else {
HXLINE(2550)			_hx_tmp4 = searchFor.length;
            		}
HXDLIN(2550)		return (_hx_tmp3 + ::Std_obj::string(::hx::strings::Strings_obj::substr8(searchIn,(foundAt + _hx_tmp4),null())));
            	}
...
HXLINE(2693)				::Array< ::String > _g3 = ::Array_obj< ::String >::__new(0);
HXDLIN(2693)				{
HXLINE(2693)					int _g4 = 0;
HXDLIN(2693)					int _g5 = strLen;
HXDLIN(2693)					while((_g4 < _g5)){
HXLINE(2693)						_g4 = (_g4 + 1);
HXDLIN(2693)						int i = (_g4 - 1);
HXDLIN(2693)						_g3->push(str.substr(i,1));
            					}
            				}
HXDLIN(2693)				return _g3;
            			}
HXLINE(2695)			if ((maxParts > strLen)) {
HXLINE(2696)				maxParts = strLen;
            			}
HXLINE(2697)			maxParts = (maxParts - 1);
HXLINE(2699)			::Array< ::String > _g6 = ::Array_obj< ::String >::__new(0);
HXDLIN(2699)			{
HXLINE(2699)				int _g7 = 0;
HXDLIN(2699)				int _g8 = maxParts;
HXDLIN(2699)				while((_g7 < _g8)){
HXLINE(2699)					_g7 = (_g7 + 1);
HXDLIN(2699)					int i1 = (_g7 - 1);
HXDLIN(2699)					_g6->push(str.substr(i1,1));
            				}
            			}
HXDLIN(2699)			::Array< ::String > result = _g6;
HXLINE(2701)			result->push(str.substr(maxParts,(strLen - maxParts)));
HXLINE(2702)			return result;
            		}
HXLINE(2705)		::Array< int > _g9 = ::Array_obj< int >::__new(0);
HXDLIN(2705)		{
HXLINE(2705)			int _g10 = 0;
HXDLIN(2705)			while((_g10 < separators->length)){
HXLINE(2705)				::String sep = separators->__get(_g10);
HXDLIN(2705)				_g10 = (_g10 + 1);
HXDLIN(2705)				int _hx_tmp2;
HXDLIN(2705)				if (::hx::IsNull( sep )) {
HXLINE(2705)					_hx_tmp2 = 0;
            				}
            				else {
HXLINE(2705)					_hx_tmp2 = sep.length;
            				}
HXDLIN(2705)				_g9->push(_hx_tmp2);
            			}
            		}
HXDLIN(2705)		::Array< int > separatorsLengths = _g9;
HXLINE(2706)		int lastFoundAt = 0;
HXLINE(2707)		::Array< ::String > result1 = ::Array_obj< ::String >::__new(0);
HXLINE(2708)		int resultCount = 0;
HXLINE(2709)		while(true){
HXLINE(2710)			int separatorLen = 0;
HXLINE(2711)			int foundAt = -1;
HXLINE(2712)			{
HXLINE(2712)				int _g11 = 0;
HXDLIN(2712)				int _g12 = separators->length;
HXDLIN(2712)				while((_g11 < _g12)){
HXLINE(2712)					_g11 = (_g11 + 1);
HXDLIN(2712)					int i2 = (_g11 - 1);
HXLINE(2713)					int sepFoundAt = ::hx::strings::Strings_obj::indexOf8(str,separators->__get(i2),lastFoundAt);
HXLINE(2714)					if ((sepFoundAt != -1)) {
HXLINE(2715)						bool _hx_tmp3;
HXDLIN(2715)						if ((foundAt != -1)) {
HXLINE(2715)							_hx_tmp3 = (sepFoundAt < foundAt);
            						}
            						else {
HXLINE(2715)							_hx_tmp3 = true;
            						}
HXDLIN(2715)						if (_hx_tmp3) {
HXLINE(2716)							foundAt = sepFoundAt;
HXLINE(2717)							separatorLen = separatorsLengths->__get(i2);
            						}
            					}
            				}
            			}
HXLINE(2721)			resultCount = (resultCount + 1);
HXLINE(2722)			bool _hx_tmp4;
HXDLIN(2722)			if ((foundAt != -1)) {
HXLINE(2722)				_hx_tmp4 = (resultCount == maxParts);
            			}
            			else {
HXLINE(2722)				_hx_tmp4 = true;
            			}
HXDLIN(2722)			if (_hx_tmp4) {
HXLINE(2724)				result1->push(str.substr(lastFoundAt,(strLen - lastFoundAt)));
HXLINE(2725)				goto _hx_goto_138;
            			}
HXLINE(2728)			result1->push(str.substr(lastFoundAt,(foundAt - lastFoundAt)));
HXLINE(2729)			lastFoundAt = (foundAt + separatorLen);
            		}
            		_hx_goto_138:;
HXLINE(2731)		return result1;
            	}
...
HXLINE(2769)				bool _hx_tmp1;
HXDLIN(2769)				if ((p >= 0)) {
HXLINE(2769)					_hx_tmp1 = (p >= strLen);
            				}
            				else {
HXLINE(2769)					_hx_tmp1 = true;
            				}
HXDLIN(2769)				if (_hx_tmp1) {
...
HXLINE(2781)				int p1 = pos->__get(_g2);
HXDLIN(2781)				_g2 = (_g2 + 1);
HXLINE(2782)				::String chunk = ( (::String)(::hx::strings::Strings_obj::substring8(str,lastPos,p1)) );
HXLINE(2783)				bool _hx_tmp2;
HXDLIN(2783)				if (::hx::IsNotNull( chunk )) {
HXLINE(2783)					_hx_tmp2 = (chunk.length > 0);
            				}
            				else {
HXLINE(2783)					_hx_tmp2 = false;
            				}
HXDLIN(2783)				if (_hx_tmp2) {
HXLINE(2784)					result->push(chunk);
            				}
HXLINE(2785)				lastPos = p1;
            			}
            		}
HXLINE(2787)		::String chunk1 = ( (::String)(::hx::strings::Strings_obj::substring8(str,lastPos,null())) );
HXLINE(2788)		bool _hx_tmp3;
HXDLIN(2788)		if (::hx::IsNotNull( chunk1 )) {
HXLINE(2788)			_hx_tmp3 = (chunk1.length > 0);
            		}
            		else {
HXLINE(2788)			_hx_tmp3 = false;
            		}
HXDLIN(2788)		if (_hx_tmp3) {
HXLINE(2789)			result->push(chunk1);
            		}
...
HXLINE(2811)			HX_STACK_DO_THROW(HX_("[count] must be greater than 0",f4,ff,7d,8f));
            		}
...
HXLINE(2822)			bool _hx_tmp1;
HXDLIN(2822)			if (::hx::IsNotNull( chunk )) {
HXLINE(2822)				_hx_tmp1 = (chunk.length == 0);
            			}
            			else {
HXLINE(2822)				_hx_tmp1 = true;
            			}
...
HXDLIN(2895)				_g = (_g + 1);
HXLINE(2896)				bool _hx_tmp1;
HXDLIN(2896)				if (::hx::IsNotNull( candidate )) {
HXLINE(2896)					_hx_tmp1 = ::hx::strings::Strings_obj::startsWith(searchIn,candidate);
            				}
            				else {
...
HXLINE(2922)					_hx_tmp1 = ::hx::strings::Strings_obj::startsWith(searchIn,( (::String)(::hx::strings::Strings_obj::toLowerCase8(candidate)) ));
            				}
            				else {
...
HXLINE(3075)			::String _hx_tmp2;
HXDLIN(3075)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3075)					_hx_tmp2 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3075)					_hx_tmp2 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3075)					_hx_tmp2 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3075)			return _hx_tmp2;
            		}
HXLINE(3077)		int foundAt = ( (::String)(str) ).indexOf(searchFor,null());
HXLINE(3078)		if ((foundAt == -1)) {
HXLINE(3079)			::String _hx_tmp3;
HXDLIN(3079)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3079)					_hx_tmp3 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3079)					_hx_tmp3 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3079)					_hx_tmp3 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3079)			return _hx_tmp3;
            		}
...
HXLINE(3104)			::String _hx_tmp1;
HXDLIN(3104)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3104)					_hx_tmp1 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3104)					_hx_tmp1 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3104)					_hx_tmp1 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3104)			return _hx_tmp1;
            		}
...
HXLINE(3110)			::String _hx_tmp2;
HXDLIN(3110)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3110)					_hx_tmp2 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3110)					_hx_tmp2 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3110)					_hx_tmp2 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3110)			return _hx_tmp2;
            		}
...
HXLINE(3141)			::String _hx_tmp2;
HXDLIN(3141)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3141)					_hx_tmp2 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3141)					_hx_tmp2 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3141)					_hx_tmp2 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3141)			return _hx_tmp2;
            		}
HXLINE(3143)		int foundAfterAt = ( (::String)(str) ).indexOf(after,null());
HXLINE(3144)		if ((foundAfterAt == -1)) {
HXLINE(3145)			::String _hx_tmp3;
HXDLIN(3145)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3145)					_hx_tmp3 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3145)					_hx_tmp3 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3145)					_hx_tmp3 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3145)			return _hx_tmp3;
            		}
HXLINE(3147)		int foundBeforeAt = ( (::String)(str) ).indexOf(before,(foundAfterAt + after.length));
HXLINE(3148)		if ((foundBeforeAt == -1)) {
HXLINE(3149)			::String _hx_tmp4;
HXDLIN(3149)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3149)					_hx_tmp4 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3149)					_hx_tmp4 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3149)					_hx_tmp4 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3149)			return _hx_tmp4;
            		}
...
HXLINE(3180)			::String _hx_tmp2;
HXDLIN(3180)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3180)					_hx_tmp2 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3180)					_hx_tmp2 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3180)					_hx_tmp2 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3180)			return _hx_tmp2;
            		}
...
HXLINE(3188)			::String _hx_tmp3;
HXDLIN(3188)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3188)					_hx_tmp3 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3188)					_hx_tmp3 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3188)					_hx_tmp3 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3188)			return _hx_tmp3;
            		}
HXLINE(3190)		int foundBeforeAt = ( (::String)(strLower) ).indexOf(before1,(foundAfterAt + after1.length));
HXLINE(3191)		if ((foundBeforeAt == -1)) {
HXLINE(3192)			::String _hx_tmp4;
HXDLIN(3192)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3192)					_hx_tmp4 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3192)					_hx_tmp4 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3192)					_hx_tmp4 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3192)			return _hx_tmp4;
            		}
...
HXLINE(3218)			::String _hx_tmp1;
HXDLIN(3218)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3218)					_hx_tmp1 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3218)					_hx_tmp1 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3218)					_hx_tmp1 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3218)			return _hx_tmp1;
            		}
HXLINE(3220)		int foundAt = ( (::String)(str) ).lastIndexOf(searchFor,null());
HXLINE(3221)		if ((foundAt == -1)) {
HXLINE(3222)			::String _hx_tmp2;
HXDLIN(3222)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3222)					_hx_tmp2 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3222)					_hx_tmp2 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3222)					_hx_tmp2 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3222)			return _hx_tmp2;
            		}
...
HXLINE(3249)			::String _hx_tmp1;
HXDLIN(3249)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3249)					_hx_tmp1 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3249)					_hx_tmp1 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3249)					_hx_tmp1 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3249)			return _hx_tmp1;
            		}
...
HXLINE(3255)			::String _hx_tmp2;
HXDLIN(3255)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3255)					_hx_tmp2 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3255)					_hx_tmp2 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3255)					_hx_tmp2 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3255)			return _hx_tmp2;
            		}
...
HXLINE(3281)			::String _hx_tmp1;
HXDLIN(3281)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3281)					_hx_tmp1 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3281)					_hx_tmp1 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3281)					_hx_tmp1 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3281)			return _hx_tmp1;
            		}
HXLINE(3283)		int foundAt = ( (::String)(str) ).indexOf(searchFor,null());
HXLINE(3284)		if ((foundAt == -1)) {
HXLINE(3285)			::String _hx_tmp2;
HXDLIN(3285)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3285)					_hx_tmp2 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3285)					_hx_tmp2 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3285)					_hx_tmp2 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3285)			return _hx_tmp2;
            		}
...
HXLINE(3312)			::String _hx_tmp1;
HXDLIN(3312)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3312)					_hx_tmp1 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3312)					_hx_tmp1 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3312)					_hx_tmp1 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3312)			return _hx_tmp1;
            		}
...
HXLINE(3318)			::String _hx_tmp2;
HXDLIN(3318)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3318)					_hx_tmp2 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3318)					_hx_tmp2 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3318)					_hx_tmp2 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3318)			return _hx_tmp2;
            		}
...
HXLINE(3346)			::String _hx_tmp1;
HXDLIN(3346)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3346)					_hx_tmp1 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3346)					_hx_tmp1 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3346)					_hx_tmp1 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3346)			return _hx_tmp1;
            		}
HXLINE(3348)		int foundAt = ( (::String)(str) ).lastIndexOf(searchFor,null());
HXLINE(3349)		if ((foundAt == -1)) {
HXLINE(3350)			::String _hx_tmp2;
HXDLIN(3350)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3350)					_hx_tmp2 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3350)					_hx_tmp2 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3350)					_hx_tmp2 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3350)			return _hx_tmp2;
            		}
...
HXLINE(3377)			::String _hx_tmp1;
HXDLIN(3377)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3377)					_hx_tmp1 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3377)					_hx_tmp1 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3377)					_hx_tmp1 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3377)			return _hx_tmp1;
            		}
...
HXLINE(3383)			::String _hx_tmp2;
HXDLIN(3383)			switch((int)(notFoundDefault)){
            				case (int)1: {
HXLINE(3383)					_hx_tmp2 = null();
            				}
            				break;
            				case (int)2: {
HXLINE(3383)					_hx_tmp2 = HX_("",00,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(3383)					_hx_tmp2 = ( (::String)(str) );
            				}
            				break;
            			}
HXDLIN(3383)			return _hx_tmp2;
            		}
...
HXLINE(3516)			HX_STACK_DO_THROW(HX_("[str] must not be null",39,a9,3f,f6));
            		}
...
HXDLIN(3739)			::Array< ::String > _g3 = ::hx::strings::Strings_obj::_splitAsciiWordsUnsafe(( (::String)(str) ));
HXDLIN(3739)			while((_g2 < _g3->length)){
HXLINE(3739)				::String word1 = _g3->__get(_g2);
HXDLIN(3739)				_g2 = (_g2 + 1);
HXLINE(3740)				sb->add(( (::String)(::hx::strings::Strings_obj::toUpperCaseFirstChar(::hx::strings::Strings_obj::toLowerCase8(word1))) ));
            			}
            		}
...
HXLINE(3824)		::Array< ::String > _this1 = ::hx::strings::Strings_obj::_splitAsciiWordsUnsafe(( (::String)(str) ));
HXDLIN(3824)		::Array< ::String > result1 = ::Array_obj< ::String >::__new(_this1->length);
HXDLIN(3824)		{
HXLINE(3824)			int _g2 = 0;
HXDLIN(3824)			int _g3 = _this1->length;
HXDLIN(3824)			while((_g2 < _g3)){
HXLINE(3824)				_g2 = (_g2 + 1);
HXDLIN(3824)				int i1 = (_g2 - 1);
HXDLIN(3824)				{
HXLINE(3824)					::String inValue1 = ( (::String)(::hx::strings::Strings_obj::toUpperCaseFirstChar(::hx::strings::Strings_obj::toLowerCase8(_hx_array_unsafe_get(_this1,i1)))) );
HXDLIN(3824)					result1->__unsafe_set(i1,inValue1);
            				}
            			}
            		}
HXDLIN(3824)		return result1->join(HX_(" ",20,00,00,00));
            	}
...
HXLINE(3856)			int _g2 = 0;
HXDLIN(3856)			::Array< ::String > _g3 = ::hx::strings::Strings_obj::_splitAsciiWordsUnsafe(( (::String)(str) ));
HXDLIN(3856)			while((_g2 < _g3->length)){
HXLINE(3856)				::String word1 = _g3->__get(_g2);
HXDLIN(3856)				_g2 = (_g2 + 1);
HXLINE(3857)				sb->add(( (::String)(::hx::strings::Strings_obj::toUpperCaseFirstChar(::hx::strings::Strings_obj::toLowerCase8(word1))) ));
            			}
            		}
...
HXDLIN(3925)				int _hx_tmp1;
HXDLIN(3925)				if (::hx::IsNull( upperChar )) {
HXLINE(3925)					_hx_tmp1 = this1;
            				}
            				else {
HXLINE(3925)					_hx_tmp1 = ( (int)(upperChar) );
            				}
HXDLIN(3925)				sb->addChar(_hx_tmp1);
            			}
            		}
...
HXDLIN(3981)		switch((int)(_g->_hx_getIndex())){
            			case (int)0: {
HXLINE(3982)				::String str1 = ( (::String)(_g->_hx_getObject(0)) );
HXLINE(3981)				removableChars = ::hx::strings::Strings_obj::toChars(str1);
            			}
            			break;
            			case (int)1: {
...
HXLINE(3986)		return ::hx::strings::Strings_obj::trimLeft(::hx::strings::Strings_obj::trimRight(str,::hx::strings::internal::_Either2::_Either2_obj::b(removableChars)),::hx::strings::internal::_Either2::_Either2_obj::b(removableChars));
            	}
...
HXDLIN(4014)		switch((int)(_g->_hx_getIndex())){
            			case (int)0: {
HXLINE(4015)				::String str1 = ( (::String)(_g->_hx_getObject(0)) );
HXLINE(4014)				removableChars = ::hx::strings::Strings_obj::toChars(str1);
            			}
            			break;
            			case (int)1: {
...
HXLINE(4024)			bool _hx_tmp1;
HXDLIN(4024)			if ((i > -1)) {
HXLINE(4024)				_hx_tmp1 = (removableChars->indexOf(::hx::strings::Strings_obj::charCodeAt8(( (::String)(::hx::strings::Strings_obj::charAt8(str,i,null())) ),0,null()),null()) > -1);
            			}
            			else {
...
HXDLIN(4056)		switch((int)(_g->_hx_getIndex())){
            			case (int)0: {
HXLINE(4057)				::String str1 = ( (::String)(_g->_hx_getObject(0)) );
HXLINE(4056)				removableChars = ::hx::strings::Strings_obj::toChars(str1);
            			}
            			break;
            			case (int)1: {
...
HXDLIN(4221)				_g = (_g + 1);
HXLINE(4222)				bool _hx_tmp2;
HXDLIN(4222)				bool _hx_tmp3;
HXDLIN(4222)				if ((ch > 8)) {
HXLINE(4222)					_hx_tmp3 = (ch < 14);
            				}
            				else {
HXLINE(4222)					_hx_tmp3 = false;
            				}
HXDLIN(4222)				if (!(_hx_tmp3)) {
HXLINE(4222)					_hx_tmp2 = (ch == 32);
            				}
            				else {
HXLINE(4222)					_hx_tmp2 = true;
            				}
HXDLIN(4222)				if (_hx_tmp2) {
HXLINE(4223)					if ((wordChars->length > 0)) {
HXLINE(4224)						{
HXLINE(4224)							int _g2 = 0;
HXDLIN(4224)							while((_g2 < wordChars->length)){
HXLINE(4224)								int wordCh = wordChars->__get(_g2);
HXDLIN(4224)								_g2 = (_g2 + 1);
HXLINE(4225)								bool _hx_tmp4;
HXDLIN(4225)								if ((currLineLength == maxLineLength)) {
HXLINE(4225)									_hx_tmp4 = splitLongWords;
            								}
            								else {
HXLINE(4225)									_hx_tmp4 = false;
            								}
HXDLIN(4225)								if (_hx_tmp4) {
...
HXLINE(4244)			int _g3 = 0;
HXDLIN(4244)			while((_g3 < wordChars->length)){
HXLINE(4244)				int wordCh1 = wordChars->__get(_g3);
HXDLIN(4244)				_g3 = (_g3 + 1);
HXLINE(4245)				bool _hx_tmp5;
HXDLIN(4245)				if ((currLineLength == maxLineLength)) {
HXLINE(4245)					_hx_tmp5 = splitLongWords;
            				}
            				else {
HXLINE(4245)					_hx_tmp5 = false;
            				}
HXDLIN(4245)				if (_hx_tmp5) {
HXLINE(4246)					sb->add(newLineSeparator);
HXLINE(4247)					currLineLength = 0;
            				}
HXLINE(4249)				currLineLength = (currLineLength + 1);
HXLINE(4250)				sb->addChar(wordCh1);
            			}
            		}
...
HXDLIN(  34)		REGEX_ANSI_ESC = ::hx::strings::Pattern_obj::compile((::String::fromCharCode(27) + HX_("\\[[;\\d]*m",f9,38,1d,be)),::hx::strings::internal::_Either3::_Either3_obj::b(HX_("g",67,00,00,00)));
            	}
{
            	HX_STACKFRAME(&_hx_pos_fd0a69697a336cdd_35_boot)
HXDLIN(  35)		REGEX_HTML_UNESCAPE = ::hx::strings::Pattern_obj::compile(HX_("&(#\\d+|amp|nbsp|apos|lt|gt|quot);",a6,cb,61,46),::hx::strings::internal::_Either3::_Either3_obj::b(HX_("g",67,00,00,00)));
            	}
{
            	HX_STACKFRAME(&_hx_pos_fd0a69697a336cdd_36_boot)
HXDLIN(  36)		REGEX_SPLIT_LINES = ::hx::strings::Pattern_obj::compile(HX_("\\r?\\n",bb,cf,67,44),::hx::strings::internal::_Either3::_Either3_obj::b(HX_("g",67,00,00,00)));
            	}
{
            	HX_STACKFRAME(&_hx_pos_fd0a69697a336cdd_39_boot)
HXDLIN(  39)		REGEX_REMOVE_XML_TAGS = ::hx::strings::Pattern_obj::compile(HX_("<[!a-zA-Z\\/][^>]*>",5e,e5,70,7b),::hx::strings::internal::_Either3::_Either3_obj::b(HX_("g",67,00,00,00)));
            	}
{

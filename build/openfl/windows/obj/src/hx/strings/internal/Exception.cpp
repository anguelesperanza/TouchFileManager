...
HXDLIN(  42)		HX_STACK_DO_THROW(this->toString());
            	}
...
HXLINE(  57)				{
HXLINE(  57)					::String x1 = ::StringTools_obj::replace(item,HX_("Called from",cd,13,cb,c9),HX_("| at",17,12,0f,52));
HXDLIN(  57)					if (::hx::IsNotNull( sb->charBuf )) {
HXLINE(  57)						sb->flush();
            					}
HXDLIN(  57)					if (::hx::IsNull( sb->b )) {
HXLINE(  57)						sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            					}
            					else {
HXLINE(  57)						::Array< ::String > sb2 = sb->b;
HXDLIN(  57)						sb2->push(::Std_obj::string(x1));
            					}
            				}
HXLINE(  58)				{

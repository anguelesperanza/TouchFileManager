...
HXLINE( 189)		if ((pos < 0)) {
HXLINE( 189)			HX_STACK_DO_THROW(HX_("[pos] must not be negative",4a,29,00,72));
            		}
HXLINE( 190)		if ((pos > this->len)) {
HXLINE( 190)			HX_STACK_DO_THROW(HX_("[pos] must not be greater than this.length",72,00,e4,81));
            		}
...
HXLINE( 214)					_g = (_g + 1);
HXDLIN( 214)					int i1 = (_g - 1);
HXLINE( 215)					::String str = pre->__get(i1);
...
HXLINE( 217)						pre->insert((i1 + 1),item);
HXLINE( 218)						 ::hx::strings::StringBuilder _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 218)						int _hx_tmp3;
HXDLIN( 218)						if (::hx::IsNull( item )) {
HXLINE( 218)							_hx_tmp3 = 0;
            						}
            						else {
HXLINE( 218)							_hx_tmp3 = item.length;
            						}
HXDLIN( 218)						_hx_tmp2->len = (_hx_tmp2->len + _hx_tmp3);
HXLINE( 219)						return ::hx::ObjectPtr<OBJ_>(this);
            					}
HXLINE( 221)					if ((next_pre_len1 > pos)) {
HXLINE( 222)						::Array< ::String > preSplitted = ::hx::strings::Strings_obj::splitAt(pre->__get(i1),::Array_obj< int >::__new(1)->init(0,(pos - pre_len)));
HXLINE( 223)						pre[i1] = preSplitted->__get(0);
HXLINE( 224)						pre->insert((i1 + 1),item);
HXLINE( 225)						pre->insert((i1 + 2),preSplitted->__get(1));
HXLINE( 226)						 ::hx::strings::StringBuilder _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 226)						int _hx_tmp5;
HXDLIN( 226)						if (::hx::IsNull( item )) {
HXLINE( 226)							_hx_tmp5 = 0;
            						}
            						else {
HXLINE( 226)							_hx_tmp5 = item.length;
            						}
HXDLIN( 226)						_hx_tmp4->len = (_hx_tmp4->len + _hx_tmp5);
...
HXLINE( 241)		{
HXLINE( 241)			 ::StringBuf _this2 = this->sb;
HXDLIN( 241)			if (::hx::IsNotNull( _this2->charBuf )) {
HXLINE( 241)				_this2->flush();
            			}
HXDLIN( 241)			if (::hx::IsNull( _this2->b )) {
HXLINE( 241)				_this2->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(item));
            			}
            			else {
HXLINE( 241)				::Array< ::String > _this3 = _this2->b;
HXDLIN( 241)				_this3->push(::Std_obj::string(item));
            			}
            		}
HXLINE( 242)		 ::hx::strings::StringBuilder _hx_tmp6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 242)		int _hx_tmp7;
HXDLIN( 242)		if (::hx::IsNull( item )) {
HXLINE( 242)			_hx_tmp7 = 0;
            		}
            		else {
HXLINE( 242)			_hx_tmp7 = item.length;
            		}
HXDLIN( 242)		_hx_tmp6->len = (_hx_tmp6->len + _hx_tmp7);
HXLINE( 243)		{
HXLINE( 243)			 ::StringBuf _this4 = this->sb;
...
HXLINE( 243)				_this4->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            			}
            			else {
HXLINE( 243)				::Array< ::String > _this5 = _this4->b;
HXDLIN( 243)				_this5->push(::Std_obj::string(x1));
            			}
            		}
...
HXLINE( 267)		if ((pos < 0)) {
HXLINE( 267)			HX_STACK_DO_THROW(HX_("[pos] must not be negative",4a,29,00,72));
            		}
HXLINE( 268)		if ((pos > this->len)) {
HXLINE( 268)			HX_STACK_DO_THROW(HX_("[pos] must not be greater than this.length",72,00,e4,81));
            		}
...
HXLINE( 292)					_g = (_g + 1);
HXDLIN( 292)					int i1 = (_g - 1);
HXLINE( 293)					::String str = pre->__get(i1);
...
HXLINE( 295)						pre->insert((i1 + 1),::String::fromCharCode(ch));
HXLINE( 296)						this->len++;
HXLINE( 297)						return ::hx::ObjectPtr<OBJ_>(this);
            					}
HXLINE( 299)					if ((next_pre_len1 > pos)) {
HXLINE( 300)						::Array< ::String > preSplitted = ::hx::strings::Strings_obj::splitAt(pre->__get(i1),::Array_obj< int >::__new(1)->init(0,(pos - pre_len)));
HXLINE( 301)						pre[i1] = preSplitted->__get(0);
HXLINE( 302)						pre->insert((i1 + 1),::String::fromCharCode(ch));
HXLINE( 303)						pre->insert((i1 + 2),preSplitted->__get(1));
HXLINE( 304)						this->len++;
...
HXLINE( 320)		{
HXLINE( 320)			 ::StringBuf _this2 = this->sb;
HXDLIN( 320)			::String x1 = sbSplitted->__get(1);
HXDLIN( 320)			if (::hx::IsNotNull( _this2->charBuf )) {
HXLINE( 320)				_this2->flush();
            			}
HXDLIN( 320)			if (::hx::IsNull( _this2->b )) {
HXLINE( 320)				_this2->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            			}
            			else {
HXLINE( 320)				::Array< ::String > _this3 = _this2->b;
HXDLIN( 320)				_this3->push(::Std_obj::string(x1));
            			}
            		}
...
HXLINE( 336)		if ((pos < 0)) {
HXLINE( 336)			HX_STACK_DO_THROW(HX_("[pos] must not be negative",4a,29,00,72));
            		}
HXLINE( 337)		if ((pos > this->len)) {
HXLINE( 337)			HX_STACK_DO_THROW(HX_("[pos] must not be greater than this.length",72,00,e4,81));
            		}
...
HXLINE( 370)			::Array< ::String > pre1 = this->pre;
HXLINE( 371)			int i1 = pre1->length;
HXLINE( 372)			{
HXLINE( 372)				int _g = 0;
HXDLIN( 372)				int _g1 = pre1->length;
HXDLIN( 372)				while((_g < _g1)){
HXLINE( 372)					_g = (_g + 1);
HXDLIN( 372)					int i2 = (_g - 1);
HXLINE( 373)					::String str = pre1->__get(i2);
...
HXLINE( 377)							::String item1 = items->__get(j);
HXLINE( 378)							pre1->insert((i2 + 1),item1);
HXLINE( 379)							 ::hx::strings::StringBuilder _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 379)							int _hx_tmp3;
HXDLIN( 379)							if (::hx::IsNull( item1 )) {
HXLINE( 379)								_hx_tmp3 = 0;
            							}
            							else {
HXLINE( 379)								_hx_tmp3 = item1.length;
            							}
HXDLIN( 379)							_hx_tmp2->len = (_hx_tmp2->len + _hx_tmp3);
            						}
            						_hx_goto_16:;
HXLINE( 381)						return ::hx::ObjectPtr<OBJ_>(this);
            					}
HXLINE( 383)					if ((next_pre_len1 > pos)) {
HXLINE( 384)						::Array< ::String > preSplitted = ::hx::strings::Strings_obj::splitAt(pre1->__get(i2),::Array_obj< int >::__new(1)->init(0,(pos - pre_len)));
HXLINE( 385)						pre1[i2] = preSplitted->__get(0);
HXLINE( 386)						pre1->insert((i2 + 1),preSplitted->__get(1));
HXLINE( 387)						int j1 = items->length;
HXLINE( 388)						while(true){
HXLINE( 388)							j1 = (j1 - 1);
HXDLIN( 388)							if (!(((j1 + 1) > 0))) {
HXLINE( 388)								goto _hx_goto_17;
            							}
HXLINE( 389)							::String item2 = items->__get(j1);
HXLINE( 390)							pre1->insert((i2 + 1),item2);
HXLINE( 391)							 ::hx::strings::StringBuilder _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 391)							int _hx_tmp5;
HXDLIN( 391)							if (::hx::IsNull( item2 )) {
HXLINE( 391)								_hx_tmp5 = 0;
            							}
            							else {
HXLINE( 391)								_hx_tmp5 = item2.length;
            							}
HXDLIN( 391)							_hx_tmp4->len = (_hx_tmp4->len + _hx_tmp5);
            						}
            						_hx_goto_17:;
...
HXDLIN( 400)				while((_g2 < items->length)){
HXLINE( 400)					::String item3 = items->__get(_g2);
HXDLIN( 400)					_g2 = (_g2 + 1);
HXLINE( 401)					this->add(item3);
            				}
            			}
...
HXLINE( 408)		{
HXLINE( 408)			int _g3 = 0;
HXDLIN( 408)			while((_g3 < items->length)){
HXLINE( 408)				::String item4 = items->__get(_g3);
HXDLIN( 408)				_g3 = (_g3 + 1);
HXLINE( 409)				{
HXLINE( 409)					 ::StringBuf _this2 = this->sb;
HXDLIN( 409)					if (::hx::IsNotNull( _this2->charBuf )) {
HXLINE( 409)						_this2->flush();
            					}
HXDLIN( 409)					if (::hx::IsNull( _this2->b )) {
HXLINE( 409)						_this2->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(item4));
            					}
            					else {
HXLINE( 409)						::Array< ::String > _this3 = _this2->b;
HXDLIN( 409)						_this3->push(::Std_obj::string(item4));
            					}
            				}
HXLINE( 410)				 ::hx::strings::StringBuilder _hx_tmp6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 410)				int _hx_tmp7;
HXDLIN( 410)				if (::hx::IsNull( item4 )) {
HXLINE( 410)					_hx_tmp7 = 0;
            				}
            				else {
HXLINE( 410)					_hx_tmp7 = item4.length;
            				}
HXDLIN( 410)				_hx_tmp6->len = (_hx_tmp6->len + _hx_tmp7);
            			}
            		}
HXLINE( 412)		{
HXLINE( 412)			 ::StringBuf _this4 = this->sb;
HXDLIN( 412)			::String x1 = sbSplitted->__get(1);
HXDLIN( 412)			if (::hx::IsNotNull( _this4->charBuf )) {
HXLINE( 412)				_this4->flush();
            			}
HXDLIN( 412)			if (::hx::IsNull( _this4->b )) {
HXLINE( 412)				_this4->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            			}
            			else {
HXLINE( 412)				::Array< ::String > _this5 = _this4->b;
HXDLIN( 412)				_this5->push(::Std_obj::string(x1));
            			}
            		}

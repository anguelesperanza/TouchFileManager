...
HXDLIN(  17)		return  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
HXLINE(  77)			 ::hx::strings::collection::OrderedStringMapImpl m1 = ( ( ::hx::strings::collection::OrderedStringMapImpl)(this1) );
HXLINE(  78)			 ::hx::strings::collection::OrderedStringMapImpl clone =  ::hx::strings::collection::OrderedStringMapImpl_obj::__alloc( HX_CTX );
HXDLIN(  78)			{
HXLINE(  78)				::Dynamic map = m1;
...
HXDLIN(  78)					 ::Dynamic _g_value = ::haxe::IMap_obj::get(_g_map,key);
HXDLIN(  78)					::String _g_key = key;
HXDLIN(  78)					::String k = _g_key;
HXDLIN(  78)					 ::Dynamic v = _g_value;
HXDLIN(  78)					clone->set(k,v);
            				}
            			}
HXDLIN(  78)			return clone;
            		}
HXLINE(  81)		::Dynamic clone1 =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  82)		{
...
HXDLIN(  82)				::String k1 = ( (::String)(_g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic)) );
HXDLIN(  82)				 ::Dynamic v1 =  ::Dynamic(_g1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic));
HXLINE(  83)				::haxe::IMap_obj::set(clone1,k1,v1);
            			}
            		}
HXLINE(  84)		return clone1;
            	}
...
HXLINE( 112)			HX_STACK_DO_THROW(HX_("[items] must not be null!",99,af,60,2f));
            		}
...
HXLINE( 121)			 ::Dynamic _g2 = ::haxe::IMap_obj::keyValueIterator(items);
HXDLIN( 121)			while(( (bool)(_g2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 121)				 ::Dynamic _g3 = _g2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 121)				::String k1 = ( (::String)(_g3->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic)) );
HXDLIN( 121)				 ::Dynamic v1 =  ::Dynamic(_g3->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic));
HXLINE( 122)				if (!(::haxe::IMap_obj::exists(this1,k1))) {
HXLINE( 123)					::haxe::IMap_obj::set(this1,k1,v1);

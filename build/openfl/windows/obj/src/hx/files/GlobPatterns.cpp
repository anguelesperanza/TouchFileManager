...
HXDLIN(  45)			HX_STACK_DO_THROW(HX_("[str] must not be null",39,a9,3f,f6));
            		}
...
HXLINE( 152)						int _hx_tmp1;
HXDLIN( 152)						if ((groupDepth > 0)) {
HXLINE( 152)							_hx_tmp1 = 124;
            						}
            						else {
HXLINE( 152)							_hx_tmp1 = 44;
            						}
HXDLIN( 152)						sb->addChar(_hx_tmp1);
            					}
            				}
            				break;
            				case (int)46: {

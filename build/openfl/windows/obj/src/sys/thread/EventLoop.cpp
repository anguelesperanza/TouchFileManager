...
HXDLIN( 146)		bool _g4 = _g_anyTime;
HXDLIN( 146)		Float _g5 = _g_nextEventAt;
HXDLIN( 146)		Float _hx_switch_0 = _g5;
...
HXLINE( 146)			goto _hx_goto_6;
            		...
            		/* default */{
HXDLIN( 146)			if (_g4) {
HXLINE( 150)				Float time = _g5;
HXDLIN( 150)				return ::sys::thread::NextEventTime_obj::AnyTime(time);
            			}
            			else {
HXLINE( 151)				Float time1 = _g5;
HXDLIN( 151)				return ::sys::thread::NextEventTime_obj::At(time1);
            			}
            		}
            		_hx_goto_6:;

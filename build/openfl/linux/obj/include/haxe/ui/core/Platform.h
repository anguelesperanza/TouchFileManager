...
class HXCPP_CLASS_ATTRIBUTES Platform_obj : public  ::haxe::ui::backend::PlatformImpl_obj
{
	...
	public:
		enum { _hx_ClassId = 0x1e4daad0 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="haxe.ui.core.Platform")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"haxe.ui.core.Platform"); }

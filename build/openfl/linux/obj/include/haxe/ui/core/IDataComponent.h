...
class HXCPP_CLASS_ATTRIBUTES IDataComponent_obj {
	public:
		...
		static inline  ::haxe::ui::data::DataSource get_dataSource( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( ::hx::interface_cast< ::haxe::ui::core::IDataComponent_obj *>(_hx_.mPtr->_hx_getInterface(0xfafb3fc3)))->_hx_get_dataSource)();
		}
		...
		static inline  ::haxe::ui::data::DataSource set_dataSource( ::Dynamic _hx_, ::haxe::ui::data::DataSource value) {
			return (_hx_.mPtr->*( ::hx::interface_cast< ::haxe::ui::core::IDataComponent_obj *>(_hx_.mPtr->_hx_getInterface(0xfafb3fc3)))->_hx_set_dataSource)(value);
		}
};

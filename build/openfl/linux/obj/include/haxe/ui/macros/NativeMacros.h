...
class HXCPP_CLASS_ATTRIBUTES NativeMacros_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< NativeMacros_obj > __new() {
			::hx::ObjectPtr< NativeMacros_obj > __this = new NativeMacros_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< NativeMacros_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("NativeMacros",fe,ef,b4,2d); }

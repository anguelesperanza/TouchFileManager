...
class HXCPP_CLASS_ATTRIBUTES ComponentMacros_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< ComponentMacros_obj > __new() {
			::hx::ObjectPtr< ComponentMacros_obj > __this = new ComponentMacros_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< ComponentMacros_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("ComponentMacros",64,b3,ec,e7); }

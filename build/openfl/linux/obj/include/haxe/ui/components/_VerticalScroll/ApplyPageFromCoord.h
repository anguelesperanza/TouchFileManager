...
#define INCLUDED_haxe_ui_components__VerticalScroll_ApplyPageFromCoord
...
HX_DECLARE_CLASS4(haxe,ui,components,_VerticalScroll,ApplyPageFromCoord)
...
class HXCPP_CLASS_ATTRIBUTES ApplyPageFromCoord_obj : public  ::haxe::ui::behaviours::Behaviour_obj
{
	...
	public:
		enum { _hx_ClassId = 0x14b245f0 };

		void __construct( ::haxe::ui::core::Component component);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="haxe.ui.components._VerticalScroll.ApplyPageFromCoord")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"haxe.ui.components._VerticalScroll.ApplyPageFromCoord"); }
...
#endif /* INCLUDED_haxe_ui_components__VerticalScroll_ApplyPageFromCoord */ 

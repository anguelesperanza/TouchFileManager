...
#define INCLUDED_haxe_ui_components__Button_TextBehaviour
...
HX_DECLARE_CLASS4(haxe,ui,components,_Button,TextBehaviour)
...
class HXCPP_CLASS_ATTRIBUTES TextBehaviour_obj : public  ::haxe::ui::behaviours::DataBehaviour_obj
{
	...
	public:
		enum { _hx_ClassId = 0x3f44e8ef };

		void __construct( ::haxe::ui::core::Component component);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="haxe.ui.components._Button.TextBehaviour")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"haxe.ui.components._Button.TextBehaviour"); }
...
#endif /* INCLUDED_haxe_ui_components__Button_TextBehaviour */ 

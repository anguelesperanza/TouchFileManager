...
class HXCPP_CLASS_ATTRIBUTES MainView_obj : public  ::haxe::ui::containers::VBox_obj
{
	...
	public:
		...
		::String cwd;
		 ::hx::files::Path p;
		::String itemClicked;
		void showDirectory( ::hx::files::Path path, ::haxe::ui::core::Component container);
		::Dynamic showDirectory_dyn();

		::Array< ::String > scanDirectory(::String cwd);
		::Dynamic scanDirectory_dyn();

		void goBackDirectory( ::hx::files::Path path, ::haxe::ui::core::Component container);

...
HX_LOCAL_STACK_FRAME(_hx_pos_8a637e7fc3b98e6a_33_getBytes,"sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","/usr/share/haxe/std/cpp/_std/sys/io/File.hx",33,0xa9f746ff)
HX_LOCAL_STACK_FRAME(_hx_pos_8a637e7fc3b98e6a_44_saveBytes,"sys.io.File","saveBytes",0x6700fb83,"sys.io.File.saveBytes","/usr/share/haxe/std/cpp/_std/sys/io/File.hx",44,0xa9f746ff)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8a637e7fc3b98e6a_59_append,"sys.io.File","append",0x02ba1725,"sys.io.File.append","/usr/share/haxe/std/cpp/_std/sys/io/File.hx",59,0xa9f746ff)
HX_LOCAL_STACK_FRAME(_hx_pos_8a637e7fc3b98e6a_62_update,"sys.io.File","update",0xf9ebbb54,"sys.io.File.update","/usr/share/haxe/std/cpp/_std/sys/io/File.hx",62,0xa9f746ff)
HX_LOCAL_STACK_FRAME(_hx_pos_8a637e7fc3b98e6a_69_copy,"sys.io.File","copy",0x165a7840,"sys.io.File.copy","/usr/share/haxe/std/cpp/_std/sys/io/File.hx",69,0xa9f746ff)
namespace sys{
namespace io{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(File_obj,getContent,return )
 ...
 ::haxe::io::Bytes File_obj::getBytes(::String path){
            	HX_STACKFRAME(&_hx_pos_8a637e7fc3b98e6a_33_getBytes)
...
void File_obj::saveBytes(::String path, ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_8a637e7fc3b98e6a_44_saveBytes)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,read,return )
 ...
 ::sys::io::FileOutput File_obj::write(::String path,::hx::Null< bool >  __o_binary){
            		bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_8a637e7fc3b98e6a_55_write)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,write,return )
 ...
 ::sys::io::FileOutput File_obj::append(::String path,::hx::Null< bool >  __o_binary){
            		bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_8a637e7fc3b98e6a_59_append)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,append,return )
 ...
 ::sys::io::FileOutput File_obj::update(::String path,::hx::Null< bool >  __o_binary){
            		bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_8a637e7fc3b98e6a_62_update)
...
void File_obj::copy(::String srcPath,::String dstPath){
            	HX_STACKFRAME(&_hx_pos_8a637e7fc3b98e6a_69_copy)

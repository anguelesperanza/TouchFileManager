...
HX_DEFINE_STACK_FRAME(_hx_pos_0462ffd2dbc17767_33_new,"sys.ssl.Certificate","new",0x5388a2e6,"sys.ssl.Certificate.new","/usr/share/haxe/std/cpp/_std/sys/ssl/Certificate.hx",33,0x0313ee10)
HX_LOCAL_STACK_FRAME(_hx_pos_00c96e576b0b6060_134___init__,"::sys::ssl::Certificate_obj","__init__",0x6779d94e,"::sys::ssl::Certificate_obj.__init__","/usr/share/haxe/std/cpp/_std/sys/ssl/Certificate.hx",134,0x0313ee10)
HX_LOCAL_STACK_FRAME(_hx_pos_0462ffd2dbc17767_39_loadFile,"sys.ssl.Certificate","loadFile",0xca3fe77c,"sys.ssl.Certificate.loadFile","/usr/share/haxe/std/cpp/_std/sys/ssl/Certificate.hx",39,0x0313ee10)
HX_LOCAL_STACK_FRAME(_hx_pos_0462ffd2dbc17767_43_loadPath,"sys.ssl.Certificate","loadPath",0xd0d5fea5,"sys.ssl.Certificate.loadPath","/usr/share/haxe/std/cpp/_std/sys/ssl/Certificate.hx",43,0x0313ee10)
HX_LOCAL_STACK_FRAME(_hx_pos_0462ffd2dbc17767_50_loadDefaults,"sys.ssl.Certificate","loadDefaults",0xcc9e6992,"sys.ssl.Certificate.loadDefaults","/usr/share/haxe/std/cpp/_std/sys/ssl/Certificate.hx",50,0x0313ee10)
...
void Certificate_obj::__construct( ::Dynamic x, ::sys::ssl::Certificate h){
            	HX_STACKFRAME(&_hx_pos_0462ffd2dbc17767_33_new)
...
void Certificate_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_00c96e576b0b6060_134___init__)
HXDLIN( 134)		_hx_ssl_init();
            	}


 ::sys::ssl::Certificate Certificate_obj::loadFile(::String file){
            	HX_GC_STACKFRAME(&_hx_pos_0462ffd2dbc17767_39_loadFile)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Certificate_obj,loadFile,return )
 ...
 ::sys::ssl::Certificate Certificate_obj::loadPath(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_0462ffd2dbc17767_43_loadPath)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Certificate_obj,loadPath,return )
 ...
 ::sys::ssl::Certificate Certificate_obj::loadDefaults(){
            	HX_GC_STACKFRAME(&_hx_pos_0462ffd2dbc17767_50_loadDefaults)

...
HX_LOCAL_STACK_FRAME(_hx_pos_dec05f81178ee6ce_140_progress,"sys.thread.EventLoop","progress",0xd3ab8d20,"sys.thread.EventLoop.progress","/usr/share/haxe/std/sys/thread/EventLoop.hx",140,0x36352808)
...
bool EventLoop_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::NextEventTime EventLoop_obj::progress(){
            	HX_STACKFRAME(&_hx_pos_dec05f81178ee6ce_140_progress)

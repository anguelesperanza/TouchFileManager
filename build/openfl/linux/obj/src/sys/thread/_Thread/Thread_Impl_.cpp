...
HX_LOCAL_STACK_FRAME(_hx_pos_fab82867dae42cec_54_get_events,"sys.thread._Thread.Thread_Impl_","get_events",0x2940127e,"sys.thread._Thread.Thread_Impl_.get_events","/usr/share/haxe/std/cpp/_std/sys/thread/Thread.hx",54,0x59448795)
...
bool Thread_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::EventLoop Thread_Impl__obj::get_events( ::sys::thread::_Thread::HaxeThread this1){
            	HX_GC_STACKFRAME(&_hx_pos_fab82867dae42cec_54_get_events)

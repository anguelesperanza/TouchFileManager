...
HX_LOCAL_STACK_FRAME(_hx_pos_b4db2871ee22ed2c_35_rename,"sys.FileSystem","rename",0x3aa2fb40,"sys.FileSystem.rename","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",35,0xcabeeced)
HX_LOCAL_STACK_FRAME(_hx_pos_b4db2871ee22ed2c_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",38,0xcabeeced)
HX_LOCAL_STACK_FRAME(_hx_pos_b4db2871ee22ed2c_64_absolutePath,"sys.FileSystem","absolutePath",0x5973f4fe,"sys.FileSystem.absolutePath","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",64,0xcabeeced)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b4db2871ee22ed2c_78_createDirectory,"sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",78,0xcabeeced)
HX_LOCAL_STACK_FRAME(_hx_pos_b4db2871ee22ed2c_93_deleteFile,"sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",93,0xcabeeced)
HX_LOCAL_STACK_FRAME(_hx_pos_b4db2871ee22ed2c_97_deleteDirectory,"sys.FileSystem","deleteDirectory",0x052a5cc0,"sys.FileSystem.deleteDirectory","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",97,0xcabeeced)
HX_LOCAL_STACK_FRAME(_hx_pos_b4db2871ee22ed2c_101_readDirectory,"sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",101,0xcabeeced)
namespace sys{
...
void FileSystem_obj::rename(::String path,::String newPath){
            	HX_STACKFRAME(&_hx_pos_b4db2871ee22ed2c_35_rename)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FileSystem_obj,rename,(void))
 ...
 ::Dynamic FileSystem_obj::stat(::String path){
            	HX_STACKFRAME(&_hx_pos_b4db2871ee22ed2c_38_stat)
HXLINE(  39)		::String s;
HXDLIN(  39)		bool s1;
...
::String FileSystem_obj::absolutePath(::String relPath){
            	HX_STACKFRAME(&_hx_pos_b4db2871ee22ed2c_64_absolutePath)
...
void FileSystem_obj::createDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_b4db2871ee22ed2c_78_createDirectory)
...
void FileSystem_obj::deleteFile(::String path){
            	HX_STACKFRAME(&_hx_pos_b4db2871ee22ed2c_93_deleteFile)
...
void FileSystem_obj::deleteDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_b4db2871ee22ed2c_97_deleteDirectory)
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_b4db2871ee22ed2c_101_readDirectory)

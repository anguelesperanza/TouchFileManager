...
HX_LOCAL_STACK_FRAME(_hx_pos_6ab7e3b0439582c8_81_writeByte,"sys.net._Socket.SocketOutput","writeByte",0xbfd704fb,"sys.net._Socket.SocketOutput.writeByte","/usr/share/haxe/std/cpp/_std/sys/net/Socket.hx",81,0xb72d4153)
HX_LOCAL_STACK_FRAME(_hx_pos_6ab7e3b0439582c8_95_writeBytes,"sys.net._Socket.SocketOutput","writeBytes",0x1c4d5718,"sys.net._Socket.SocketOutput.writeBytes","/usr/share/haxe/std/cpp/_std/sys/net/Socket.hx",95,0xb72d4153)
...
void SocketOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_6ab7e3b0439582c8_81_writeByte)
...
int SocketOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_6ab7e3b0439582c8_95_writeBytes)
HXDLIN(  95)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);

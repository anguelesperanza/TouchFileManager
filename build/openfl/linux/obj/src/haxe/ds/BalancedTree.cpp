...
HX_LOCAL_STACK_FRAME(_hx_pos_4f13c97c1ff92405_181_keysLoop,"haxe.ds.BalancedTree","keysLoop",0x20d5eba9,"haxe.ds.BalancedTree.keysLoop","/usr/share/haxe/std/haxe/ds/BalancedTree.hx",181,0x65905886)
HX_LOCAL_STACK_FRAME(_hx_pos_4f13c97c1ff92405_188_merge,"haxe.ds.BalancedTree","merge",0x620fbce7,"haxe.ds.BalancedTree.merge","/usr/share/haxe/std/haxe/ds/BalancedTree.hx",188,0x65905886)
HX_LOCAL_STACK_FRAME(_hx_pos_4f13c97c1ff92405_198_minBinding,"haxe.ds.BalancedTree","minBinding",0xd2237344,"haxe.ds.BalancedTree.minBinding","/usr/share/haxe/std/haxe/ds/BalancedTree.hx",198,0x65905886)
...
HX_LOCAL_STACK_FRAME(_hx_pos_4f13c97c1ff92405_237_clear,"haxe.ds.BalancedTree","clear",0xa4a48bbc,"haxe.ds.BalancedTree.clear","/usr/share/haxe/std/haxe/ds/BalancedTree.hx",237,0x65905886)
...
bool BalancedTree_obj::remove( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_4f13c97c1ff92405_86_remove)
HXDLIN(  86)		try {
...
bool BalancedTree_obj::exists( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_4f13c97c1ff92405_101_exists)
...
HX_DEFINE_DYNAMIC_FUNC0(BalancedTree_obj,keys,return )
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::setLoop( ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode node){
            	HX_GC_STACKFRAME(&_hx_pos_4f13c97c1ff92405_150_setLoop)
...
HX_DEFINE_DYNAMIC_FUNC3(BalancedTree_obj,setLoop,return )
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::removeLoop( ::Dynamic k, ::haxe::ds::TreeNode node){
            	HX_STACKFRAME(&_hx_pos_4f13c97c1ff92405_163_removeLoop)
...
void BalancedTree_obj::keysLoop( ::haxe::ds::TreeNode node,::cpp::VirtualArray acc){
            	HX_STACKFRAME(&_hx_pos_4f13c97c1ff92405_181_keysLoop)
...
HX_DEFINE_DYNAMIC_FUNC2(BalancedTree_obj,keysLoop,(void))
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::merge( ::haxe::ds::TreeNode t1, ::haxe::ds::TreeNode t2){
            	HX_STACKFRAME(&_hx_pos_4f13c97c1ff92405_188_merge)
...
HX_DEFINE_DYNAMIC_FUNC2(BalancedTree_obj,merge,return )
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::minBinding( ::haxe::ds::TreeNode t){
            	HX_STACKFRAME(&_hx_pos_4f13c97c1ff92405_198_minBinding)
...
HX_DEFINE_DYNAMIC_FUNC1(BalancedTree_obj,minBinding,return )
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::removeMinBinding( ::haxe::ds::TreeNode t){
            	HX_STACKFRAME(&_hx_pos_4f13c97c1ff92405_202_removeMinBinding)
...
HX_DEFINE_DYNAMIC_FUNC1(BalancedTree_obj,removeMinBinding,return )
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::balance( ::haxe::ds::TreeNode l, ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode r){
            	HX_GC_STACKFRAME(&_hx_pos_4f13c97c1ff92405_205_balance)
HXLINE( 206)		int hl;
...
int BalancedTree_obj::compare( ::Dynamic k1, ::Dynamic k2){
            	HX_STACKFRAME(&_hx_pos_4f13c97c1ff92405_226_compare)
...
void BalancedTree_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_4f13c97c1ff92405_237_clear)

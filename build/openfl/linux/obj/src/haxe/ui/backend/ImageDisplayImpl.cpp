...
HXLINE(  74)				_hx_tmp = (this->sprite->contains(this->_bmp) == true);
            			}
            			else {
...
HXLINE( 118)			 ::openfl::display::Sprite _hx_tmp = this->sprite;
HXDLIN( 118)			_hx_tmp->set_scrollRect( ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,-(this->_left),-(this->_top),::Math_obj::fround(this->_imageClipRect->width),::Math_obj::fround(this->_imageClipRect->height)));

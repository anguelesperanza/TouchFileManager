...
HXLINE(  94)			 ::openfl::display::Graphics _hx_tmp = this->get_graphics();
HXDLIN(  94)			::haxe::ui::backend::openfl::OpenFLStyleHelper_obj::paintStyleSection(_hx_tmp,style,::Math_obj::fround(( (Float)(width) )),::Math_obj::fround(( (Float)(height) )),null(),null(),null());
            		}
            	}

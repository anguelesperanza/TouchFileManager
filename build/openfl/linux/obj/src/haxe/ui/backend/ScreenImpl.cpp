...
HXLINE(  25)			int _hx_tmp = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXDLIN(  25)			return (( (Float)(_hx_tmp) ) / ::haxe::ui::Toolkit_obj::get_scaleX());
            		}
HXLINE(  27)		Float _hx_tmp1 = this->get_container()->get_width();
HXDLIN(  27)		return (_hx_tmp1 / ::haxe::ui::Toolkit_obj::get_scaleX());
            	}
...
HXLINE(  32)			int _hx_tmp = ::openfl::Lib_obj::get_current()->stage->stageHeight;
HXDLIN(  32)			return (( (Float)(_hx_tmp) ) / ::haxe::ui::Toolkit_obj::get_scaleY());
            		}
HXLINE(  34)		Float _hx_tmp1 = this->get_container()->get_height();
HXDLIN(  34)		return (_hx_tmp1 / ::haxe::ui::Toolkit_obj::get_scaleY());
            	}
...
HXLINE( 136)				 ::openfl::display::Stage _hx_tmp = ::openfl::Lib_obj::get_current()->stage;
HXDLIN( 136)				_hx_tmp->addEventListener(::haxe::ui::backend::openfl::EventMapper_obj::HAXEUI_TO_OPENFL->get_string(type),this->_hx___onMouseEvent_dyn(),false,0,true);
            			}
...
HXLINE( 158)			 ::openfl::display::Stage _hx_tmp = ::openfl::Lib_obj::get_current()->stage;
HXDLIN( 158)			_hx_tmp->removeEventListener(::haxe::ui::backend::openfl::EventMapper_obj::HAXEUI_TO_OPENFL->get_string(type),this->_hx___onMouseEvent_dyn(),null());

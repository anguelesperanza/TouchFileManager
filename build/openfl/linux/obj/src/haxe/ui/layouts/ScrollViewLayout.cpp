...
HXLINE(  25)			Float _hx_tmp = (this->get_paddingLeft() + borderSize);
HXDLIN(  25)			 ::Dynamic _hx_tmp1 = this->get_component()->get_componentHeight();
HXDLIN(  25)			Float _hx_tmp2 = (( (Float)(_hx_tmp1) ) - ( (Float)(hscroll->get_componentHeight()) ));
HXDLIN(  25)			Float _hx_tmp3 = (_hx_tmp2 - this->get_paddingBottom());
HXDLIN(  25)			hscroll->moveComponent(_hx_tmp,::Math_obj::fround(((_hx_tmp3 + this->marginTop(hscroll)) - borderSize)));
            		}
HXLINE(  29)		bool _hx_tmp1;
HXDLIN(  29)		if (::hx::IsNotNull( vscroll )) {
HXLINE(  29)			_hx_tmp1 = (this->hidden(vscroll) == false);
            		}
            		else {
HXLINE(  29)			_hx_tmp1 = false;
            		}
HXDLIN(  29)		if (_hx_tmp1) {
HXLINE(  33)			 ::Dynamic _hx_tmp = this->get_component()->get_componentWidth();
HXDLIN(  33)			Float _hx_tmp1 = (( (Float)(_hx_tmp) ) - ( (Float)(vscroll->get_componentWidth()) ));
HXDLIN(  33)			Float _hx_tmp2 = (_hx_tmp1 - this->get_paddingRight());
HXDLIN(  33)			Float _hx_tmp3 = (::Math_obj::fround((_hx_tmp2 + this->marginLeft(vscroll))) - borderSize);
HXDLIN(  33)			vscroll->moveComponent(_hx_tmp3,(this->get_paddingTop() + borderSize));
            		}
...
HXLINE(  39)			Float _hx_tmp = (this->get_paddingLeft() + borderSize);
HXDLIN(  39)			contents1->moveComponent(_hx_tmp,(this->get_paddingTop() + borderSize));
            		}
            	}
...
HXLINE(  66)					Float usableSize1 = usableSize->height;
HXDLIN(  66)					Float cy1 = ((usableSize1 * ( (Float)(child->get_percentHeight()) )) / percentHeight);
...
HXLINE(  77)						_hx_tmp1 = ::hx::IsNotNull( vscroll );
            					}
            					else {
HXLINE(  77)						_hx_tmp1 = false;
            					}
HXDLIN(  77)					if (_hx_tmp1) {
HXLINE(  77)						_hx_tmp = (vscroll->get_hidden() == false);
            					}
            					else {
...
HXLINE(  79)							_hx_tmp1 = ::hx::IsNotNull( hscroll );
            						}
            						else {
HXLINE(  79)							_hx_tmp1 = false;
            						}
HXDLIN(  79)						if (_hx_tmp1) {
HXLINE(  79)							_hx_tmp = (hscroll->get_hidden() == false);
            						}
            						else {
...
HXDLIN(  94)			 ::Dynamic _hx_tmp = hscroll->get_componentHeight();
HXDLIN(  94)			size1->height = (size2 - (( (Float)(_hx_tmp) ) - this->marginTop(hscroll)));
            		}
HXLINE(  96)		bool _hx_tmp2;
HXDLIN(  96)		bool _hx_tmp3;
HXDLIN(  96)		if (::hx::IsNotNull( vscroll )) {
HXLINE(  96)			_hx_tmp3 = (vscroll->get_includeInLayout() == true);
            		}
            		else {
HXLINE(  96)			_hx_tmp3 = false;
            		}
HXDLIN(  96)		if (_hx_tmp3) {
HXLINE(  96)			_hx_tmp2 = (this->hidden(vscroll) == false);
            		}
            		else {
HXLINE(  96)			_hx_tmp2 = false;
            		}
HXDLIN(  96)		if (_hx_tmp2) {
HXLINE(  97)			 ::haxe::ui::geom::Size size1 = size;
HXDLIN(  97)			Float size2 = size1->width;
HXDLIN(  97)			 ::Dynamic _hx_tmp = vscroll->get_componentWidth();
HXDLIN(  97)			size1->width = (size2 - (( (Float)(_hx_tmp) ) - this->marginLeft(vscroll)));
            		}
HXLINE( 100)		bool _hx_tmp4;
HXDLIN( 100)		if (::hx::IsNotEq( this->get_component()->get_native(),true )) {
HXLINE( 100)			_hx_tmp4 = (this->_component->get_isNativeScroller() == true);
            		}
            		else {
...
HXLINE( 103)				 ::Dynamic _hx_tmp = contents->get_componentWidth();
HXDLIN( 103)				if (::hx::IsGreater( _hx_tmp,size->width )) {
HXLINE( 104)					 ::haxe::ui::geom::Size size1 = size;
HXDLIN( 104)					Float size2 = size1->height;
HXDLIN( 104)					size1->height = (size2 - ::haxe::ui::core::Platform_obj::get_hscrollHeight());
            				}
HXLINE( 106)				 ::Dynamic _hx_tmp1 = contents->get_componentHeight();
HXDLIN( 106)				if (::hx::IsGreater( _hx_tmp1,size->height )) {
HXLINE( 107)					 ::haxe::ui::geom::Size size1 = size;
HXDLIN( 107)					Float size2 = size1->width;
HXDLIN( 107)					size1->width = (size2 - ::haxe::ui::core::Platform_obj::get_vscrollWidth());
            				}
            			}
            		}
HXLINE( 112)		Float borderSize = this->get_borderSize();
HXLINE( 113)		 ::haxe::ui::geom::Size size1 = size;
HXDLIN( 113)		size1->width = (size1->width - (borderSize * ( (Float)(2) )));
HXLINE( 114)		 ::haxe::ui::geom::Size size2 = size;
HXDLIN( 114)		size2->height = (size2->height - (borderSize * ( (Float)(2) )));
...
HXLINE( 128)			 ::haxe::ui::geom::Size size1 = size;
HXDLIN( 128)			Float size2 = size1->width;
HXDLIN( 128)			size1->width = (size2 + vscroll->get_componentWidth());
            		}
...
HXLINE( 134)				Float _hx_tmp = contents->get_width();
HXDLIN( 134)				if ((_hx_tmp > this->get_component()->get_width())) {
HXLINE( 135)					 ::haxe::ui::geom::Size size1 = size;
HXDLIN( 135)					Float size2 = size1->height;
HXDLIN( 135)					size1->height = (size2 + ::haxe::ui::core::Platform_obj::get_hscrollHeight());
            				}
HXLINE( 137)				Float _hx_tmp1 = contents->get_height();
HXDLIN( 137)				if ((_hx_tmp1 > this->get_component()->get_height())) {
HXLINE( 138)					 ::haxe::ui::geom::Size size1 = size;
HXDLIN( 138)					Float size2 = size1->width;
HXDLIN( 138)					size1->width = (size2 + ::haxe::ui::core::Platform_obj::get_vscrollWidth());
            				}
            			}
            		}
HXLINE( 143)		 ::haxe::ui::geom::Size size1 = size;
HXDLIN( 143)		Float size2 = size1->width;
HXDLIN( 143)		size1->width = (size2 + (this->get_borderSize() * ( (Float)(2) )));
HXLINE( 144)		 ::haxe::ui::geom::Size size3 = size;
HXDLIN( 144)		Float size4 = size3->height;
HXDLIN( 144)		size3->height = (size4 + (this->get_borderSize() * ( (Float)(2) )));

...
HXLINE(1165)					Float _hx_tmp = (usableSize->width / vcw1);
HXDLIN(1165)					hscroll->set_pageSize((_hx_tmp * hscroll->get_max()));
            				}
...
HXLINE(1176)						_hx_tmp = ::hx::IsNotNull( hscroll );
            					}
            					else {
...
HXLINE(1182)			_hx_tmp1 = (usableSize->height > 0);
            		}
            		else {
HXLINE(1182)			_hx_tmp1 = false;
            		}
...
HXLINE(1193)					Float _hx_tmp = (usableSize->height / vch1);
HXDLIN(1193)					vscroll->set_pageSize((_hx_tmp * vscroll->get_max()));
            				}
...
HXLINE(1204)						_hx_tmp = ::hx::IsNotNull( vscroll );
            					}
            					else {
...
HXLINE(1382)				 ::Dynamic style1 = style->contentWidthPercent;
HXDLIN(1382)				_hx_tmp = ::hx::IsNotEq( style1,this->_scrollview->get_percentContentWidth() );
            			}
            			else {
...
HXLINE(1386)			 ::Dynamic style1 = style->contentHeight;
HXDLIN(1386)			_hx_tmp1 = ::hx::IsNotEq( style1,this->_scrollview->get_contentHeight() );
            		}
            		else {
...
HXLINE(1388)				 ::Dynamic style1 = style->contentHeightPercent;
HXDLIN(1388)				_hx_tmp = ::hx::IsNotEq( style1,this->_scrollview->get_percentContentHeight() );
            			}
            			else {

...
HXLINE( 368)			 ::haxe::ui::tooltips::ToolTipManager _hx_tmp = ::haxe::ui::tooltips::ToolTipManager_obj::get_instance();
HXDLIN( 368)			 ::haxe::ui::core::Component _hx_tmp1 = this->_component;
HXDLIN( 368)			_hx_tmp->updateTooltipRenderer(_hx_tmp1,( ( ::haxe::ui::core::ItemRenderer)(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->_value)) ));
            		}
            	}

...
HXLINE( 151)							::Dynamic this1 = this->directives;
HXDLIN( 151)							( ( ::haxe::ds::StringMap)(this1) )->set(HX_("font-italic",ee,98,29,9d), ::haxe::ui::styles::elements::Directive_obj::__alloc( HX_CTX ,HX_("font-italic",ee,98,29,9d),::haxe::ui::styles::Value_obj::VBool(true),null()));
            						}
            						else {
HXLINE( 152)							if ((s == HX_("underline",0c,15,d1,87))) {
HXLINE( 153)								::Dynamic this1 = this->directives;
HXDLIN( 153)								( ( ::haxe::ds::StringMap)(this1) )->set(HX_("font-underline",ce,7d,77,c9), ::haxe::ui::styles::elements::Directive_obj::__alloc( HX_CTX ,HX_("font-underline",ce,7d,77,c9),::haxe::ui::styles::Value_obj::VBool(true),null()));
            							}
            						}
            					}
            				}
...
HXLINE( 105)					this->processComposite( ::haxe::ui::styles::elements::Directive_obj::__alloc( HX_CTX ,HX_("",00,00,00,00),vl->__get(0).StaticCast<  ::haxe::ui::styles::Value >(),null()),::Array_obj< ::String >::fromData( _hx_array_data_e40ef043_22,2),null());
HXLINE( 106)					this->processComposite( ::haxe::ui::styles::elements::Directive_obj::__alloc( HX_CTX ,HX_("",00,00,00,00),vl->__get(1).StaticCast<  ::haxe::ui::styles::Value >(),null()),::Array_obj< ::String >::fromData( _hx_array_data_e40ef043_23,2),null());
            				}
            			}
...
HXLINE(  95)					this->processComposite( ::haxe::ui::styles::elements::Directive_obj::__alloc( HX_CTX ,HX_("",00,00,00,00),vl->__get(0).StaticCast<  ::haxe::ui::styles::Value >(),null()),::Array_obj< ::String >::fromData( _hx_array_data_e40ef043_25,2),null());
HXLINE(  96)					this->processComposite( ::haxe::ui::styles::elements::Directive_obj::__alloc( HX_CTX ,HX_("",00,00,00,00),vl->__get(1).StaticCast<  ::haxe::ui::styles::Value >(),null()),::Array_obj< ::String >::fromData( _hx_array_data_e40ef043_26,2),null());
            				}
            				else {
...
HXDLIN( 166)			switch((int)(_g1->_hx_getIndex())){
            				case (int)1: {
HXLINE( 180)					Float _g = _g1->_hx_getFloat(0);
HXLINE( 181)					{
HXLINE( 181)						int _g2 = 0;
HXDLIN( 181)						while((_g2 < parts->length)){
HXLINE( 181)							::String p = parts->__get(_g2);
HXDLIN( 181)							_g2 = (_g2 + 1);
HXLINE( 182)							{
HXLINE( 182)								::Dynamic this1 = this->directives;
HXDLIN( 182)								( ( ::haxe::ds::StringMap)(this1) )->set(p, ::haxe::ui::styles::elements::Directive_obj::__alloc( HX_CTX ,p,d->value,null()));
            							}
            						}
            					}
            				}
...
HXDLIN( 177)							_g = (_g + 1);
HXLINE( 178)							{
HXLINE( 178)								::Dynamic this1 = this->directives;
HXDLIN( 178)								( ( ::haxe::ds::StringMap)(this1) )->set(p, ::haxe::ui::styles::elements::Directive_obj::__alloc( HX_CTX ,p,::haxe::ui::styles::Value_obj::VDimension(v),null()));
            							}
            						}
            					}
            				}
            				break;
            				case (int)4: {
HXLINE( 168)					int _g = _g1->_hx_getInt(0);
HXLINE( 169)					if ((duplicate == false)) {
HXLINE( 170)						::Dynamic this1 = this->directives;
...
HXDLIN( 170)						( ( ::haxe::ds::StringMap)(this1) )->set(parts->__get(0),value);
            					}
            					else {
HXLINE( 172)						int _g = 0;
HXDLIN( 172)						while((_g < parts->length)){
HXLINE( 172)							::String p = parts->__get(_g);
HXDLIN( 172)							_g = (_g + 1);
HXLINE( 173)							{
...
HXDLIN( 173)								( ( ::haxe::ds::StringMap)(this1) )->set(p, ::haxe::ui::styles::elements::Directive_obj::__alloc( HX_CTX ,p,d->value,null()));
            				...
            				break;
            				case (int)6: {
HXLINE( 167)					::String _g = _g1->_hx_getString(0);
            				}
            				break;
            				case (int)7: {
...
HXLINE( 188)									 ::haxe::ui::styles::elements::Directive nd =  ::haxe::ui::styles::elements::Directive_obj::__alloc( HX_CTX ,p,vl->__get(n).StaticCast<  ::haxe::ui::styles::Value >(),null());
HXLINE( 189)									this->processDirective(nd);
HXLINE( 190)									this->directives->set(p,nd);
            								}
HXLINE( 192)								n = (n + 1);
            							}
            						}
            				...
            				case (int)9: {
HXLINE( 195)					int _g = 0;
HXDLIN( 195)					while((_g < parts->length)){
HXLINE( 195)						::String p = parts->__get(_g);
HXDLIN( 195)						_g = (_g + 1);
HXLINE( 196)						 ::haxe::ui::styles::elements::Directive nd =  ::haxe::ui::styles::elements::Directive_obj::__alloc( HX_CTX ,p,d->value,null());
HXLINE( 197)						this->processDirective(nd);
HXLINE( 198)						this->directives->set(p,nd);
            					}
            				}
            				break;
            				default:{
...
HXLINE(  64)				 ::haxe::ui::core::Component p = d->parentComponent;
...
HXLINE(  72)				 ::haxe::ui::core::Component p = d->parentComponent;

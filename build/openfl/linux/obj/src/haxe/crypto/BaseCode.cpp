...
HX_LOCAL_STACK_FRAME(_hx_pos_bcdbedb757785a37_44_encodeBytes,"haxe.crypto.BaseCode","encodeBytes",0x58a8e40a,"haxe.crypto.BaseCode.encodeBytes","/usr/share/haxe/std/haxe/crypto/BaseCode.hx",44,0x2847b3a0)
...
bool BaseCode_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes BaseCode_obj::encodeBytes( ::haxe::io::Bytes b){
            	HX_STACKFRAME(&_hx_pos_bcdbedb757785a37_44_encodeBytes)

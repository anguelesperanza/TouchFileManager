...
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_54_get_text,"lime.system.Clipboard","get_text",0xe647e374,"lime.system.Clipboard.get_text","lime/system/Clipboard.hx",54,0x9490b5ee)
...
::String Clipboard_obj::get_text(){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_54_get_text)
HXLINE(  63)		if (::hx::IsNull( ::lime::_hx_system::Clipboard_obj::_text )) {
HXLINE(  65)			::lime::_hx_system::Clipboard_obj::_hx___update();
HXLINE(  69)			::lime::_hx_system::Clipboard_obj::set_text(::lime::_hx_system::Clipboard_obj::_text);
            		}
HXLINE(  73)		return ::lime::_hx_system::Clipboard_obj::_text;
            	}
